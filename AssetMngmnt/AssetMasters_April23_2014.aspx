...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td class="NormalText" style="width: 196px">
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                SelectCommand="SELECT b.asset_type_name,b.asset_type_id FROM dbo.jct_asset_type_master b JOIN jct_asset_master a ON a.asset_id=b.asset_id  WHERE  a.status='A' and a.asset_id =@asset_id">
                <SelectParameters>
    ...
    <tr>
        ...
        <td class="NormalText" style="height: 15px; width: 105px;">
            Acquisition Date</td>
    ...
    <tr>
        ...
        <td class="NormalText" style="width: 196px">
            <asp:DropDownList ID="ddlmanufacturer" runat="server" CssClass="combobox" 
                DataSourceID="SqlDataSource3" DataTextField="manufacturer" 
                DataValueField="manufacturer_id">
              
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                SelectCommand="SELECT manufacturer,manufacturer_id from dbo.jct_asset_manufacturer_master WHERE status='A'">
            </asp:SqlDataSource>
        </td>
        <td class="NormalText" style="width: 105px">
            State</td>
