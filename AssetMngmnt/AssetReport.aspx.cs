...
public partial class AssetManagment_AssetReport : System.Web.UI.Page
{
    ...
    private void bindgrid_NotActiveEmployee()
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("Jct_Asset_Aceeptance_Status_NotActive", con);
        
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@AuthStatus", SqlDbType.VarChar, 20).Value = "All";
        ...
        GridViewEmployeeNotActive.DataSource = null;
        GridViewEmployeeNotActive.DataBind();

        if (ds.Tables.Count > 0)
        {
            GridViewEmployeeNotActive.DataSource = ds.Tables[0];
            GridViewEmployeeNotActive.DataBind();         
        }
        ...
        try
        {
          ...
          //  url = "http://localhost:4052/FusionApps/OPS/MailContentPages/asset_sendmail_new.aspx?" + querystring;
            // url = "http://test2k/FusionApps/OPS/MailContentPages/asset_sendmail_new.aspx?" + querystring;
             ...
             url = "http://testerp/FusionApps/OPS/MailContentPages/asset_sendmail_new.aspx?" + querystring;
