...
<script type="text/javascript"> 
    ...
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 122px">
                ...
                <asp:SqlDataSource ID="SqlDataSource13" runat="server"
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                    SelectCommand="Select '' as state_desc,-1 as state_id Union SELECT state_desc,state_id FROM jct_asset_state_master  where status='A' order by state_id"></asp:SqlDataSource>
            </td>
        ...
        <tr>
            <td class="NormalText" style="width: 80px">Shared</td>
            <td class="NormalText" style="width: 122px">
            ...
            <td class="NormalText" style="width: 115px">ComputerName</td>
            <td class="NormalText">
