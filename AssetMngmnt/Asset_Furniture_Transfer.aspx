<%@ Page Title="" Language="C#" MasterPageFile="~/AssetMngmnt/MasterPage.master" AutoEventWireup="true" CodeFile="Asset_Furniture_Transfer.aspx.cs" Inherits="AssetMngmnt_Asset_Furniture_Transfer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="mytable">
                ...
                <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <telerik:RadComboBox ID="ddlTargetSubloc" runat="server" AutoPostBack="True" CssClass="combobox"
                            EnableVirtualScrolling="True" Height="85px" OnSelectedIndexChanged="ddlTargetSubloc_SelectedIndexChanged">
                            <Items>
                                <telerik:RadComboBoxItem runat="server" />
                            </Items>
                        </telerik:RadComboBox>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddltargetloc" EventName="SelectedIndexChanged" />
                        <asp:AsyncPostBackTrigger ControlID="ddlSubloc" EventName="SelectedIndexChanged" />
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddltargetloc" EventName="SelectedIndexChanged" />
                        <asp:AsyncPostBackTrigger ControlID="ddlTargetSubloc" EventName="SelectedIndexChanged" />
                        <asp:AsyncPostBackTrigger ControlID="ddlSubloc" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText">
             <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                <telerik:RadComboBox ID="ddlRefType" runat="server" CssClass="combobox" EnableVirtualScrolling="True"
                    Height="85px">
                    <Items>
                        ...
                        <telerik:RadComboBoxItem runat="server" Text="Invoice" Value="Invoice" />
                        <telerik:RadComboBoxItem runat="server" Text="Igp" Value="Igp" />
                    </Items>
                </telerik:RadComboBox>
                </ContentTemplate>
                </asp:UpdatePanel>
            ...
            <td class="NormalText">
             ...
             <%--   <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                    <ContentTemplate>--%>
                       <asp:TextBox ID="txtrefdocno" runat="server" CssClass="textbox"></asp:TextBox>
                        <asp:LinkButton ID="lnkInvoiceDetail" runat="server" CssClass="searchbluesmall" 
                            Height="16px" OnClick="lnkInvoiceDetail_Click" Width="16px">LinkButton</asp:LinkButton>
                  <%--  </ContentTemplate>
                </asp:UpdatePanel>--%>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:TextBox ID="txtRemarks" runat="server" CssClass="textbox" TextMode="MultiLine"
                    Height="50px" Width="300px" ToolTip="Remarks If Any." TabIndex="15"></asp:TextBox>
            </td>
            <td class="NormalText" style="width: 115px">
                &nbsp;
            </td>
        ...
        <tr>
            <td class="NormalText">     
                        <%--<asp:Panel ID="pnlInvoice" runat="server" Height="300px" ScrollBars="Vertical">
                            <asp:GridView ID="grdInvoiceDetail" runat="server"                                  
                                 Width="100%" 
                                >
    ...
    <table class="mytable">
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlInvoice" runat="server" Height="100px" ScrollBars="Vertical">
                    <asp:GridView ID="grdInvoiceDetail" runat="server" Width="100%">
                        <AlternatingRowStyle CssClass="GridAI" />
                        <HeaderStyle CssClass="HeaderStyle" />
                        <PagerStyle CssClass="PageStyle" />
                    </asp:GridView>
                                    ...
                                    <asp:TemplateField HeaderText="AllocationDate">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtAllocationDate" runat="server" Columns="12" CssClass="textbox"
                                                MaxLength="100" Text='<%# Eval("AllocationDate") %>' Width="70px" ToolTip="Remarks"></asp:TextBox>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="lblTotaltext" runat="server" Text="Total Items" CssClass="Normal text"></asp:Label>:
                                <asp:Label ID="lblTotal" runat="server" CssClass="Normal text"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddltargetloc" EventName="SelectedIndexChanged" />
