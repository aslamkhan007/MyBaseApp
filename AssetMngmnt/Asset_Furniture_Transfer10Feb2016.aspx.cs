    ...
    protected void lnkTransfer_Click(object sender, EventArgs e)
    {
        ...
        if (OK == "OK")
        {
            ...
            try
            {
                ...
                item_id = Convert.ToInt16(cmd.Parameters["@item_id"].Value.ToString());
                ...
                foreach (GridViewRow gvRow in grdDetail.Rows)
                {
                    ...
                    {
                        int TransNo = Convert.ToInt16(gvRow.Cells[8].Text);
                ...
                cmd.Parameters.Add("@RefdocNo", SqlDbType.VarChar, 200).Value = txtempcode.Text;
