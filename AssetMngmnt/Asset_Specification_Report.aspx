<%@ Page Title="" Language="C#" MasterPageFile="~/AssetMngmnt/MasterPage.master" AutoEventWireup="true" CodeFile="Asset_Specification_Report.aspx.cs" Inherits="AssetMngmnt_Asset_Specification_Report" %>
...
<script type="text/javascript">
    ...
    <table class="mytable">
        <tr>
            <td class="tableheader" colspan="6">Asset Specification Report:</td>
        </tr>
        <tr>
            ...
            <td class="NormalText">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ...
                    SelectCommand="Select '' as Asset,-1 as Asset_ID Union SELECT ITEM_NAME AS ASSET, ASSET_ID  FROM JCT_ASSET_MASTER WHERE STATUS=@STATUS and module_usedby='MIS' ORDER BY ASSET_ID">
                    <SelectParameters>
            ...
            <td class="NormalText">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                    SelectCommand="Select '' as Asset_type_Name,-1 as Asset_Type_ID  Union SELECT ASSET_TYPE_NAME ,ASSET_TYPE_ID FROM JCT_ASSET_TYPE_MASTER WHERE STATUS='A' and module_usedby='MIS'  AND  ASSET_ID=@ASSET_ID ORDER BY ASSET_TYPE_ID">
                    <SelectParameters>
        ...
        <tr>
            ...
            <td class="NormalText">
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                    SelectCommand="select distinct type_name,SrNo  from jct_asset_type_master_detail where status=@status and asset_type_ID=@ASSET_TYPE_ID and module_usedby='MIS' ">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="A" Name="status" Type="String" />
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 122px">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                    SelectCommand="SELECT name,id from dbo.jct_asset_manufacturer_master WHERE status='A' and type='manufacturer' and module_usedby='MIS'  order by id"></asp:SqlDataSource>
            </td>
                 ...
                 <%--             <asp:TemplateField HeaderText="E-mail">
                                  <ItemTemplate>
                                      <asp:LinkButton ID="lnkemail" runat="server" BorderStyle="None" 
                                          ...
                                          onclick="lnkemail_Click"></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>--%>
