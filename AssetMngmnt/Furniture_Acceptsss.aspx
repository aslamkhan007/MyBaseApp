<%@ Page Title="" Language="C#" MasterPageFile="~/AssetMngmnt/MasterPage.master"
    AutoEventWireup="true" CodeFile="Furniture_Acceptsss.aspx.cs" Inherits="AssetMngmnt_Furniture_Accept" %>
        ...
        <tr>
            <td class="buttonbackbar" colspan="6">
                ...
                <asp:LinkButton ID="lnkaccept" runat="server" CssClass="buttonc" 
                    OnClick="lnkaccept_Click" ValidationGroup="mandatory" >Accept</asp:LinkButton>
                ...
                <asp:LinkButton ID="lnkRaiseConcern" runat="server" CssClass="buttonc" 
                            onclick="lnkRaiseConcern_Click">Raise Concern</asp:LinkButton>
                <%--                        <asp:TemplateField HeaderText="AllocationDate">
                            <ItemTemplate>
                                <asp:Label ID="lblAllocationDate" runat="server" Text='<%# Eval("AllocationDate") %>'></asp:Label>
                            </ItemTemplate>
