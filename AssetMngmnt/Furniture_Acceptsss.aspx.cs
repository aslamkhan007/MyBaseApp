        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                if (emailid == 0)
                {
                    ...
                    to = "ashish@jctltd.com,rbaksshi@jctltd.com";
                }
                else if (emailid == 1)
                {
                ...
                {
                    ViewState["RequestBy"] = usercode;
                    ViewState["RequestByEmail"] = "aslam@jctltd.com,ashish@jctltd.com,rbaksshi@jctltd.com";
                    Body = "<html><body><Table><tr><td>The Following User</td></tr><BR /><tr><td>EmployeeCode " + UserCode + "</td></tr><BR /><tr><td>EmployeeName : " + ds.Tables[0].Rows[0]["empname"].ToString() + " </td> </tr><BR /><tr><td>Location : " + location + "</td></tr><Br/><tr><td>Sublocation: " + Sublocation + "</td></tr><Br/>  <tr><td>Does Not Have Email Id</td></table></body></html>";
                    to = "ashish@jctltd.com,rbaksshi@jctltd.com,manishk@jctltd.com";
                }
            }
            ...
            bcc = "aslam@jctltd.com,ashish@jctltd.com,rbaksshi@jctltd.com,manishk@jctltd.com";
    ...
    protected void lnkRaiseConcern_Click(object sender, EventArgs e)
    {
        ...
        if (OK == "OK")
        {
            ...
            try
            {
                ...
                to = "aslam@jctltd.com" + "," + "kamal@jctltd.com" + "," +Genratedby_Email; 
                //to = too;

                bcc = "aslam@jctltd.com,rbaksshi@jctltd.com";
                //bcc = bccc;
