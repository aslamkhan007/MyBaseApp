                  ...
                  RepeatColumns="6" 
                    ...
                    <ItemTemplate>
                        <table>
                                ...
                                <td>
                                    <div style="margin: auto; width: 64px">
                                        <asp:ImageButton ID="ImageButton3" runat="server" 
                                            AlternateText='<%# Eval("RefDocActFileName") %>' 
                                            ImageUrl='<%# Eval("LogoImgPath") %>' Visible="False" Width="30px" />
                            ...
                            <tr>
                             <%--CommandArgument='<%# Eval("RefDocActFileName") + "," + Eval("ItemId") %>' --%>
                                <td class="NormalText" style="text-align: center">
                                    <asp:LinkButton ID="HyperLink1" runat="server"                                    
                                        CommandArgument='<%# Eval("RefDocActFileName") + "," + Eval("ItemId") %>' CommandName="Download" 
                                        NavigateUrl='<%# Eval("RefDocFilePath") %>' 
                                        Text='<%# Eval("RefDocActFileName") %>' ></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
                ...
                <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div ID="FileUploadContainer">
                            &nbsp;<img alt="Add File" onclick="AddFileUpload()" src="../Image/Icons/Action/document_add.png"
                            width="30" /><%--<asp:ImageButton ID="imgUpload" runat="server" AlternateText="Upload File(s)"
                                ImageUrl="~/OPS/Image/Upload.png" Width="48px" />--%></div>
                    </ContentTemplate>
                    <Triggers>
            ...
            <td class="buttonbackbar">
                ...
                <asp:UpdatePanel ID="Updbuttons" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkDelete" runat="server" CssClass="buttonc" OnClick="lnkDelete_Click" >Remove</asp:LinkButton>
