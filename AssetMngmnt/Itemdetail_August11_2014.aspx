        ...
        <tr>
            ...
            <td class="NormalText" style="width: 277px">
                ...
                <asp:SqlDataSource ID="SqlDataSource13" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                    SelectCommand="SELECT state_desc,state_id FROM jct_asset_state_master where Status='A'">
                </asp:SqlDataSource>
            </td>
            <td class="NormalText" style="width: 141px">
                Plant</td>
        ...
        <tr>
            ...
            <td class="NormalText" >
              ...
              <asp:SqlDataSource ID="SqlDataSource23" runat="server" 
                ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                SelectCommand="SELECT '' AS name ,'' AS [id] UNION  SELECT name,[id] from dbo.jct_asset_manufacturer_master WHERE status='A' and type='Manufacturer'">
            </asp:SqlDataSource> 
            </ContentTemplate>
                       <Triggers>
                           <asp:AsyncPostBackTrigger ControlID="lnkReset" EventName="Click" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="AssetType">
                                    <ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="SELECT ITEM_NAME AS ASSET, ASSET_ID  FROM JCT_ASSET_MASTER WHERE STATUS=@STATUS ORDER BY ASSET_ID">
                                            <SelectParameters>
                                ...
                                <asp:TemplateField HeaderText="ItemDescripction">
                                    <ItemTemplate>
                                        <telerik:RadComboBox ID="ddlItemDesc" Runat="server"  Height="200" EnableVirtualScrolling="true" ExpandDirection="Down"  CheckBoxes="True" DataSourceID="SqlDataSource3" DataTextField="item_desc" DataValueField="item_id" EnableCheckAllItemsCheckBox="True">
                                        </telerik:RadComboBox>
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="select  type_name  as item_desc,SrNo as item_id from jct_asset_type_master_detail where status=@status and asset_type_ID=@ASSET_TYPE_ID and asset_type_name <>'Processor' union select type_name +', '+ type_description as item_desc,asset_type_id as item_id from jct_asset_type_description where asset_type_id=@ASSET_TYPE_ID and status='A' order by type_name">
                                            <SelectParameters>
                                                <asp:Parameter DefaultValue="A" Name="status" Type="String" />
            ...
            <td class="buttonbackbar">
                ...
                <asp:UpdatePanel ID="Updbuttons" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkDelete" runat="server" CssClass="buttonc" onclick="lnkDelete_Click">Delete</asp:LinkButton>
