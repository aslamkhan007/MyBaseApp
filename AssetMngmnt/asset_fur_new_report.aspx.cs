...
public partial class AssetMngmnt_asset_fur_new_report : System.Web.UI.Page
{
    ...
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                // }
                cmd.Parameters.Add("@asset_type_id", SqlDbType.VarChar, 20).Value = ddlAssetCatg.SelectedItem.Text;
                cmd.Parameters.Add("@item_desc", SqlDbType.VarChar, 40).Value = ddlItemDesc.SelectedItem.Text;
    ...
    protected void ddlAssetCatg_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
    {
