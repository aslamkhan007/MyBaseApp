...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="mytable">
        ...
        <tr>
           ...
           <td class="NormalText" style="width: 196px">
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ...
                SelectCommand="SELECT b.asset_type_name,b.asset_type_id FROM dbo.jct_asset_type_master b JOIN jct_asset_master a ON a.asset_id=b.asset_id and a.status=b.status   WHERE  a.status='A' and a.module_usedby='MIS' ">
        ...
        <tr>
            <td class="NormalText">
                <asp:Label ID="lbjctsrno" runat="server" Text="Jct Srno"></asp:Label>
            </td>
            <td class="NormalText">
