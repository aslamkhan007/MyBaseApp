            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="SELECT DISTINCT deptloc  FROM  dbo.jct_asset_item_details WHERE status='a'"></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="SELECT  description  FROM dbo.jct_asset_manufacturer_master  WHERE type='Vendor'  AND status='A'"></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="SELECT  description  FROM dbo.jct_asset_manufacturer_master  WHERE type='Manufacturer'  AND status='A'"></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="NormalText">
        ...
        <tr>
            <td class="buttonbackbar" colspan="4">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:LinkButton ID="lnkadd" runat="server" CssClass="buttonc" onclick="lnkadd_Click">Add</asp:LinkButton>
                        <asp:LinkButton ID="lnkupd" runat="server" CssClass="buttonc" onclick="lnkupd_Click">Update</asp:LinkButton>
        ...
        <tr>
            <td class="NormalText" colspan="4">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="grdDetail" runat="server" AutoGenerateSelectButton="True" onselectedindexchanged="grdDetail_SelectedIndexChanged" Width="100%">
