<%@ Page Title="" Language="C#" MasterPageFile="~/Courier Tracking System/MasterPage.master"
    AutoEventWireup="true" CodeFile="Authorize_Courier_Requests.aspx.cs" Inherits="Courier_Tracking_System_Authorize_Courier_Requests" %>
...
Select DeptName ,DeptCode from Deptmast where Company_Code='JCT00LTD' order by DeptName">
        ...
        <tr>
            ...
            <td class="NormalText" colspan="3">
                <asp:DropDownList ID="ddlSelectType" runat="server"  OnSelectedIndexChanged="ddlSelectType_SelectedIndexChanged">
         ...
         <tr>
            <td class="NormalText" style="width: 146px">
                <asp:Label ID="Label46" runat="server" Text="Courier Service"></asp:Label>
            </td>
            <td class="NormalText" colspan="3">
                <asp:DropDownList ID="ddlCourierService" runat="server" CssClass="combobox" 
                    DataSourceID="SqlDataSource3" DataTextField="Courier_Service" 
                    DataValueField="Courier_Service" AppendDataBoundItems="True" 
                  >
                    <asp:ListItem Selected="True"></asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                    SelectCommand="SELECT Courier_Service,Courier_Service FROM dbo.jct_Courier_Service_Master WHERE STATus='A'">
                </asp:SqlDataSource>
            </td>
            <td class="NormalText">
                &nbsp;</td>
        ...
        <tr>
            <td class="NormalText" style="width: 146px">
                <asp:Label ID="Label45" runat="server" Text="Courier Id"></asp:Label>
            </td>
            <td class="NormalText" colspan="3">
                 
                <asp:TextBox ID="txtCourierID" runat="server"
        ...
        <tr>
            <td class="buttonbackbar">
                ...
                <asp:LinkButton ID="lnkAddCost" runat="server" CssClass="buttonc"  
                    ...
                    onclick="lnkCancel_Click" Visible="False">Cancel</asp:LinkButton>
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  EnableModelValidation="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Ref. No">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="txtDispatchDt" runat="server" Columns="12" Text='<%#Eval("DispatchDt")%>' 
                                        CssClass="textbox" MaxLength="10"></asp:TextBox>
                                    <asp:CalendarExtender ID="txtDispatchDt_CalendarExtender" runat="server" 
                                        TargetControlID="txtDispatchDt">
                                    </asp:CalendarExtender>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Cost">
                                <ItemTemplate>
                                    ...
                                    <ContentTemplate>
                                    <asp:LinkButton ID="lnkSave" Visible="false" runat="server" onclick="lnkSave_Click">Save</asp:LinkButton>
                                    </ContentTemplate>
                                    </asp:UpdatePanel>
                                </ItemTemplate>
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Party Name">
                                <ItemTemplate>
                                 <asp:Label ID="lblPartyCode" runat="server" Text='<%# Eval("Party_Name") %>'></asp:Label>
