                        ...
                        <telerik:RadGrid ID="radgrdCheckDetail" runat="server" CellSpacing="0" GridLines="None" 
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="AWBNo,AWBNo">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="PartyName" 
                                        FilterControlAltText="Filter PartyName column" HeaderText="PartyName" 
                                        SortExpression="PartyName" UniqueName="PartyName">
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="80px" />
                                    </telerik:GridBoundColumn>
                                     <telerik:GridBoundColumn DataField="RequestBy" 
                                        FilterControlAltText="Filter RequestBy column" HeaderText="RequestBy" 
                                        SortExpression="RequestBy" UniqueName="RequestBy">
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="80px" />
                                    </telerik:GridBoundColumn>
