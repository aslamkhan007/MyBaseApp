...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 120px">
                <asp:Label ID="Label28" runat="server" Text="Courier Type"></asp:Label>
            </td>
            <td class="NormalText">
                <asp:DropDownList ID="ddlCourierType" runat="server" CssClass="combobox">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem>Personal</asp:ListItem>
                    <asp:ListItem>Non-Personal</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
            ...
            <td class="buttonbackbar" colspan="4">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkList" runat="server" CssClass="buttonc" 
                            onclick="lnkList_Click">List</asp:LinkButton>
  ...
  <asp:LinkButton ID="lnkExcel" runat="server" CssClass="buttonc" 
       ...
       <asp:LinkButton ID="lnkToExcel" runat="server" CssClass="buttonXL" 
                    Height="32px"  ToolTip="Export To Excel" Width="32px" Visible="False"></asp:LinkButton>
                        
                        <asp:HyperLink ID="hlnk" runat="server" 
                            
                    NavigateUrl="~/Courier%20Tracking%20System/Couriers_Generated.aspx">Summary
                        </asp:HyperLink>
    ...
    <ContentTemplate>
      <asp:Panel ID="Panel3" runat="server" Height="500px" ScrollBars="Vertical" 
          ...
          <asp:GridView ID="GridView2" runat="server"  
              ShowFooter="True" Width="100%" PageSize="50" 
