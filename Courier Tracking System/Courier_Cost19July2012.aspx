                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle" EmptyDataText="No data found."
                                ...
                                <Columns>
                                    <asp:HyperLinkField DataNavigateUrlFields="Cost_Center" 
                                        DataNavigateUrlFormatString="Detailed_Cost.aspx?DeptName={0}" 
                                        HeaderText="Detail" Text="Select" Target="_blank" />
                                    <asp:TemplateField HeaderText="Cost Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCostCenter" runat="server" Text='<%# Eval("Cost_Center") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Department">
                                        <ItemTemplate>
                                            <asp:Label ID="Label24" runat="server" Text='<%# Eval("DeptName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cost">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkCost" runat="server" Text='<%# Eval("Cost") %>' Visible="True"></asp:LinkButton>
                                          
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="No. Of Couriers Sent">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkCourierSent" runat="server" Text='<%# Eval("Couriers_Sent") %>'
