<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/Planning/MasterPagePlanning.master" AutoEventWireup="true" CodeFile="Final_Plan.aspx.cs" Inherits="OPS_Planning_Final_Plan" %>
                                     ...
                                     <asp:TemplateField HeaderText="Case Type">
                                       <ItemTemplate>
                                           ...
                                           <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                               ...
                                               SelectCommand="Select '--Select--' as [CaseType] Union SELECT Distinct  [CaseType] FROM [JCT_Process_Greigh_Request_Variation] where GetDate() between Eff_from and Eff_To">
                                           </asp:SqlDataSource>
