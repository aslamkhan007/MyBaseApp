...
<%--        <script type = "text/javascript">
            function DisableButton() {
                document.getElementById("<%=lnkSubmit.ClientID %>").disabled = true;
            }
                    ...
                    <table style="width: 100%;" class="tableback">
                        ...
                        <td class="NormalText" colspan="3">
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txt" runat="server" AutoPostBack="True" CssClass="textbox" 
                                                OnTextChanged="txt_TextChanged" TabIndex="5" 
                                                ToolTip="Enter party Code or click Search Button to search Party."></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ControlToValidate="txt" Enabled="False" ErrorMessage="Please Enter Party Code"></asp:RequiredFieldValidator>
                                        </ContentTemplate>
                                        <Triggers>
                                            ...
                                            <asp:AsyncPostBackTrigger ControlID="rblSelect" 
                                                EventName="SelectedIndexChanged" />
                                            <asp:AsyncPostBackTrigger ControlID="rblSaleOffices" 
                                                EventName="SelectedIndexChanged" />
                                ...
                                <tr>
                                    <td colspan="3">
                                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="GrdAddress" runat="server" AllowPaging="True" OnPageIndexChanging="GrdAddress_PageIndexChanging"
                                                    PageSize="3" onselectedindexchanged="GrdAddress_SelectedIndexChanged">
                            ...
                            <tr>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtPartyName" runat="server" AutoPostBack="True" 
                                                CssClass="textbox" OnTextChanged="txtPartyName_TextChanged" TabIndex="6" 
                                            ...
                                            <div ID="divwidth" style="display: none;">
                                                <cc1:AutoCompleteExtender ID="txtSupplierName_AutoCompleteExtender" 
                                                    runat="server" CompletionInterval="1" CompletionListCssClass="AutoExtender" 
                                                    CompletionListElementID="divwidth" 
                                                    CompletionListHighlightedItemCssClass="AutoExtenderHighlight" 
                                                    CompletionListItemCssClass="AutoExtenderList" FirstRowSelected="True" 
                                                    MinimumPrefixLength="1" ServiceMethod="SupplierAddress_CourierSystem" 
                                                    ServicePath="~/WebService.asmx" TargetControlID="txtSupplierName">
                                                </cc1:AutoCompleteExtender>
                                            </div>
                                            <div ID="divwidth1" style="display: none;">
                                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" 
                                                    ...
                                                    CompletionListHighlightedItemCssClass="AutoExtenderHighlight" 
                                                    CompletionListItemCssClass="AutoExtenderList" FirstRowSelected="True" 
                                                    MinimumPrefixLength="1" ServiceMethod="CustomerAddress_CourierSystem" 
                                                    ServicePath="~/WebService.asmx" TargetControlID="txtPartyName">
                                                </cc1:AutoCompleteExtender>
                                            </div>
                                            <br />
                                            <asp:TextBox ID="txtOtherParty" runat="server" AutoPostBack="True" 
                                                CssClass="textbox" ontextchanged="txtOtherParty_TextChanged" TabIndex="6" 
                                                Visible="False" Width="200px"></asp:TextBox>
                                            <cc1:AutoCompleteExtender ID="txtOtherParty_AutoCompleteExtender" 
                                                runat="server" CompletionInterval="1" CompletionListCssClass="AutoExtender" 
                                                CompletionListElementID="divwidth" 
                                                CompletionListHighlightedItemCssClass="AutoExtenderHighlight" 
                                                CompletionListItemCssClass="AutoExtenderList" FirstRowSelected="True" 
                                                MinimumPrefixLength="1" ServiceMethod="OtherPartyAddress_CourierSystem" 
                                                ServicePath="~/WebService.asmx" TargetControlID="txtOtherParty">
                                            </cc1:AutoCompleteExtender>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="GridView2" 
                                            ...
                                            <asp:AsyncPostBackTrigger ControlID="rblSaleOffices" 
                                                EventName="SelectedIndexChanged" />
                                            <asp:AsyncPostBackTrigger ControlID="GrdAddress" 
                                                EventName="SelectedIndexChanged" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                    <a ID="addLink" href="javascript:void(0)" onclick="ShowEditBox()" 
                                        style="display: none;" title="Add">Add</a>
                                </td>
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtAdd1" runat="server" CssClass="textbox" TabIndex="7" 
                                                Width="200px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                ControlToValidate="txtAdd1" ErrorMessage="Address cannot Be Blank" 
                            ...
                            <tr>
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtAdd2" runat="server" CssClass="textbox" TabIndex="8" 
                                                Width="200px"></asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="GridView2" 
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtAdd3" runat="server" CssClass="textbox" TabIndex="9" 
                                                Width="200px"></asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="GridView2" 
                            ...
                            <tr>
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtCity1" runat="server" CssClass="textbox" TabIndex="10" 
                                                Width="200px"></asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="GridView2" 
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtZipCode" runat="server" Columns="11" CssClass="textbox" 
                            ...
                            <tr>
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtState1" runat="server" Columns="25" CssClass="textbox" 
                                ...
                                <td class="NormalText">
                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtCountry1" runat="server" Columns="20" CssClass="textbox" 
                            ...
                            <tr>
                                ...
                                <td class="NormalText">
                                    <asp:TextBox ID="txtDestination" runat="server" Columns="25" CssClass="textbox" 
                                        TabIndex="12"></asp:TextBox>
                                </td>
                                <td class="NormalText">
                                </td>
        ...
        <tr>
            <td class="buttonbackbar" colspan="2">
                <asp:LinkButton ID="lnkSubmit" runat="server" CssClass="buttonc" OnClick="lnkSubmit_Click"
                    TabIndex="16" ValidationGroup="A">Submit</asp:LinkButton>
                <asp:LinkButton ID="lnkSubmit0" runat="server" CssClass="buttonc" OnClick="lnkSubmit0_Click"
                    TabIndex="17">Reset</asp:LinkButton>
