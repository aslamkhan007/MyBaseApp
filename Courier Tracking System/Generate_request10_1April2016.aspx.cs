...
public partial class Courier_Tracking_System_Generate_request10 : System.Web.UI.Page
{
    ...
    protected void EmptyFormWithoutPartyCode()
    {
        #region Empty textbox value
        txtAdd1.Text = "";
        txtAdd2.Text = "";
    ...
    protected void SubmitRecord()
    {
        ...
        try
        {
            ...
            if (obj1.CheckRecordExistInTransaction(sql, Tran, con2))
            {
                ...
                string msg = "alert('Request generated Successfully.Your Request number is : " + hd3.Value + " ');window.location ='Generate_request10.aspx';";                
    ...
    protected void txt_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rblSelect.SelectedItem.Text == "Customer")
            {
                ...
                sql = " SELECT b.cust_name as Custmer  , a.address_1 as Addr1 , a.address_2 as  Addr2  , a.address_3  as Addr3, a.city  as City , a.State ,  a.country as Country,isnull(a.zip_no,'') as ZipCode,isnull(a.Phone_no,'') as [Phone]  FROM miserp.som.dbo.m_cust_address a JOIN miserp.som.dbo.m_customer b ON a.cust_no=b.cust_no where a.cust_no ='" + txt.Text + "' ";
                if (obj1.CheckRecordExistInTransaction(sql))
                {
                    SqlDataReader dr = obj1.FetchReader(sql);
                    if (dr.HasRows)
                    {
                        ...
                        dsCustomers.Tables.Add("cust_name");
                        dsCustomers.Tables.Add("address_1");
                        dsCustomers.Tables.Add("address_2");
                        dsCustomers.Tables.Add("address_3");
                        dsCustomers.Tables.Add("city");
                        dsCustomers.Tables.Add("State");
                        dsCustomers.Tables.Add("country");
                        dsCustomers.Tables.Add("zip_no");
                        dsCustomers.Tables.Add("Phone_no");                        
                        dsCustomers.Tables[0].Load(dr);
                        GrdAddress.DataSource = dsCustomers;
                        GrdAddress.DataBind();
            ...
            if (rblSelect.SelectedItem.Text == "Supplier")
            {
                ...
                sql = "Select vendor_name as Vendor , ISnull(addr1,'') as Addr1 , Isnull(addr2,'') as Addr2  , Isnull(addr3,'') as Addr3 , Isnull(city,'') as City  , State ,  Country,ISnull( zipcode,'') as ZipCode,isnull(phone_no,'') as [Phone]  from miserp.apdb.dbo.ap_vendor_master where vendor_code ='" + txt.Text + "' ";
                if (obj1.CheckRecordExistInTransaction(sql))
                {
                    SqlDataReader dr = obj1.FetchReader(sql);
                    if (dr.HasRows)
                    {
                        ...
                        DataSet dsCustomers = new DataSet();
                        dsCustomers.Tables.Add("vendor_name");
                        dsCustomers.Tables.Add("addr1");
                        dsCustomers.Tables.Add("addr2");
                        dsCustomers.Tables.Add("addr3");
                        dsCustomers.Tables.Add("city");
                        dsCustomers.Tables.Add("State");
                        dsCustomers.Tables.Add("country");
                        dsCustomers.Tables.Add("zipcode");
                        dsCustomers.Tables.Add("phone_no");                        
                        dsCustomers.Tables[0].Load(dr);
                        GrdAddress.DataSource = dsCustomers;
                        GrdAddress.DataBind();
    ...
    private void BindAddressGrid()
    {
        try
        {
            if (rblSelect.SelectedItem.Text == "Customer")
            {
                ...
                da.Fill(ds);
                GrdAddress.DataSource = ds.Tables[0];
                GrdAddress.DataBind();
            }
    ...
    {
        GrdAddress.PageIndex = e.NewPageIndex;
        BindAddressGrid();
    }
    protected void GrdAddress_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblSelect.SelectedItem.Text == "Customer")
        {
            txtPartyName.Text = GrdAddress.SelectedRow.Cells[1].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtAdd1.Text = GrdAddress.SelectedRow.Cells[2].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtAdd2.Text = GrdAddress.SelectedRow.Cells[3].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtAdd3.Text = GrdAddress.SelectedRow.Cells[4].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtCity1.Text = GrdAddress.SelectedRow.Cells[5].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtState1.Text = GrdAddress.SelectedRow.Cells[6].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtCountry1.Text = GrdAddress.SelectedRow.Cells[7].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtZipCode.Text = GrdAddress.SelectedRow.Cells[8].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtPhoneNo.Text = GrdAddress.SelectedRow.Cells[9].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
        }
        if (rblSelect.SelectedItem.Text == "Supplier")
        {
            txtSupplierName.Text = GrdAddress.SelectedRow.Cells[1].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtAdd1.Text = GrdAddress.SelectedRow.Cells[2].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtAdd2.Text = GrdAddress.SelectedRow.Cells[3].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtAdd3.Text = GrdAddress.SelectedRow.Cells[4].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
            txtCity1.Text = GrdAddress.SelectedRow.Cells[5].Text.Replace("&nbsp;", "").Replace("&amp;", "&");
