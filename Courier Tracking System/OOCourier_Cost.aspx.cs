...
public partial class Courier_Tracking_System_Courier_Cost : System.Web.UI.Page
{
    ...
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
       ...
       // sql = "Select a.ecode as [Salary Code],b.deptcode as [Dept],a.Name as [Name],a.Designation,a.DOB as [DOB] ,a.Age as [Age],a.Relation as [Relationship] from GMEIS2 a inner join deptmast b on a.dept=b.deptcode and a.status='A' and a.mode='Submit' ";
    ...
    public bool CreateExcelFile(DataTable dt)
    {
        ...
        string sTableStart = "<HTML><BODY><TABLE Border=1><TR><TH>Total Courier Cost Between "+ txtDateFrom.Text +" and "+ txtDateTo.Text +"</TH></TR>";
