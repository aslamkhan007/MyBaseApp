...
public partial class Courier_Tracking_System_ReceiptEntryScreen : System.Web.UI.Page
{
    ...
    protected void lnkUpdate_Click(object sender, EventArgs e)
    {
        ...
        //else
        {
            ...
            sql = "Insert into jct_courier_ReciptNo_Entry(Reciept_No,Dept,Amount,Status,EntryBy,EntryDate,Courier_Service,Remarks)values(@Reciept_No,@Dept,@Amount,@Status,@EntryBy,@EntryDate,@Courier_Service,@Remarks)";
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            FMsg.CssClass = "errormsg";
            FMsg.Message = "Please select record to be deleted.";
            FMsg.Display();
        }
    }
}