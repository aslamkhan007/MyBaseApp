...
public partial class Courier_Tracking_System_ReceiptEntryScreen : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddlDept.SelectedItem.Text = GridView1.SelectedRow.Cells[2].Text;
    ...
    {
        sql = "Select Courier_Service,Dept,Reciept_No,Amount,CONVERT(VARCHAR,Entrydate,106)  as [Entry Date] from jct_courier_ReciptNo_Entry where Status='A'  order by Reciept_No Desc";
        obj1.FillGrid(sql, ref GridView2);
    }
    protected void GridView2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ddlCourier.SelectedItem.Text = GridView2.SelectedRow.Cells[1].Text;
        ddlDept.SelectedItem.Text = GridView2.SelectedRow.Cells[2].Text;
