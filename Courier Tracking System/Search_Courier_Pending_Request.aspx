<%@ Page Title="" Language="C#" MasterPageFile="~/Courier Tracking System/MasterPage.master" AutoEventWireup="true" CodeFile="Search_Courier_Pending_Request.aspx.cs" Inherits="Courier_Tracking_System_Search_Courier_Pending_Request" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                   ...
                   <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        <asp:LinkButton ID="lnkSearch" runat="server" CssClass="buttonc" 
                            onclick="lnkSearch_Click" ValidationGroup="mandatory">Search</asp:LinkButton>
  ...
  EmptyDataText="No Record Found ..." onrowdatabound="grdDetail_RowDataBound" AutoGenerateColumns="False" 
                                 >
                        ...
                        <RowStyle CssClass="GirdItem" />
                          <Columns>  
                            <asp:HyperLinkField DataNavigateUrlFields="Courier ID" DataNavigateUrlFormatString="Cancel_Courier_Pending_Request.aspx?CourierID={0}" Text="Cancel" />

                                <asp:BoundField DataField="Courier ID" HeaderText="Courier ID"   ItemStyle-Wrap="True" />   
                                        ...
                                        <asp:BoundField DataField="Courier" HeaderText="Courier" />   
                                          <asp:BoundField DataField="Delivery" HeaderText="Delivery" />   
                                            <asp:BoundField DataField="SUBJECT" HeaderText="SUBJECT" />   
                                              <asp:BoundField DataField="Request By" HeaderText="Request By" />
                                                <asp:BoundField DataField="Request Date" HeaderText="Request Date" />
                                                <asp:BoundField DataField="Remarks" HeaderText="Remarks"   ItemStyle-Width="50px" ItemStyle-Wrap="True" ItemStyle-VerticalAlign="Bottom" />   
