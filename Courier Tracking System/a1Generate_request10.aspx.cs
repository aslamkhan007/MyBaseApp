...
public partial class a1Courier_Tracking_System_Generate_request10 : System.Web.UI.Page
{
            ...
            if (obj1.CheckRecordExistInTransaction(sql, Tran, con2))
            {
                ...
                if (chkIsSample.Checked==true)
                {
                   sql = "Jct_Courier_Request_Invoices_insert";
                    ...
                    bundles = ((Label)(GrdInvoice.Rows[i].FindControl("lblBundleNo"))).Text;
        ...
        if (dr.HasRows)
        {
            while (dr.Read())
            {
                ...
                if (chkIsSample.Checked == true)
                {
                    ...
                    sm.SendMailStringBuilder(sender_email, "noreply@jctltd.com", " " + subject + " ( ID - " + hd3.Value + ")  ", sb, "harshsoni@jctltd.com");
    ...
    protected void txt_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rblSelect.SelectedItem.Text == "Customer")
            {
                ...
                sql = " SELECT b.cust_name , a.address_1 , a.address_2  , a.address_3 , a.city  , a.State ,  a.country,isnull(a.zip_no,'') as ZipCode,isnull(a.Phone_no,'') as [Phone]  FROM miserp.som.dbo.m_cust_address a JOIN miserp.som.dbo.m_customer b ON a.cust_no=b.cust_no where a.cust_no ='" + txt.Text + "' and address_id=1";
                if (obj1.CheckRecordExistInTransaction(sql))
                {
                    SqlDataReader dr = obj1.FetchReader(sql);
                    if (dr.HasRows)
    ...
    protected void GrdInvoice_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "fetch")
        {
            ...
            lblbundles = (Label)(gvr.FindControl("lblBundleNo"));
