...
public partial class Courier_Tracking_System_Courier_Cost : System.Web.UI.Page
{
    ...
    {
        sql = " Exec jct_courier_TotalCost_ToExcel '" + txtDateFrom.Text + "','" + txtDateTo.Text + "','" + ddlDept.SelectedItem.Value + "','" + ddlCourierService.SelectedItem.Value + "'";//,'" + ddlCourierType.SelectedItem.Value + "' ";
        obj1.FillGrid(sql, ref GridView1);
    ...
    {
        sql = " Exec jct_courier_TotalCost '" + txtDateFrom.Text + "','" + txtDateTo.Text + "','" + ddlDepartment.SelectedItem.Value + "','" + ddlCourierService.SelectedItem.Value + "' ";
        //sql = " Exec jct_courier_TotalCost_ToExcel '" + txtDateFrom.Text + "','" + txtDateTo.Text + "','" + ddlDept.SelectedItem.Text + "','" + ddlCourierService.SelectedItem.Text + "' ";
