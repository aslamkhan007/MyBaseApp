...
Partial Public Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        objfun.AddBlurAtt(ContentPlaceHolder1)

        If Not Page.IsPostBack Then
            objfun.RegAppHit(Session("Companycode"), Session("Empcode"), "DocMgmt", Request.UserHostAddress)
    ...
    Protected Sub TreeView1_SelectedNodeChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Dr As SqlDataReader = objfun.FetchReader(Sqlpass)
        Try
