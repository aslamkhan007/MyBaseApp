...
Partial Class ResultGrid
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        qry = "JCT_DMS_Search_File_Move '" & "~\dms\" & "','','','','','','" & Session("Empcode") & "','" & Request.QueryString("catg") & "','',' Select * from #t1 '"
        'qry = "JCT_DMS_Search_File_Move '" & Server.MapPath("~\dms\") & Session("Empcode") & "\" & "','" & Request.QueryString("catg") & "','',' Select * from #t1 '"

        dr = obj1.FetchReader(qry)
        ...
        'qry = "JCT_DMS_Search_File_Typewise '" & Server.MapPath("~\dms\") & Session("Empcode") & "\','','','','','','" & Session("Empcode") & "','" & Request.QueryString("catg") & "','',' Select * from #t1 '"

        obj1.FillGrid(qry, GrdResult)
    ...
    Protected Sub GrdResult_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GrdResult.SelectedIndexChanged
        ...
        qry = "JCT_DMS_Search_File_Move_Test '" & Server.MapPath("~\DOCmgmt\upd\") & "','','','','','','" & Session("Empcode") & "','" & Request.QueryString("catg") & "','" & CType(GrdResult.SelectedRow.FindControl("LnkTrans"), HyperLink).Text & "',' Select path from #t1 ','" + DirectCast(GrdResult.SelectedRow.FindControl("lblName"), Label).Text + "'"
