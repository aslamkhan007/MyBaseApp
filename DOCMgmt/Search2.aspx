...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 650px; height: 107px;" border="2">
        ...
        <tr>
            <td class="labelcells" style="width: 98px">
        ...
        <tr>
            <td class="labelcells" colspan="4">
                <table border="2" cellpadding="2" cellspacing="2" style="width:75%;">
                    <tr>
        ...
        <tr>
            <td class="labelcells" style="width: 98px; height: 23px">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                    SelectCommand="select deptname from deptmast where company_code='jct00ltd' order by deptname">
                </asp:SqlDataSource>
            </td>
            <td class="textcells" width="30%" style="height: 23px" colspan="3">
                <asp:TextBox runat="server" TextMode="MultiLine" Rows="2" Width="373px" 
