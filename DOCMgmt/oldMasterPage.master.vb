...
Partial Public Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim Sqlpass As String = "select description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='DocMgmt' and uname='" & Session("Empcode") & "'   and parent_menu=''   UNION select b.description,page_name=isnull(c.page_name,''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='DocMgmt' and uname='" & Session("Empcode") & "'  and parent_menu='' order by parent_menu,seq"
            ...
            For Each rowResp In objDS.Tables("Parent").Rows
                ...
                '---------------Parent Node-----------------------
                Dim Sqlpass1 As String = "select  description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='DocMgmt' and uname='" & Session("Empcode") & "'   and parent_menu='" & ID1 & " '   UNION select b.description,page_name=isnull(c.page_name,''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='DocMgmt' and uname='" & Session("Empcode") & "'  and parent_menu='" & ID1 & " ' order by parent_menu,seq"
                ...
                For Each rowUnder In objDS1.Tables("dtUnder").Rows
                    ...
                    Dim Sqlpass2 As String = "select description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='DocMgmt'and uname='" & Session("Empcode") & "'   and parent_menu='" & ID2 & "'  UNION select b.description,page_name=isnull(c.page_name,''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='DocMgmt'and uname='" & Session("Empcode") & "'  and parent_menu='" & ID2 & "' order by parent_menu,seq"
                    ...
                    For Each rowUnder2 In objDS2.Tables("dtUnder2").Rows
                        ...
                        Dim Sqlpass3 As String = "select  description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='DocMgmt' and uname='" & Session("Empcode") & "'    and parent_menu='" & ID3 & "'  UNION select b.description,page_name=isnull(c.page_name,''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='DocMgmt' and uname='" & Session("Empcode") & "'  and parent_menu='" & ID3 & "' order by parent_menu,seq"
    ...
    'Protected Sub LinkButton4_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton4.Click
    '    Response.Redirect("Login.aspx")
    'End Sub

    'Protected Sub cmdHome_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdHome.Click
