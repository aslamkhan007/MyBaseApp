...
Dim update As String = ""
        ...
        update = update & "All employees from the rank of D.M. and above are requested to submit their car allowance forms with accounts department before the month end. ~~ Please check your I Tax Computation and submit related documents immidiately to Mr. Surinder Mohindroo in Factory Dept otherwise necessary tax deductions will be made. ~~"
        'update = update & " ~~~~ Please find Holiday Calender 2012 under Office Orders. ~~~~ "
        'urgent = "~~ Please Submit your Medical Bills for Reimbursement till 10 Mar 2016 in Factory Dept. after this date rest of the amount will become taxable."
        ...
        ' update = update & "~~ WISHING ALL OF YOU  VERY HAPPY HOLI. ~~"
        ...
        ' update = update & "~~ Please Submit your Medical Bills for Reimbursement till 16 Mar 2015 in Factory Dept. ~~"
        ...
        mytext = update & urgent & mytext &  greetings & news '& " ~~~ Please keep your Contact Detail up to date in Personal Profile Area of FUSION APPS ~~~ "
