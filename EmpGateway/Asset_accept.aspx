    ...
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText" colspan="5">
                <asp:TextBox ID="txtremarks" runat="server" CssClass="textbox" Height="35px" 
                    TextMode="MultiLine" Width="200px" MaxLength="400"></asp:TextBox>
        ...
        <tr>
            <td class="buttonbackbar" colspan="6">
                <asp:LinkButton ID="lnkaccept" runat="server" CssClass="buttonc" 
                    onclick="lnkaccept_Click" Enabled="False">Accept</asp:LinkButton>
                <asp:LinkButton ID="lnkreject" runat="server" CssClass="buttonc" 
                    onclick="lnkreject_Click" ValidationGroup="A" Enabled="False">Reject</asp:LinkButton>
