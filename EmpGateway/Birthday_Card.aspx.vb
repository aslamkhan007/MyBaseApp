...
Partial Class Birthday_Card
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        lblTo.Text = lblTo.Text + " " + StrConv(Trim(Get_empname(Session("Empcode"), Session("Companycode"))), VbStrConv.ProperCase) + ","
        Me.Lbllocation.Text = Me.Lbllocation.Text + " " + Session("Loc")
        'lblMsg.Text = lblMsg.Text.Insert(8, " 19th August, 2008,")
        Dim DOB As String = Format(CDate(Get_dob(Session("Empcode"), Session("Companycode"))), "dd MMMM,")
