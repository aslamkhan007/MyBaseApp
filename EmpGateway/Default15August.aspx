...
document.write('</td></table>')
        ...
        <tr>
            <td colspan="3" style="height: 320px; text-align: center; background-color: dimgray;" valign="middle">
                <Bewise:flashcontrol id="FlashControl1" runat="server" FlashVersion="9" height="320px"
                    loop="True" movieurl="~/Ind2New.swf" width="99%" AlternativeImage="~/Ind.jpg" XHTMLcompliant="True" BgColor="#404040">
