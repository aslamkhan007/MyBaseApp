<%@ Page Language="VB" MasterPageFile="MasterPage_Default.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="_Default" title="Welcome to Employee Gateway" %>
...
//}
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="height: 100%">
        <tr>
            <td style="font-family: 'Trebuchet MS'; font-size: 10pt; font-weight: bold; color: #CC0000; text-align: center; background-image: url('../Image/Background/Default_Page_Bg.png'); height: 380px;">
