...
document.write('</td></table>')
        ...
        <tr>
            <td colspan="3" style="height: 315px; text-align: center;" valign="middle">
                <Bewise:FlashControl id="FlashControl1" runat="server" FlashVersion="5" height="318px"
                    loop="True" movieurl="~/Gurpurb Guru Gobind Singh Ji.swf" width="100%" XHTMLcompliant="True" AlternativeImage="~/Gurpurb Guru Gobind Singh Ji.PNG">
                </Bewise:FlashControl></td>
        </tr>
        <tr>
            <td colspan="3" style="background-image: url(Image/FormHeader.PNG); height: 26px;
                text-align: center" valign="middle">
            </td>
        </tr>
    </table>
