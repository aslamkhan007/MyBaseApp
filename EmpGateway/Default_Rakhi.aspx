...
document.write('</td></table>')
        ...
        <tr>
            <td colspan="3" style="height: 320px; text-align: center;" valign="middle">
                <Bewise:flashcontrol id="FlashControl1" runat="server" FlashVersion="5" height="320px"
                    loop="True" movieurl="~/Rakhi.swf" width="100%" AlternativeImage="~/Rakhi.PNG" XHTMLcompliant="True">
