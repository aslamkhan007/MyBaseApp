...
document.write('</td></table>')
        ...
        <tr>
            <td colspan="3" style="background-image: url(Image/FormHeader.PNG); height: 27px;
                text-align: center" valign="middle">
                <div style="font-size: 18pt; z-index: 1; left: 227px; width: 140px; color: #ffff66;
                    font-family: 'Monotype Corsiva'; top: 201px; height: 23px">
                    To JCT Family</div>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 320px; text-align: center;" valign="middle">
                <Bewise:flashcontrol id="FlashControl1" runat="server" FlashVersion="5" height="341px"
                    loop="True" movieurl="~/GandhiJayanti.swf" width="100%" AlternativeImage="~/Dussehra-2" XHTMLcompliant="True">
                </Bewise:flashcontrol></td>
        </tr>
        <tr>
            <td colspan="3" style="background-image: url(Image/FormFooter.PNG); height: 26px;
                text-align: center" valign="middle">
                <div style="font-size: 16pt; left: 781px; width: 173px; color: yellow; font-family: 'Monotype Corsiva';
                    top: 534px; height: 23px">
                    From IT Deptt.</div>
            </td>
        </tr>
    </table>
