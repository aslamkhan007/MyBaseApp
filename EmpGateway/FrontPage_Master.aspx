...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <td style="width: 275px; text-align: left; " class="textcells">
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                  <ContentTemplate>
                              ...
                              <asp:ListItem Value="MedTips">Medical Tips</asp:ListItem>
                              <asp:ListItem Value="GenTips">General Tips</asp:ListItem>
                               <asp:ListItem Value="My Area">My Area</asp:ListItem>
                               <asp:ListItem Value="Technical News Letter">Technical News Letter</asp:ListItem>
                               <asp:ListItem Value="Notice Board">Notice Board</asp:ListItem>
                          </asp:DropDownList>
         
                  </ContentTemplate>
            </asp:UpdatePanel>
            </td>
              <td style="text-align: left; " class="labelcells" colspan="2">
          
                  <asp:Label ID="Label24" runat="server" Font-Names="Tahoma" Font-Size="8pt" 
                      ForeColor="Red" Text="Note: Please select Item Category before search"></asp:Label>
        ...
        <tr>
            ...
            <td style="width: 275px; text-align: left; height: 12px;" valign="top" 
               ...
               <ContentTemplate>
                <asp:TextBox ID="txtSDesc" runat="server" CssClass="textbox" Width="263px" 
        ...
        <tr>
            <td style="border-left: thin groove #C0C0C0; border-top: thin groove #C0C0C0; width: 111px; text-align: left; border-bottom-width: thin; border-bottom-color: #C0C0C0; border-top-style: groove; border-bottom-style: none; border-left-style: groove;" 
                class="labelcells">
                <asp:Label ID="Label2" runat="server" Text="Upload Icon Image" Width="107px" 
                    Height="16px"></asp:Label>
            </td><td style="border-top: thin groove #C0C0C0; border-bottom: thin none #C0C0C0; width: 275px; text-align: left; "  valign="top" class="textcells">
                <asp:UpdatePanel ID="UpdatePanel28" runat="server">
                    ...
                    Height="22px" Width="183px" /><asp:LinkButton ID="CmdUpload" runat="server" CssClass="buttonc" 
                                    ...
                                    </Triggers></asp:UpdatePanel></td><td style="border-top: thin groove #C0C0C0; border-bottom: thin none #C0C0C0; text-align: left; width: 104px; border-top-style: groove; border-bottom-style: groove;" class="labelcells" rowspan="3">
    ...
    Width="89px" Height="80px" />
            ...
            <td style="border-right: thin groove #C0C0C0; border-top: thin groove #C0C0C0; border-bottom: thin none #C0C0C0; text-align: left; width: 249px;" 
                class="textcells">
                &nbsp;</td>
        </tr>
        <tr>
            <td style="border-left: thin groove #C0C0C0; border-top: thin groove #C0C0C0; width: 111px; text-align: left; border-bottom-width: thin; border-bottom-color: #C0C0C0; border-top-style: none; border-bottom-style: none; border-left-style: groove;" 
                class="labelcells">
                <asp:Label ID="Label18" runat="server" Text="Path"></asp:Label>
            </td>
            <td style="border-top: thin none #C0C0C0; border-bottom: thin none #C0C0C0; width: 275px; text-align: left; " 
            ...
            <td style="border-right: thin groove #C0C0C0; border-top: thin groove #C0C0C0; border-bottom: thin none #C0C0C0; text-align: left; width: 249px; border-top-style: none; border-right-style: groove; border-bottom-style: none;" 
                class="textcells">
                &nbsp;</td>
        </tr>
        <tr>
            <td style="border-left: thin groove #C0C0C0; border-top: thin groove #C0C0C0; width: 111px; text-align: left; border-bottom-width: thin; border-bottom-color: #C0C0C0; border-top-style: none; border-bottom-style: groove; border-left-style: groove;" 
                class="labelcells">
                &nbsp;</td>
            <td style="border-top: thin none #C0C0C0; border-bottom: thin groove #C0C0C0; width: 275px; text-align: left; " 
                valign="top" class="textcells">
                &nbsp;</td>
            <td style="border-right: thin groove #C0C0C0; border-top: thin groove #C0C0C0; border-bottom: thin none #C0C0C0; text-align: left; width: 249px; border-top-style: none; border-right-style: groove; border-bottom-style: groove;" 
                class="textcells">
                &nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="border-left: thin groove #C0C0C0; border-top: thin groove #C0C0C0; border-bottom: thin groove #C0C0C0; width: 111px; text-align: left; border-top-style: groove; border-bottom-style: none; border-left-style: groove;" 
                class="labelcells">
                <asp:Label ID="Label23" runat="server" Text="Document Type"></asp:Label>
            </td>
            <td style="border-top: thin groove #C0C0C0; border-bottom: thin none #C0C0C0; width: 275px; text-align: left; " 
                valign="top" class="textcells">
            ...
            <td style="border-top: thin groove #C0C0C0; border-bottom: thin groove #C0C0C0; text-align: left; width: 104px; border-top-style: groove; border-bottom-style: none;" 
                class="labelcells">
                &nbsp;</td>
            <td style="border-right: thin groove #C0C0C0; border-top: thin none #C0C0C0; border-bottom: thin none #C0C0C0; text-align: left; width: 249px; border-top-style: groove; border-right-style: groove; border-bottom-style: none;" 
                class="textcells">
                <asp:UpdatePanel ID="UpdatePanel31" runat="server">
                    <ContentTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server">View Document Here</asp:HyperLink>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td></tr>
        <tr>
            <td style="border-left: thin groove #C0C0C0; border-top: thin groove #C0C0C0; border-bottom: thin groove #C0C0C0; width: 111px; text-align: left; border-top-style: none; border-bottom-style: groove; border-left-style: groove;" 
                class="labelcells">
            ...
            <td style="border-top: thin none #C0C0C0; border-bottom: thin groove #C0C0C0; width: 275px; text-align: left; " 
                valign="top">
                           <asp:UpdatePanel ID="UpdatePanel27" runat="server">
                                ...
                                </td><td style="border-top: thin groove #C0C0C0; border-bottom: thin groove #C0C0C0; text-align: left; width: 104px; border-top-style: none; border-bottom-style: groove;"class="labelcells">
                <asp:Label ID="Label20" runat="server" Text="Path"></asp:Label>
            </td>
            <td style="border-right: thin groove #C0C0C0; border-top: thin none #C0C0C0; border-bottom: thin none #C0C0C0; text-align: left; width: 249px; border-top-style: none; border-right-style: groove; border-bottom-style: groove;" 
                class="textcells">
                <asp:UpdatePanel ID="UpdatePanel18" runat="server">
              <ContentTemplate>
                  <asp:TextBox ID="txtDocumentIconImage" runat="server" CssClass="textbox" 
                      MaxLength="50" Width="246px" Enabled="False"></asp:TextBox> 
                      </ContentTemplate>
                      </asp:UpdatePanel>
                
                <br /></td></tr><tr><td style="text-align: left; font-size: 1px;" 
                class="labelcells" colspan="4">
                &nbsp;</td>
            </tr>
        <tr><td style="width: 111px; text-align: left; border-top-style: groove; border-left-style: groove; border-top-width: thin; border-bottom-width: thin; border-left-width: thin; border-top-color: #C0C0C0; border-bottom-color: #C0C0C0; border-left-color: #C0C0C0;" 
                class="labelcells">
                <asp:Label ID="lblEffFrom" runat="server" Text="Eff From"></asp:Label>
            </td><td style="width: 275px; text-align: left; border-top-style: groove; border-top-width: thin; border-top-color: #C0C0C0; border-bottom-width: thin; border-bottom-color: #C0C0C0;" 
                class="textcells"><asp:UpdatePanel ID="UpdatePanel8" runat="server"><ContentTemplate>
                    <asp:TextBox ID="txtEffFrom" runat="server" CssClass="textbox" 
                          Width="80px"></asp:TextBox><asp:RequiredFieldValidator ID="Err1" runat="server" ControlToValidate="txtEffFrom" ErrorMessage="*" 
                          SetFocusOnError="True"></asp:RequiredFieldValidator><cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtEffFrom" Mask="99/99/9999" MaskType="Date" ></cc1:MaskedEditExtender><cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TxtEffFrom" Animated="False" Format="MM/dd/yyyy">
                </cc1:CalendarExtender>
                </ContentTemplate></asp:UpdatePanel></td><td style="text-align: left; width: 104px; border-top-style: groove; border-top-width: thin; border-top-color: #C0C0C0; border-bottom-width: thin; border-bottom-color: #C0C0C0;" class="labelcells"><asp:Label ID="lblEffTo" runat="server" Text="Eff To"></asp:Label>
            </td>
            <td style="text-align: left; width: 249px; border-top-style: groove; border-top-width: thin; border-top-color: #C0C0C0; border-right-style: groove; border-right-width: thin; border-right-color: #C0C0C0; border-bottom-width: thin; border-bottom-color: #C0C0C0;" class="textcells">
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                 <ContentTemplate>
                     <asp:TextBox ID="txtEffTo" runat="server" CssClass="textbox" 
        ...
        <tr><td style="width: 111px; text-align: left; border-bottom-style: groove; border-left-style: groove; border-top-width: thin; border-bottom-width: thin; border-left-width: thin; border-top-color: #C0C0C0; border-bottom-color: #C0C0C0; border-left-color: #C0C0C0;" 
                class="labelcells">
                <asp:Label ID="lblEffFrom1" runat="server" Text="Created Date"></asp:Label>
            </td>
            <td style="width: 275px; text-align: left; border-top-width: thin; border-top-color: #C0C0C0; border-bottom-style: groove; border-bottom-width: thin; border-bottom-color: #C0C0C0;" 
                class="textcells">
                <asp:UpdatePanel ID="UpdatePanel32" runat="server">
              <ContentTemplate>
                       <asp:TextBox ID="txtCreatedDate" runat="server" CssClass="textbox" 
                          Width="80px"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="Err8" runat="server" 
                          ControlToValidate="txtCreatedDate" ErrorMessage="*" 
                          SetFocusOnError="True"></asp:RequiredFieldValidator>
                             <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" 
                    TargetControlID="txtCreatedDate" Mask="99/99/9999" MaskType="Date" ></cc1:MaskedEditExtender>
                       <cc1:CalendarExtender ID="CalendarExtender3" runat="server" 
                           TargetControlID="txtCreatedDate" Animated="False" Format="MM/dd/yyyy">
                </cc1:CalendarExtender>
                </ContentTemplate>
                  </asp:UpdatePanel></td>
            <td style="text-align: left; width: 104px; border-top-width: thin; border-top-color: #C0C0C0; border-bottom-style: groove; border-bottom-width: thin; border-bottom-color: #C0C0C0;" 
                class="labelcells">
                &nbsp;</td>
            <td style="text-align: left; width: 249px; border-top-width: thin; border-top-color: #C0C0C0; border-right-style: groove; border-right-width: thin; border-right-color: #C0C0C0; border-bottom-style: groove; border-bottom-width: thin; border-bottom-color: #C0C0C0;" 
                class="textcells">
                &nbsp;</td></tr>
        <tr>
            <td style="text-align: center; font-size: 1px;" colspan="4">
        ...
        <tr>
            <td style="text-align: center;" colspan="4" class="buttonbackbar">
                ...
                <asp:LinkButton ID="cmdEdit" runat="server" CssClass="buttonc" 
                    ...
                    CausesValidation="False" Height="22px" Width="84px">Search</asp:LinkButton>
                    <cc1:PopupControlExtender ID="PopupExp" runat="server" 
                    CommitProperty="value" Enabled="True"
                            PopupControlID="Panel2" Position="Left" TargetControlID="CmdSearch" 
                            OffsetX="-250" OffsetY="-175"></cc1:PopupControlExtender>
                ...
                <asp:UpdatePanel ID="Movement" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        <asp:LinkButton ID="CmdFirst" runat="server" CausesValidation="False" CssClass="buttonc"
                            Height="22px" TabIndex="5" Width="84px">First</asp:LinkButton><asp:LinkButton ID="CmdPrevious" runat="server"
                                    CausesValidation="False" CssClass="buttonc" Height="22px" TabIndex="7" Width="84px">Move Prev</asp:LinkButton><asp:LinkButton ID="CmdNext"
                                runat="server" CausesValidation="False" CssClass="buttonc" Height="22px" TabIndex="6"
                                Width="84px">Move Next</asp:LinkButton><asp:LinkButton
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                    <ContentTemplate>
                    <asp:Panel ID="Panel2" runat="server" Height="126px" Width="480px" CssClass="panelbg" 
                           ScrollBars="None" BorderStyle="Inset" BorderColor="Black" BorderWidth="0px" 
                            Font-Names="Tahoma" Font-Size="8pt" style="display:none"> 
                            <div  id = "AdjResultsDiv"> 
                                <asp:GridView ID="GrdHelp" runat="server" BorderStyle="None" Height="52px" HorizontalAlign="Left" 
                                    OnSelectedIndexChanged="grdHelp_SelectedIndexChanged" Width="1280px" 
                                    GridLines="Both">
                                    <PagerSettings Visible="False" />
        ...
        <tr>
            <td style="text-align: center;" colspan="4"  height="20">
