...
public partial class AssetMngmnt_Furniture_Accept : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            sql = "jct_asset_Enable_Disable_Applybutton";
            ...
            if (a.Trim() == "C")
            {
                lnkaccept.Enabled = true;
                lnkRaiseConcern.Enabled = true;
                lnkresest.Enabled = true;
            }
            if (a.Trim() == "B")
            {
                lnkaccept.Enabled = true;
    ...
    public void BindRaiseConcernGrid()
    {
        sql = "Jct_Asset_UserWise_Raise_Concern_List";
        SqlCommand cmd = new SqlCommand(sql, obj.Connection());
        cmd.CommandType = CommandType.StoredProcedure;        
        cmd.Parameters.Add("@requestID", SqlDbType.VarChar, 50).Value = ViewState["requestID"];
        cmd.Parameters.Add("@Usercode", SqlDbType.VarChar, 50).Value = Session["EmpCode"];
        ...
        DataSet ds = new DataSet();
        da.Fill(ds);
        GrdConcernItems.DataSource = ds;
        GrdConcernItems.DataBind();
    }
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                if (emailid == 0)
                {
                    ...
                    ViewState["RequestByEmail"] = "aslam@jctltd.com";
                    ...
                    //url = "http://localhost:4186/FusionApps/AssetMngmnt/asset_accept_AcceptedMail.aspx?" + querystring + "&Empcode=" + querystring1;
                    url = "http://testerp/FusionApps/AssetMngmnt/asset_accept_AcceptedMail.aspx?" + querystring + "&Empcode=" + querystring1;
                    string Body2 = GetPage(url);
                    string Body1 = "<html><body><Table><tr><td>The Following User</td></tr><BR /><tr><td>EmployeeCode " + UserCode + "</td></tr><BR /><tr><td>EmployeeName : " + ds.Tables[0].Rows[0]["empname"].ToString() + " </td> </tr><BR /><tr><td>Location : " + location + "</td></tr><Br/><tr><td>Sublocation: " + Sublocation + "</td></tr><Br/>  <tr><td>Does Not Have Email Id</td></table></body></html>";                    
                ...
                else if (emailid == 1)
                {
                   ...
                   // url = "http://localhost:4186/FusionApps/AssetMngmnt/asset_accept_AcceptedMail.aspx?" + querystring + "&Empcode=" + querystring1;
                    url = "http://testerp/FusionApps/AssetMngmnt/asset_accept_AcceptedMail.aspx?" + querystring + "&Empcode=" + querystring1;
                    Body = GetPage(url);
                    to = "ashish@jctltd.com" + "," + ViewState["RequestByEmail"]; 
                ...
                else if (emailid > 1)
                {
                   ...
                   // url = "http://localhost:4186/FusionApps/AssetMngmnt/asset_accept_AcceptedMail.aspx?" + querystring + "&Empcode=" + querystring1;
                    url = "http://testerp/FusionApps/AssetMngmnt/asset_accept_AcceptedMail.aspx?" + querystring + "&Empcode=" + querystring1;
                    string Body2 = GetPage(url);
                    string Body1 = "<html><body><Table><tr><td>The Following User</td></tr><BR /><tr><td>EmployeeCode " + UserCode + "</td></tr><BR /><tr><td>EmployeeName : " + ds.Tables[0].Rows[0]["empname"].ToString() + " </td> </tr><BR /><tr><td>Location : " + location + "</td></tr><Br/><tr><td>Sublocation: " + Sublocation + "</td></tr><Br/>  <tr><td>Does Not Have Unique Email Id</td></table></body></html>";
                    to = "ashish@jctltd.com" + "," + ViewState["RequestByEmail"]; 
            ...
            bcc = "aslam@jctltd.com,ashish@jctltd.com,rbaksshi@jctltd.com,kamal@jctltd.com";
            //bcc = "aslam@jctltd.com";
            //cc = "ashish@jctltd.com";


            subject = "Furniture Asset Acceptance";
            //subject = "Furniture Asset Acceptance" + "To" + "  " + to + "CC" + "  " + cc + "bcc" + "  " + bcc;
            //to = "ashish@jctltd.com";
            ...
            if (OK == "OK")
            {
                foreach (GridViewRow gvRow in GridView1.Rows)
                {
                    ...
                    if (chkRemove.Checked == true)
                    {
                        ...
                        cmd = new SqlCommand("Jct_Asset_Furniture_Raise_Concern_detail_Insert", obj.Connection(), tran);
                        cmd.CommandType = CommandType.StoredProcedure;                        
                        cmd.Parameters.Add("@requestID", SqlDbType.Int).Value = ViewState["requestID"];
                        cmd.Parameters.Add("@Usercode", SqlDbType.VarChar, 50).Value = Session["EmpCode"];
                        cmd.Parameters.Add("@Location", SqlDbType.VarChar, 50).Value = Location.Text;
    ...
    public void RaiseConcernMail()
    {
        ...
        if (OK == "OK")
        {
            try
            {
                ...
                mail.From = new MailAddress(@from);
                to = "ashish@jctltd.com" + "," + Genratedby_Email;
                ...
                //mail.Subject = "Raise Concern Mail" + "To" + "  " + to + "CC" + "  " + cc + "bcc" + "  " + bcc;
                //to = "ashish@jctltd.com";
    ...
    protected void GrdConcernItems_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            GrdConcernItems.PageIndex = e.NewPageIndex;
            BindRaiseConcernGrid();
        }
        catch (Exception ex)
        {
