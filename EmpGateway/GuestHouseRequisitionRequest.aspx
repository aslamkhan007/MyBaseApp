...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <p runat="server" class="panelbg" id="pnlStayYes" visible="False">
        <table style="width: 100%;">
            ...
            <tr>
                <td class="NormalText" style="width: 162px">&nbsp;</td>
                <td class="NormalText" style="width: 161px"><span>
                    <asp:Label ID="lbl11" runat="server" Text="Name of the Person accompained"></asp:Label>
                    </span></td>
                <td class="NormalText" colspan="4">
                    <asp:TextBox ID="txtPersonAccompained0" runat="server" CssClass="textbox" Width="200px"></asp:TextBox>
                </td>
                <td class="NormalText">&nbsp;</td>
            </tr>
            <tr>
     ...
     <p runat="server" class="panelbg" id="pnlStayNo" visible="False">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 161px">
                <span>
                <asp:Label ID="Lbl9" runat="server" Text="Date of Stay"></asp:Label>
                </span></td>
            ...
            <tr>
                <td class="NormalText" style="width: 162px">&nbsp;</td>
                <td class="NormalText" style="width: 161px"><span>
                    <asp:Label ID="Label30" runat="server" Text="Where to accomodate"></asp:Label>
                    </span></td>
                <td class="NormalText" colspan="5">
                    <asp:DropDownList ID="ddlAccomodateStay" runat="server" CssClass="combobox">
                        <asp:ListItem>Main Guest House</asp:ListItem>
                        <asp:ListItem>B-1</asp:ListItem>
                        <asp:ListItem>A-2</asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                <td class="NormalText" style="width: 162px"></td>
                <td class="NormalText" style="width: 161px"><span>
                    <asp:Label ID="Lbl1" runat="server" Text="Meals to be served"></asp:Label>
                    </span></td>
                <td class="NormalText" colspan="5">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 161px">
                <span>
                <asp:Label ID="Lbl10" runat="server" Text="Kind of Food to be served"></asp:Label>
                </span></td>
            <td class="NormalText" colspan="4">
                <asp:DropDownList ID="ddlFoodStay" runat="server" CssClass="combobox">
                    <asp:ListItem>Vegetarian</asp:ListItem>
                    <asp:ListItem>Non-Vegetarian</asp:ListItem>
                </asp:DropDownList>
            </td>
            ...
            <tr>
                <td class="NormalText" style="width: 162px">&nbsp;</td>
                <td class="NormalText" style="width: 161px"><span>
                    <asp:Label ID="lbl5" runat="server" Text="Whether drinks to be served"></asp:Label>
                    </span></td>
                <td class="NormalText" colspan="4">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 161px">
    <span >
                    <asp:Label ID="lbl6" runat="server"  Text="Name of the Person accompained" 
                       ></asp:Label>
       </span></td>
            <td class="NormalText" colspan="4">
