    ...
    Protected Sub bindReport()
        If RadioButtonList1.Items(1).Selected = True Then
            ...
            Else
                ...
                If Status.Text = "Pending" And Department.Text = "All" Then
                    SqlPass = "SELECT A.* FROM JCTDEV..JCT_EMPG_LEAVE A, JCTDEV..JCT_EMPMAST_BASE B WHERE A.EMPCODE=B.EMPCODE AND SALARYTYPE NOT IN ('W1','W2','W3') AND  MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LEAVEFROM )) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "' And NatureLeave='" & Nature.Text & "'  AND NATURELEAVE  NOT IN ('Short Leave','Official Duty','Tour') ORDER BY A.CARDNO"
                ElseIf Status.Text <> "Pending" And Department.Text = "All" Then
                ...
                ElseIf Status.Text = "Pending" And Department.Text <> "All" Then
                    SqlPass = "SELECT A.* FROM JCTDEV..JCT_EMPG_LEAVE A, JCTDEV..JCT_EMPMAST_BASE B WHERE A.EMPCODE=B.EMPCODE AND SALARYTYPE NOT IN ('W1','W2','W3') AND  MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LEAVEFROM )) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "' AND Department='" & Department.Text & "' And NatureLeave='" & Nature.Text & "' AND NATURELEAVE  NOT IN ('Short Leave','Official Duty','Tour') ORDER BY A.CARDNO"
                Else
        ...
        ElseIf RadioButtonList1.Items(2).Selected = True Then
            If Nature.Text = "All" Then
                ...
                If Status.Text = "Pending" And Department.Text = "All" Then
                    SqlPass = "SELECT * FROM JCTDEV..JCT_EMPG_LEAVE where  MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LEAVEFROM)) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "'  AND NATURELEAVE  IN ('Short Leave','Official Duty','Tour')  ORDER BY CARDNO"
                ElseIf Status.Text <> "Pending" And Department.Text = "All" Then
                    SqlPass = "SELECT * FROM JCTDEV..JCT_EMPG_LEAVE WHERE  MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LASTTIME )) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "' AND NATURELEAVE  IN ('Short Leave','Official Duty','Tour') and convert(smalldatetime,convert(char(12),LEAVEFROM )) BETWEEN '" & Format(LeaveDateFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveDateTo.SelectedDate, "MM/dd/yyyy") & "'    ORDER BY CARDNO"
                ElseIf Status.Text = "Pending" And Department.Text <> "All" Then
                    SqlPass = "SELECT * FROM JCTDEV..JCT_EMPG_LEAVE  WHERE  MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LEAVEFROM )) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "' AND Department='" & Department.Text & "' AND NATURELEAVE  IN ('Short Leave','Official Duty','Tour')  ORDER BY CARDNO"
                Else
            ...
            Else
                ...
                If Status.Text = "Pending" And Department.Text = "All" Then
                    SqlPass = "SELECT  *  FROM JCTDEV..JCT_EMPG_LEAVE where  MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LEAVEFROM )) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "' And NatureLeave='" & Nature.Text & "'  AND NATURELEAVE   IN ('Short Leave','Official Duty','Tour') ORDER BY CARDNO"
                ElseIf Status.Text <> "Pending" And Department.Text = "All" Then
                ...
                ElseIf Status.Text = "Pending" And Department.Text <> "All" Then
                    SqlPass = "SELECT *  FROM JCTDEV..JCT_EMPG_LEAVE where MainFlag=Left('" & Status.Text & "',1)  AND convert(smalldatetime,convert(char(12),LEAVEFROM)) BETWEEN '" & Format(LeaveFrom.SelectedDate, "MM/dd/yyyy") & "' AND '" & Format(LeaveTo.SelectedDate, "MM/dd/yyyy") & "' AND Department='" & Department.Text & "' And NatureLeave='" & Nature.Text & "' AND NATURELEAVE   IN ('Short Leave','Official Duty','Tour')  ORDER BY CARDNO"
                Else
