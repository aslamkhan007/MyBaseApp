    ...
    <table style="width:100%">
        <tr>
            <td class="tableheader" colspan="5">
                <asp:Label ID="Label5" runat="server" BorderColor="Transparent" Text="Leave Application (OD/SL/PL/CL/Travel Leave/Comp Leave)" Width="373px"></asp:Label>
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td class="buttonbackbar" colspan="4">
                ...
                <asp:Button ID="UnCheck" runat="server" Text="UnCheck" CssClass="ButtonBack" BackColor="Black"/>&nbsp;<asp:Button 
                    ID="CmdCancel" runat="server" Text="Cancel leave" 
                    CssClass="ButtonBack" BackColor="Black" /><cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1"
                        runat="server" ConfirmText="Are you sure???" 
                    TargetControlID="CmdCancel">
