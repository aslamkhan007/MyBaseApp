...
Partial Class MasterPage
    ...
    Protected Sub Menu1_MenuItemClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.MenuEventArgs) Handles Menu1.MenuItemClick
        ...
        If e.Item.Text = "Presentation" Then
            Response.Redirect("Downloadfile.aspx?filepth=D:/WebApplications/FusionApps/EmpGateway/presentation/pre.ppsx")
        ...
        ElseIf e.Item.Text = "Help - HOW DO I ?" Then
            Page.RegisterClientScriptBlock("scr", "<script language = javascript> window.open('http://90.0.1.222/howdoi');</script>")
