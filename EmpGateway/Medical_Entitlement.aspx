                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="Panel3" runat="server" Height="300px" ScrollBars="Vertical">
                            <asp:GridView ID="grdDetail" AutoGenerateColumns="False" runat="server" 
                                Width="100%" onrowupdating="grdDetail_RowUpdating" 
                                onrowcancelingedit="grdDetail_RowCancelingEdit" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Edit">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:Button ID="BtnCancel" runat="server" Text="Cancel" CommandName="Cancel" />--%>
                                             <asp:LinkButton ID="BtnUpdate" runat="server"  CommandName="Update" ValidationGroup="Updatemandatory">Update</asp:LinkButton>
                                          <%--  <asp:Button ID="BtnUpdate" runat="server" Text="Update" CommandName="Update" />--%>
                                 ...
                                 Cancel" CommandName="Cancel" />--%>
                                    ...
                                    <asp:TemplateField HeaderText="Designation Code">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDesgCode" runat="server" Text='<%#Eval("[Designation Code]") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Entitlement Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmount" runat="server" Text='<%#Eval("EntitlementAmount") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtAmount" runat="server" Text='<%#Eval("EntitlementAmount") %>' CssClass="textbox"></asp:TextBox>
                                            <cc11:FilteredTextBoxExtender ID="txtGridAmount_FilteredTextBoxExtender" runat="server"
                                                FilterType="Custom" TargetControlID="txtAmount" ValidChars="0123456789">
                                            </cc11:FilteredTextBoxExtender>
                                            <asp:RequiredFieldValidator ID="reqGridAmount" runat="server" ControlToValidate="txtAmount"
                                                ErrorMessage="**" ValidationGroup="Updatemandatory"></asp:RequiredFieldValidator>
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Effective From">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEffFrom" runat="server" Text='<%#Eval("[Effective from]") %>'></asp:Label>
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Effective To">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEffTo" runat="server" Text='<%#Eval("[Effective To]") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEffTo" runat="server" Text='<%#Eval("[Effective To]") %>' ValidationGroup="Updatemandatory" CssClass="textbox"></asp:TextBox>
                                            <cc11:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999"
                                            ...
                                            <cc11:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender1"
                                                ...
                                                InvalidValueMessage="INVALID DATE" ValidationGroup="mandatory"></cc11:MaskedEditValidator>
                                            <cc11:CalendarExtender ID="txtFrom_CalendarExtender" runat="server" TargetControlID="txtEffTo">
                                            </cc11:CalendarExtender>
                                             <asp:RequiredFieldValidator ID="reqEffTo" runat="server" ControlToValidate="txtEffTo"
                                                ErrorMessage="**" ValidationGroup="Updatemandatory"></asp:RequiredFieldValidator>
