...
Partial Class MyWorkArae
    ...
    Public Sub BindData()
        ...
        ' Dim Sqlpass = "select AutoId as ID ,NatureLeave as Nature, Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code   and flag=left(FlagHC,2) and  DateDiff(day,getdate(),CurLeaveTime)>=-75 and Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "' order by AutoId "
    ...
    Public Sub Authorize()
        ...
        'Dim Sqlpass = "select AutoId as ID ,NatureLeave as Nature,Name,Department,Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  AuthFlag='A' and flag='1H' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "' " & _
        '             "union select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  SubAuthFlag='A' and flag='2T' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and  b.Company_Code='" & Session("Companycode") & "' " & _
        '             "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department,Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  CFlag='A' and flag='3C' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and  b.Company_Code='" & Session("Companycode") & "'  " & _
        '             "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B1Flag='A' and flag='B1' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
        '             "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B2Flag='A' and flag='B2' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "' " & _
        '            "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B3Flag='A' and flag='B3' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
        '            "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B4Flag='A' and flag='B4' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  order by autoid desc " & _
        ...
        Dim Sqlpass = "select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS,Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK)   ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  AuthFlag='A' and flag='1H' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "' " & _
                    "union select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS, Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  SubAuthFlag='A' and flag='2T' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and  b.Company_Code='" & Session("Companycode") & "' " & _
                    "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS,Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  CFlag='A' and flag='3C' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and  b.Company_Code='" & Session("Companycode") & "'  " & _
                    "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS, Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B1Flag='A' and flag='B1' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
                    "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS, Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B2Flag='A' and flag='B2' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "' " & _
                   "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS, Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B3Flag='A' and flag='B3' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
                   "Union Select AutoId as ID ,NatureLeave as Nature,Name,Department,a.DAYS, Convert( char(10),LeaveFrom,103) as [From] , Convert( char(10),LeaveTo,103) as [To], Convert( char(10),curleavetime,103) as [Applied On] from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  B4Flag='A' and flag='B4' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and  Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
    ...
    Public Sub Cancle()
        ...
        'Dim Sqlpass = "select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ]  from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  AuthFlag='C' and flag='1H' and DateDiff(day,getdate(),CurLeaveTime)>=-20 and Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
        '              "Union select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ]  from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  SubAuthFlag='C' and flag='2T' and  DateDiff(day,getdate(),leavefrom)>=-20 and Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  " & _
        '              " Union select AutoId as ID ,NatureLeave as Nature,Name,Department, Convert( char(10),LeaveFrom,103) as [ From ] , Convert( char(10),LeaveTo,103) as [ To ], Convert( char(10),curleavetime,103) as [ Applied On ]  from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and  CFlag='C' and flag='3C' and  DateDiff(day,getdate(),leavefrom)>=-20 and Resp_emp='" & Trim(ECode) & "' and auth_req='Y' and status is null and b.Company_Code='" & Session("Companycode") & "'  order by autoid desc"
    ...
    Protected Sub GridView2_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView2.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            SqlPass = " select * from jctdev..jct_empg_leave  (NOLOCK)   where Autoid='" & e.Row.DataItem(0) & "'"
            OnRowDataBind(SqlPass)
            Dim toolTip As String = ""
    ...
    Public Sub GetDataForGrid()
        ...
        Dim Sqlpass = "select a.Survey_No,a.Subject,b.empname PostedBy,c.Deptname,a.Last_Date from jct_emp_survey_Master a, jct_empmast_base b (NOLOCK), deptmast c (NOLOCK) where a.user_code=b.empcode and a.dept_code = c.deptcode and a.auth_Flag='U'"
        Dim Dr As SqlDataReader = objClassFunction.FetchReader(Sqlpass)
        Dim Da As SqlDataAdapter = New SqlDataAdapter(Sqlpass, Obj.Connection())
    ...
    Public Sub Comments()
        ...
        Dim Sqlpass = "select empname As [Comment By],convert(varchar(10),a.created_dt,103) as [On Date], Topic, Point, Remarks from jct_emp_guestbook a (NOLOCK), jct_emp_guestbook_trans b (NOLOCK), jct_empmast_base c (NOLOCK) where a.comment_no=b.comment_no and a.user_code=c.empcode and c.active='y' and address_to='" & Session("Empcode") & "' order by a.created_dt"
        Dim Dr As SqlDataReader = objClassFunction.FetchReader(Sqlpass)
        Dim Da As SqlDataAdapter = New SqlDataAdapter(Sqlpass, Obj.Connection())
    ...
    Protected Sub GrdDoc_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GrdDoc.RowUpdating
        ...
        Obj.ConOpen()
        sqlpass1 = "select distinct deptcode from deptmast  WHERE  (NOLOCK) deptname='" & dept & "'"
        ...
        If type = "Forms" Then
            sqlpass3 = "update jct_empg_forms  (NOLOCK) set Auth_flag='A' where usercode='" & user & "' and DeptCode='" & dept & "' and filename='" & filename & "' and FileExt='" & fileext & "' and companycode='JCT00LTD'"
            'Obj.ExecQry(sqlpass3)
            objClassFunction.UpdateRecord(sqlpass3)
        ElseIf type = "Office Order" Then
            sqlpass3 = "update jct_empg_order  (NOLOCK)  set Auth_flag='A' where usercode='" & user & "' and DeptCode='" & dept & "' and filename='" & filename & "' and FileExt='" & fileext & "' and companycode='JCT00LTD'"
            'Obj.ExecQry(sqlpass3)
            objClassFunction.UpdateRecord(sqlpass3)
        ElseIf type = "Training Material" Then
            sqlpass3 = "update jct_empg_trainee  (NOLOCK)  set Auth_flag='A' where usercode='" & user & "' and DeptCode='" & dept & "' and filename='" & filename & "' and FileExt='" & fileext & "' and companycode='JCT00LTD'"
            'Obj.ExecQry(sqlpass3)
            objClassFunction.UpdateRecord(sqlpass3)
        End If

        sqlpass4 = "select e_mailid from mistel   (NOLOCK)  where empcode='" & user & "'"
    ...
    '-------------------------------------------------------------------Hitesh 28/DEC/2009-------------------------------------------------------
    Public Sub Position()
        Dim Sqlpass = "select Flag,FlagHC  from jctdev..jct_empg_leave a (NOLOCK) ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code and Resp_emp='" & Trim(Session("Empcode")) & "' and auth_req='Y' and AutoId='" & Session("AID") & "' and status is null "
    ...
    Protected Sub cmdauthorize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdauthorize.Click
            ...
            For Each row As GridViewRow In GridView1.Rows
                ...
                If cb IsNot Nothing AndAlso cb.Checked Then
                    ...
                    Else
                        ...
                        SqlPass = " select * from jctdev..jct_empg_leave  (NOLOCK)   where Autoid='" & ID & "' " 'Left('" & ID & " ',CharIndex('>','" & ID & " ')-1) "
                        Me.GetFlag(SqlPass)
                        Tot = Session("Check")
        ...
        '            SqlPass = " select * from jctdev..jct_empg_leave  (NOLOCK)   where Autoid=Left('" & ID & " ',CharIndex('>','" & ID & " ')-1) "
        '            Me.GetFlag(SqlPass)
        '            Tot = Session("Check")
    ...
    Public Sub H()
        If Session("To") = "1H" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set AutHodTime= getdate() ,AuthFlag='A' where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
    ...
    Public Sub T()
        If Session("To") = "2T" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set SubAutHodTime= getdate() ,SubAuthFlag='A'  where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            'Response.Redirect("MyWorkArae.aspx")
        End If
    End Sub
    Public Sub C()
        If Session("To") = "3C" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set CTime= getdate() ,CFlag='A'  where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            'Response.Redirect("MyWorkArae.aspx")
        End If
    End Sub
    Public Sub B1()
        If Session("To") = "B1" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set B1Time= getdate() ,B1Flag='A'  where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
        End If
    End Sub
    Public Sub B2()
        If Session("To") = "B2" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set B2Time= getdate() ,B2Flag='A' where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            '  Response.Redirect("MyWorkArae.aspx")
        End If
    End Sub
    Public Sub B3()
        If Session("To") = "B3" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set B3Time= getdate() ,B3Flag='A' where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            ' Response.Redirect("MyWorkArae.aspx")
        End If
    End Sub
    ...
    Public Sub B4()
        If Session("To") = "B4" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set B4Time= getdate() ,B4Flag='A' where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            ' Response.Redirect("MyWorkArae.aspx")
        End If
    End Sub
    ...
    Public Sub MainFlag()
        SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set Mainflag='A' , LastTime=getdate() where  autoid= " & Session("AID")
        objClassFunction.UpdateRecord(SqlPass)
    End Sub
        ...
        If Session("StoreFlag") <> "" Then
            ...
            Else
                ...
                SqlPass = "select a.empcode, c.empname, b.mobile, a.natureleave, a.days, replace(convert(varchar(11),a.leavefrom,106),' ','-') as [leavefrom], " & _
                            "replace(convert(varchar(11), a.leaveto,106),' ','-') as [leaveto] from jct_empg_leave a (NOLOCK) inner join mistel b on a.empcode = b.empcode " & _
    ...
    Public Sub HCancle()
        If Session("To") = "1H" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set AutHodTime= getdate() ,AuthFlag='C',MainFlag='C',FlagHC='', LastTime=getdate() where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            'Response.Redirect("MyWorkArae.aspx")
        End If
    ...
    Public Sub CCancle()
        If Session("To") = "3C" Then
            SqlPass = "update  jctdev..jct_empg_leave   (NOLOCK)  set CTime= getdate() ,CFlag='C',MainFlag='C',FlagHC='' , LastTime=getdate() where  autoid= " & Session("AID")
            objClassFunction.UpdateRecord(SqlPass)
            'Response.Redirect("MyWorkArae.aspx")
        End If
    End Sub
    ...
    Public Sub CancelMail()
        ...
        '------------------------------------
        ob.opencn()
        SqlPass = "select empcode from jct_empg_leave  (NOLOCK)   where Autoid='" & Session("AID") & "' and companycode='" & Session("Companycode") & "' "
    ...
    Public Sub Guest()
        ...
        If Me.ddlGuest.Text = "P" Then
            qry = "select TRANSACTIONNO as ID ,EMPCODE as EMPCODE, employeee_name AS [Employee Name],CONVERT(VARCHAR(12),CREATEDDT,101) AS [Applied on] from JCT_EMP_GUESTHOUSE a ,jctdev..jct_emp_hod b   (NOLOCK) where  a.empcode=b.Emp_Code   and flag=left(FlagHC,2) and Resp_emp='" & Trim(ECode) & "' and authFLAG='P' and a.status is null and b.Company_Code='" & Session("Companycode") & "'  and b.status is null order by transactionno "
