...
Partial Class PF
    ...
    Public Sub BindData()
        ...
        Dim SqlPass = "select a.*,b.* from JCTDEV..pfstaff a, JCTDEV..spintt b  where Empcode='" & Session("Empcode") & "' AND Empcode*=empcd  "
        Dim Dr As SqlDataReader = Obj.FetchReader(SqlPass)
        Try
        ...
        Try
            ...
            If Dr.HasRows = True Then
                ...
                While Dr.Read()
                    ...
                    If Dr.Item("UAN") Is System.DBNull.Value Then
                    Else
                        Me.TxtUAN.Text = Dr.Item("UAN")
                    End If

                    If Dr.Item("IFSC_CODE") Is System.DBNull.Value Then
                    Else
                        Me.TxtUAN.Text = Me.TxtUAN.Text & "/" & Dr.Item("IFSC_CODE")
                    End If
