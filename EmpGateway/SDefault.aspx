...
document.write('</td></table>')
        ...
        <tr>
            <td colspan="3" style="height: 320px; text-align: center; background-image: url(Image/MainBack.png);" valign="middle">
                <Bewise:flashcontrol id="FlashControl1" runat="server" FlashVersion="9" height="200px"
                    loop="True" movieurl="~/shiv.swf" width="300px" WMode="Transparent">
