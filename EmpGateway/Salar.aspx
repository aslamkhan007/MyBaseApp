                ...
                <div ID="printDiv">
                                        ...
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 2px;">
                                                    <asp:Label ID="Label32" runat="server" Height="13px" Text="Electric Bill" 
                                                        Width="104px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 2px; height: 2px;">
                                                    <asp:Label ID="Label1" runat="server" Text="Label" Width="60px"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 7px;">
                                                    <asp:Label ID="Label87" runat="server" Height="13px" Text="Bus+Tea" 
                                                        Width="104px"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 5px; ">
                                                    <asp:Label ID="Label85" runat="server" style="height: 13px" 
                                                        Text="Int. Monthly Rent" Width="120px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 2px; height: 5px;">
                                            ...
                                            <tr>
                                                ...
                                                <td labelcells"="" style="width: 108px; height: 5px; class=" class="labelcells">
                                                    <asp:Label ID="Label86" runat="server" Text="Claim Deduction" Width="120px"></asp:Label>
                                                </td>
                                                <td labelcells"="" style="width: 2px; height: 5px; class=" class="labelcells">
                    ...
                    <asp:Panel ID="Panel3" runat="server" Height="9px" Visible="False" Width="29px">
                        <img ID="IMG1" alt="Print Salary Slip" 
                            onclick="JavaScript:printPartOfPage('print_area');" src="~/EmpGateway/Image/print_ico.gif" /></asp:Panel>
