...
Partial Class Salary
    ...
    Protected Sub DTP2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DTP2.SelectedIndexChanged
        ...
        If Session("Companycode") = "JCT00LTD" Then
            SqlPass = "select replace(replace(desg,'<',' '),'>','') desg ,EMPNAME,DEPTCODE,MONTHYEAR,BANKCODE,BANKNO,PAN, " & _
                ...
                "SAL_ADV,SADV_LOAN,CYC_ADV,FR_ADV,TEL_ADV,OTH_ADV,JCT_CAFE,STAFFEXP,MESS_EXP,SECURITY,CLUB,CLUB2,COUPON,LOAN_STOR,ROUNDOFF,  " & _
    ...
    Protected Sub txtEmpCode_TextChanged(sender As Object, e As System.EventArgs) Handles txtEmpCode.TextChanged
        ...
        Try
            ...
            txtEmpCode.Text = txtEmpCode.Text.Split("|")(1)
    ...
    Protected Sub btnFetch_Click(sender As Object, e As System.EventArgs) Handles btnFetch.Click
        ...
        Dim Sql As String = " SELECT  uname FROM    production..role_user_mapping WHERE   role = 777  and uname ='" & Session("EmpCode") & "' and uname IN ( 'a-00098', 'R-03339', 'R-03584', 'h-01436','J-01945', 'h-01543',   'C-00509', 'M-02467', 'S-13823', 'Demo', 'J-01838', 'H-01419' )"

        If (obj1.CheckRecordExistInTransaction(Sql) Or Session("EmpCode") = "S-03727") Then
            ...
            If Session("Companycode") = "JCT00LTD" Then
                SqlPass = "select replace(replace(desg,'<',' '),'>','') desg ,EMPNAME,DEPTCODE,MONTHYEAR,BANKCODE,BANKNO,PAN, " & _
                    ...
                    "SAL_ADV,SADV_LOAN,CYC_ADV,FR_ADV,TEL_ADV,OTH_ADV,JCT_CAFE,STAFFEXP,MESS_EXP,SECURITY,CLUB,CLUB2,COUPON,LOAN_STOR,ROUNDOFF,  " & _
                    "PF,FPF,VPF,PFLDED,LIC,TATA_AIG,ESI,RENT_RECV,LOAN_TWCC,CTD,RD,ABP_RD,IT,ECESS,SH_ECESS,OTHER3,OTHER4,PB_WELFARE,TOT_DED,NET_SAL ,ALW_2010,BP_ALW,NET_RENT,NET_CONCHG   " & _
                    "FROM JCTDEV..EMPMAST WHERE   EMPCODE='" & txtEmpCode.Text & "' and MonthYear='" & c & "' "
            Else
                SqlPass = "select replace(replace(desg,'<',' '),'>','') desg ,EMPNAME,DEPTCODE,MONTHYEAR,BANKCODE,BANKNO,PAN, " & _
                   "Basic, STD_ADHC, PRESENT, Pl, Cl, SL, Absent, LWP, PD, " & _
                   "SUBTOT_SAL, FDA, ADHWB_INC,STDPA,STDSPLALLO,SPLALLO,SPLALW_ARR,PA,ADL_ALW,PA_ARREAR,ADL_ARREAR ,Arrear, TOT_SAL, HRA,HRA_ARREAR,TRPT_ALLOW,TRPT_ARR,OTHER1,COLONY_ALW ,OTHER2,ELEC_ALLOW, GROSS_SAL, " & _
                   "SAL_ADV,SADV_LOAN,CYC_ADV,FR_ADV,TEL_ADV,OTH_ADV,JCT_CAFE,STAFFEXP,MESS_EXP,SECURITY,CLUB,CLUB2,COUPON,LOAN_STOR,ROUNDOFF,  " & _
                   "PF,FPF,VPF,PFLDED,LIC,TATA_AIG,ESI,RENT_RECV,LOAN_TWCC,CTD,RD,ABP_RD,IT,ECESS,SH_ECESS,OTHER3,OTHER4,PB_WELFARE,TOT_DED,NET_SAL,ALW_2010,BP_ALW,NET_RENT,NET_CONCHG    " & _
                   "FROM JCTDEV..empmasthosh WHERE   EMPCODE='" & txtEmpCode.Text & "' and MonthYear='" & c & "' "
            End If
            Dim Dr As SqlDataReader = Obj.FetchReader(SqlPass)
            '"FROM SAVIOR..EMPMAST WHERE   EMPCODE='" & Me.EMPCODE.Text & "' and MonthYear='" & (Mid(Me.DTP1.Text, 1, 2) + Mid(Me.DTP1.Text, 4, 7)) & " ' "
            '"FROM SAVIOR..EMPMAST inner join savior..deptmast on empmast.deptcode=deptmast.deptcode  and  EMPCODE='" & Me.EMPCODE.Text & "'"
        ...
        Else
            ...
            Page.RegisterClientScriptBlock("scr", "<script language = javascript>alert('You think that you are smart..!! But not more than me..!!')</script>")
