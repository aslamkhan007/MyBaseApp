<%@ Page Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="SurveyChart.aspx.vb" Inherits="SurveyChart" title="Survey Results" %>
        ...
        <tr>
            ...
            <td align="left" colspan="2" valign="top">
                ...
                &nbsp;<web:ChartControl ID="ChartControl1" runat="server"
                    ChartPadding="30" Height="400px" Width="544px" YValuesInterval="2" GridLines="Both" ShowTitlesOnBackground="False" YCustomEnd="20" YCustomStart="0" XValuesInterval="5" ChartFormat="Png" HasChartLegend="False" LeftChartPadding="25" RightChartPadding="10" TopChartPadding="-20" TopPadding="40">
                    ...
                    <PlotBackground Color="#FFF7E7" ForeColor="White" ImageUrl="~/Webcharts/" />
                    ...
                    <Background Color="SkyBlue" ImageUrl="\webcharts\"  />
                </web:ChartControl></td>
        </tr>
        <tr>
