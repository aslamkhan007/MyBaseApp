...
Partial Class SurveyChart
    ...
    Private Sub CreateChart()
        ...
        ChartControl1.ChartTitle.Text = "Survey Ratings " & vbCrLf & "Total Votes:-  " & Session("TotalVotes")
