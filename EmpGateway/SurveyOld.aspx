...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%">
        ...
        <tr>
            <td class="labelcells">
                <asp:Label ID="lblQno" runat="server" Text="Q.No 1"></asp:Label>
            </td>
            <td class="labelcells">
        ...
        <tr>
            ...
            <td class="labelcells" style="height: 82px">
                <asp:RadioButtonList ID="RdoList" runat="server" Width="320px" CssClass="combobox" Visible="False">
                </asp:RadioButtonList>
        ...
        <tr>
            <td colspan="2" class="buttonbackbar" >
                ...
                <asp:Button ID="ApplyBtn" runat="server" Text="Submit" CssClass="ButtonBack" 
                    BackColor="Black" />
                &nbsp;
                <asp:Button ID="ResetBtn" runat="server" Text="Reset" CssClass="ButtonBack" BackColor="Black" />
            </td>
        </tr>
    </table>
</asp:Content>
