...
Partial Class Tree
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            For Each rowResp In objDS.Tables("dtHod").Rows
                ...
                Dim SqlPass1 As String = "SELECT DISTINCT previousempcode AS EMP_CODE , ReqEmpName AS EMPNAME FROM dbo.Jct_Payroll_WorkFlow_Request WHERE Status = 'A' AND AreaApply =  'Leave' AND Plant = 'Pln-100' AND ActionTakenBy = '9000000806'"
                '" & Session("Location") & "' "
                ...
                For Each rowUnder In objDS1.Tables("dtUnder").Rows
                    ...
                    Dim SqlPass2 As String = "SELECT DISTINCT previousempcode AS EMP_CODE , ReqEmpName AS EMPNAME FROM dbo.Jct_Payroll_WorkFlow_Request WHERE Status = 'A' AND AreaApply =  'Leave' AND Plant = 'Pln-100' AND ActionTakenBy = '" & ID2 & "' "
                    ...
                    For Each rowUnder2 In objDS2.Tables("dtUnder2").Rows
                        ...
                        '----------------------------Level 4----------------------
                        Dim SqlPass3 As String = "SELECT  DISTINCT EMP_CODE,EMPNAME FROM JCT_EMP_HOD A, JCT_EMPMAST_BASE B  WHERE(A.EMP_CODE = B.EMPCODE)  AND  FLAG='1H' AND STATUS IS NULL AND ACTIVE='Y' AND Resp_Emp='" & ID3 & " ' AND a.Company_Code='" & Session("Companycode") & "'"
                        'Dim SqlPass2 = "SELECT  DISTINCT EMP_CODE,EMPNAME FROM JCT_EMP_HOD A, JCT_EMPMAST_BASE B  WHERE(A.EMP_CODE = B.EMPCODE) AND DEPTCODE='ACT' AND  FLAG='1H' AND STATUS IS NULL AND Resp_Emp='" & ID2 & " '  "
                        ...
                        For Each rowUnder3 In objDS3.Tables("dtUnder3").Rows
                            ...
                            nodeUnder3.Text = rowUnder3("EMPNAME") + " " + ":" + " " + rowUnder3("EMP_CODE") + "A"
                            ID4 = rowUnder3("EMP_CODE")
    ...
    Protected Sub TreeView1_SelectedNodeChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TreeView1.SelectedNodeChanged
        ...
        '                '    nodeUnder3 = New TreeNode
        '                '    nodeUnder3.Text = rowUnder3("EMPNAME") + " " + ":" + " " + rowUnder3("EMP_CODE")
        '                '    ID4 = rowUnder3("EMP_CODE")
        '                '    nodeUnder2.ChildNodes.Add(nodeUnder3)
        '                '    '----------------------------------------------------Level 5--------------------------------
        '                '    Dim SqlPass4 As String = "SELECT  DISTINCT EMP_CODE,EMPNAME FROM JCT_EMP_HOD A, JCT_EMPMAST_BASE B  WHERE(A.EMP_CODE = B.EMPCODE)  AND  FLAG='1H' AND STATUS IS NULL AND ACTIVE='Y' AND Resp_Emp='" & ID4 & " ' AND a.Company_Code='" & Session("Companycode") & "'   "
