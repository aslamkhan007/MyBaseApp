...
Partial Class Default_New
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Try
        DataList2.DataSource = FetchDS(sql_left_frame).Tables(0)
        DataList2.DataBind()
        DataList4.DataSource = FetchDS(sql_right_frame).Tables(0)
        DataList4.DataBind()
        'Catch
    ...
    Protected Sub fillChildMenuAndDataList(ByVal DatalistName As String, ByVal MenuName As String, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs)
        Try
            ...
            sql = "select itemcode 'value', sdescription 'text', ldescription 'desc' from jct_fap_item_master where parentitemcode = '" & item & "'"

            Dim ds As DataSet = FetchDS(sql)
            ds.DataSetName = "Menus"
            ds.Tables(0).TableName = "Menu"
    ...
    Protected Sub GenerateMarqueeContent()
