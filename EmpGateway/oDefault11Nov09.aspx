...
//}
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="height: 100%">
        <tr>
            <td 
                style= "font-weight: bold;  font-size: 10pt; color: white; font-family: 'Trebuchet MS';" 
                class="tableheader">
           
            </td>
        </tr>
        <tr>
            <td style="font-family: 'Trebuchet MS'; font-size: 10pt; font-weight: bold; color: #CC0000; text-align: center;">
...
document.write('</td></table>')
                ...
                <Bewise:flashcontrol id="FlashControl1" runat="server" FlashVersion="5"
                    loop="True" movieurl="~/GatewayFlash.swf" width="44%" 
                    AlternativeImage="~/Message" XHTMLcompliant="True" Height="200px">
                </Bewise:flashcontrol>
