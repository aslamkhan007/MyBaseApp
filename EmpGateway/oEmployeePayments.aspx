        ...
        <tr>
            <td class="textcells" style="height: 26px">
                <asp:DropDownList ID="ddlSal" runat="server" AutoPostBack="True" 
                    CssClass="combobox">
                    <asp:ListItem Value="Sal">Salary</asp:ListItem>
                    <asp:ListItem Value="All" Selected="True">Allowance</asp:ListItem>
                </asp:DropDownList>
            &nbsp;for
...
where monthyear = @monthyear and type = @paymenttype
order by seniority">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="select distinct designation, seniority from JCT_Emp_Catg_Desg_Mapping
where designation not in(
select distinct b.designation from jct_emp_salary_update a inner join JCT_Emp_Catg_Desg_Mapping b on a.catg = b.catg
where monthyear = @monthyear and type = @paymenttype)
order by seniority">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlMonthYear" Name="monthyear" 
