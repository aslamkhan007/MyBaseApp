    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For Each row As GridViewRow In GridView1.Rows
            ...
            If cb IsNot Nothing AndAlso cb.Checked Then
                ...
                Dim ID As Integer = Convert.ToInt32(GridView1.Rows(row.RowIndex).Cells(1).Text)
        ...
        Next
        If AutoStr <> "" Then
            SqlPass = "update  jctdev..jct_empg_leave set mainflag='A' ,lasttime=getdate(),EntryMater='" & Session("Empname") & "',FlagHC='Sign'  where  autoid in(" & AutoStr & ") "
