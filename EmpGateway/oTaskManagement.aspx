                ...
                <ew:CollapsablePanel ID="PnlRec" runat="server" CollapseImageUrl="Image/UPARROW.JPG"
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="height: 71px" width="43%" class="textcells">
        ...
        <tr>
            <td >
                <ew:CollapsablePanel ID="PnlReply" runat="server" CollapseImageUrl="Image/UPARROW.JPG"
                    CollapserAlign="Left" ExpandImageUrl="Image/DNARROW.JPG" Width="460px" ScrollBars="Both">
                    <table  id="" width="100%">
                        <tr>
                            <td class="labelcells">
                            ...
                            <td class="textcells">
                                <asp:DropDownList ID="DrpTaskStatus" runat="server" Width="152px" AutoPostBack="True">
