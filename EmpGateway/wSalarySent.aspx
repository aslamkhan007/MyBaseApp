<%@ Page Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="SalarySent.aspx.vb" Inherits="SalarySent" title="Salary Sent In Account For Month" %>
    ...
    <table width="100%">
        <tr>
            <td class="tableheader" colspan="2">
                <asp:Label ID="Label5" runat="server" BorderColor="Transparent" Text="Salary Sent To Account"></asp:Label></td>
        </tr>
        <tr>
            <td class="labelcells" style="height: 26px">
                <asp:DropDownList ID="ddlSal" runat="server" AutoPostBack="True" 
                    CssClass="combobox">
                    <asp:ListItem Value="Sal">Salary</asp:ListItem>
                    <asp:ListItem Value="All">Allowance</asp:ListItem>
                </asp:DropDownList>
&nbsp;For Month :</td>
