...
Partial Class Guest_Login_Rquest_Guest_Internet_Login_Request
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If obj1.CheckRecordExistInTransaction(Sql) = False Then
            ...
            Try
                Department = "Right(right('" & txtEmployee.Text & "',charindex(':',reverse('" & txtEmployee.Text & "'),-1)),Len(right('" & txtEmployee.Text & "',charindex(':',reverse('" & txtEmployee.Text & "'),-1))) -1  )"
                Employee = "Left(Substring('" & txtEmployee.Text & "',1,charindex(':','" & txtEmployee.Text & "')),Len(Substring('" & txtEmployee.Text & "',1,charindex(':','" & txtEmployee.Text & "')))-1)"
            Catch ex As Exception
            ...
            Try
                If Button1.Text = "Submit" Then
                    ...
                    Sql = "Select * from jct_Guest_Internet_Request where status='A' and name ='" & txtName.Text & "' and company = '" & txtCompany.Text & "' and mobile=" & txtMobile.Text & " "
                    If obj1.CheckRecordExistInTransaction(Sql) = True Then
                        lblerror.Text = "User already exists..!!"
                        lblerror.Visible = True
                        lblEnquiry.Visible = True
                    Else
                        'Tran = Conn.Connection.BeginTransaction
                        Generate_SecurityCode()
                        Sql = "Insert into jct_Guest_Internet_Request(IP,Name,Email,mobile,Company,Visiting_Department,Visiting_Employee,Stay_Upto,StayDays,PurposeOfVisit,SubmitTime,RequestID,Status,CountryCode,SecurityCode)values('" & Request.ServerVariables("REMOTE_ADDR") & "' , " & _
                                    " '" & txtName.Text & "','" & txtEmail.Text & "' ,'" & txtMobile.Text & "','" & txtCompany.Text & "' ," & Department & "," & Employee & " ,'" & txtDate.Text & "',dateDiff(day, '" & DateTime.Today & "','" & txtDate.Text & "' ),'" & txtPurpose.Text & "',getdate()," & RequestID & " ,'A','" & txtCountryCode.Text & "','" & ViewState("SecurityCode") & "' )"
                        If obj1.InsertRecord(Sql) = True Then
                            lblerror.Text = "Your Request ID is : " & RequestID
                            Dim msg As String = "Please note down your Request ID  : " & RequestID
                            ShowAlertMsg(msg)
                            Panel2.Visible = True
                            lblmsgError.Text = "Please wait for a minute to receive Security Code in your mobile number."

                            Dim msg1 As String = "Your Security Code is " & ViewState("SecurityCode") & " with reference ID " & RequestID & ". Please enter security code to receive the login details"
                            Dim mobile As String = txtMobile.Text
                            ' sm.SendMail_ITHelpdesk(txtEmail.Text, "it.helpdesk@jctltd.com", "Request For Internet Access", "For any problem regarding same issue please contact us with RequestID=" & ViewState("RequestID") & " and mobile no. : "& txtmobile.text &" . This RequestID is important for any future queries. Thanks for your time and Welcome To JCT Family..!!")
                            Dim body As String = "<p>Hello " + txtName.Text + ",</p> <p>Login Details to access JCT's internet facility.</p> <p>Your Security Code is " & ViewState("SecurityCode") & " with ReferenceID " & RequestID & ". </p><p>The security code is also sent via SMS to your registered mobile no. : " + txtMobile.Text + ".</p><p> Please enter security code to receive the login details.</p><p>Thanks,<br/>JCT LTD, Phagwara</p>"
                            sm.SendMail_ITHelpdesk(txtEmail.Text, "it.helpdesk@jctltd.com", "Request For Internet Access", body)
                            'sm.SendMail_ITHelpdesk(txtEmail.Text, "it.helpdesk@jctltd.com", "Request For Internet Access", "Internet Request has been Generated by " & txtName.Text & " on " & DateTime.Today & " with Security Code :" & ViewState("SecurityCode") & " and mobile no. : " & txtmobile.text & "  with IP Address : " & Request.ServerVariables("REMOTE_ADDR") & ". For any problem please contact us with RequestID : " & RequestID & " . This RequestID is important for any future queries. Thanks for your time and Welcome To JCT Family..!!")
                ...
                ElseIf Button1.Text = "Get Password" Then
                    Sql = "Insert into jct_Guest_Internet_Request(IP,Name,Email,mobile,Company,Visiting_Department,Visiting_Employee,Stay_Upto,StayDays,PurposeOfVisit,SubmitTime,RequestID,Status,CountryCode)values('" & Request.ServerVariables("REMOTE_ADDR") & "' , " & _
                                     " '" & txtName.Text & "','" & txtEmail.Text & "' ,'" & txtMobile.Text & "','" & txtCompany.Text & "' ," & Department & "," & Employee & ",'" & txtDate.Text & "',dateDiff(day, '" & DateTime.Today & "','" & txtDate.Text & "' ) ,'" & txtPurpose.Text & "',getdate()," & RequestID & " ,'A','" & txtCountryCode.Text & "' )"
                    If obj1.InsertRecord(Sql) = True Then
                        lblerror.Text = "Your Request ID is : " & RequestID
                        Dim msg As String = "Please note down your Request ID  : " & RequestID
                        ShowAlertMsg(msg)
    ...
    Protected Sub btnSubmitCode_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmitCode.Click
        ...
        Try
                ...
                If ViewState("SecurityCode") = code Then
                    ...
                    If obj1.CheckRecordExistInTransaction(Sql) = True Then
                        ...
                        While dr1.Read()
                            ...
                            trans_no.Text = dr1(0)
                            Dim body As String = "<p>Hello " + txtName.Text + ",</p> <p>You are receiving this email on the behalf of JCT Ltd because you have requested a new login details to access JCT's internet facility.</p> <p>Your UserName is : " & lblUserName.Text & " </br> Password : " & lblPassword.Text & ". </p><p>The login details have also been sent via SMS to your registered mobile no. : " + txtMobile.Text + ".</p><p>You can use internet using the above username and password.</p><p>Thanks,<br/>JCT LTD, Phagwara</p>"
                            sm.SendMail_ITHelpdesk(txtEmail.Text, "it.helpdesk@jctltd.com", "Guest Login Request", body)
                        ...
                        End While
                        dr1.Close()
                        'Sql = "Update Jct_Guest_Internet_LoginDetail set Status='A', UsedBy_Guest ='" & txtName.Text & "' , UsedDate ='" & DateTime.Today & "',Deactivationdate='" & txtDate.text & "' ,RequestID=" & ViewState("RequestID") & ",SecurityCode = " & ViewState("SecurityCode") & " where Status='A' and trans_no =" & trans_no.Text & ""
                        Sql = "Update Jct_Guest_Internet_LoginDetail set Status='A', UsedBy_Guest ='" & txtName.Text & "' , UsedDate =getdate(),Deactivationdate=Convert(datetime,'" & txtDate.Text & "')   +1 ,RequestID=" & ViewState("RequestID") & "   where Status='A' and trans_no =" & trans_no.Text & ""
            ...
            ElseIf Button1.Text = "Get Password" Then
                ...
                If obj1.CheckRecordExistInTransaction(Sql) = True Then
                    ...
                    While dr1.Read()
                        ...
                        lblUserName.Text = dr1(1)
                        lblPassword.Text = dr1(2)
                        ViewState("trans_no") = dr1(0)
                        Dim body As String = "<p>Hello " + txtName.Text + ",</p> <p>You are receiving this email on the behalf of JCT Ltd because you have requested a new login details to access JCT's internet facility.</p> <p>Your UserName is : " & lblUserName.Text & " </br> Password : " & lblPassword.Text & ". </p><p>The login details have also been sent via SMS to your registered mobile no. : " + txtMobile.Text + ".</p><p>You can use internet using the above username and password.</p><p>Thanks,<br/>JCT LTD, Phagwara</p>"
                        sm.SendMail_ITHelpdesk(txtEmail.Text, "it.helpdesk@jctltd.com", "Guest Login Request", body)
                        'sm.SendMail_ITHelpdesk(txtEmail.Text, "it.helpdesk@jctltd.com", "Guest Login Request", "  '" & txtName.Text & "' is a new guest in JCT which has applied for the internet connection and has been alloted a new username = '" & lblUserName.Text & "' and password='" & lblPassword.Text & "' under RequestID=" & ViewState("RequestID") & "  and mobile no. : " & txtmobile.text & "  with IP Address : " & Request.ServerVariables("REMOTE_ADDR") & " .This msg is just to inform you. ")
                        Dim email As String = txtEmail.Text
                        Dim mobile As String = txtMobile.Text
                    ...
                    End While
                    dr1.Close()
                    Sql = "Update Jct_Guest_Internet_LoginDetail set Status='A', UsedBy_Guest ='" & txtName.Text & "' , UsedDate ='" & DateTime.Today & "',Deactivationdate=Convert(datetime,'" & txtDate.Text & "')   +1  ,RequestID=" & ViewState("RequestID") & "   where Status='A' and trans_no =" & ViewState("trans_no") & ""
                    obj1.UpdateRecord(Sql)
            ...
            End If
        Catch ex As Exception
            lblerror.Text = "No Login Detail available at the moment. Please contact IT-Helpdesk..!!"
        End Try
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        If txtRegMobile.Text <> "" Then
            Sql = "Select Name,Email,Mobile,Company,Isnull(CountryCode,91) as CountryCode from  jct_Guest_Internet_Request where status='A' and  mobile=" & txtRegMobile.Text & " and trans_no = (select max(trans_no) from jct_Guest_Internet_Request where mobile=" & txtRegMobile.Text & ")"
            If obj1.CheckRecordExistInTransaction(Sql) = True Then
