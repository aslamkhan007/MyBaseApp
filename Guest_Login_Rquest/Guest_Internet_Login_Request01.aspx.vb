...
Partial Class Guest_Login_Rquest_Guest_Internet_Login_Request
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            ViewState.Add("IPAddress", IPAddress)
        End If
    End Sub
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Sql = "Select right('" & txtCountryCode.Text & "',2)"
        Dim CountryCode As String = obj1.FetchValue(Sql)
        If IP = ".22" And CountryCode = "91" Then
            Generate_RequestID()
            Conn.ConOpen()
            Panel3.Visible = True
            ...
            Try
                If Button1.Text = "Submit" Then
                    ...
                    Else
                        ...
                        Sql = "Insert into jct_Guest_Internet_Request(IP,Name,Email,CountryCode,mobile,Company,Visiting_Department,Visiting_Employee,DateofVisiting,StayDays,PurposeOfVisit,SubmitTime,RequestID,Status)values('" & Request.ServerVariables("REMOTE_ADDR") & "' , " & _
                                    " '" & txtName.Text & "','" & txtEmail.Text & "','" & txtCountryCode.Text & "' ,'" & txtMobile.Text & "','" & txtCompany.Text & "' ," & Department & "," & Employee & " ,'" & txtDate.Text & "'," & txtStay.Text & ",'" & txtPurpose.Text & "',getdate()," & RequestID & " ,'A' )"
            ...
            Finally
                Conn.ConClose()
            End Try
        ElseIf IP = ".21" And CountryCode <> "91" Then
            Generate_RequestID()
            Conn.ConOpen()
            Panel3.Visible = True
            Panel4.Visible = False
                ...
                If Button1.Text = "Submit" Then
                    ...
                    Else
                        ...
                        If obj1.InsertRecord(Sql) = True Then
                            ...
                            Generate_SecurityCode()
                            Dim sm As New SendMail()
                            sm.SendMail(" " & Trim(txtEmail.Text) & " ", "it.helpdesk@jctltd.com", "Guest Login Request", "  '" & SecurityCode & "' is the SecurityCode .Please Fill the Security Code and proceed Further. ")
                            'Dim msg1 As String = "Your " & SecurityCode & " for the Month of " & SecurityCode & " has been transferred to your bank account."
                            'Dim mobile As String = txtMobile.Text
                            lblerror.Text = SecurityCode
                            Sql = "Select distinct a.empcode from jct_empmast_base a inner join deptmast b on a.deptcode=b.deptcode where a.active='Y' and a.empname =(Select Visiting_Employee from jct_Guest_Internet_Request where RequestID =" & RequestID & ") and b.Deptname = (Select Visiting_Department from jct_Guest_Internet_Request where RequestID =" & RequestID & ")"
    ...
    Protected Sub btnSubmitCode_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmitCode.Click
        ...
        If Button1.Text = "Submit" Then
            ...
            If ViewState("SecurityCode") = code Then
                ...
                Panel1.Visible = True
                Sql = "Select Trans_no,username,Password from Jct_Guest_Internet_LoginDetail where status='A' and UsedBy_Guest is null and UsedDate is null and DeactivationDate is null "
                If obj1.CheckRecordExistInTransaction(Sql) = True Then
                    ...
                    While dr1.Read()
                        ...
                        ' sm.SendMail("harendra@jctltd.com", "it.helpdesk@jctltd.com", "Guest Login Request", "  '" & txtName.Text & "' is a new guest in JCT which has applied for the internet connection and has been alloted a new username = '" & dr(1) & "' and password='" & dr(2) & "' under RequestID=" & RequestID & " .This msg is just to inform you. ")
                        ' sm.SendMail("jatindutta@jctltd.com", "it.helpdesk@jctltd.com", "Guest Login Request", "  '" & txtName.Text & "' is a new guest in JCT which has applied for the internet connection and has been alloted a new username = '" & dr(1) & "' and password='" & dr(2) & "' under RequestID=" & RequestID & " .This msg is just to inform you. ")
                        Dim email As String = txtEmail.Text
                        Dim mobile As String = txtMobile.Text
                        Dim msg As String = "Your " & dr1(1) & " for the Month of " & dr1(2) & " has been transferred to your bank account."
                        ...
                        'sm.SendSMS("JCTLTD", "Jatin", mobile, msg, dr1(0) & "Sent")
                    End While
                    dr1.Close()
                    Panel1.Visible = True
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If txtRegMobile.Text <> "" Then
            Sql = "Select Name,Email,Mobile,Company,CountryCode from  jct_Guest_Internet_Request where mobile=" & txtRegMobile.Text & ""
            If obj1.CheckRecordExistInTransaction(Sql) = True Then
