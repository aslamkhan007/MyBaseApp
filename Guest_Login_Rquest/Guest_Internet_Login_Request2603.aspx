    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td  colspan="2">
                   <div id="Div3">
                    <h3>   <asp:Label ID="Label5" runat="server" 
                            Text="For International Guests please check your email for Security Code info."></asp:Label></h3>
                    </div>
            </td>
            <td>
         ...
         <tr>
            ...
            <td  style="width: 161px">
                 <div id="Div5">
                    <h2>  <asp:Label ID="Label7" runat="server">Stay Upto</asp:Label> </h2>
                    </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" 
                            PostBackUrl="http://192.168.20.1:8090/">Access Internet if you have login details</asp:LinkButton>
                    </ContentTemplate>
                    <Triggers>
