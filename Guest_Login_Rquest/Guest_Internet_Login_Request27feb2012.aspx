...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <table style="width: 100%;">
        <tr>
            <td class="NormalText" style="width: 50px">
                	&nbsp;</td>
        ...
        <tr>
            <td class="NormalText" style="vertical-align: top; width: 50px;">
                  &nbsp;</td>
            <td class="NormalText" colspan="2" style="vertical-align: top">
                  <div id="Div9">
                    <h3>  <asp:Label ID="Label10" runat="server" Text="(10 digit number without using 0 or +91) "></asp:Label> </h3>
                    </div> 
         ...
         <tr>
            <td class="NormalText" style="width: 50px; height: 16px; vertical-align: top;" >
                &nbsp;</td>
            <td class="NormalText" style="width: 161px; height: 16px; vertical-align: top;" >
                <div id="Div7">
