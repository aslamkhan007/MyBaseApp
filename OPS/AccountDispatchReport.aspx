...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <table style="width: 88%; height: 264px;">
        ...
        <tr>
         ...
         <tr>
          <td style="width:57px" class="BoundColumn_Date">
         ...
         <tr>
         <td style="width:95px">
                <asp:Label ID="Label3" runat="server" CssClass="labelcells" Text="Customer"></asp:Label>
            </td>
            <td class="NormalText" style="width: 38px">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox ID="txtCustomer" runat="server" CssClass="textbox" 
                            Width="200px" TabIndex="70"></asp:TextBox>
           ...
           <td style="text-align: center; width: 57px;">
            ...
            <td style="text-align: center; width: 57px;">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                <asp:Label ID="Label4" runat="server" CssClass="labelcells" ForeColor="Red" Text=""></asp:Label>
                       
                                <asp:LinkButton ID="lnkGRDetailToExcel" runat="server" CssClass="buttonc" onclick="lnkGRDetailToExcel_Click" 
                              >GR Detail</asp:LinkButton>
                    </ContentTemplate>
                     <Triggers>
                        
                         <asp:PostBackTrigger ControlID="lnkGRDetailToExcel" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
           </tr>
    ...
    <td style="text-align: center; width: 57px;">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                <asp:Label ID="Label5" runat="server" CssClass="labelcells" ForeColor="Red" Text=""></asp:Label>
                        <asp:LinkButton ID="LnkSale" runat="server" CssClass="buttonc" onclick="LnkSale_Click" 
                              >Sale</asp:LinkButton>
                      
                    </ContentTemplate>
                     <Triggers>
                        <asp:PostBackTrigger ControlID="LnkSale" />
             ...
             <td style="text-align: center; width: 57px;">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                <asp:Label ID="Label6" runat="server" CssClass="labelcells" ForeColor="Red" Text=""></asp:Label>
                        <asp:LinkButton ID="LnkCMDM" runat="server" CssClass="buttonc" onclick="LnkCMDM_Click"  
                              >CM DM </asp:LinkButton>
                      
                    </ContentTemplate>
                     <Triggers>
                        <asp:PostBackTrigger ControlID="LnkCMDM" />
