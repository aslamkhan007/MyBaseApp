...
public partial class OPS_AccountDispatchReport : System.Web.UI.Page
{
    ...
    protected void lnkGRDetailToExcel_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@company", SqlDbType.VarChar, 20).Value = "JCTLTD";
        cmd.Parameters.Add("@location", SqlDbType.VarChar, 10).Value = "PHG";
        cmd.Parameters.Add("@lang_id", SqlDbType.VarChar, 10).Value =1;
     
        cmd.Parameters.Add("@sdate", SqlDbType.VarChar, 20).Value = txt_FromDate.Text;
        cmd.Parameters.Add("@edate", SqlDbType.VarChar, 10).Value = txt_ToDate.Text;
        cmd.Parameters.Add("@CustCode", SqlDbType.VarChar, 10).Value = strCustCode;
        cmd.Parameters.Add("@Flag", SqlDbType.VarChar, 20).Value = "N";
    ...
    protected void LnkSale_Click(object sender, EventArgs e)
    {
        ...
        da.Fill(ds);
        dt = ds.Tables[0];
        string attachment = "attachment; filename=SaleReconciliation.xls";
        Response.Clear();
        Response.ClearContent();
        Response.AddHeader("content-disposition", attachment);
        Response.ContentType = "application/vnd.ms-excel";
    ...
    protected void LnkCMDM_Click(object sender, EventArgs e)
    {
        dtFrom = DateTime.Parse(txt_FromDate.Text);
        dtTo = DateTime.Parse(txt_ToDate.Text);
        ...
        da.Fill(ds);
        dt = ds.Tables[0];
        string attachment = "attachment; filename=CMDMSummary.xls";
        Response.Clear();
        Response.ClearContent();
        Response.AddHeader("content-disposition", attachment);
        Response.ContentType = "application/vnd.ms-excel";
