        ...
        try
        {
            foreach (GridDataItem dataItem in RadGrid1.Items)
            {
                ...
                if (chk.Checked.ToString() == "True")
                {
                    ...
                    str1 = "insert into tblAccountDocumentSend(InvoiceNo,Line_no,InvoiceDate,GrNo,GrDate,ItemGroup,Quantity,Customer,SalePerson,OrderNo,ItemNo,DocumentSend,DocumentSendDate,ActionPerformed,DocumentSendTo)";
                    ...
                    str2 = str2 + dataItem["Customer"].Text + "','" + dataItem["SalePerson"].Text + "','" + dataItem["OrderNo"].Text + "','" + dataItem["ItemNo"].Text + "','Y','" + System.DateTime.Now + "','" + action + "','" + document + "')";
                    str1 = str1 + str2;
