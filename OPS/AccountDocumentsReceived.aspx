        ...
        <tr>
         ...
         <td style="width: 155px">
            ...
            <td>
			    ...
			    <td style="width: 155px">
                <asp:Label ID="Label2" runat="server" Text="Document Id"></asp:Label>
            </td>
            <td>
                   <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="radtxtDocId"
                    Width="200px">
                </telerik:RadTextBox>
            </td>
       ...
       <table style="width: 100%;">
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="NormalText">
            <asp:TextBox ID="RadPartycode" runat="server" 
        ...
        <tr>
            ...
            <td>
                 <telerik:RadTextBox ID="txtRemarks" runat="server" 
                    CssClass="textbox" Width="200px" Height="20px"></telerik:RadTextBox>
