        ...
        try
        {
            ...
            foreach (GridDataItem item in RadGrid1.Items)
            {
                ...
                if (chk.Checked.ToString() == "True")
                {
                    ...
                    str = "UPDATE tblAccountDocumentSend SET DocumentReceive='" + item1 + "', DocumentreceiveDate='" + DateTime.Now + "' where InvoiceNo ='" + item["InvoiceNo"].Text + "' AND Line_no="+item["Line_no"].Text+"";
