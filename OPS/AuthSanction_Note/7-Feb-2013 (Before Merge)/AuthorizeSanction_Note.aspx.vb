...
Partial Class OPS_AuthorizeSanction_Note
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Try
            ...
            qry = "   SELECT  'Attachments' AS Attachment , ImgName AS AttachedFile FROM    dbo.Jct_Ops_SanctionNote_Attachments  WHERE   SanctionNoteID = '" + Trim(GridView1.SelectedRow.Cells(1).Text) + "'"
                    ...
                    If .SelectedIndex > -1 Then
                        If GridView1.SelectedRow.Cells(1).Text <> "" Or GridView1.Rows.Count >= 1 Then
                            ...
                            Else ' Else part executed for all sanction note other than Exceptions
                                ...
                                Dim Body1 As String = "Subject Mentioned :- " & Subject & " <hr><br><br> Under Area :-" & Area & " <BR> <HR>"
                                Dim Val1 As String = ""
