...
Partial Class OPS_AuthorizeSanction_Note
                    ...
                    If .SelectedIndex > -1 Then
                                ...
                                Else ' Else part will be executed in case when either maxauthlevel is achevied or some one wants to cancel any sanctionnote
                                    ...
                                    Else
                                        ...
                                        If SendMailTo <> "" Then
                                            Dim Sp As String
                                            Sp = ""
                                            qry = "Select top 1 isnull(E_MailID,'None') from JCT_OPS_SanctionNote_AUTHORIZATION_LISTING a,mistel b WHERE AreaCode='" & AreaCode & "'  and id='" & SanctionNote & "' and a.Usercode=b.empcode order by userlevel"
                        ...
                        Else ' Else part executed for all sanction note other than Exceptions
                                Try
                                    ...
                                    Else
                                        SendMail(Body, Body1, Body3, "", SendMailTo, AuthorizedBy, "Ashish@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com", "This SanctionNote :-" & SanctionNote & "  has been " & ddlAction.SelectedItem.Text & "", SanctionNote, CurrentUserLevel, MaxAuthLevel, FinalNotify, ddlAction.SelectedItem.Text)
                                    End If
    ...
    '    sb.AppendLine("</table>")
    '    sb.AppendLine("<br />")
    '    sb.Append("<a href='http://misdev/fusionapps/OPS/materialrequest.aspx'> Click here to view details... </a><br />")
...
'                                SendMail(Body, Body1, Body3, RaisedBy, SendMailTo, "ashish@jctltd.com", "Ashish@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com", "This SanctionNote :-" & SanctionNote & "  has been " & ddlAction.SelectedItem.Text & "", SanctionNote, CurrentUserLevel, MaxAuthLevel, FinalNotify, ddlAction.SelectedItem.Text)
'                            End If
'                            RefreshLists()
