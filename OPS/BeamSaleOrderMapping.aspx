...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <script type="text/javascript">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="NormalText" style="width: 109px">
                <asp:Label ID="Label31" runat="server" Text="Select Year" Visible="false"></asp:Label>
            </td>
            <td class="NormalText" style="width: 161px">
                <asp:DropDownList ID="ddlYear" runat="server" CssClass="combobox" Visible="false">
                    <asp:ListItem></asp:ListItem>
            ...
            <td class="NormalText" style="width: 80px">
                <asp:Label ID="Label32" runat="server" Text="Select Month" Visible="false"></asp:Label>
            </td>
            <td class="NormalText">
                <asp:DropDownList ID="ddlMonth" runat="server" CssClass="combobox" Visible="false">
                    <asp:ListItem></asp:ListItem>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkSave" runat="server" CssClass="buttonc"  
                            OnClick="lnkSave_Click">Save</asp:LinkButton>
                                ...
                                <asp:LinkButton ID="lnkEdit" runat="server" CssClass="buttonc"  Visible="false"
            ...
            <td class="NormalText" colspan="4">
                <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="lnkSave" EventName="Click" />
                         <asp:AsyncPostBackTrigger ControlID="grdSaleOrder" EventName="RowCommand" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:GridView ID="grdEdit" runat="server" AllowPaging="True" 
                                EnableModelValidation="True" onpageindexchanging="grdEdit_PageIndexChanging" 
                                onrowdeleted="grdEdit_RowDeleted" onrowdeleting="grdEdit_RowDeleting" 
                                Width="100%">
                                <AlternatingRowStyle CssClass="GridAI" />
                                <Columns>
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="grdEdit" EventName="PageIndexChanging" />
                        <asp:AsyncPostBackTrigger ControlID="grdEdit" EventName="RowDeleting" />
                        <asp:AsyncPostBackTrigger ControlID="grdEdit" EventName="RowDeleted" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
