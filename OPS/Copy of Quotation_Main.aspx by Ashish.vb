...
Partial Class OPS_Quotation_Main
    ...
    Protected Sub ibtSave_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtSave.Click
        ...
        'If rblQuotOwner.SelectedIndex = 1 Then
        ...
        Catch ex As Exception
            ...
            sm.SendMail("jagdeep@jctltd.com", "noreply@jctltd.com", "Error Occurred while creating/saving quotation" & lblQuotationNo.Text & " <br/> " & Session("EmpName").ToString, ex.Message)
    ...
    Protected Sub cmdAuthorise_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles cmdAuthorise.Click
        ...
        Try
            ...
            Try
                ...
                cc = cc & "rbaksshi@jctltd.com; jagdeep@jctltd.com;"
        ...
        Catch ex As Exception
            sm.SendMail2("jagdeep@jctltd.com", "", "", "approvals@jctltd.com", "Error occurred while authorising Quotation:" + lblQuotationNo.Text, ex.Message)
            ofn.Alert(ex.Message)
    ...
    'Protected Sub ShowHideSOReqButton()
    ...
    '    cmd.Parameters.Add("Quotation_No", SqlDbType.VarChar, 16).Value = lblQuotationNo.Text
    '    cmd.Parameters.Add("User_Code", SqlDbType.VarChar, 10).Value = Session("EmpCode").ToString
    '    cmd.Parameters.Add("Access_Type", SqlDbType.VarChar, 10).Value = "SOReq"

    '    Try

    '        Dim dr As SqlDataReader = cmd.ExecuteReader()
    '        Dim so_req_vis As String = ""
    '        If dr.HasRows Then

    '            so_req_vis = dr("Show").ToString

    '            If so_req_vis = "Y" Then
    '                cmdPush_SO.Visible = True
    '            ElseIf so_req_vis = "N" Then
    '                cmdPush_SO.Visible = False
    '            Else
    '                lblMessage.Text = "Problem setting SO Request Access."
    '            End If
    ...
    Protected Sub ShowHideAuthSOReqButton()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                'If auth_so_req = "Y" Then
                '    cmdAuthorise_Push_SO.Visible = True
                'Else
                '    cmdAuthorise_Push_SO.Visible = False
                'End If
