                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                            SelectCommand="Select '' as AreaName,0 as AreaCode Union SELECT AreaName,AreaCode FROM Jct_Ops_SanctioNote_Area_Master WHERE STATUS='A' AND AreaCode NOT IN (1015,1018,1019,1020,1021,1022,1024,1023,1026,1027,1029) ORDER BY AreaName ASC">
                        </asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
