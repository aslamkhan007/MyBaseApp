        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                 <ContentTemplate>
                        <asp:TextBox ID="txtActualCount" runat="server" CssClass="textbox" AutoPostBack="false"
           ...
           <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                 <ContentTemplate>
                        <asp:TextBox ID="txtSequenceNo" runat="server" CssClass="textbox" AutoPostBack="false"
