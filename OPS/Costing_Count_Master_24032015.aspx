...
<table style="width: 88%; height: 264px;">
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtCountCode" runat="server" CssClass="textbox" Width="133px"
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtCountDesc" runat="server" CssClass="textbox" Width="250px" 
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                 <ContentTemplate>
                        <asp:TextBox ID="txtActualCount" runat="server" CssClass="combobox" AutoPostBack="false"
           ...
           <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlCountUsage" runat="server" CssClass="combobox" AutoPostBack="false"
                            Width="130px" >
                                 <asp:ListItem Text="Select" Value=""></asp:ListItem>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                 <ContentTemplate>
                        <asp:TextBox ID="txtSequenceNo" runat="server" CssClass="combobox" AutoPostBack="false"
                            Width="130px" onkeypress="return NumberOnly()" ></asp:TextBox>
        ...
        <tr>
            <td colspan="10">
                <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" Height="400px" ScrollBars="Both" Width="955px">
                    <div>
                        <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                            <ContentTemplate>
                                <%--GRID HERE --%>
                                  <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False"  Width="920px"
                                    onselectedindexchanged="grdView_SelectedIndexChanged" 
                                    DataKeyNames="tran_no"  Height="393px" >                                    
                                    <Columns>                                    
