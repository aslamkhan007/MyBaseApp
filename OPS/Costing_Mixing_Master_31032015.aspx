...
function NumberOnly()
    ...
    <table style="width: 88%; height: 264px;">
        ...
        <tr>
            <td style="width: 94px">
                <asp:Label ID="Label3" runat="server" Text="Mixing Code" CssClass="labelcells" Width="90px"></asp:Label>
            </td>
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtMixingCode" runat="server" CssClass="textbox" Width="133px" Enabled="False"
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtMixingDesc" runat="server" CssClass="textbox" Width="250px" Enabled="False"
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSequence" runat="server" CssClass="combobox" AutoPostBack="false"
                            Width="130px" onkeypress="return NumberOnly()" MaxLength="3"></asp:TextBox>
        ...
        <tr>
            <td colspan="10">
                <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" Height="400px" ScrollBars="Both">
                    <div>
