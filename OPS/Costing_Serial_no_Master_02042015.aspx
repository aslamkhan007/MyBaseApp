        ...
        <tr>
            ...
            <td colspan="4" align="center">
                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnAdd" runat="server" Text="ADD" CssClass="buttonc" OnClick="btnAdd_Click" />
                        ...
                        <asp:Button ID="btnRefresh" runat="server" Text="Refresh" CssClass="buttonc" OnClick="btnRefresh_Click" />
                        <asp:Button ID="btnAuthorize" runat="server" Text="Authorize" CssClass="buttonc"
                            OnClick="btnAuthorize_Click" />
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="buttonc" OnClick="btnDelete_Click" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td colspan="5" class="style7">
