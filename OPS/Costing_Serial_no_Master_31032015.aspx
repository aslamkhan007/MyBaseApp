...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 88%; height: 264px;">
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtTypeCode" runat="server" CssClass="textbox" Width="120px" 
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtType" runat="server" CssClass="textbox" Width="250px" 
        ...
        <tr>
            ...
            <td style="height: 67px">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtPrefix" runat="server" CssClass="textbox" MaxLength="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            ...
            <td style="height: 67px">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSuffix" runat="server" CssClass="textbox" Width="250px"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td style="height: 67px">
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:TextBox ID="txt_efffrom" runat="server" CssClass="textbox" Height="19px" Width="75px" >
                        </asp:TextBox>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:TextBox ID="txt_effto" runat="server" CssClass="textbox" Height="20px" 
        ...
        <tr>
            <td colspan="10">
                <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" Height="200px" ScrollBars="Both">
                    <div style="overflow: ">
                        <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                            <ContentTemplate>
                                <%--GRID HERE  --%>
                                <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False" Width="900px" 
