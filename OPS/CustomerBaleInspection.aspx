...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CssClass="labelcells"
                                    ...
                                    <Columns>
                                       ...
                                       <ItemTemplate>
                                               <asp:TextBox ID="txtRemarks" runat="server" Font-Size="Medium" >
                                ...
                                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CssClass="labelcells"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="InvoiceDate" HeaderText="Invoice Date" />
                                         <asp:TemplateField HeaderText="Remarks">
                                       <ItemTemplate>
                                               <asp:TextBox ID="txtReturnRemarks" runat="server" Font-Size="Medium" >
        ...
        <tr>
            ...
            <td>
              <asp:LinkButton ID="lnkNotReturn" runat="server" CssClass="buttonc" 
                    Width="67px" onclick="lnkNotReturn_Click">Not Return</asp:LinkButton>
              </td>
        </tr>
    </table>
</asp:Content>
