...
Partial Class DailyProductionAndDispatch
    ...
    Protected Sub BtnFetch_Click(sender As Object, e As System.EventArgs) Handles BtnFetch.Click
        ...
        SqlPass = "EXEC SHP..JCT_NEWTPM '" & TxtDateFrom.Text & "' ,  '" & txtDateTo.Text & "'  ,'" & Session("EmpCode") & "'   "
    ...
    Protected Sub TabelFetch()
        ...
        SqlPass = "SELECT ItemGroup,DESCRIPTION ,[Group] ,SubGroup ,MainGroup ,Type,PckgTdy,PckgUTD,DisTdy,DisTdyVal,DisUTD,DisUTDVal,NSR,FromDate , ToDate  FROM   shp..JCT_NEW_TPM_FINAL_FIGURE where userid='" & Session("EmpCode") & "' ORDER BY [Group] ,  SubGroup ,  Type "
