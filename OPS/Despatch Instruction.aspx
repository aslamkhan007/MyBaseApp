<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/OPS/MasterPage.master" CodeFile="Despatch Instruction.aspx.vb" Inherits="OPS_ODS_Despatch_Instruction" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                RequestID</td>
                <td><asp:Label ID="lblID" runat="server" Font-Bold="True" Font-Size="Medium"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
