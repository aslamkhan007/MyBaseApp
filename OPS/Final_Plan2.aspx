<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="Final_Plan2.aspx.cs" Inherits="OPS_Planning_Final_Plan2" %>
                ...
                <td class="NormalText" style="width:30px">
                    ...
                    <Columns>
                       <asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="Actual Delivery Dt">
                                       <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Expected Delivery Dt">
                                       <ItemTemplate>
                                           <asp:TextBox ID="lblReqdt1" runat="server" Columns="12" MaxLength="12" CssClass="textbox" 
                                               Text='<%# Eval("ac_req_dt") %>' AutoPostBack="True" ></asp:TextBox>
                                   ...
                                   <asp:TemplateField HeaderText="Shed">
                                       <ItemTemplate>
                                           <asp:UpdatePanel ID="UpdatePanel9" runat="server" RenderMode="Inline">
                                               ...
                                               <asp:DropDownList ID="ddlShedS" CssClass="combobox" runat="server"  
                                               AutoPostBack="True" >
                                                   <asp:ListItem Value="">Select</asp:ListItem>
                                                   <asp:ListItem Value="RP190">Rapier</asp:ListItem>
                                                   <asp:ListItem Value="AR190">Airjet</asp:ListItem>
