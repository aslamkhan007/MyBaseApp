<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="FoldingObservationReport.aspx.cs" Inherits="OPS_FoldingObservationReport" %>
    ...
    <table style="width:100%;">
        <tr>
            <td class="tableheader">
                <asp:Label ID="Label18" runat="server" Text="Folding Observation Report"></asp:Label>
            </td>
        </tr>
    </table>
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 166px">
                <asp:TextBox ID="txtsortno" runat="server" Columns="20" CssClass="textbox"   ToolTip="Please enter your unique sort no. E.g- DYD12345 "
                    MaxLength="20"></asp:TextBox>
            </td>
            <td class="NormalText" style="width: 78px">
                <asp:Label ID="Label25" runat="server" Text="Order No"></asp:Label>
               </td>
            <td class="NormalText">
            
                <asp:TextBox ID="txtOrderNo" runat="server" Columns="20" CssClass="textbox" 
                    MaxLength="20" 
                    
                    ToolTip="Please enter your unique courier id. E.g- pinv/123456/2015 or just 1022"></asp:TextBox>
        ...
        <tr>
          ...
          <%--              <cc1:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" 
                            ...
                            ServicePath="~/WebService.asmx" TargetControlID="txtSancitonNOte">
                        </cc1:AutoCompleteExtender>--%>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="NormalText" style="width: 78px">
                <asp:Label ID="Label26" runat="server" Text="Shade"></asp:Label>
               </td>
            <td class="NormalText">
          
                <asp:TextBox ID="txtShade" runat="server" Columns="20" CssClass="textbox" 
                    MaxLength="20" 
                    
                    ToolTip="Please Enter Shade"></asp:TextBox>
