...
public partial class OPS_FoldingObservationReport : System.Web.UI.Page
{
    ...
    protected void BindGridGroupByTotalQty()
    {
        sql = "Jct_Ops_Folding_Observation_Fetch_Report";
    ...
    {
        sql = "Jct_Ops_Folding_Observation_Fetch_Report_individual";
        SqlCommand cmd = new SqlCommand(sql, obj.Connection());
        cmd.CommandType = CommandType.StoredProcedure;
    ...
    {
        if (ddlReporttype.SelectedItem.Text == "GroupWise")
        {

            BindGridGroupByTotalQty();
        }
        else
        if (ddlReporttype.SelectedItem.Text == "Individual")
        {
            BindGridIndividual();
        }
    ...
    {
        Response.Redirect("FoldingObservationReport.aspx");
