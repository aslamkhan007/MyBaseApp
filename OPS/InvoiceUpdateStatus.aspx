<%@ Page Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false" CodeFile="InvoiceUpdateStatus.aspx.vb" Inherits="InvoiceUpdateStatus" title="Packing Update Status" MaintainScrollPositionOnPostback="true" %>  
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td class="labelcells" colspan="4">
                        <asp:RadioButtonList ID="rblPlant" runat="server" AutoPostBack="True" 
                            RepeatDirection="Horizontal" Width="340px">
                ...
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="txtRemarksToUpdate" runat="server" AutoPostBack="True" 
                            ...
                            DataValueField="Catogories" ValidationGroup="B">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                            SelectCommand="   SELECT '' AS Catogories  UNION  SELECT UPPER(Catogories)  AS Catogories  FROM JCT_OPS_INVOICE_REASON   ORDER BY  Catogories  ">
                        </asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
               </td>
