...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="StoreIssue Between"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtEffecFrom" runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
            ...
            <td >
                <asp:TextBox ID="txtEffecTo" runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
        ...
        <tr>
            <td>
                Actual Price</td>
            <td colspan="2">
                <asp:CheckBox ID="chkActualPrice" runat="server" />
            </td>
            <td>
                &nbsp;</td>
                 <td rowspan="2">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <telerik:RadGrid ID="RadGrid1" runat="server" 
                            CellSpacing="0">
                            <ExportSettings FileName="Comparision Sheet">
                            </ExportSettings>
