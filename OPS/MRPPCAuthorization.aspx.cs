...
GridViewRow row = grdDetail.SelectedRow;
        ...
        try
        {
		  ...
		  //05 feb 2016
  str1 = "INSERT INTO jct_ops_MRPPC(RequestID,Category,ReqSO,PPCStatus,ReqSoDate,CreatedBy,CreatedDate,RemarksForBckOff) VALUES('" + txtMrNo.Text + "','" + txtcategory.Text + "','Y','" + status + "','" + DateTime.Now + "','" + Session["empcode"].ToString() + "','" + DateTime.Now + "','"+txtBckOffRmrks.Text+"')";
  //05 feb 2016
        ...
        try
        {
            ...
            if (ViewState["SanctionID"] != null)
            {
                if (parameter == "BackOffice")
                {
                 ...
                 // url = "http://localhost:2800/FusionApps/ops/MRPPCAuthorizationMail.aspx?" + querystring + "&Empcode=" + querystring1 + "&Returntype=" + querystring2;
                }
                if (parameter == "Logistics")
                {
                    ...
                    querystring = "SanctionID=" + ViewState["SanctionID"];
                    querystring1 = Session["Empcode"].ToString();
                 //url = "http://localhost:2800/FusionApps/ops/MRPPCAuthLogisticMail.aspx?" + querystring + "&Empcode=" + querystring1 + "&Returntype=" + querystring2;
...
GridViewRow row = grdPending.SelectedRow;
		...
		//05 feb 2016
  str1 = "UPDATE jct_ops_MRPPC SET OrderNo='" + txtOrderNo.Text + "', PPCStatus='PPCAuth',LogisticSend='" + DateTime.Now + "',LogisticStatus='P',RemarksForLogistics='"+txtRemarks.Text+"' WHERE RequestID='" + txtMRNumber.Text + "'";
  //05 feb 2016
            command.Transaction = CommonTrans;
            command.CommandText = str1;
            command.Connection = con;
