...
public partial class OPS_MRPreviewPrintReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["ID"] != null)
        {
            ...
            sql = "JCT_OPS_MR_Logistic_Status_Report";
            cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@SanctionNoteID", SqlDbType.VarChar, 20).Value = ID;
            da = new SqlDataAdapter(cmd);
            ...
            {
                ds.Tables[0].Rows.Add(ds.Tables[0].NewRow());
                grdLogisticAuth.DataSource = ds;
                grdLogisticAuth.DataBind();
                int columncount = grdLogisticAuth.Rows[0].Cells.Count;
                grdLogisticAuth.Rows[0].Cells.Clear();
                grdLogisticAuth.Rows[0].Cells.Add(new TableCell());
                grdLogisticAuth.Rows[0].Cells[0].ColumnSpan = columncount;
                grdLogisticAuth.Rows[0].Cells[0].Text = "No Records Found";
                grdLogisticAuth.Rows[0].Cells[0].ForeColor = System.Drawing.Color.Red;
