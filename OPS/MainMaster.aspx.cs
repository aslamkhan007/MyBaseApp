...
public partial class OPS_MainMaster : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["EmpCode"].ToString() == "A-00098" || Session["EmpCode"].ToString() == "J-1945" || Session["EmpCode"].ToString() == "J-01838" || Session["EmpCode"].ToString() == "R-03339")
            {
            ...
            {
                sql = "SELECT  PARAMETER_CODE , parameter FROM    JCT_OPS_MULTI_MASTER a,JCt_OPS_Parameter_User_Mappings b  WHERE   a.status = 'A' AND b.STATUS='A' AND EmpCode='Y-04806' AND a.PARAMETER_CODE=b.ParameterCode and Empcode='" + Session["EmpCode"] + "'  ORDER BY PARAMETER";
            }
    ...
    protected void lnkSave_Click(object sender, EventArgs e)
    {
        try
        {
                    ...
                    cmd.Parameters.Add("@UserCode", SqlDbType.VarChar, 7).Value = Session["EmpCode"].ToString();
