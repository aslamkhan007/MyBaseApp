...
Partial Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 'Handles Me.Load
        ...
        If IsPostBack = False Then
            objFunction.RegAppHit(Session("Companycode"), Session("Empcode"), "PP", Request.UserHostAddress)
            Menu1.Items.Clear()
            'obj.opencn()
            'qry = "select b.description,page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='HuskMgmt' and uname='" & Session("empcode") & "' union select b.description,page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='HuskMgmt' and uname='" & Trim(Session("empcode")) & "' order by parent_menu,seq"
        ...
        'lblGreeting.Text = objFunction.Greet()
    ...
    Protected Sub Menu1_MenuItemClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.MenuEventArgs) Handles Menu1.MenuItemClick
        ...
        If e.Item.Text = "Presentation" Then
            Response.Redirect("Downloadfile.aspx?filepth=D:/WebApplications/FusionApps1/EmpGateway/presentation/pre.pps")
        ElseIf e.Item.Text = "Policies" Then
            Response.Redirect("Downloadfile.aspx?filepth=D:/WebApplications/FusionApps1/EmpGateway/policies/policies.pdf")
        ElseIf e.Item.Text = "Logout" Then
            Session("empcode") = ""
            Response.Redirect("Default.aspx")
        ElseIf e.Item.Text = "Help - HOW DO I ?" Then
            Page.RegisterClientScriptBlock("scr", "<script language = javascript> window.open('http://misdev/howdoi');</script>")
    ...
    Private Function GetMenuData() As DataTable
        ...
        Try
            ...
            'Dim strSQL As String = "select b.description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='PP' and uname='" & Session("Empcode") & "' union select b.description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='PP' and uname='" & Trim(Session("Empcode")) & "' order by parent_menu,seq" '"select b.description,page_name=isnull(page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.mnuname=c.mnuname where a.module ='Costing System' and uname='" & Session("Empcode") & "' union select b.description,page_name=isnull(page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.mnuname=c.mnuname  where a.module ='Costing System' and uname='" & Trim(Session("Empcode")) & "' order by parent_menu,seq"
            Dim strSQL As String = "select b.description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu ,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='PP' and uname='" & Session("Empcode") & "' union select b.description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu ,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='PP' and uname='" & Trim(Session("Empcode")) & "' order by parent_menu ,seq "
    ...
    Private Sub AddChildMenuItems(ByVal menuData As DataTable, ByVal parentID As String, ByVal parentMenu As MenuItem)
        ...
        Try
            ...
            For Each datRow In datView
                ...
                If childMenu.Text = "Purchase Advice" Then
                    childMenu.ImageUrl = "~/Image/icon_modal_close.png"
                ElseIf childMenu.Text = "Processing Advice" Then
                    childMenu.ImageUrl = "~/Image/icon_modal_close.png"
                ElseIf childMenu.Text = "Workers Engagement Advice" Then
                    childMenu.ImageUrl = "~/Image/icon_modal_close.png"
                End If
            Next
