<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="MaterialReturnClosure_Report.aspx.cs" Inherits="OPS_MaterialReturnClosure_Report" %>
    ...
    <table style="width:100%;">
        <tr>
            <td class="tableheader">
                <asp:Label ID="Label18" runat="server" Text="MR Closure Report"></asp:Label>
            &nbsp;:</td>
        </tr>
    </table>
    <table style="width:100%;">
