...
public partial class OPS_MaterialReturnDetail : System.Web.UI.Page
{
    ...
    protected void grdDetail_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        sql = "SELECT RequestID,customer,invoice_no,item_no,Convert(numeric(12,2),invoice_qty) as invoice_qty,ret_qty ,bales,Freight_by FROM dbo.jct_ops_material_request WHERE RequestID=" + grdDetail.SelectedRow.Cells[1].Text + " AND SR_NO=" + grdDetail.SelectedRow.Cells[7].Text;
        ...
        if (dr.HasRows)
        {
            while (dr.Read())
            {
                ...
                lblSrNo.Text = grdDetail.SelectedRow.Cells[7].Text;
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.Parameters.Add("@SrNo", SqlDbType.VarChar, 5).Value = lblSrNo.Text;
            cmd.ExecuteNonQuery();
            SendMail();
