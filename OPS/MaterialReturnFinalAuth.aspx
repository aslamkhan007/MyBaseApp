...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:Label ID="lblrequests" runat="server" Visible="false"></asp:Label>
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                                SelectCommand="JCT_OPS_MR_LOGISTIC_FETCH_FOR_AUTHORIZATION" SelectCommandType="StoredProcedure">
                                <SelectParameters>
    ...
    <table style="width: 100%;">
        <tr>
            <td class="NormalText">
                        ...
                        <asp:Panel ID="pnlEdit" runat="server" CssClass="panelbg" Visible="False">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="NormalText">
                                        <asp:TextBox ID="txtReturnQty" runat="server" CssClass="textbox" AutoPostBack="True"
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="txtReturnQty_FilteredTextBoxExtender" runat="server"
                                            TargetControlID="txtReturnQty" ValidChars="1234567890.">
                                ...
                                <tr>
                                    ...
                                    <td class="NormalText">
                                        <asp:TextBox ID="txtGrDate" runat="server" CssClass="textbox" Text=" "></asp:TextBox>
                                       <%--  <cc1:CalendarExtender ID="txtGrDate_CalendarExtender0" runat="server" TargetControlID="txtGrDate">
                                        </cc1:CalendarExtender>--%>
                                       <%-- 27 Jan 2016--%>
                                        <cc1:CalendarExtender ID="txt_From_CalendarExtender" runat="server" TargetControlID="txtGrDate">
                                        </cc1:CalendarExtender>
                                        <cc1:MaskedEditValidator ID="ME1" runat="server" ControlExtender="MEE1" ControlToValidate="txtGrDate"
                                ...
                                <tr>
                                    ...
                                    <td class="NormalText" style="width: 130px">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlPhysicalDocsRecvd"
                                            Display="Dynamic" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="NormalText" style="width: 112px">
                                        &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="NormalText">
                                        <asp:Label ID="lblValueInvolved" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="NormalText" style="width: 158px">
                                ...
                                <tr>
                                    <td class="buttonbackbar" colspan="4">
                                        <asp:LinkButton ID="lnkAuthorize" runat="server" CssClass="buttonc" OnClick="lnkAuthorize_Click"
                                            BorderStyle="None">Authorize</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                ...
                <asp:FileUpload ID="FileUpload1" runat="server" Height="1px" Width="1px" multiple="true" />
            </td>
        </tr>
    </table>
</asp:Content>
