    ...
    <table style="width: 100%;">
        <tr>
            <td class="NormalText">
                                ...
                                <tr>
                                    ...
                                    <td class="NormalText">
                                        <asp:TextBox ID="txtReturnQty" runat="server" CssClass="textbox" 
                                            AutoPostBack="True" ontextchanged="txtReturnQty_TextChanged"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                            ControlToValidate="txtReturnQty" Display="Dynamic" ErrorMessage="*" 
                                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        <cc1:FilteredTextBoxExtender ID="txtReturnQty_FilteredTextBoxExtender" 
                                            runat="server" TargetControlID="txtReturnQty" ValidChars="1234567890.">
                                ...
                                <tr>
                                    <td class="buttonbackbar" colspan="4">
                                        <asp:LinkButton ID="lnkAuthorize" runat="server" CssClass="buttonc" 
                                            OnClick="lnkAuthorize_Click" BorderStyle="None">Authorize</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                ...
                <asp:FileUpload ID="FileUpload1" runat="server" Height="1px" Width="1px" 
                    multiple="true" />
            </td>
        </tr>
    </table>
