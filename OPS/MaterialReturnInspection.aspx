...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td class="NormalText" style="width: 377px">
        ...
        <tr>
            <td class="buttonbackbar" colspan="3">
                <asp:LinkButton ID="lnkSearch" runat="server" CausesValidation="False" CssClass="buttonc" OnClick="lnkSearch_Click">Search</asp:LinkButton>
            </td>
        </tr>
        </table>
    <table style="width:100%;">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtReturnQty_ins" Display="Dynamic" ErrorMessage="** Please mention return qty."></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 284px">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRolls_ins" Display="Dynamic" ErrorMessage="** Please mention number of rolls."></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 284px">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtInspectionRemarks" Display="Dynamic" ErrorMessage="**Please give remarks."></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 284px">
