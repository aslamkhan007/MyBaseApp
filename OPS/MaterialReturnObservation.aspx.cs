...
public partial class OPS_MaterialReturnObservation : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        if (ViewState["SanctionID"] != null)
        {
            ...
            try
            {
              ...
              sendmail(Genratedby_Email, Genratedby_Email, NotifyEmailGroup, "hitesh@jctltd.com,sandeepr@jctltd.com");
    ...
    public void sendmail(string SalesPerson_Email, string too, string NotifyEmailGroup, string bccc)
    {
        ...
        try
        {
            ...
            //     url = "http://localhost:1084/FusionApps/ops/MrFoldingObservationMail.aspx?" + querystring + "&Empcode=" + querystring1 + "&Returntype=" + querystring2;
    ...
    protected void btnUpload_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            string sanctionid = "9000000537201904";
    ...
    protected void lnkFetch_Click(object sender, EventArgs e)
    {
        ...
        qry = "Jct_Ops_Mr_Folding_Observation_Fetch '" + Session["Empcode"].ToString() + "','" + AreaName + "','" + txtRequest.Text + "'";
