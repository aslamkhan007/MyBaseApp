                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" EnableModelValidation="True"
                            AllowPaging="true" PageSize="100" Width="100%" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
...
<asp:ListItem>SM</asp:ListItem>
                                            <asp:ListItem>SW</asp:ListItem><asp:ListItem>SF</asp:ListItem>
                                            <asp:ListItem>FN</asp:ListItem><asp:ListItem>RG</asp:ListItem>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkaddrow" runat="server" CssClass="buttonc" CausesValidation="True"
                            OnClick="lnkaddrow_Click" ValidationGroup="mandatory" Visible="False">AddRow</asp:LinkButton>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
        ...
        <tr>
            <td>
                ...
                &nbsp;<img alt="Add File" src="../Image/Icons/Action/document_add.png" onclick="AddFileUpload()"
                    width="48" /><asp:ImageButton AlternateText="Upload File(s)" ID="imgUpload" runat="server"
