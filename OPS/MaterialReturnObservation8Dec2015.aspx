<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="MaterialReturnObservation.aspx.cs" Inherits="OPS_MaterialReturnObservation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;">
        ...
        <ContentTemplate>
         <asp:DropDownList ID="ddlObservationType" runat="server" AutoPostBack="True" 
                CssClass="combobox" 
                            ...
                            <AlternatingRowStyle CssClass="GridAI" />
                              <Columns>
                                ...
                                <asp:TemplateField AccessibleHeaderText="OrderNo" HeaderText="OrderNo">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtOrderNo" runat="server" CssClass="textbox" Text='<%# Eval("OrderNo") %>' CausesValidation="true" ></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="RequiredOrderNo" runat="server" ErrorMessage="*" ControlToValidate="txtOrderNo" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Sort">
                                   <ItemTemplate>
                                        <asp:TextBox ID="txtSort" runat="server" CssClass="textbox" Text='<%# Eval("SortNo") %>' CausesValidation="true"  ></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredSortNo" runat="server" ErrorMessage="*" ControlToValidate="txtSort" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                  </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Shade">
                                   <ItemTemplate>
                                        <asp:TextBox ID="txtShade" runat="server" CssClass="textbox"  CausesValidation="true"  Text='<%# Eval("Shade") %>'></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredShade" runat="server" ErrorMessage="*" ControlToValidate="txtShade" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                  </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Packing Type">
                                   <ItemTemplate>
                                        <asp:DropDownList ID="ddlPackingType" runat="server" CssClass="combobox" 
                                            AutoPostBack="True" 
                                  ...
                                  <asp:TemplateField HeaderText="Meters">
                                   <ItemTemplate>
                                        <asp:TextBox ID="txtMeters" runat="server" CssClass="textbox" ValidationGroup="mandatory" CausesValidation="true"  Text='<%# Eval("Meters") %>' ></asp:TextBox>                               
                                       
                                        <cc1:FilteredTextBoxExtender
                        ID="FilteredTextBoxExtender2" runat="server" 
                    TargetControlID="txtMeters" ValidChars="0123456789" FilterType="Numbers">
                    </cc1:FilteredTextBoxExtender>

                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtMeters" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                  </asp:TemplateField>
                                  ...
                                  <asp:TemplateField HeaderText="Observation">
                                   <ItemTemplate>
                                        <asp:TextBox ID="txtObservation" runat="server" CssClass="textbox" Text='<%# Eval("Observation") %>' CausesValidation="true" ></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredObservation" runat="server" ErrorMessage="*" ControlToValidate="txtObservation" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
                                   </ItemTemplate>
                                  </asp:TemplateField>
        ...
        <tr>
            ...
            <td colspan="4">
                        ...
                        <asp:GridView ID="GridView3" runat="server" AutoGenerateSelectButton="True" 
                            ...
                            Width="100%" Caption="Pending Requests:" CaptionAlign="Left" 
                  >
                            <AlternatingRowStyle CssClass="GridAI" />
                              <Columns>
                                <asp:TemplateField>
        ...
        <asp:GridView ID="nestedGridView_MultipleID0" runat="server" Width="100%" 
                    AutoGenerateColumns="False"  >
                    <SelectedRowStyle CssClass="SelectedRowStyle" />
                    <HeaderStyle CssClass="GridHeader" />
                    <RowStyle CssClass="GridItem" />
