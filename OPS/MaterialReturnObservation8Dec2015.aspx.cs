...
public partial class OPS_MaterialReturnObservation : System.Web.UI.Page
{
        ...
        if (ViewState["SanctionID"] != null)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow gvRow in GridView2.Rows)
                {
                    ...
                    TextBox TxtSort = (TextBox)gvRow.FindControl("txtSort");
                    ...
                    cmd.Parameters.Add("@SortNo", SqlDbType.VarChar, 30).Value = TxtSort.Text;
    ...
    public void sendmail(string SalesPerson_Email, string too, string NotifyEmailGroup, string bccc)    
    {
        try
        {
            ...
            //    querystring1 = "EmpCode=" + Session["Empcode"].ToString();

            //    querystring2 = "Returntype=" + Session["Empcode"].ToString();
          ...
          // url = "http://test2k/FusionApps/ops/MrFoldingObservationMail.aspx?" + querystring + "&Empcode=" + querystring1 + "&Returntype=" + querystring2;
             url = "http://misdev/FusionApps/ops/MrFoldingObservationMail.aspx?" + querystring + "&Empcode=" + querystring1 + "&Returntype=" + querystring2;
