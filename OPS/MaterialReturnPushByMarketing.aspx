...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="4">
                <asp:Label ID="Label1" Visible="false" runat="server">Costing Observation</asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4">
        ...
        <tr>
            <td>
                <asp:Label ID="lblPartyCode" runat="server">Party Code</asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtPartycode" runat="server" CssClass="textbox" Width="200px">
                </asp:TextBox>
                <div id="divWidth" style="display: none;">
                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="10"
                        ...
                        CompletionListCssClass="AutoExtender" ServicePath="~/WebService.asmx" EnableCaching="false"
                        CompletionListElementID="divwidth" CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                        FirstRowSelected="false" CompletionListItemCssClass="AutoExtenderList" TargetControlID="txtPartycode">
                ...
                <asp:UpdatePanel ID="UpdObservation" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView2" runat="server" ShowHeaderWhenEmpty="True" Width="100%"
                            AutoGenerateColumns="False" CaptionAlign="Left" OnRowDataBound="GridView2_RowDataBound">
                            <AlternatingRowStyle CssClass="GridAI" />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Price">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtPrice" runat="server" Text="" onkeypress="return NumberOnly()">
                                        </asp:TextBox>
                                        <%-- <telerik:RadNumericTextBox ID="txtPrice" runat="server" Width="60px" inputtype="Number"
                                            MaxLength="7" DataType="System.Int32" MinValue="1" Culture="en-US" DbValueFactor="1"
                                            EmptyMessage="?" LabelWidth="32px" MaxValue="10000" CausesValidation="True" ValidationGroup="mandatory">
                                            <NumberFormat DecimalDigits="0" />
                                        </telerik:RadNumericTextBox>--%>
