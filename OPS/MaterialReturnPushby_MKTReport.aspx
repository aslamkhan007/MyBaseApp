<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="MaterialReturnPushby_MKTReport.aspx.cs" Inherits="OPS_MaterialReturnPushby_MKTReport" %>
    ...
    <table style="width:100%;">
        <tr>
            <td class="tableheader">
                <asp:Label ID="Label18" runat="server" Text="MR Pushby Marketing Report :"></asp:Label>
            &nbsp;:</td>
        </tr>
    </table>
    <table style="width:100%;">
        ...
        <tr>
            <td class="NormalText" style="width: 108px">
                ...
                <asp:Label ID="Label26" runat="server" Text="Variant"></asp:Label>
             
            </td>
            <td class="NormalText" style="width: 166px">
               
                        <asp:TextBox ID="txtVariant" runat="server" AutoPostBack="True" 
                            CssClass="textbox" 
            ...
            <td class="NormalText" style="width: 78px">
                ...
                <asp:Label ID="Label27" runat="server" Text="Shade"></asp:Label>
        ...
        <tr>
            ...
            <td class="NormalText">
                ...
                <asp:TextBox ID="txtSortno" runat="server" Columns="20" CssClass="textbox" 
                    MaxLength="20" 
           ...
           <%--<asp:Panel ID="Panel2" runat="server">--%>        <%--<asp:Panel ID="Panel2" runat="server">--%>
