    ...
    <table style="width: 100%;">
            ...
            <td colspan="2">
                <asp:Panel ID="pnlMain" runat="server" Height="300px" Width="90%" ScrollBars="Both">
                    <asp:GridView ID="grdDetail" runat="server" EmptyDataText="No data available" EnableModelValidation="True"
                        AutoGenerateColumns="false" Width="100%" DataSourceID="SqlDataSource1" AutoGenerateSelectButton="True"
        ...
        <tr>
            ...
            <td width="400px" align="left" valign="top">
                <asp:TextBox ID="txtRemarks" runat="server" CssClass="textbox" MaxLength="500" TextMode="MultiLine"
                    Width="90%" Height="300px"></asp:TextBox>
