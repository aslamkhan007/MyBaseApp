...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel21" runat="server" ChildrenAsTriggers="False" 
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlRequestType" runat="server" AutoPostBack="True" 
                            CssClass="combobox" Width="140px">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ReqVldRequestType" runat="server" 
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:CheckBoxList ID="chkItemList" runat="server" CssClass="chkbox">
                        </asp:CheckBoxList>
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtVariant" runat="server" CssClass="textbox"></asp:TextBox>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="Panel3" runat="server" Height="300px" ScrollBars="Both" 
                                Width="95%">
                                <asp:GridView ID="GrdBasicDetail" runat="server" EnableModelValidation="True" 
                                    Width="100%">
            ...
            <td colspan="3">
              ...
              <td valign="top">
                  ...
                  <asp:UpdatePanel ID="UpdatePanel28" runat="server">
                      <ContentTemplate>
                          <asp:LinkButton ID="cmdDeleteRows" runat="server" CssClass="btncross" 
                              Height="21px" ToolTip="Click To Clear All Selected Items" Width="24px"></asp:LinkButton>
                      </ContentTemplate>
                  </asp:UpdatePanel>
            ...
            <td valign="top">
                        ...
                        <td colspan="3" valign="top">
                            <asp:UpdatePanel ID="UpdatePanel8" runat="server" RenderMode="Inline">
                                <ContentTemplate>
                                    ...
                                    <asp:LinkButton ID="cmdSearchEmployee" runat="server" 
                                        CssClass="searchbluesmall" Height="16px"
                                        Width="16px"></asp:LinkButton>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <br /><%--  <asp:BoundField DataField="CurrentOrder" HeaderText="CurrentOrder" />
                                    <asp:BoundField DataField="LineItem" HeaderText="LineItem" />
                                    <asp:BoundField DataField="ItemNo" HeaderText="ItemNo" />
                                    <asp:BoundField DataField="OrderVar" HeaderText="OrderVar" />
