...
Partial Class OPS_Order_Processing_Info
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As System.EventArgs) Handles LinkButton1.Click
        ...
        End If
        ' Qry = "SELECT * FROM JCT_Order_Processing_Info_Tbl"
        Qry = "exec  jct_ops_get_Order_Processing_Info_New '','','" & CustCode & "','" & SalePerson & "','','" & PlantType & "' "
