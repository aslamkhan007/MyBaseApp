<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="OrdersList.aspx.cs" Inherits="OPS_OrdersList" %>
            ...
            <td class="buttonbackbar">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkAdd" runat="server" CssClass="buttonc" Visible="false" 
                            ...
                            <asp:GridView ID="GrdOrders" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        DataNavigateUrlFormatString="~/OPS/PlanOrders.aspx?OrderNo={0}" DataTextField="OrderNo" 
                                        HeaderText="OrderNo" NavigateUrl="~/OPS/PlanOrders.aspx" />
                                    <asp:TemplateField HeaderText="Customer">
                                        <ItemTemplate>
                                            <asp:Label ID="Label26" runat="server" Text='<%# Eval("Customer") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                
                                    <asp:TemplateField HeaderText="OrderDt">
                                        <ItemTemplate>
                                            <asp:Label ID="Label29" runat="server" Text='<%# Eval("OrderDt") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="DeliveryDt">
                                        <ItemTemplate>
                                            <asp:Label ID="Label30" runat="server" Text='<%# Eval("DeliveryDt") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Plant">
                                        <ItemTemplate>
                                            <asp:Label ID="Label31" runat="server" Text='<%# Eval("Plant") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlOrders" runat="server" CssClass="panelbg" Height="200px"  style="float:left;"
                            ...
                            <asp:CheckBoxList ID="chbOrderList" runat="server" 
                                ...
                                DataValueField="order_no" AutoPostBack="True" 
