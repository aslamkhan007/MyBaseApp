...
public partial class OPS_PPlanOrders : System.Web.UI.Page
{
    ...
    private   void grdParentFill(string orderno, string itemno)
    {
        ...
        cmd.Parameters.Add("@PlanID", SqlDbType.Int).Value = ddlPlanID.SelectedItem.Value;
        cmd.Parameters.Add("@SortNo", SqlDbType.VarChar,20).Value = itemno;
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        DataSet ds = new DataSet();
        da.Fill(ds);
    ...
    private void SendMailCotton()
    {
        ...
        cc = "ksaini@jctltd.com,sobti@jctltd.com,arvindsharma@jctltd.com";
