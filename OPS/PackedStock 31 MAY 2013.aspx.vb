...
'        '       " ) AS Sinc GROUP BY  SalePerson ORDER BY SalePerson   "
...
'        'Response.AddHeader("Content-Disposition", String.Format("attachment; filename = {0}", System.IO.Path.GetFileName("PackedStock.xls")))
...
'        Xl.Export("PackedStock.xls", grdStage)
'    End Sub
