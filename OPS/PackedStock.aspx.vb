    ...
    Protected Sub ItemGroup()
        ...
        ElseIf RadioButtonList1.SelectedValue = "GODOWNWISE+" Then
            ...
            SqlPass = "SELECT    Wh_no AS GodownNo,stock_no AS Sort,variant_no AS Variant ," & _
              ...
              " ) AS Sinc GROUP BY  Wh_no , variant_no,stock_no     " & _
             " UNION SELECT   '[Total]' ,'' ,''   , " & _
                "  ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 0 AND 30   THEN  qty_recd END)) ),'')  ,   " & _
               "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 31 AND 60  THEN  qty_recd END)) ),'')   ,   " & _
              "   ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 61 AND 90  THEN  qty_recd END))  ),'')  ,   " & _
               "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 91 AND 120 THEN  qty_recd END)) ),'')  ,  " & _
              "    ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 121 AND 150 THEN qty_recd END))  ),''),  " & _
               "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 151 AND 180 THEN qty_recd END))),'')    ,  " & _
              "   ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 181 AND 210 THEN qty_recd END))   ),''),  " & _
              "   ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 211 AND 240 THEN qty_recd END)) ),'')  ,  " & _
              "   ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 241 AND 270 THEN qty_recd END))  ),'')  ,  " & _
                " ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 271 AND 300 THEN qty_recd END))  ),'')  ,  " & _
                "  ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 301 AND 330 THEN qty_recd END))  ),'')  ,  " & _
              "    ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 331 AND 365 THEN qty_recd END))  ),'') ,  " & _
              "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  > 365 THEN qty_recd END))  ),'')  " & _
               " FROM          JCT_Pack_Stock_UptoDate_MIS  ORDER BY Wh_no,stock_no,variant_no"


        ElseIf RadioButtonList1.SelectedValue = "GODOWNWISE" Then

            SqlPass = "SELECT   SalePerson, Wh_no AS GodownNo ,variant_no AS Variant," & _
              "ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN Since BETWEEN 0 AND 30   THEN  qty_recd END))),'') AS [0-30] , " & _
              "ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN Since BETWEEN 31 AND 60  THEN  qty_recd END))),'') AS [31-60] , " & _
              "ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN Since BETWEEN 61 AND 90  THEN  qty_recd END))),'') AS [61-90] , " & _
              "ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN Since BETWEEN 91 AND 120 THEN  qty_recd END))),'') AS [91-120] ," & _
              ...
              "ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN Since BETWEEN 331 AND 365 THEN qty_recd END),2)),'') AS [331-365]," & _
              "ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN Since > 365 THEN qty_recd END),2)),'') AS [>365]" & _
              "FROM      ( SELECT SalePerson,Wh_no,Order_no ,stock_no ,variant_no ,DATEDIFF(day, recd_date, GETDATE()) Since ,qty_recd FROM      JCT_Pack_Stock_UptoDate_MIS" & _
              " ) AS Sinc GROUP BY  SalePerson,Wh_no , variant_no    " & _
             " UNION SELECT   '[Total]' ,'' ,''   , " & _
                "  ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 0 AND 30   THEN  qty_recd END)) ),'')  ,   " & _
               "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 31 AND 60  THEN  qty_recd END)) ),'')   ,   " & _
              "   ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 61 AND 90  THEN  qty_recd END))  ),'')  ,   " & _
              ...
              "    ISNULL(CONVERT(VARCHAR,CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 331 AND 365 THEN qty_recd END))  ),'') ,  " & _
              "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  > 365 THEN qty_recd END))  ),'')  " & _
               " FROM JCT_Pack_Stock_UptoDate_MIS  ORDER BY SalePerson,Wh_no,variant_no"

        ElseIf RadioButtonList1.SelectedValue = "HOMEFURNISHING" Then


            SqlPass = " SELECT  Wh_no AS GodownNo , stock_no AS Sort ,  Descr2 ,      Descr1 ,   Quality , SIZE ,  variant_no AS Variant , " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 0 AND 30 " & _
                      "                                                 THEN qty_recd " & _
                            "                                      END))), '') AS [0-30] , " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 31 AND 60     " & _
                            "                                           THEN qty_recd       " & _
                                  "                                END))), '') AS [31-60] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 61 AND 90    " & _
                                                                     "  THEN qty_recd    " & _
                                                                "  END))), '') AS [61-90] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 91 AND 120    " & _
                                                                     "  THEN qty_recd    " & _
                                                                "  END))), '') AS [91-120] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 121 AND 150    " & _
                            "                                           THEN qty_recd    " & _
                               "                                   END), 2)), '') AS [121-150] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 151 AND 180    " & _
                            "                                           THEN qty_recd    " & _
                                  "                                END), 2)), '') AS [151-180] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 181 AND 210    " & _
                            "                                           THEN qty_recd    " & _
                               "                                   END), 2)), '') AS [181-210] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 211 AND 240    " & _
                            "                                           THEN qty_recd    " & _
                                  "                                END), 2)), '') AS [211-240] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 241 AND 270    " & _
                            "                                           THEN qty_recd    " & _
                                  "                                END), 2)), '') AS [241-270] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 271 AND 300    " & _
                            "                                           THEN qty_recd    " & _
                                  "                                END), 2)), '') AS [271-300] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 301 AND 330    " & _
                            "                                           THEN qty_recd    " & _
                                                                "  END), 2)), '') AS [301-330] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since BETWEEN 331 AND 365    " & _
                            "                                           THEN qty_recd    " & _
                                  "                                END), 2)), '') AS [331-365] ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN Since > 365    " & _
                            "                                           THEN qty_recd    " & _
                                  "                                END), 2)), '') AS [>365]    " & _
              "  FROM    ( SELECT    Wh_no ,  Descr2 ,Descr1 , Quality ,  SIZE , Order_no , stock_no ,  variant_no ,    DATEDIFF(day, recd_date, GETDATE()) Since , qty_recd  FROM      JCT_Pack_Stock_UptoDate_MIS   ) AS Since  " & _
              "  GROUP BY Wh_no , Descr2 ,  Descr1 ,Quality , SIZE , variant_no , stock_no     UNION   " & _
              "  SELECT  '[Total]' ,  '' , '' ,   '' ,        '' ,    '' ,        '' ,   " & _
                    "     ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,    " & _
                          "                                                    recd_date,   " & _
                                "                                              GETDATE()) BETWEEN 0 AND 30   " & _
                                      "                                 THEN qty_recd   " & _
                                            "                      END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                                                            "  GETDATE()) BETWEEN 31 AND 60   " & _
                                                                     "  THEN qty_recd   " & _
                                                                "  END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 61 AND 90   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                    "    ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                          "                                                    recd_date,   " & _
                                "                                              GETDATE()) BETWEEN 91 AND 120   " & _
                                      "                                 THEN qty_recd   " & _
                                            "                      END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 121 AND 150   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                 "       ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,      " & _
                       "                                                       recd_date,    " & _
                             "                                                 GETDATE()) BETWEEN 151 AND 180   " & _
                                   "                                    THEN qty_recd   " & _
                                         "                         END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 181 AND 210   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,    " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 211 AND 240   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 241 AND 270   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 271 AND 300   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 301 AND 330   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) BETWEEN 331 AND 365   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '') ,   " & _
                      "  ISNULL(CONVERT(VARCHAR, CONVERT(REAL, SUM(CASE WHEN DATEDIFF(day,   " & _
                            "                                                  recd_date,   " & _
                                  "                                            GETDATE()) > 365   " & _
                                        "                               THEN qty_recd   " & _
                                              "                    END))), '')   " & _
              "  FROM    JCT_Pack_Stock_UptoDate_MIS   " & _
              "  ORDER BY Wh_no ,   stock_no ,    variant_no "
