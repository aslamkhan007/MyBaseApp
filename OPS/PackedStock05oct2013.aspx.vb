        ...
        ElseIf RadioButtonList1.SelectedValue = "GODOWNWISE+" Then
            ...
            SqlPass = "SELECT    Wh_no AS GodownNo,stock_no AS Sort,variant_no AS Variant ," & _
             ...
             " UNION SELECT   '[Total]' ,'' ,''   , " & _
                " CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 0 AND 30   THEN  qty_recd END))   ,   " & _
               "  CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 31 AND 60  THEN  qty_recd END))    ,   " & _
              "   CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 61 AND 90  THEN  qty_recd END))    ,   " & _
               "  CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 91 AND 120 THEN  qty_recd END))   ,  " & _
              "   CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 121 AND 150 THEN qty_recd END))  ,  " & _
               "  CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 151 AND 180 THEN qty_recd END))    ,  " & _
              "   CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 181 AND 210 THEN qty_recd END))   ,  " & _
              "   CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 211 AND 240 THEN qty_recd END))   ,  " & _
              "   CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 241 AND 270 THEN qty_recd END))    ,  " & _
                " CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 271 AND 300 THEN qty_recd END))    ,  " & _
                " CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 301 AND 330 THEN qty_recd END))    ,  " & _
              "   CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  BETWEEN 331 AND 365 THEN qty_recd END))   ,  " & _
              " CONVERT(REAL,SUM(CASE WHEN DATEDIFF(day, recd_date, GETDATE())  > 365 THEN qty_recd END))    " & _
