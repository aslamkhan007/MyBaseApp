    ...
    <table style="width: 800px;">
        ...
        <tr>
            <td>
                Fin Year</td>
            <td colspan="3">
                <asp:DropDownList ID="ddlFinYr" runat="server" CssClass="combobox">
        ...
        <tr>
            <td colspan="4">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <cc1:XGridView ID="XGridView" runat="server" BorderStyle="Solid" 
                            BorderWidth="1px" CellPadding="4" EnableCellClick="True" ForeColor="#333333" 
                            GridLines="None" oncellclicked="XGridView_CellClicked">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="Panel2" runat="server" Height="400px" ScrollBars="Both" 
                            ...
                            <asp:GridView ID="GridView5" runat="server">
                             ...
                             <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="XGridView" 
