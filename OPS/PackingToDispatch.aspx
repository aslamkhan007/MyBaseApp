<%@ Page Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false"
    ...
    MaintainScrollPositionOnPostback="true" EnableEventValidation="false"  Debug="True"%>
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 269px">
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="combobox">
                    ...
                    <asp:ListItem Value="RequiredDate">Required Date</asp:ListItem>
                    <asp:ListItem Value="AmendDate">Amend Date</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td class="labelcells">
                &nbsp;</td>
                ...
                <table __designer:mapid="28" style="width: 100%;">
                    <tr __designer:mapid="29">
                        ...
                        <td __designer:mapid="2c" style="text-align: left">
                            ...
                            <asp:Button ID="BtnSummary" runat="server" BackColor="Black" CausesValidation="False"
                                CssClass="ButtonBack" Text="Summary" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td>
               <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <cc2:XGridView ID="GridView2" runat="server" GridLines="None" PageSize="2" Width="100%"  >
                            <PagerSettings Mode="NumericFirstLast" PageButtonCount="20"/>
                                                <HeaderStyle CssClass="GridviewScrollHeader" />
                            <RowStyle CssClass="GridviewScrollItem" />
                            <PagerStyle CssClass="GridviewScrollPager" />
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <cc2:XGridView ID="GridView3" runat="server" GridLines="None" PageSize="8" Width="100%"  >
                            <PagerSettings Mode="NumericFirstLast" PageButtonCount="20"/>
                                                <HeaderStyle CssClass="GridviewScrollHeader" />
                            <RowStyle CssClass="GridviewScrollItem" />
                            <PagerStyle CssClass="GridviewScrollPager" />
