                ...
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                        <asp:RadioButtonList ID="rblSelection" runat="server" AutoPostBack="True" 
                            ...
                            <asp:ListItem Selected="True">Pack Stock</asp:ListItem>
        ...
        <tr>
            ...
            <td class="labelcells" colspan="4">
                        <asp:RadioButtonList ID="rblPlant" runat="server" AutoPostBack="True" 
                            ...
                            <asp:ListItem>Garment</asp:ListItem>
                        </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
                            ...
                            <ContentTemplate>
                                <asp:DropDownList ID="txtSalePerson" runat="server" CssClass="combobox" AutoPostBack="true">
                                    ...
                                    <asp:ListItem>PUSHP RAJ JAIN</asp:ListItem>
                                     <asp:ListItem>RAKESH KOCHHAR</asp:ListItem>
                ...
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                   ...
                   <%-- <asp:ListItem>ALL</asp:ListItem>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="txtRemarksToUpdate" Display="Dynamic" ErrorMessage="*" 
