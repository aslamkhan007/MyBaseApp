...
Partial Class PackingUpdateStatus
    ...
    Public Sub BindData()
        ...
        If rblSelection.Text = "Pack Stock" Then
            ...
            If rblPlant.Text = "Cotton" Then
                ...
                SqlPass = "SELECT  ISNULL(Status,'') AS Status ,item_group_no AS ItemGroupNo , stock_no AS StockNo , variant_no AS Variant ,  lot_no AS LotNo , CONVERT(NUMERIC(10,2),qty_recd) AS Qty ,  CONVERT(VARCHAR,recd_date,103) AS PackDate ," & _
                     ...
                     "  AND  ( Shade='" & txtShade.Text & "' OR '" & txtShade.Text & "' ='' ) AND ( variant_no='" & txtVariant.Text & "' OR '" & txtVariant.Text & "' ='' ) AND LOT_NO NOT IN ( SELECT LOT_NO FROM JCT_Pack_Stock_UptoDate_MIS_Status) AND  wh_no IN ('G-88','G-39','G-47','TRFR') ORDER BY recd_date"
                ...
                Qry = " SELECT SUM(QTY_RECD) AS QTY_RECD FROM  JCT_Pack_Stock_UptoDate_MIS_OPS WHERE recd_date BETWEEN '" & TxtDateFrom.Text & "' AND  '" & txtDateTo.Text & "' AND  ( SalePerson ='" & txtSalePerson.Text & "' OR '" & txtSalePerson.Text & "'='ALL') AND  ( DispatchDate IS NULL    OR ISNULL(DispatchDate,'')='' ) AND " & _
                           "     ( item_group_no = '" & Trim(txtItemGroup.Text) & "'      OR '" & Trim(txtItemGroup.Text) & "'  = ''   )         AND ( CustomerName =   '" & Trim(txtCustomer.Text) & "'         OR   '" & Trim(txtCustomer.Text) & "'        = ''    )    AND ( order_no =   '" & TxtOrder.Text & "'  OR   '" & TxtOrder.Text & "' = ''   )  " & _
                           "  AND  ( Shade='" & txtShade.Text & "' OR '" & txtShade.Text & "' ='' ) AND ( variant_no='" & txtVariant.Text & "' OR '" & txtVariant.Text & "' ='' ) AND LOT_NO NOT IN ( SELECT LOT_NO FROM JCT_Pack_Stock_UptoDate_MIS_Status)  AND  wh_no IN ('G-88','G-39','G-47','TRFR') "
            ...
            ElseIf rblPlant.Text = "Tafetta" Then
                ...
                SqlPass = "SELECT  ISNULL(Status,'') AS Status ,item_group_no AS ItemGroupNo , stock_no AS StockNo , variant_no AS Variant ,  lot_no AS LotNo , CONVERT(NUMERIC(10,2),qty_recd) AS Qty ,  CONVERT(VARCHAR,recd_date,103) AS PackDate ," & _
                     ...
                     " From JCT_Pack_Stock_UptoDate_MIS_OPS WHERE recd_date BETWEEN '" & TxtDateFrom.Text & "' AND  '" & txtDateTo.Text & "' AND  ( SalePerson ='" & txtSalePerson.Text & "' OR '" & txtSalePerson.Text & "'='ALL') AND  ( DispatchDate IS NULL    OR ISNULL(DispatchDate,'')='' ) AND " & _
                     "     ( item_group_no = '" & Trim(txtItemGroup.Text) & "'      OR '" & Trim(txtItemGroup.Text) & "'  = ''   )         AND ( CustomerName =   '" & Trim(txtCustomer.Text) & "'         OR   '" & Trim(txtCustomer.Text) & "'        = ''  )    AND ( order_no =   '" & TxtOrder.Text & "'  OR   '" & TxtOrder.Text & "' = ''   )  " & _
                     "  AND  ( Shade='" & txtShade.Text & "' OR '" & txtShade.Text & "' ='' ) AND ( variant_no='" & txtVariant.Text & "' OR '" & txtVariant.Text & "' ='' ) AND LOT_NO NOT IN ( SELECT LOT_NO FROM JCT_Pack_Stock_UptoDate_MIS_Status) AND  wh_no IN ('G-99') ORDER BY recd_date"


                Qry = " SELECT SUM(QTY_RECD) AS QTY_RECD FROM  JCT_Pack_Stock_UptoDate_MIS_OPS WHERE recd_date BETWEEN '" & TxtDateFrom.Text & "' AND  '" & txtDateTo.Text & "' AND  ( SalePerson ='" & txtSalePerson.Text & "' OR '" & txtSalePerson.Text & "'='ALL') AND  ( DispatchDate IS NULL    OR ISNULL(DispatchDate,'')='' ) AND " & _
                           "     ( item_group_no = '" & Trim(txtItemGroup.Text) & "'      OR '" & Trim(txtItemGroup.Text) & "'  = ''   )         AND ( CustomerName =   '" & Trim(txtCustomer.Text) & "'         OR   '" & Trim(txtCustomer.Text) & "'        = ''    )    AND ( order_no =   '" & TxtOrder.Text & "'  OR   '" & TxtOrder.Text & "' = ''   )  " & _
                           "  AND  ( Shade='" & txtShade.Text & "' OR '" & txtShade.Text & "' ='' ) AND ( variant_no='" & txtVariant.Text & "' OR '" & txtVariant.Text & "' ='' ) AND LOT_NO NOT IN ( SELECT LOT_NO FROM JCT_Pack_Stock_UptoDate_MIS_Status) AND  wh_no IN ('G-99') "


            ElseIf rblPlant.Text = "Garment" Then

                SqlPass = "SELECT  ISNULL(Status,'') AS Status ,item_group_no AS ItemGroupNo , stock_no AS StockNo , variant_no AS Variant ,  lot_no AS LotNo , CONVERT(NUMERIC(10,2),qty_recd) AS Qty ,  CONVERT(VARCHAR,recd_date,103) AS PackDate ," & _
                     " ISNULL(SalePerson, '') AS SalePerson ,ISNULL(order_no, '') AS OrderNo , ISNULL(CustomerName, '') AS CustomerName , ISNULL(Shade, '') AS Shade ,  ISNULL(ItemDescription, '') AS ItemDescription " & _
                     " From JCT_Pack_Stock_UptoDate_MIS_OPS WHERE recd_date BETWEEN '" & TxtDateFrom.Text & "' AND  '" & txtDateTo.Text & "' AND  ( SalePerson ='" & txtSalePerson.Text & "' OR '" & txtSalePerson.Text & "'='ALL') AND  ( DispatchDate IS NULL    OR ISNULL(DispatchDate,'')='' ) AND " & _
                     "     ( item_group_no = '" & Trim(txtItemGroup.Text) & "'      OR '" & Trim(txtItemGroup.Text) & "'  = ''   )         AND ( CustomerName =   '" & Trim(txtCustomer.Text) & "'         OR   '" & Trim(txtCustomer.Text) & "'        = ''  )    AND ( order_no =   '" & TxtOrder.Text & "'  OR   '" & TxtOrder.Text & "' = ''   )  " & _
                     "  AND  ( Shade='" & txtShade.Text & "' OR '" & txtShade.Text & "' ='' ) AND ( variant_no='" & txtVariant.Text & "' OR '" & txtVariant.Text & "' ='' ) AND LOT_NO NOT IN ( SELECT LOT_NO FROM JCT_Pack_Stock_UptoDate_MIS_Status) AND  wh_no IN ('G-14') ORDER BY recd_date"


                Qry = " SELECT SUM(QTY_RECD) AS QTY_RECD FROM  JCT_Pack_Stock_UptoDate_MIS_OPS WHERE recd_date BETWEEN '" & TxtDateFrom.Text & "' AND  '" & txtDateTo.Text & "' AND  ( SalePerson ='" & txtSalePerson.Text & "' OR '" & txtSalePerson.Text & "'='ALL') AND  ( DispatchDate IS NULL    OR ISNULL(DispatchDate,'')='' ) AND " & _
                           "     ( item_group_no = '" & Trim(txtItemGroup.Text) & "'      OR '" & Trim(txtItemGroup.Text) & "'  = ''   )         AND ( CustomerName =   '" & Trim(txtCustomer.Text) & "'         OR   '" & Trim(txtCustomer.Text) & "'        = ''    )    AND ( order_no =   '" & TxtOrder.Text & "'  OR   '" & TxtOrder.Text & "' = ''   )  " & _
                           "  AND  ( Shade='" & txtShade.Text & "' OR '" & txtShade.Text & "' ='' ) AND ( variant_no='" & txtVariant.Text & "' OR '" & txtVariant.Text & "' ='' ) AND LOT_NO NOT IN ( SELECT LOT_NO FROM JCT_Pack_Stock_UptoDate_MIS_Status) AND  wh_no IN ('G-14')  "
