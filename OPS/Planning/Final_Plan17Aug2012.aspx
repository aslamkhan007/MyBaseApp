<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="Final_Plan.aspx.cs" Inherits="OPS_Planning_Final_Plan" %>
...
<script type="text/javascript">
    ...
    <table style="width:100%;">
     ...
     <!--   <tr>
           <td class="NormalText" style="width: 130px">
                <asp:Label ID="Label6" runat="server" Text="Revision No."></asp:Label>
            </td>
            <td class="NormalText" style="width: 242px">
                <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlRevisionNo" runat="server" AutoPostBack="True" 
                            CssClass="combobox">
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
                ...
                <ContentTemplate>
                 <asp:Panel ID="Panel1" CssClass="panelbg" runat="server" ScrollBars="Auto" 
                    ...
                    <Columns>
                                           ...
                                           <asp:UpdatePanel ID="UpdatePanel9" runat="server" RenderMode="Inline">
                                               <ContentTemplate>
                                                   <asp:TextBox ID="txtShed" runat="server" AutoPostBack="True" Columns="2" 
                                                       CssClass="textbox" MaxLength="2" OnTextChanged="txtShed_TextChanged" 
                                   ...
                                   <asp:TemplateField HeaderText="Wvg Date">
                                       <ItemTemplate>
        ...
        <tr>
            <td class="NomalText">
                <asp:UpdatePanel ID="UpdPopUp" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel2" runat="server" CssClass="panelbg" Width="500px">
                            <table style="width:100%;">
                                <tr>
