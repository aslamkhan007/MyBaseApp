...
public partial class OPS_Planning_Final_Plan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            sql = "Select distinct   Revision_no from  JCT_OPS_MONTHLY_PLANNING where yearmonth=201208 and Location='" + ddlPlant.SelectedItem.Text + "' and ( Cloth_Type ='" + ddlCotSyn.SelectedItem.Text + "' or 'All'='All')  ";
        ...
        sql = "Select * from  JCT_OPS_MONTHLY_PLANNING where mode='Freezed' and yearmonth=" + yearMonth() + " and Location='" + ddlPlant.SelectedItem.Text + "' and ( Cloth_Type ='" + ddlCotSyn.SelectedItem.Text + "' or 'All'='All')  ";
        if (obj1.CheckRecordExistInTransaction(sql))
        {
    ...
    {
        sql = "Select * from JCT_OPS_MONTHLY_PLANNING where yearmonth =" + yearMonth() + " and Location='" + ddlPlant.SelectedItem.Text + "' and ( Cloth_Type ='" + ddlCotSyn.SelectedItem.Text + "' or 'All'='All') and PlanStart_Date is not null and PlanEnd_Date is not null ";
        if (obj1.CheckRecordExistInTransaction(sql))
        {
    ...
    protected void CheckWvgCompeletionDate(GridView grd)
    {
        ...
        for (int i = 0; i <= grd.Rows.Count - 1; i++)
        {
            ...
            sql = " EXEC JCT_OPS_DELAY_ORDERS '" + orderno.Text + "','" + Sort.Text + "'," + LineItem.Text + "";
    ...
    protected void ddlPlant_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //{
        //    ddlCotSyn.SelectedIndex = 1;
        //}
        //else if (ddlPlant.SelectedIndex == 1)
        //{
        //    ddlCotSyn.SelectedIndex = 2;
        //}
    }
    protected void lnkSave_Click(object sender, EventArgs e)
    {
            ...
            sql = "Select * from JCT_OPS_MONTHLY_PLANNING where yearmonth="+ yearMonth() +" and Location='"+ ddlPlant.SelectedItem.Text +"' and ( Cloth_Type ='"+ ddlCotSyn.SelectedItem.Text +"' or 'All'='All') and mode='Freezed' ";
            if (obj1.CheckRecordExistInTransaction(sql))
            {
            
                FMsg.CssClass = "errormsg";
                FMsg.Message = "Plan Cannot be modified once Freezed. If you want to change the current plan, please UnFreeze it first.";
                FMsg.Display();
                return;
            }
        ...
        else
        {
            ...
            for (int i = 0; i <= GridView1.Rows.Count - 1; i++)
            {
                ...
                {
                    String script1 = "alert('Please select record.');";
