...
Partial Class frm_loom_bookingvsactual
    ...
    Protected Sub cmdFetch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdFetch.Click
        ...
        sqlpass = "exec jct_pp_revnowise_storage_data_report'" & Right(ddlyrmth.Text, 6) & "','" & ddlshed.SelectedItem.Text & "','" & ddlplnrevno.SelectedItem.Value & "'"
    ...
    Public Sub BindData1()
        ...
        Sqlpass = "SELECT sort_status 'Sort Status',section_code as 'Section', loom_no as 'LoomNo', loom_size as 'Loom Size',day1 as ' 1',day2 as ' 2',day3 as ' 3',day4 as ' 4',day5 ' 5',day6 ' 6',day7 ' 7',day8 ' 8',day9 ' 9',day10 '10',day11 '11',day12 '12',day13 '13',day14 '14',day15 '15',day16 '16',day17 '17',day18 '18',day19 '19',day20 '20',day21 '21',day22 '22',day23 '23',day24 '24',day25 '25',day26 '26',day27 '27',day28 '28',day29 '29',day30 '30',day31 '31' FROM jct_pp_revnowise_data_storage where monthyr = '" & Right(ddlyrmth.Text, 6) & "' and  section_code = '" & ddlshed.Text & "' and  pln_rev_no = '" & ddlplnrevno.SelectedItem.Text & "' order by loom_no,sort_status  "
        CstModule.FillGrid(Sqlpass, grdGrid1)
    End Sub
