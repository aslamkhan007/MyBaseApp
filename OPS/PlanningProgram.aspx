...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 158px">
                <asp:Label ID="Label32" runat="server" Text="Select Plan"></asp:Label>
            </td>
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT [DESCRIPTION], [PLANID] FROM [JCT_OPS_PLANNING_GENERATE_PLANID] WHERE (([STATUS] = @STATUS) AND ([Plant] = @Plant)) ORDER BY [PLANID] DESC">
                            <SelectParameters>
        ...
        <tr>
            <td class="NormalText" style="height: 17px;">
                ...
                <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlSubTotal" runat="server" CssClass="panelbg" Visible="false" 
                            Width="300px">
                            <table style="width:100%;">
                                <tr>
                                    <td class="tableheader" colspan="2">
                                ...
                                <tr>
                                    <td style="width: 155px">
                                        <asp:Label ID="Label2" runat="server" Text="Total Greigh Required"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblGreigh" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 155px">
                                        <asp:Label ID="Label4" runat="server" Text="Total Sizing Required"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 155px">
                                        <asp:Label ID="Label6" runat="server" Text="No. of Orders"></asp:Label>
                                    </td>
                                    <td>
