<%@ Page Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false"
    CodeFile="ProductionDispatch.aspx.vb" Inherits="ProductionDispatch" Title="Packing Update Status Report"
    ...
    <table style="width: 100%">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="text-align: right">
                            <asp:Button ID="BtnFetch" runat="server" BackColor="Black" CausesValidation="False"
                                CssClass="ButtonBack" Text="Fetch" />
                        </td>
        ...
        <tr>
            <td style="height: 11px; text-align: left; color: #FF3300;">
                * Value for GINS,TINS has not included
            </td>
        </tr>
        <tr>
            <td style="height: 11px; text-align: center;">
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <cc2:XGridView ID="GridView1" runat="server" GridLines="BOTH" PageSize="150000" Width="100%"
        ...
        <tr>
            <td>
                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                    BestFitPage="False" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasToggleGroupTreeButton="False"  
