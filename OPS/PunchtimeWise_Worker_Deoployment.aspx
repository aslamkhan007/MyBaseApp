<%@ Page Title="" Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false" CodeFile="PunchtimeWise_Worker_Deoployment.aspx.vb" Inherits="OPS_PunchtimeWise_Worker_Deoployment" %>
        ...
        <tr>
            <td style="height: 33px" colspan="2">
                <asp:Label ID="Label1" runat="server" 
                    Text="Punch Time/ Designation  wise Worker Deployment"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td style="height: 5px; width: 622px;">
                <asp:DropDownList ID="ddlreporttype" runat="server" AutoPostBack="True" 
                    CssClass="combobox" >                  
                    <asp:ListItem>PunchtimeWise</asp:ListItem>
                    <asp:ListItem>DesignationWise</asp:ListItem>                                        
                </asp:DropDownList>
            </td>
            <td style="height: 5px">
                &nbsp;</td>
...
<%--                                <asp:GridView ID="GridView1" runat="server" Font-Bold="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="es_a" DataFormatString="{0:N2}" HeaderText="A" />
                                        <asp:BoundField DataField="es_b" DataFormatString="{0:N2}" HeaderText="B" />
                                        <asp:BoundField DataField="es_c" DataFormatString="{0:N2}" HeaderText="C" />
                                        <asp:BoundField DataField="es_total" DataFormatString="{0:N2}" 
                                            HeaderText="Total" />
                                        <asp:BoundField DataField="et_g" DataFormatString="{0:N2}" HeaderText="ET G" />
                                        <asp:BoundField DataField="et_a" DataFormatString="{0:N2}" HeaderText="A" />
                                        <asp:BoundField DataField="et_b" DataFormatString="{0:N2}" HeaderText="B" />
                                        <asp:BoundField DataField="et_c" DataFormatString="{0:N2}" HeaderText="C" />
                                        <asp:BoundField DataField="et_total" DataFormatString="{0:N2}" 
                                            HeaderText="Total" />
                                        ...
                                        <asp:BoundField DataField="spl_sanction_eset_hours_total" 
                                            DataFormatString="{0:N2}" HeaderText="Total" />
