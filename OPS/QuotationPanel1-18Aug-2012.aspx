                                        ...
                                        <asp:GridView ID="grdFinalizedQuote" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                <asp:HyperLinkField DataNavigateUrlFields="Quotation_No" 
                                                    DataNavigateUrlFormatString="Quotation.aspx?Quot={0}" HeaderText="Detail" 
                            ...
                            <tr>
                                <td class="NormalText">
                                    <asp:GridView ID="grdIndicativeQuote" runat="server" 
                                        ...
                                        <Columns>
                                            <asp:HyperLinkField DataNavigateUrlFields="Quotation_No" 
                                                DataNavigateUrlFormatString="Quotation_No.apx?Quot={0}" HeaderText="Edit" Text="Edit" />
                                            <asp:BoundField DataField="Quotation_No" HeaderText="Quotation_No" 
                                                SortExpression="Quotation_No" />
                                            <asp:BoundField DataField="Customer_Name" HeaderText="Customer" 
                                                SortExpression="Customer_Name" />
                    ...
                    <ContentTemplate>
                        ...
                        <table style="width: 100%;" class="tableback">
                            ...
                            <table class="tableback" style="width: 100%;">
                                <tr>
                                    <td class="NormalText">
                                        <asp:GridView ID="grdLabDip" runat="server" AutoGenerateColumns="False" 
                                            EmptyDataText="No Data Available" EnableModelValidation="True" Width="100%">
                                            <Columns>
                                                <asp:BoundField DataField="SAMPLE ORDER" HeaderText="Lab Dip" 
                                                    SortExpression="SAMPLE ORDER" />
                                                ...
                                                <asp:BoundField DataField="LabDip_Dt" HeaderText="Lab-Dip Date" ReadOnly="True" 
                                                    SortExpression="LabDip_Dt" />
                                                <asp:BoundField DataField="Status" HeaderText="Status" ReadOnly="True" 
                                                    SortExpression="Status" />
                                                   <asp:BoundField DataField="Result" HeaderText="Results Issued" ReadOnly="True" 
