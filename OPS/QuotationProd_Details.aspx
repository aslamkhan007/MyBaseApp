...
<%@ Page Title="" Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false"
    CodeFile="QuotationProd_Details.aspx.vb" Inherits="OPS_QuotationProd_Details_new" %>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server" RenderMode="Inline">
                        <ContentTemplate>
                            Pending Quotation-
                            <asp:Label runat="server" ID="lblstatus"></asp:Label></ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
            <tr>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div id="AdjResultsDiv1" style="height: 200px; overflow: scroll; width: 1050px; top: 0px;
                                left: 0px;">
                                <asp:GridView ID="GridViewLevel2" runat="server" AutoGenerateColumns="False" DataKeyNames="Quotation_No"
                                    EmptyDataText="No Relevant QuoFtation is found." EnableModelValidation="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="Quotation_No" DataNavigateUrlFormatString="Quotation_Main.aspx?quot={0}"
                                            Target="_blank" DataTextField="Quotation_No" HeaderText="Quotation No" NavigateUrl="#" />
                            ...
                            <ItemStyle Wrap="False" />
                                        ...
                                        <asp:BoundField DataField="DNVCost" HeaderText="DnV Cost" ReadOnly="True" SortExpression="DnV Cost AWtd.">
                                            <HeaderStyle Wrap="False" />
                                            <ItemStyle Wrap="False" />
                                        </asp:BoundField>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grdDispatchDetail" runat="server" AutoGenerateColumns="False" EmptyDataText="No Dispatch Schedule for this Quotation is found."
                             ...
                             <asp:BoundField DataField="Remarks" HeaderText="Remarks" />--%>
                                    ...
                                    <asp:BoundField DataField="Line_Item_No" HeaderText="Line No" />
                                    ...
                                    <asp:BoundField DataField="GreighQtyEntered" HeaderText="Entered Greigh Qty" />
                                    <asp:TemplateField HeaderText="Stage">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlStage" runat="server" CssClass="combobox" DataSourceID="SqlDataSource4"
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                                                SelectCommand="spGet_Jct_Ops_Planning_internal_hierarchy" SelectCommandType="StoredProcedure">
                                            </asp:SqlDataSource>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Greigh Qty.">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGreighQty" runat="server" CssClass="text" Width="70px">
                                            </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Date">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtdate" runat="server" CssClass="text" Width="70px">
                                            </asp:TextBox>
                               ...
                               <asp:TemplateField HeaderText="Greigh Remark">
<ItemTemplate>
<asp:TextBox ID="txtGreighRemark" runat="server" CssClass="text" Width="90px">
</asp:TextBox>
</ItemTemplate>
</asp:TemplateField>
		...
		<asp:TemplateField HeaderText="Select">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSelect" runat="server" CssClass="text" Width="70px"></asp:CheckBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <HeaderStyle CssClass="GridHeader" Wrap="False" />
            ...
            <tr>
                <td>
                    <%--Greigh Date Detail For Quotation #--%>
            ...
            <tr>
                <td colspan="2">
                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GridVewGreigh" runat="server" EnableModelValidation="True" ShowHeaderWhenEmpty="true"
                                ShowHeader="true" Width="100%" AutoGenerateColumns="False">
                                <AlternatingRowStyle CssClass="GridAI" />
                                <Columns>
                                    <asp:BoundField DataField="Quotation_No" HeaderText="Qutation No" />
				    <asp:BoundField DataField="Line_No" HeaderText="Line No" />
                                    <asp:BoundField DataField="Type" HeaderText="Stage" />
                                    <asp:BoundField DataField="GreighQty" HeaderText="Greigh Qty" />
                                    <asp:BoundField DataField="Target_Date" HeaderText="Greigh Date" />
                                </Columns>
                                <HeaderStyle CssClass="GridHeader" Wrap="False" />
                                <RowStyle CssClass="GridItem" Wrap="False" />
                            </asp:GridView>
           ...
           <%-- <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtGreighQty" CssClass="textbox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator123" runat="server" ControlToValidate="txtdate"
                        ValidationGroup="ab" ErrorMessage="Please Specify   Date"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table>
            <tr>
                <td align="right">
                    <asp:LinkButton ID="cmdsubmit" runat="server" CssClass="buttonc" ValidationGroup="ab"
                        Visible="false">Submit</asp:LinkButton>
                    <asp:LinkButton ID="lnkSubmit" runat="server" CssClass="buttonc" ValidationGroup="ab">Save</asp:LinkButton>
                </td>
                <td> &nbsp; &nbsp; &nbsp;</td>
                <td>
                    <asp:LinkButton ID="LnkReject" runat="server" CssClass="buttonc" ValidationGroup="ab">Reject</asp:LinkButton>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline">
                        <ContentTemplate>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Quotation_No"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Greige Remarks" HeaderText="Greige Remarks" SortExpression="Greige Remarks">
                                        <HeaderStyle Wrap="False" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
