...
Partial Class OPS_QuotationProd_Details_new
    ...
    Protected Sub ddlType_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlType.SelectedIndexChanged
        ...
        bindgrid()
    End Sub
    Private Sub bindDispatch(Quotation As String)
    ...
    Protected Sub GridViewLevel2_PageIndexChanging(sender As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GridViewLevel2.PageIndexChanging
