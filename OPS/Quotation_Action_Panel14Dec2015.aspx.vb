...
Partial Class OPS_Quotation_Action_Panel
    ...
    Protected Sub grdUnauthorisedQuotes_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles grdUnauthorisedQuotes.SelectedIndexChanged
        ...
        'Else
         ...
         '   ScriptManager.RegisterStartupScript(TryCast(sender, Control), Me.GetType(), "redirect", "alert('The Quotation Greige Date and Finish Date not authorized yet'); window.location='" + Request.ApplicationPath + "/OPS/QuotationProd_Details.aspx';", True)
    ...
    Protected Function CheckQutation(Quotation As String) As Boolean
        ...
        Auth_status = ""
        Dim sqlstr As String = "Select Auth_status from jct_ops_check_Qutaion_planningstatus  where quotation_no = '" + Quotation + "' and Auth_status = 'A' and [Type]='Final'"
        Dim cn As New Connection
        Dim dr As SqlDataReader
