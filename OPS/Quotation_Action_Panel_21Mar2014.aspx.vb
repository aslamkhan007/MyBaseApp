...
Partial Class OPS_Quotation_Action_Panel
    ...
    Protected Sub cmdAdvise_Click(sender As Object, e As System.EventArgs) Handles cmdAdvise.Click
        ...
        '    Catch ex As Exception
        '        sm.SendMail2("jagdeep@jctltd.com", "", "", "noreply@jctltd.com", "Error Occurred while sending mail at PPC Advise", ex.Message)
        '    End Try
        '    lblQuotationNo.Text = ""
        'Catch ex As Exception
        '    tran.Rollback()
        ...
        Try
            ...
            Catch ex As Exception
                sm.SendMail("jagdeep@jctltd.com", "noreply@jctltd.com", "Error Occurred ", "Error Occurred <br/>" & ex.Message)
    ...
    Protected Sub cmdReject_Click(sender As Object, e As System.EventArgs) Handles cmdReject.Click
        ...
        Try
            ...
            Try
                Dim body As String
                If GetAuthLevel() = "DEV" Then
                    body = "Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Dispatch_Sch.aspx?quot=" & lblQuotationNo.Text & "'>" & lblQuotationNo.Text & "</a> has been rejected by PPC Dept. You may make changes in it as per the suggestions. " & _
            ...
            Catch ex As Exception
                sm.SendMail("jagdeep@jctltd.com", "noreply@jctltd.com", "Error Occurred while sending email ", "Error Occurred while sending email <br/>" & ex.Message)
    ...
    Protected Sub cmdDevApprove_Click(sender As Object, e As System.EventArgs) Handles cmdDevApprove.Click
        ...
        Try
            ...
            Try
                ...
                Dim body As String = "Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Dispatch_Sch.aspx?quot=" & lblQuotationNo.Text & "'>" & lblQuotationNo.Text & "</a> has been approved by PPC Dept. " & _
                    "<br/>. <br/> Remarks: " & txtRejectionRemarks.Text
