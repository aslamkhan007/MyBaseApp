        ...
        <tr>
            <td>
                <div id="AdjResultsDiv1"
                    ...
                    style="height: 200px; overflow: scroll; width: 1050px; top: 0px; left: 0px;">
    ...
    <table style="width: 100%;">
        <tr>
            <td class="labelcells">
                ...
                Rejection Remarks</td>
            <td style="vertical-align: top">
               
                <asp:DropDownList ID="ddlRejectionReason" runat="server" CssClass="combobox" 
                    ValidationGroup="Reject" Visible="False">
                ...
                <asp:TextBox ID="txtRejectionRemarks" runat="server" Columns="100" 
                    CssClass="textbox" TextMode="MultiLine" ValidationGroup="Reject"></asp:TextBox>
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:LinkButton ID="cmdReject" runat="server" CssClass="buttonc" 
                    ValidationGroup="Reject" >Reject Quot</asp:LinkButton>
        ...
        <tr>
            <td>
                 <asp:LinkButton ID="cmdApprove" runat="server" CssClass="buttonc" 
                     CausesValidation="False">Approve Quot</asp:LinkButton>
