    ...
    Protected Sub cmdReject_Click(sender As Object, e As System.EventArgs) Handles cmdReject.Click
        ...
        Try
            ...
            Try
                ...
                Dim body As String = "Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Dispatch_Sch.aspx?quot=" & lblQuotationNo.Text & "'>" & lblQuotationNo.Text & "</a> has been rejected by PPC Dept. You may make changes in it as per the suggestions. " & _
