...
Partial Class OPS_Quotation_Cost_Memo
    ...
    Protected Sub bind_data()
        ...
        Try
            ...
            If lblPrintingType.Text = "Pigment" Then
                lblPrintingCharge.Text = "12.12"
            ElseIf lblPrintingType.Text = "VAT DISCHARGE" Then
                lblPrintingCharge.Text = "17.70"
            Else
    ...
    Protected Sub Calc_DnV()
        ...
        If Val(lblDyesChemDyingCost.Text) = 0 Then
            lblFinalDnvRFD.Text = Val(lblGryCostRFD.Text) + Val(lblProcMcCostRFD.Text) + Val(lblDyeChemCostRFD.Text) + Val(lblFinishChrgRFD.Text) + Val(lblPrintingChrgRFD.Text) + Val(lblFoldCostRFD.Text) + Val(lblShrRFD.Text) + Val(lblValLossRFD.Text) + Val(lblSellExpRFD.Text)
            lblFinalDnvWhite.Text = Val(lblGryCostWhite.Text) + Val(lblProcMcCostWhite.Text) + Val(lblDyeChemCostWhite.Text) + Val(lblFinishChrgWhite.Text) + Val(lblPrintingChrgWhite.Text) + Val(lblFoldCostWhite.Text) + Val(lblShrWhite.Text) + Val(lblValLossWhite.Text) + Val(lblSellExpWhite.Text)

        Else
            lblFinalDnvLight.Text = Val(lblGryCostLight.Text) + Val(lblProcMcCostLight.Text) + Val(lblDyeChemCostLight.Text) + Val(lblFinishChrgLight.Text) + Val(lblPrintingChrgLight.Text) + Val(lblFoldCostLight.Text) + Val(lblShrLight.Text) + Val(lblValLossLight.Text) + Val(lblSellExpLight.Text)
            lblFinalDnvMed.Text = Val(lblGryCostMed.Text) + Val(lblProcMcCostMed.Text) + Val(lblDyeChemCostMed.Text) + Val(lblFinishChrgMed.Text) + Val(lblPrintingChrgMed.Text) + Val(lblFoldCostMed.Text) + Val(lblShrMed.Text) + Val(lblValLossMed.Text) + Val(lblSellExpMed.Text)
            lblFinalDnvDark.Text = Val(lblGryCostDark.Text) + Val(lblProcMcCostDark.Text) + Val(lblDyeChemCostDark.Text) + Val(lblFinishChrgDark.Text) + Val(lblPrintingChrgDark.Text) + Val(lblFoldCostDark.Text) + Val(lblShrDark.Text) + Val(lblValLossDark.Text) + Val(lblSellExpDark.Text)
            lblFinalDnvExtraDark.Text = Val(lblGryCostED.Text) + Val(lblProcMcCostED.Text) + Val(lblDyeChemCostED.Text) + Val(lblFinishChrgED.Text) + Val(lblPrintingChrgED.Text) + Val(lblFoldCostED.Text) + Val(lblShrED.Text) + Val(lblValLossED.Text) + Val(lblSellExpED.Text)
        End If
    ...
    Protected Sub Calculate_Finish_Charge()
        ...
        End Try
        lblFinishCharge.Text = Val(lblFinishCharge.Text) + fin_mc_cost
        ViewState("FinishCost") = lblFinishCharge.Text
        ...
        Else
            lblFinishChrgLight.Text = ViewState("FinishCost")
            lblFinishChrgMed.Text = ViewState("FinishCost")
            lblFinishChrgDark.Text = ViewState("FinishCost")
            lblFinishChrgED.Text = ViewState("FinishCost")
            'lblFinishChrgLight.Text = Math.Round((Val(lblFinishCharge.Text) - Val(lblDyesChemFinishingCost.Text)) * Val(lblYarnWtMtr.Text), 2)
            'lblFinishChrgMed.Text = Math.Round((Val(lblFinishCharge.Text) - Val(lblDyesChemFinishingCost.Text)) * Val(lblYarnWtMtr.Text), 2)
            'lblFinishChrgDark.Text = Math.Round((Val(lblFinishCharge.Text) - Val(lblDyesChemFinishingCost.Text)) * Val(lblYarnWtMtr.Text), 2)
            'lblFinishChrgED.Text = Math.Round((Val(lblFinishCharge.Text) - Val(lblDyesChemFinishingCost.Text)) * Val(lblYarnWtMtr.Text), 2)
    ...
    Protected Sub Calculate_Finish_Charge_Final()
        ...
        lblFinishCharge.Text = Math.Round((Val(lblFinishCharge.Text) / (100 - 5)) * 100, 2)
        lblFinishCharge.Text = Math.Round(Val(lblFinishCharge.Text) / Val(lblValRecovery.Text), 2)
        lblFinishCharge.Text = Math.Round(Val(lblFinishCharge.Text) / (100 - Val(lblSellingExpPerc.Text)) * 100, 2)

        Dim impact As Double = Math.Round(Val(lblFinishCharge.Text) - Val(ViewState("FinishCost")), 2)
