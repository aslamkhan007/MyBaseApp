...
Partial Class OPS_Quotation_Cost_Memo
    ...
    Protected Sub Calculate_Finish_Charge()
        ...
        lblFinishCharge.Text = TotalPerMtr
        ...
        Else
            ...
            lblFinishChrgLight.Text = Math.Round(ViewState("FinishCost"), 2)
            lblFinishChrgMed.Text = Math.Round(ViewState("FinishCost"), 2)
            lblFinishChrgDark.Text = Math.Round(ViewState("FinishCost"), 2)
            lblFinishChrgED.Text = Math.Round(ViewState("FinishCost"), 2)
        End If
    End Sub
