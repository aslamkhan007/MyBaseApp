            ...
            <td colspan="8" style="font-weight: bold">
                        <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="grdDispatchDetailStatus" runat="server" 
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                                    DataSourceMode="DataReader" SelectCommand="jct_ops_get_quote_dispatch_sch" 
    ...
    <table style="width:100%;" class="tableback">
        ...
        <tr>
            <td style="font-weight: bold" colspan="4">
                <asp:LinkButton ID="lnkForwardToPPC" runat="server" CausesValidation="False" 
                    ValidationGroup="Remarks">Forward to PPC/Development for Advise / Approval</asp:LinkButton>
        ...
        <tr>
            <td colspan="4" style="font-weight: bold">
                <asp:LinkButton ID="lnkForwardToDev" runat="server" CausesValidation="False" 
                    ValidationGroup="Remarks" Visible="False">Forward to Development for Advise / Approval</asp:LinkButton>
