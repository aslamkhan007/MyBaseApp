...
Partial Class OPS_Quotation_Dispatch_Sch
    ...
    Protected Sub lnkForwardToPPC_Click(sender As Object, e As System.EventArgs) Handles lnkForwardToPPC.Click
        ...
        If grdDispatchDetail.Rows.Count = 0 Then
            lblMessage.Text = "Please generate dispatch schedule and save it before Requesting approval from PPC."
            Exit Sub
        End If
        ...
        Try
            ...
            Try
                ...
                Dim subject As String = "Required Approval/Advise regarding Dispatch Schedule of Quotation No. " + lblQuotationNo.Text + " by " + sender_name
                Dim body As String = "Please provide advise or approve the dispatch schedule of Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Dispatch_Sch.aspx?quot=" & lblQuotationNo.Text & "'> " & lblQuotationNo.Text & "</a> <br/> " & sender_name & " <br/> Click on Quotation Number to view details."
