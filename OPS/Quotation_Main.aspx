<%@ Page Title="" Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false"   CodeFile="Quotation_Main.aspx.vb" Inherits="OPS_Quotation_Main"  MaintainScrollPositionOnPostback="false" %>
        ...
        <tr>
            <td style="height: 12px; font-weight: bold; font-size: 10pt; text-align: center;
                ...
                <asp:ImageButton ID="ibtDispatchDetail" runat="server" ImageUrl="~/OPS/Image/STab_DispatchDetail.png"
                    ValidationGroup="Tab" />
			<asp:ImageButton ID="ibtUpload" runat="server" ImageUrl="~/OPS/Image/STab_upload.png" AlternateText="Upload File"
                    ValidationGroup="Tab" />
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td colspan="2" rowspan="2">
                ...
                <asp:ImageButton ID="cmdAuthorise2" runat="server" ImageUrl="~/Image/Icons/Action/Authorise.png"
                    ToolTip="Authorise" Width="32px" ValidationGroup="Authorise" />
        ...
        <tr>
            ...
            <td class="labelcells">
                PPC Status</td>
            <td>
                        <asp:Label ID="lblPPCAuthStatus" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="labelcells">
            ...
            <td colspan="3">
                <asp:UpdatePanel ID="UpdatePanel68" runat="server">
                    <ContentTemplate>
                        <asp:DataList ID="DataList1" runat="server" DataSourceID="dsAuthorisationStatus"
                        ...
                        <asp:SqlDataSource ID="dsAuthorisationStatus" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                            SelectCommand="jct_ops_get_quote_auth_queue" SelectCommandType="StoredProcedure">
                            <SelectParameters>
            ...
            <td colspan="3" style="font-weight: bold; color: #FF0000">
                    <asp:UpdatePanel ID="UpdatePanel75" runat="server">
                        <ContentTemplate>
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        <tr>
                                            <td style="width: 100px">
                                                <asp:Label ID="lblActionStatus" runat="server" 
                                                    Text='<%# Eval("Action_Status") %>'></asp:Label>
                                                -</td>
                                            <td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" DataSourceID="dsPPCAuthStatus" 
                                EnableModelValidation="True" GridLines="None" ShowHeader="False" Width="100%">
                            </asp:GridView>
                            <asp:SqlDataSource ID="dsPPCAuthStatus" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                        SelectCommand="jct_ops_get_quot_remarks" 
...
<%--            <td style="height: 12px; width: 380px;">
                <asp:UpdatePanel ID="UpdatePanel59" runat="server">
                    <ContentTemplate>
                        <asp:RadioButtonList ID="rblQuotOwner" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                            Width="100%">
                            <asp:ListItem Value="S" Selected="True">Self</asp:ListItem>
                ...
                <asp:UpdatePanel ID="UpdatePanel58" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlTeamLeader" runat="server" CssClass="combobox" AppendDataBoundItems="True"
                            DataSourceID="dsSalesPersons" DataTextField="group_desc" 
                ...
                <asp:RequiredFieldValidator ID="ReqTeamLeader" runat="server" 
                ControlToValidate="ddlTeamLeader" ErrorMessage="*" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
            ...
            <td class="labelcells" style="height: 12px">
                <asp:Label ID="lblYarnD" runat="server" Text="Yarn Dyeing"></asp:Label>
            </td>
            <td>
              <asp:UpdatePanel ID="UpdatePanel244" runat="server">
                    <ContentTemplate>
            <asp:CheckBox ID="chkYarnDyeing" runat="server" />
            </ContentTemplate>
            </asp:UpdatePanel>
...
<%--            <td style="height: 12px" valign="top">
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel67" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlQuotationType" runat="server" CssClass="combobox">
                            ...
                            <asp:ListItem>DevRequest</asp:ListItem>
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            ...
            <td style="height: 12px" valign="top">
                <asp:UpdatePanel ID="UpdatePanel70" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlSaleOrderType" runat="server" AppendDataBoundItems="True"
                            CausesValidation="True" CssClass="combobox" DataSourceID="dsSalesOrderType" DataTextField="tran_type"
                            DataValueField="tran_type">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlSaleOrderType"
                            ErrorMessage="Please Specify Sale Order Type" SetFocusOnError="True" ValidationGroup="mandatory"  ></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:UpdatePanel ID="UpdatePanel36" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlProductCatg" runat="server" CssClass="combobox"  OnSelectedIndexChanged="ddlProductCatg_SelectedIndexChanged"
                            AutoPostBack="True"  >
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Fabric</asp:ListItem>
                            <asp:ListItem>FOC</asp:ListItem>
                            <asp:ListItem>Garments</asp:ListItem>
                            <asp:ListItem>Home Furnishing</asp:ListItem>
                            <asp:ListItem>Lead cloth</asp:ListItem>
                            <asp:ListItem>Synthetic</asp:ListItem>
                            <asp:ListItem Enabled="False">Yarn</asp:ListItem>
                        </asp:DropDownList>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator103" runat="server" ControlToValidate="ddlProductCatg" ValidationGroup="mandatory" 
                            ErrorMessage="Required " SetFocusOnError="True"></asp:RequiredFieldValidator>
							  <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="ddlProductCatg" ValidationGroup="b" 
                            ErrorMessage="Required " SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </ContentTemplate>
        ...
        <td class="labelcells" style="width: 150px">
            ...
            <td style="width: 380px">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlType" runat="server" CssClass="combobox" AutoPostBack="True">                           
                            <asp:ListItem></asp:ListItem>
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel24" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        <asp:TextBox ID="txtItemCode" runat="server" CssClass="textbox" Width="66px" 
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="Updatepanel122" runat="server"> 
                <ContentTemplate>
                        ...
                        <asp:DropDownList ID="ddlSegmentdetail" runat="server" CssClass="combobox"  OnSelectedIndexChanged="ddlSegmentdetail_SelectedIndexChanged"
                            AutoPostBack="True"  Width="154px"  ></asp:DropDownList>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlSegmentdetail" ValidationGroup="mandatory" 
                            ErrorMessage="Required " SetFocusOnError="True"></asp:RequiredFieldValidator>
							
							 <asp:RequiredFieldValidator ID="RequiredFieldValir11" runat="server" ControlToValidate="ddlSegmentdetail" ValidationGroup="b" 
                            ErrorMessage="Required " SetFocusOnError="True"></asp:RequiredFieldValidator>
                 </ContentTemplate>
        ...
        <tr>
            <td class="labelcells" style="width: 150px">
                Sub Segment</td>
                <td>
                 <asp:UpdatePanel ID="UpdateP2" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlSubCat" runat="server"    CausesValidation="True" CssClass="combobox"  
                            Width="300px">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlSubCat" ValidationGroup="mandatory" ErrorMessage="Required " SetFocusOnError="True">
                           </asp:RequiredFieldValidator>
                  <asp:RequiredFieldValidator ID="RequiredFieldVali2" runat="server" ControlToValidate="ddlSubCat" ValidationGroup="b" ErrorMessage="Required " SetFocusOnError="True">
                           </asp:RequiredFieldValidator>
                    </ContentTemplate>
                </asp:UpdatePanel>
        ...
        <tr>
            ...
            <td style="width: 380px">
                <asp:UpdatePanel ID="UpdatePanel69" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSearchBrand" runat="server" AutoPostBack="True" Columns="50" 
                            CssClass="textbox" 
                            ToolTip="Type in characters to search a Brand"></asp:TextBox>
                        <cc1:AutoCompleteExtender ID="txtSearchBrand_AutoCompleteExtender" runat="server" 
                            ...
                            FirstRowSelected="True" ServiceMethod="OPS_Brands" 
                            ServicePath="~/WebService.asmx" TargetControlID="txtSearchBrand" 
        ...
        <tr>
            ...
            <td style="width: 380px">
                <asp:UpdatePanel ID="UpdatePanel72" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtBrandCode" runat="server" Columns="25" CssClass="textbox" 
                            Enabled="False"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                            ControlToValidate="txtBrandCode" 
                            ErrorMessage="Please Select Valid Brand from List">*</asp:RequiredFieldValidator>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="labelcells">
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel71" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtBrandName" runat="server" Columns="40" CssClass="textbox" 
                            Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grdCosting" runat="server" EnableModelValidation="True" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:HyperLinkField DataNavigateUrlFields="Memo No"
                                        DataNavigateUrlFormatString="Quotation_Cost_Memo.aspx?memo_no={0}"
                                        DataTextField="Memo No" DataTextFormatString="View Memo" Target="_blank" />--%>
                                </Columns>
                                <HeaderStyle CssClass="GridHeader" />
                                <RowStyle CssClass="GridItem" />
        ...
        <tr>
            <td>
                ...
                <asp:ImageButton ID="cmdAuthorise" runat="server" ImageUrl="~/Image/Icons/Action/Authorise.png"
                    ToolTip="Authorise Quotation" Width="32px" ValidationGroup="Authorise" />
            ...
            <td style="text-align: right">
                <asp:UpdatePanel ID="UpdatePanel74" runat="server">
                    <ContentTemplate>
                        <asp:ImageButton ID="cmdAuthorise_Push_SO" runat="server" 
                            ImageUrl="~/Image/Icons/Action/Authorise_Make_SO.png" 
                            ToolTip="Authorise Quotation and Request its Sale Order (Only for HOD)" 
                            ValidationGroup="Authorise" Width="32px" />
                        <asp:ImageButton ID="cmdPush_SO" runat="server" 
                            ImageUrl="~/Image/Icons/Action/Make_SO.png" 
                            ToolTip="Request Sale Order for this Quotation" ValidationGroup="Authorise" 
                            Width="32px" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
