...
Partial Class OPS_Quotation_Main
    ...
    Protected Sub grdCosting_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles grdCosting.SelectedIndexChanged
        ...
        Dim memo_dt As String = grdCosting.SelectedRow.Cells(16).Text
    ...
    Protected Sub ibtSave_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtSave.Click
	 ...
	 '06 April 2016
        If ddlType.SelectedItem.ToString() = "" Then
            ScriptManager.RegisterClientScriptBlock(Me, Me.GetType, "scr", "alert('Please select Type for Quotation No Field.');", True)
            ddlType.Focus()
            Exit Sub
        End If
        '06 April 2016
        ...
        cmd.Parameters.Add("@Segement", SqlDbType.VarChar, 50)
        cmd.Parameters("@Segement").Value = ddlSegmentdetail.SelectedItem.Text

        cmd.Parameters.Add("@Subsegment", SqlDbType.VarChar, 510)
        cmd.Parameters("@Subsegment").Value = ddlSubCat.SelectedItem.Text

        cmd.Parameters.Add("@Category", SqlDbType.VarChar, 510)
        cmd.Parameters("@Category").Value = ddlProductCatg.SelectedValue
        ...
        cmd.Parameters("@Brand").Value = txtBrandCode.Text
        'cmd.Parameters("@Brand").Value = ddlBrandName.SelectedIndex
        ...
        cmd.Parameters.Add("@IsYarnDyning", SqlDbType.Bit)
        cmd.Parameters("@IsYarnDyning").Value = chkYarnDyeing.Checked

         '06 April 2016
        cmd.Parameters.Add("@QuotType", SqlDbType.VarChar, 10)
        cmd.Parameters("@QuotType").Value = ddlType.SelectedItem.Text
        '06 April 2016
 ...
 Dim baseurl As String = Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd("/"c) + "/"
        Try
            ...
            If Trim(txtQuotationNo.Text) = "" Then
			  baseurl = baseurl + "ops/Quotation_Main.aspx?quot=" + cmd.Parameters("@Quot_No").Value
                email_msg = "Quotation # <a href = ' " + baseurl + " '> " & cmd.Parameters("@Quot_No").Value & "</a> created successfully! <br/> Click on Quotation Number to view details."
            ...
            ElseIf lblQuotationNo.Text = cmd.Parameters("@Quot_No").Value Then
			  baseurl = baseurl + "ops/Quotation_Main.aspx?quot=" + cmd.Parameters("@Quot_No").Value
                email_msg = "Quotation # <a href = '" + baseurl + "'> " & cmd.Parameters("@Quot_No").Value & "</a> saved successfully! <br/> Click on Quotation Number to view details."
            ...
            Try
                Dim bcc As String = "rbaksshi@jctltd.com;hitesh@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com"
                ...
                'sm.SendMail("ashish@jctltd.com", "noreply@jctltd.com", msg + " by " + Session("EmpName"), email_msg + " <br/> Customer : " + lblCustomerName.Text + " <br/> Sales Person : " + Session("EmpName"))
                ...
                ''sm.SendMail("ashish@jctltd.com", "noreply@jctltd.com", "Quotation # " & lblQuotationNo.Text + " created successfully!", "Quotation # " & lblQuotationNo.Text + " created successfully!")
        ...
        Catch ex As Exception
            ...
            sm.SendMail("hitesh@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com", "noreply@jctltd.com", "Error Occurred while creating/saving quotation" & lblQuotationNo.Text & " <br/> " & Session("EmpName").ToString, ex.Message)
    ...
    Protected Sub ibtViewQuotation_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtViewQuotation.Click

        Dim sqlstr As String = "jct_ops_get_quotes '" & txtQuotationNo.Text & "'"
        Dim cn As New Connection
        Dim cn1 As New Connection
        Dim cmd1 As SqlCommand = New SqlCommand(sqlstr, cn1.Connection)
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                'txtBrandName.Text = dr("brand").ToString
                ...
                txtBrandCode.Text = dr("Brand").ToString

                chkYarnDyeing.Checked = IIf(dr("IsYarnDyning") = True, True, False)
                'ddlBrandName.SelectedIndex = ddlBrandName.Items.IndexOf(ddlBrandName.Items.FindByValue(dr("brand").ToString))

				 '06 April 2016
                ddlType.Text = dr("QuotType").ToString
                '06 April 2016
                ...
                ddlProductCatg.SelectedIndex = ddlProductCatg.Items.IndexOf(ddlProductCatg.Items.FindByValue(dr("Category").ToString))
                bindcatgory()
                ddlSegmentdetail.SelectedIndex = ddlSegmentdetail.Items.IndexOf(ddlSegmentdetail.Items.FindByValue(dr("segement").ToString))
                segmentbind()
                ddlSubCat.SelectedIndex = ddlSubCat.Items.IndexOf(ddlSubCat.Items.FindByText(dr("Subsegment").ToString))
                Try
                ...
                lnkAttachedDocs.Visible = True
                lnkAttachedDocs.Text = GetAttachments(lblQuotationNo.Text).ToString + " " + "document(s) attached for " + lblQuotationNo.Text
        ...
        If dr.HasRows Then
            ...
            If lblMemoDate.Text <> "01 Jan 1900" Then
                ...
                ElseIf ddlQuotationType.SelectedItem.Text = "Forecast" Then
                    ...
                    'ElseIf ddlQuotationType.SelectedItem.Text = "DevRequest" Then
                    '    lblExpiryDate.Text = Convert.ToDateTime(lblQuoteDate.Text).AddDays(90).ToString()
                Else
    ...
    Protected Sub cmdAuthorise_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles cmdAuthorise.Click
        ...
        count = GetAttachments(lblQuotationNo.Text).ToString
		  Dim baseurl As String = Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd("/"c) + "/"
        ...
        Else
            ...
            Try
                ...
                Try
					 baseurl = baseurl + "ops/Quotation_Main.aspx?quot=" & lblQuotationNo.Text
                    'Dim bcc As String = "rbaksshi@jctltd.com; hitesh@jctltd.com; harendra@jctltd.com; hiren@jctltd.com; sandeep@jctltd.com"
                   ...
                   ' body_to = "Quotation # <a href = 'http://testerp/fusionapps/ops/Quotation_Main.aspx?quot=" & lblQuotationNo.Text & "'> " & lblQuotationNo.Text & "</a> has been Authorised successfully! " + Session("EmpName").ToString + "<br/> Click on Quotation Number to view details."
				     body_to = "Quotation # <a href = '"+ baseurl +"'> " & lblQuotationNo.Text & "</a> has been Authorised successfully! " + Session("EmpName").ToString + "<br/> Click on Quotation Number to view details."
                    body_to += GetPage("Quotation_Detail_Preview.aspx?quot=" & lblQuotationNo.Text)
                    ...
                    Dim recipients, m_sender, sender_name, recipient_name, cc As String
                    recipients = ""
                    m_sender = ""
                    sender_name = ""
                    recipient_name = ""
                    ...
                    cc = cc & "rbaksshi@jctltd.com; hitesh@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com"
            ...
            Catch ex As Exception
                sm.SendMail2("hitesh@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com", "", "", "approvals@jctltd.com", "Error occurred while authorising Quotation:" + lblQuotationNo.Text, ex.Message)
                ofn.Alert(ex.Message)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            'Dim li As New ListItem(Session("EmpName").ToString, Session("EmpCode").ToString)
    ...
    Protected Sub ibtShadeQty_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtShadeQty.Click
        ...
        Response.Redirect("Quotation_Qty.aspx?quot=" & lblQuotationNo.Text + "&Quotype=" & ddlQuotationType.Text + "&Isyarn=" & chkYarnDyeing.Checked)
    ...
    Protected Sub cmdEnquiryRequest_Click(sender As Object, e As System.EventArgs) Handles cmdEnquiryRequest.Click
        ...
        'sm.SendMail("ashish@jctltd.com", "noreply@jctltd.com", "Request for New Fabric Particular Enquiry and its Cost", body_to)
        ...
        Dim bcc As String = "rbaksshi@jctltd.com; hitesh@jctltd.com; harendra@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com"
        sm.SendMail2("jagjit@jctltd.com;nsaini@jctltd.com;arunsinghal@jctltd.com;tajinderpal@jctltd.com", "", bcc, "noreply@jctltd.com", "Request for New Fabric Particular Enquiry and its Cost ", body_to & str)
    ...
    Protected Sub cmdReqExtCost_Click(sender As Object, e As System.EventArgs) Handles cmdReqExtCost.Click
        ...
        'sm.SendMail("ashish@jctltd.com", "noreply@jctltd.com", "Request for External Cost", body_to & str)
        ...
        sm.SendMail2("jagjit@jctltd.com;nsaini@jctltd.com;arunsinghal@jctltd.com;rajgopal@jctltd.com;tajinderpal@jctltd.com", "", bcc, "noreply@jctltd.com", "Request for External/Market Cost ", body_to & str)
    ...
    Protected Sub cmdReqFreshCost_Click(sender As Object, e As System.EventArgs) Handles cmdReqFreshCost.Click
        ...
        Dim bcc As String = "rbaksshi@jctltd.com; hitesh@jctltd.com; harendra@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com"
        sm.SendMail2("jagjit@jctltd.com;nsaini@jctltd.com;arunsinghal@jctltd.com", "", bcc, "noreply@jctltd.com", "Request for Fresh Cost Sheet for Sort No : " & txtItemCode.Text, body_to)
    ...
    Protected Sub cmdAuthorise_Push_SO_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles cmdAuthorise_Push_SO.Click
        Dim count As Integer = GetAttachments(lblQuotationNo.Text).ToString
        If count = 0 Then
            ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('Please Attach Document Before SO Request');", True)
        Else
            Dim IsMailsent As String
            IsMailsent = "N"

            Dim sqlstr As String = "SELECT  'A' FROM dbo.jct_ops_quotation_hdr WHERE Quotation_No = '" & lblQuotationNo.Text & "'and  ( Req_SO is null or  Req_SO='')"
            Dim dr As SqlDataReader = ofn.FetchReader(sqlstr)
            ...
            Try
                ...
                If IsMailsent = "N" Then
                    Req_SO_Mail()
                Else
                    ofn.Alert("Req SO Already made")
                End If



                'added by ashish
                'sqlstr = "SELECT  'A' FROM dbo.jct_ops_quotation_hdr WHERE Quotation_No = '" & lblQuotationNo.Text & "'and   Req_SO is null"
                'Dim dr As SqlDataReader = ofn.FetchReader(sqlstr)
    ...
    Protected Sub cmdPush_SO_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles cmdPush_SO.Click
        ...
        Else
            ...
            sqlstr = "jct_ops_request_sale_order "
            Dim cn As New Connection
            Dim cmd As SqlCommand = New SqlCommand(sqlstr, cn.Connection)
    ...
    Protected Sub Req_SO_Mail()
        ...
        Try
            ...
            '---Dim body As String = "You have got Sale Order Request for Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Dispatch_Sch.aspx?quot=" & lblQuotationNo.Text & "'>" & lblQuotationNo.Text & "</a>.<br/> Click on Quotation Number to view details."
			 Dim body As String = "You have got Sale Order Request for Quotation # <a href = '"+ baseurl +"'>" & lblQuotationNo.Text & "</a>.<br/> Click on Quotation Number to view details."
            Dim sql As String
            ...
            m_sender = ""
            If ddlPlant.SelectedValue = "Cotton" Then
                cc = "neeraj@jctltd.com;"
            End If
        ...
        Catch ex As Exception
            sm.SendMail2("hitesh@jctltd.com;hiren@jctltd.com;sandeepr@jctltd.com", "", "", "noreply@jctltd.com", "Error Occurred while sending mail for Sale Order Request for Quotation # " + lblQuotationNo.Text, ex.Message)
    ...
    Protected Function GetPage(page_name As String) As String
		...
		Dim baseurl As String = Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd("/"c) + "/"
        'baseurl = baseurl + "ops/Quotation_Dispatch_Sch.aspx?quot=" + lblQuotationNo.Text
        currentPageUrl = baseurl + "OPS/Quotation_Detail_Preview.aspx?quot=" & lblQuotationNo.Text
    ...
    Protected Sub txtBrandName_TextChanged(sender As Object, e As System.EventArgs) Handles txtSearchBrand.TextChanged

        Try

            If txtSearchBrand.Text <> String.Empty Then

                txtBrandName.Text = Trim(txtSearchBrand.Text.Split("|c")(0).ToString)
                txtBrandCode.Text = Trim(txtSearchBrand.Text.Split("|c")(1).ToString)
            ...
            If Not CheckBrand(txtBrandName.Text) Then
                Throw New Exception
        ...
        Catch ex As Exception
            ...
            ofn.Alert("Please Select Valid Brand from the dynamic list")
    ...
    Protected Function CheckBrand(brand As String) As Boolean

        Dim cn As New Connection
        'Dim sql As String = "SELECT 'X' FROM jct_ops_brands WHERE branddesc = @brand and status = 'A'"
        Dim sqlstr As String = "jct_ops_get_brands"
        Dim cmd As New SqlCommand(sqlstr, cn.Connection)
        cmd.CommandType = CommandType.StoredProcedure
        cn.ConOpen()
        cmd.Parameters.Add("prefix", SqlDbType.VarChar, 30).Value = brand
    ...
    Protected Sub ShowHideAuthSOReqButton()

        Dim cn As New Connection
        Dim sql As String = "jct_ops_quote_so_req_access"
        Dim cmd As New SqlCommand(sql, cn.Connection)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("Quotation_No", SqlDbType.VarChar, 16).Value = txtQuotationNo.Text
        cmd.Parameters.Add("User_Code", SqlDbType.VarChar, 10).Value = Session("EmpCode").ToString
        'cmd.Parameters.Add("Access_Type", SqlDbType.VarChar, 10).Value = access_type

        Try

            Dim dr As SqlDataReader = cmd.ExecuteReader()
            Dim auth_so_req, so_req As String
            auth_so_req = ""
            so_req = ""
            If dr.HasRows Then

                dr.Read()
                auth_so_req = dr("AuthSOReq").ToString
                so_req = dr("SOReq").ToString

            End If

        Catch ex As Exception

            lblMessage.Text = "Problem setting Authorisation and SO Request Access. "
            lblMessage.Text += ex.Message
    ...
    Protected Sub ddlProductCatg_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlProductCatg.SelectedIndexChanged
        bindcatgory()
    End Sub
    Protected Sub ddlSegmentdetail_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlSegmentdetail.SelectedIndexChanged
        segmentbind()
    End Sub

    Private Sub bindcatgory()
        Dim cn As New Connection
        Dim sql As String = "jct_ops_get_segments_new"
        Dim cmd As New SqlCommand(sql, cn.Connection)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("Category", SqlDbType.VarChar, 510).Value = ddlProductCatg.SelectedValue
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
        da.Fill(ds)
        If ds.Tables(0).Rows.Count <> 0 Then

            ddlSegmentdetail.DataSource = ds
            ddlSegmentdetail.DataTextField = "segment"
            ddlSegmentdetail.DataValueField = "segment"
            ddlSegmentdetail.DataBind()
            ddlSegmentdetail.Items.Insert(0, New ListItem([String].Empty, [String].Empty))
            ddlSegmentdetail.SelectedIndex = 0
        End If
    End Sub

    Private Sub segmentbind()
        Dim cn As New Connection
        Dim sql As String = "Jct_Ops_GetSubSegement"
        Dim cmd As New SqlCommand(sql, cn.Connection)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("Segement", SqlDbType.VarChar, 510).Value = ddlSegmentdetail.SelectedValue
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
        da.Fill(ds)
        ...
        If ds.Tables(0).Rows.Count <> 0 Then
            ...
            ddlSubCat.DataTextField = "prifix"
            ddlSubCat.DataValueField = "Subcat"
            ddlSubCat.DataBind()
            ddlSubCat.Items.Insert(0, New ListItem([String].Empty, [String].Empty))
            ddlSubCat.SelectedIndex = 0
        End If
    End Sub

    Protected Sub lnkAttachedDocs_Click(sender As Object, e As System.EventArgs) Handles lnkAttachedDocs.Click
        Dim sql As String
        Dim con As New Connection
        sql = "jct_ops_Quotation_Docs"
        Dim cmd As SqlCommand = New SqlCommand(Sql, con.Connection)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("BaseDocNo", SqlDbType.VarChar, 16)
        cmd.Parameters("BaseDocNo").Value = lblQuotationNo.Text

        Dim RefDocFilePath As String = String.Empty
        Dim RefDocActFileName As String = String.Empty
        Dim dr As SqlDataReader
        dr = cmd.ExecuteReader(CommandBehavior.CloseConnection)

        If dr.HasRows Then
            While dr.Read
                RefDocFilePath = dr("RefDocFilePath").ToString
                RefDocActFileName = dr("RefDocActFileName").ToString
            End While
        End If
        dr.Close()

        Dim filepath As String = Server.MapPath("~\\Ops\\Files\\" + "Quotation" + "\\" + lblQuotationNo.Text.Replace("/", "-") + "\\")
        Response.Redirect("QutationDownloadFile.aspx?filepath=" + filepath + "&FileName=" + RefDocActFileName)
    ...
    Protected Sub dtlAttachment_ItemCommand(source As Object, e As System.Web.UI.WebControls.DataListCommandEventArgs) Handles dtlAttachment.ItemCommand
        ...
        If e.CommandName = "Download" Then
            ...
            Dim filepath As String = Server.MapPath("~\\Ops\\Files\\" + "Quotation" + "\\" + lblQuotationNo.Text.Replace("/", "-") + "\\")
            ' ''Server.MapPath("~\Ops\Upload\" + e.CommandArgument.ToString())
    ...
    Protected Sub ibtUpload_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtUpload.Click
        Response.Redirect("QutationFileUplaod.aspx?quot=" & IIf(lblQuotationNo.Text = "", txtQuotationNo.Text, lblQuotationNo.Text))
    End Sub
    Private Sub bindcosting()
        Dim sm As New SendMail
        Dim str, body_to, subject As String
        ...
        Try
            Dim cn As New Connection
            Dim sql As String = "jct_ops_get_cost_param_new"
            Dim cmd As New SqlCommand(sql, cn.Connection)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add("Sort", SqlDbType.VarChar, 30).Value = txtItemCode.Text
            cmd.Parameters.Add("Enq", SqlDbType.Int, 0).Value = lblEnqNo.Text
            cmd.Parameters.Add("Dev", SqlDbType.Int, 0).Value = lblDevNo.Text
            cmd.Parameters.Add("Finishing", SqlDbType.VarChar, 10).Value = ddlFinish.SelectedValue
            cmd.Parameters.Add("Printing", SqlDbType.VarChar, 20).Value = ddlPrintingType.SelectedValue
            cmd.Parameters.Add("Memo", SqlDbType.VarChar, 15).Value = lblMemoNo.Text
            cmd.Parameters.Add("Plant", SqlDbType.VarChar, 10).Value = ddlPlant.SelectedValue
            cmd.Parameters.Add("status", SqlDbType.VarChar, 15).Value = lblStatus.Text
            ...
            da.Fill(ds)
            If ds.Tables(0).Rows.Count <> 0 Then
                grdCosting.DataSource = ds
                grdCosting.DataBind()
            End If
        Catch ex As Exception

            sm.SendMail2("manishk@jctltd.com", "", "", "noreply@jctltd.com", "Error occurred while binding costing   Quotation:" + lblQuotationNo.Text, ex.Message)
        End Try

    End Sub

    Protected Sub dtlAttachment_DeleteCommand(source As Object, e As System.Web.UI.WebControls.DataListCommandEventArgs) Handles dtlAttachment.DeleteCommand
        Dim sm As New SendMail
        Dim str, body_to, subject As String
        ...
        subject = ""
        Try
            If lblStatus.Text = "QuotOpen" Then
                Dim Recoredid As Integer = CInt(dtlAttachment.DataKeys(CInt(e.Item.ItemIndex)))
                Dim cn As New Connection
                Dim sql As String = "jct_ops_Quotation_Docs_Delete"
                Dim cmd As New SqlCommand(sql, cn.Connection)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("Quotation_no", SqlDbType.VarChar, 20).Value = lblQuotationNo.Text
                cmd.Parameters.Add("Recoredid", SqlDbType.Int, 0).Value = Recoredid
                cmd.Parameters.Add("Userid", SqlDbType.VarChar, 16).Value = Session("EmpCode").ToString
                cmd.ExecuteNonQuery()
                binddoc()
            Else
                ScriptManager.RegisterStartupScript(Me, [GetType](), "showalert", "alert('You Can Not  Delete This File After Authorisation');", True)
    ...
    Private Sub binddoc()
        ...
        Dim sqlstr As String = " select RecordId,'Attachments' AS Attachment ,RefDocActFileName AS AttachedFile from jct_ops_ref_docs where basedocno = '" & txtQuotationNo.Text & "' and status='A'"
