...
Partial Class OPS_Quotation_Main
 ...
 Dim baseurl As String = Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd("/"c) + "/"
        Try
            ...
            Try
                Dim bcc As String = "rbaksshi@jctltd.com;ashish@jctltd.com;manishk@jctltd.com"
        ...
        Catch ex As Exception
            ...
            sm.SendMail("ashish@jctltd.com;manishk@jctltd.com", "noreply@jctltd.com", "Error Occurred while creating/saving quotation" & lblQuotationNo.Text & " <br/> " & Session("EmpName").ToString, ex.Message)
    ...
    Protected Sub cmdAuthorise_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles cmdAuthorise.Click
        ...
        Else
            ...
            Catch ex As Exception
                sm.SendMail2("ashish@jctltd.com;manishk@jctltd.com", "", "", "approvals@jctltd.com", "Error occurred while authorising Quotation:" + lblQuotationNo.Text, ex.Message)
                ofn.Alert(ex.Message)
    ...
    Protected Sub Req_SO_Mail()
        ...
        Catch ex As Exception
            sm.SendMail2("ashish@jctltd.com;manishk@jctltd.com", "", "", "noreply@jctltd.com", "Error Occurred while sending mail for Sale Order Request for Quotation # " + lblQuotationNo.Text, ex.Message)
