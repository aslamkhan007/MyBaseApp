...
Partial Class OPS_Quotation_Main
    ...
    Protected Sub ibtSave_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtSave.Click
        ...
        Catch ex As Exception
            ...
            sm.SendMail("jagdeep@jctltd.com", "noreply@jctltd.com", "Error Occurred while creating/saving quotation" + " <br/> " + Session("EmpName"), ex.Message)
    ...
    Protected Sub ibtSave_Load(sender As Object, e As System.EventArgs) Handles ibtSave.Load
