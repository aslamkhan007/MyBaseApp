        ...
        <tr>
            ...
            <td style="height: 12px" valign="top">
                 <asp:UpdatePanel ID="UpdatePanel70" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlSaleOrderType" runat="server" 
                            AppendDataBoundItems="True" CausesValidation="True" CssClass="combobox" 
                            DataSourceID="dsSalesOrderType" DataTextField="tran_type" 
                            DataValueField="tran_type">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                            ControlToValidate="ddlSaleOrderType" 
                            ErrorMessage="Please Specify Sale Order Type" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                        <asp:SqlDataSource ID="dsSalesOrderType" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                            SelectCommand="jct_ops_so_type" SelectCommandType="StoredProcedure">
                        </asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td style="width: 380px">
                <asp:UpdatePanel ID="UpdatePanel69" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtBrandName" runat="server" Columns="70" CssClass="textbox"></asp:TextBox>
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                            ControlToValidate="txtBrandName" ErrorMessage="Please Specify Brand Name" 
