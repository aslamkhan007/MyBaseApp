        ...
        <tr>
            ...
            <td colspan="3" style="font-weight: bold; color: #FF0000">
                    <asp:UpdatePanel ID="UpdatePanel75" runat="server">
                        <ContentTemplate>
                            <asp:DataList ID="DataList2" runat="server" DataSourceID="dsPPCAuthStatus" 
                ...
                <asp:UpdatePanel ID="UpdatePanel58" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlTeamLeader" runat="server" CssClass="combobox" AppendDataBoundItems="True"
                            ...
                            DataValueField="sale_person_code" Visible="False">
                ...
                <asp:UpdatePanel ID="UpdatePanel70" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlSaleOrderType"
                            ErrorMessage="Please Specify Sale Order Type" SetFocusOnError="True">*</asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="width: 380px">
                <asp:UpdatePanel ID="UpdatePanel73" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlSegment" runat="server" AppendDataBoundItems="True"
                            CausesValidation="True" CssClass="combobox" DataSourceID="dsSegment" DataTextField="Segment"
                            DataValueField="Segment">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlSaleOrderType"
                            ErrorMessage="Please Specify Sale Order Type" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                        <asp:SqlDataSource ID="dsSegment" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                            SelectCommand="jct_ops_get_segments" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="labelcells">
