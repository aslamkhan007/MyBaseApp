        ...
        <tr>
            ...
            <td colspan="2" rowspan="2">
                ...
                <asp:ImageButton ID="cmdCancel" runat="server" ImageUrl="~/Image/Icons/Action/Cancel.png"
                    ToolTip="Cancel/Reject" Width="32px" />
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel64" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtRamcoItemCode" runat="server" CssClass="textbox" 
                            ToolTip="Item Code to be referred in RAMCO while creating Sale Order."></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                            ControlToValidate="txtRamcoItemCode" 
        ...
        <tr>
            ...
            <td style="width: 380px; font-weight: bold;">
                <asp:UpdatePanel ID="UpdatePanel65" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlMaxShades" runat="server" 
    CssClass="combobox">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
