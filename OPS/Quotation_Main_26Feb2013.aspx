    ...
    <table class="NormalText" style="width: 100%;">
        <tr>
            <td class="tableheader">
                Quotation<asp:UpdatePanel ID="UpdatePanel27" runat="server" 
...
&nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ControlToValidate="txtQuotationNo" 
        ...
        <tr>
            <td style="height: 12px; font-weight: bold; font-size: 10pt; text-align: center; text-decoration: none; vertical-align: text-top;" 
                valign="baseline">
                <asp:ImageButton ID="ibtBasicInfo" runat="server" 
                    ImageUrl="~/OPS/Image/Tab_BasicInfo.png" Enabled="False" />
                <asp:ImageButton ID="ibtShadeQty" runat="server" 
                    ImageUrl="~/OPS/Image/STab_ShadesQuantities.png" ValidationGroup="Tab" />
                <asp:ImageButton ID="ibtPayTerms" runat="server" 
                    ImageUrl="~/OPS/Image/STab_PaymentTerms.png" ValidationGroup="Tab" />
                <asp:ImageButton ID="ibtDispatchDetail" runat="server" 
                    ImageUrl="~/OPS/Image/STab_DispatchDetail.png" ValidationGroup="Tab" />
            </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="height: 12px; width: 380px;">
                <asp:UpdatePanel ID="UpdatePanel28" runat="server" RenderMode="Inline" 
                    UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox ID="txtQuotationNo" runat="server" CssClass="textbox" 
            ...
            <td colspan="2" rowspan="2">
                ...
                <asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/Image/Icons/Action/Search.png"
                    ToolTip="Preview Quotation" Width="32px" 
                    CausesValidation="False" />
                </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="labelcells">Expiry Date</td>
            <td>
         ...
         <tr>
            <td class="labelcells">
                        <asp:Label ID="lblBehalfof" runat="server">On behalf of</asp:Label>
                    </td>
            <td>
                <asp:UpdatePanel ID="UpdatePanel58" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlSalePerson" runat="server" CssClass="combobox" 
                            DataSourceID="SqlDataSource3" DataTextField="group_desc" 
                            DataValueField="sale_person_code">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="SELECT  '' AS [sale_person_code] ,
        '' AS [group_desc]
UNION
SELECT DISTINCT
        a.sale_person_code ,
...
FROM    MISERP.SOM.DBO.jct_team_saleperson_mapping a
        ...
        INNER JOIN dbo.JCT_EmpMast_Base c ON REPLACE(c.empcode,'-','')=a.sale_person_code
WHERE   a.status = 'O'
        AND group_type = 'SalesP'
        AND team_code NOT IN ('Sales Team' ) 
        AND c.Active='Y'
        "></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
    ...
    <table class="tableback" style="width: 100%;">
                ...
                <asp:UpdatePanel ID="UpdatePanel38" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSearchCustomer" runat="server" AutoPostBack="True" 
                            Columns="50" CssClass="textbox"></asp:TextBox>
        ...
        <tr>
            <td class="labelcells" style="height: 12px; width: 150px;">
                Customer/Prospect Code</td>
            <td style="height: 12px; width: 380px;">
                    
                    <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtCustomerCode" runat="server" Columns="10" 
                                CssClass="textbox" Enabled="False" ReadOnly="True"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtCustomerCode" ErrorMessage="Please enter Customer">*</asp:RequiredFieldValidator>
                            <asp:ImageButton ID="cmdNewProspect" runat="server" CausesValidation="False" 
                                Height="24px" ImageUrl="~/Image/Icons/Action/NewDocument.png" 
                                PostBackUrl="CustomerProspectDetail.aspx" 
        ...
        <tr>
            ...
            <td style="width: 380px">
                <asp:UpdatePanel ID="UpdatePanel39" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSearchItem" runat="server" AutoPostBack="True" Columns="50" 
                            CssClass="textbox" 
                    ...
                    <cc1:AutoCompleteExtender ID="txtSearchItem_AutoCompleteExtender" runat="server" 
                            CompletionInterval="10" CompletionSetCount="20" 
                            ServiceMethod="OPS_Fabric_Items"   CompletionListCssClass="AutoExtender" 
                            ServicePath="~/WebService.asmx" 
    ...
    Width="66px" AutoPostBack="True"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                            ControlToValidate="txtItemType" ErrorMessage="Please provide valid Item Code">*</asp:RequiredFieldValidator>
                        <asp:ImageButton ID="ibtRefresh" runat="server" CausesValidation="False" 
                            ImageUrl="~/Image/Icons/Action/Refresh.png" 
                            ToolTip="Click to Refresh Fabric Particulars &amp; Costing Details for this Quality" 
                            Width="24px" Visible="False" />
                        <asp:ImageButton ID="cmdSearchItem" runat="server" CausesValidation="False"
        ...
        </table><table class="tableback" style="width: 100%;">
        <tr>
            <td style="font-weight: bold; font-size: 10pt; width: 150px;">
                Fabric Particulars 
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ControlToValidate="txtBlend" 
                    ErrorMessage="No Particulars Picked or Exists for Given Item" 
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ...
                            DataSourceMode="DataReader" SelectCommand="jct_ops_get_count_detail" 
                            SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="txtItemCode" Name="sort" PropertyName="Text" 
                                    Type="String" />
                                <asp:ControlParameter ControlID="lblEnqNo" Name="enq" PropertyName="Text" 
                                    Type="Decimal" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="sdsQuoteFabCount" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                            DataSourceMode="DataReader" SelectCommand="jct_ops_get_quote_fab_count" 
                            SelectCommandType="StoredProcedure">
                            <SelectParameters>
    ...
    <table class="tableback" style="width: 100%;">
        <tr>
            <td class="labelcells" 
                style="height: 12px; font-weight: bold; font-size: 10pt;">
                Cost Parameters</td>
            <td style="width: 380px">
                &nbsp;</td>
            <td class="labelcells">
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel34" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                            ControlToValidate="txtItemType" 
                            ErrorMessage="Please provide valid Item Type">*</asp:RequiredFieldValidator>
                    <div id="div4" style="display:none;">   
                        <cc1:AutoCompleteExtender ID="txtItemType_AutoCompleteExtender" runat="server" 
                            CompletionInterval="10" CompletionSetCount="20" MinimumPrefixLength="1" 
                            ServiceMethod="OPS_Fetch_ItemType"   CompletionListCssClass="AutoExtender" 
                            ServicePath="~/WebService.asmx" 
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel52" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlDyeType" runat="server" AppendDataBoundItems="True" 
                            CssClass="combobox" DataSourceID="dsDyeChem" DataTextField="parameter" 
                            DataValueField="parameter_code" AutoPostBack="True">
...
where parent_category = 'dyetype'"></asp:SqlDataSource>
    ...
    CssClass="combobox" DataTextField="parameter" 
                    DataValueField="parameter_code" AppendDataBoundItems="True" 
                    DataSourceID="dsPrintType" AutoPostBack="True">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
        ...
        <tr>
            ...
            <td style="width: 380px; font-weight: bold;">
                <asp:UpdatePanel ID="UpdatePanel42" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlPeachingType" runat="server" 
            ...
            <td>
                        <asp:UpdatePanel ID="UpdatePanel55" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlPackStyle" runat="server" AppendDataBoundItems="True" 
                                    CssClass="combobox" DataSourceID="dsPackingStyle" DataTextField="parameter" 
                                    DataValueField="parameter_code" AutoPostBack="True">
                                    <asp:ListItem></asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="dsPackingStyle" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="select parameter_code, parameter from jct_ops_multi_master
...
">
    ...
    <table class="tableback" style="width: 100%;">
        <tr>
            ...
            <td style="height: 12px; font-weight: bold; font-size: 8pt; text-align: right;">
                <asp:LinkButton ID="cmdReqFreshCost" runat="server" 
                    ValidationGroup="b">Request for Fresh Cost</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td style="height: 12px; font-weight: bold; font-size: 10pt; width: 150px;">
                ...
                <div>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="grdCosting" runat="server" EnableModelValidation="True" 
                                Width="100%" EmptyDataText="No Cost Sheet Available">
                                <AlternatingRowStyle CssClass="GridAI" />
                                <Columns>
                                    <asp:CommandField ShowSelectButton="True">
                                        <ItemStyle Width="40px" />
                                    </asp:CommandField>
                                    <asp:HyperLinkField DataNavigateUrlFields="Memo No,Sort/Enq,Finishing,Printing,DyeType,Peaching,Plant" 
                                        DataNavigateUrlFormatString="Quotation_Cost_Memo.aspx?memo_no={0}&amp;sort_no={1}&amp;finish={2}&amp;printing={3}&amp;dyetype={4}&amp;peaching={5}&amp;plant={6}" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                                DataSourceMode="DataReader" SelectCommand="jct_ops_get_cost_param" 
                                SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="txtItemCode" Name="sort" PropertyName="Text" 
                                        Type="String" />
                                    <asp:ControlParameter ControlID="lblEnqNo" Name="Enq" PropertyName="Text" 
                                        Type="Decimal" />
                                    <asp:ControlParameter ControlID="ddlFinish" Name="Finishing" 
                                        PropertyName="SelectedValue" DefaultValue=" " Type="String" />
                                    <asp:ControlParameter ControlID="ddlPrintingType" Name="Printing" 
                                        PropertyName="SelectedValue" DefaultValue=" " Type="String" />
                                    <asp:ControlParameter ControlID="ddlDyeType" DefaultValue=" " Name="DyeType" 
                        ...
                        <Triggers>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="ddlDyeType" 
                                EventName="SelectedIndexChanged" />
                            <asp:AsyncPostBackTrigger ControlID="ddlFinish" 
                                EventName="SelectedIndexChanged" />
                            <asp:AsyncPostBackTrigger ControlID="ddlPrintingType" 
                                EventName="SelectedIndexChanged" />
                            <asp:AsyncPostBackTrigger ControlID="ddlPackStyle" 
                                EventName="SelectedIndexChanged" />
                                <asp:AsyncPostBackTrigger ControlID="ddlPlant" 
                                EventName="SelectedIndexChanged" />
                                <asp:AsyncPostBackTrigger ControlID="ddlPeachingType" 
                                EventName="SelectedIndexChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ErrorMessage="Please Select Cost Sheet to Pick Cost" 
                    ControlToValidate="txtRawMaterial">*</asp:RequiredFieldValidator>
            </td>
            <td class="labelcells">
                Memo No.</td>
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtRawMaterial" runat="server" CssClass="textbox" 
                            Enabled="False" Columns="6"></asp:TextBox>
                    </ContentTemplate>
                    <Triggers>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtProcessing" runat="server" CssClass="textbox" 
                            Enabled="False" Columns="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSpinning" runat="server" CssClass="textbox" Enabled="False" 
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtFinishing" runat="server" CssClass="textbox" 
                            Enabled="False" Columns="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSizing" runat="server" CssClass="textbox" Enabled="False" 
                            Columns="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtWeaving" runat="server" CssClass="textbox" Enabled="False" 
                            Columns="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtPacking" runat="server" CssClass="textbox" Enabled="False" 
                            Columns="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSellingExp" runat="server" CssClass="textbox" 
                            Enabled="False" Columns="6"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
    ...
    <table class="tableback" style="width: 100%;">
        ...
        <tr>
            <td class="labelcells">
                (Calculated on basis of Cost Parameters)</td>
            <td style="font-weight: bold">
                &nbsp;</td>
            <td class="labelcells">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl="~/LabDipSystem/LabDipRequest.aspx" Target="_blank">Create LabDip Request</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="labelcells">
