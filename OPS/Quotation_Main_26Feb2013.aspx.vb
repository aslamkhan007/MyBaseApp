...
Partial Class OPS_Quotation_Main
    ...
    Protected Sub Get_Cost_Details(sort As String, memo_no As String, memo_dt As String, plant As String, finish As String, printing As String, dyetype As String) ', loom As String, customer As String)
        ...
        If dr.HasRows Then
            ...
            lblDnv.Text = Math.Round(dr("DnV_Cost"), 2).ToString
    ...
    Protected Sub ibtSave_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtSave.Click
        ...
        cmd.Parameters.Add("@BEHALF_SALEPERSON", SqlDbType.VarChar, 20)
        cmd.Parameters("@BEHALF_SALEPERSON").Value = ddlSalePerson.SelectedItem.Value
        ...
        Try
            ...
            If Trim(txtQuotationNo.Text) = "" Then
                email_msg = "Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Main.aspx?quot=" & cmd.Parameters("@Quot_No").Value & "'> " & cmd.Parameters("@Quot_No").Value & "</a> created successfully! Click on Quotation Number to view details."
            ElseIf lblQuotationNo.Text = cmd.Parameters("@Quot_No").Value Then
                email_msg = "Quotation # <a href = 'http://misdev/fusionapps/ops/Quotation_Main.aspx?quot=" & cmd.Parameters("@Quot_No").Value & "'> " & cmd.Parameters("@Quot_No").Value & "</a> saved successfully! Click on Quotation Number to view details."
            ...
            Try
                ...
                If dr.HasRows Then
                    dr.Read()
                    'sm.SendMail(dr("e_mailid").ToString(), "dummy@jctltd.com", msg + " <br/> " + Session("EmpName"), msg + " <br/> " + Session("EmpName"))
                    sm.SendMail(dr("e_mailid").ToString(), "noreply@jctltd.com", msg + " <br/> " + Session("EmpName"), email_msg + " <br/> " + Session("EmpName"))
                End If
                sm.SendMail("jagjit@jctltd.com", "noreply@jctltd.com", msg + " - " + Session("EmpName"), email_msg + " <br/> " + Session("EmpName"))
                sm.SendMail("nsaini@jctltd.com", "noreply@jctltd.com", msg + " - " + Session("EmpName"), email_msg + " <br/> " + Session("EmpName"))
                sm.SendMail("jagdeep@jctltd.com", "noreply@jctltd.com", msg + " - " + Session("EmpName"), email_msg + " <br/> " + Session("EmpName"))
                sm.SendMail("rbaksshi@jctltd.com", "noreply@jctltd.com", msg + " - " + Session("EmpName"), email_msg + " <br/> " + Session("EmpName"))
                sm.SendMail("harendra@jctltd.com", "noreply@jctltd.com", msg + " - " + Session("EmpName"), email_msg + " <br/> " + Session("EmpName"))
                'sm.SendMail("jagjit@jctltd.com", "dummy@jctltd.com", msg + " <br/> " + Session("EmpName"), msg + " <br/> " + Session("EmpName"))
                'sm.SendMail("jagdeep@jctltd.com", "dummy@jctltd.com", msg + " <br/> " + Session("EmpName"), msg + " <br/> " + Session("EmpName"))
        ...
        Catch ex As Exception
            ...
            sm.SendMail("jagdeep@jctltd.com", "noreply@jctltd.com", "Error Occurred while saving quotation" + " <br/> " + Session("EmpName"), ex.Message)
    ...
    Protected Sub SaveWarpWeftCountDetail(cn As Connection, tr As SqlTransaction, quot_no As String)
        ...
        For Each drow As GridViewRow In grdWarpWeft.Rows
            ...
            cmd.Parameters("@Sort_No").Value = Val(drow.Cells(1).Text)
            Dim code As String = drow.Cells(2).Text
            If code = "Weft" Then
                code = "F"
            End If
            cmd.Parameters("@code").Value = code
            cmd.Parameters("@count_no").Value = drow.Cells(3).Text
            cmd.Parameters("@act_count").Value = Val(drow.Cells(4).Text)
            cmd.Parameters("@count_name").Value = drow.Cells(5).Text
            cmd.Parameters("@blend").Value = drow.Cells(6).Text
            cmd.Parameters("@blend_perc").Value = drow.Cells(7).Text
            cmd.Parameters("@no_of_ends").Value = Val(drow.Cells(8).Text)
            cf = "0"
            Try
                cmd.ExecuteNonQuery()
            Catch ex As Exception
    ...
    Protected Sub txtQuotationNo_TextChanged(sender As Object, e As System.EventArgs) Handles txtQuotationNo.TextChanged
        ...
        Dim sql As String = "Select SALEPERSON from JCT_OPS_QUOTATION_BEHALF_OF_SALEPERSON where quotation='" + txtQuotationNo.Text + "' and Status='A'"
        If (obj1.CheckRecordExistInTransaction(sql)) Then
            item = ddlSalePerson.Items.FindByValue(obj1.FetchValue(sql))
            ddlSalePerson.SelectedValue = item.Value
        Else
            ddlSalePerson.SelectedIndex = 0
        End If
    End Sub
    ...
    Protected Sub ibtViewQuotation_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtViewQuotation.Click
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                'ddlDyeType.Items.FindByValue(dr("DyeType")).Selected = True
                'ddlFinish.Items.FindByValue(dr("FinishType")).Selected = True
                'ddlPrintingType.Items.FindByValue(dr("PrintingType")).Selected = True
                'ddlPackStyle.Items.FindByValue(dr("PackingType")).Selected = True
        ...
        If dr.HasRows Then
            ...
            lblMemoDate.Text = dr("Memo_Dt").ToString
    ...
    Protected Sub cmdReqExtCost_Click(sender As Object, e As System.EventArgs) Handles cmdReqExtCost.Click
        Dim sm As New SendMail
        Dim str As String = ""
        Dim body_to As String = "<p>Hello,</p><p> Please provide external/market cost detail for the given particulars<p><p>" & _
    ...
    Protected Sub cmdReqFreshCost_Click(sender As Object, e As System.EventArgs) Handles cmdReqFreshCost.Click
        ...
        Dim body_to As String = "<p>Hello,</p><p> Please provide fresh cost sheet for the given quality/particulars<p><p>" & _
                "Customer : " & lblCustomerName.Text & " (" & txtCustomerCode.Text & ")" & "<br/>" & _
                "Item Type : " & txtItemType.Text & "<br/>" & _
                "Sort No : " & txtItemCode.Text & "<br/>" & _
                "Enq. No : " & lblEnqNo.Text & "<br/>" & _
        ...
        If dr.HasRows Then
            ...
            Dim body_from As String = "<p>Hello, " & Session("EmpName") & "</p><p> Your request has been forwarded regrading fresh cost sheet for the given quality/particulars<p><p>" & _
                "Customer : " & lblCustomerName.Text & " (" & txtCustomerCode.Text & ")" & "<br/>" & _
                "Item Type : " & txtItemType.Text & "<br/>" & _
                "Sort No : " & txtItemCode.Text & "<br/>" & _
                "Enq. No : " & lblEnqNo.Text & "<br/>" & _
            ...
            sm.SendMail(dr("e_mailid").ToString(), "noreply@jctltd.com", "Request for Fresh Cost for Sort No : " & txtItemCode.Text, body_from)
