<%@ Page Title="" Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false"   CodeFile="Quotation_Main_New2.aspx.vb" Inherits="OPS_Quotation_Main"  MaintainScrollPositionOnPostback="false" %>
...
<%--            <td style="height: 12px; width: 380px;">
            ...
            <td class="labelcells" style="height: 12px">
              <%--  <asp:Label ID="lblTeamLeader" runat="server" Text="If other then specify"></asp:Label>--%>
            </td>
