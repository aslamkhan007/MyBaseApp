...
Dim cmd1 As SqlCommand = New SqlCommand(sqlstr, cn1.Connection)
        ...
        Try
		  ...
		  sqlstr = " select 'Attachments' AS Attachment ,RefDocActFileName AS AttachedFile from jct_ops_ref_docs where basedocno = '" & txtQuotationNo.Text & "' and status='A'"
...
        ibtViewQuotation_Click(sender, Nothing)
    ...
    Protected Function GetAttachments(quot_no As String) As Integer
        ...
        sql = "select isnull(count(*),0) from jct_ops_ref_docs where basedocno = '" & quot_no & "'"
