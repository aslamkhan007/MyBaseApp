...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;" class="tableback">
        ...
        <tr>
            ...
            <td class="labelcells">
               <asp:Label ID="lblsub" name="lblsub" runat="server" Visible="false"> Sub Sort No.</asp:Label></td>
            <td class="NormalText" valign="top" style="width: 83px">
             <asp:UpdatePanel ID="UpdatePanel90" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator03" runat="server" Enabled=false
...
where parent_category = 'printingtype'"></asp:SqlDataSource>
        ...
        <tr>
        <td><asp:Label runat="server" ID="sortdesc" name="sortdesc" Visible="false" > Sort Description</asp:Label></td>
        <td colspan="6">
