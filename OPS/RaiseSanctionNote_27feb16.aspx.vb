...
Partial Class OPS_RaiseSanctionNote
    ...
    Protected Sub cmdApply_Click(sender As Object, e As System.EventArgs) Handles cmdApply.Click
        ...
        Try
            ...
            '    NotifyEmailGroup=
            'End If
            GenrateMail(body, Body1, Body2, Body3, SanctionID, Genratedby_Email, Genratedby_Email, NotifyEmailGroup, "hitesh@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com,hiren@jctltd.com,sandeepr@jctltd.com", "Your SanctionNote No :-" & SanctionID & " has been genrated ")
