...
public partial class OPS_Re_Plan_PendingOrders : System.Web.UI.Page
{
    ...
    protected void lnkFetch_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@Category", SqlDbType.VarChar, 30).Value = ddlCategory.SelectedItem.Text;
    ...
    protected void lnkStop_Click(object sender, EventArgs e)
    {
        ...
        string orderType = Orderno.Text.Substring(Orderno.Text.Length - 2);
        ...
        {
            sql = "Update JCT_OPS_SHORTFALL_ORDER_REQUEST_AUTHORIZED set Completed='Y' , completed_by='"+ Session["EmpCode"].ToString() +"' where RequestID=" + ID.Text;
            obj1.UpdateRecord(sql);
            gridRow.Enabled = false;
            string script = "alert('Shortfall Closed. No More Sizing will be done..!!');";
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ServerControlScript", script, true);
        }
