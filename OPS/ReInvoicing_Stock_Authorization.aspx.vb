...
Partial Class OPS_ReInvoicing_Stock_Authorization
                    ...
                    If .SelectedIndex > -1 Then
                        If GrdRequestDEtails.SelectedRow.Cells(1).Text <> "" Or GrdRequestDEtails.Rows.Count >= 1 Then
                            ...
                            If AreaCode <> 9999 Then
                                ...
                                SendMailPage("", SendMailTo, AuthorizedBy, "Ashish@jctltd.com,jagdeep@jctltd.com,rbaksshi@jctltd.com", "SanctionNote :-" & SanctionNote & "  has been " & ddlAction.SelectedItem.Text & "", SanctionNote, CurrentUserLevel, MaxAuthLevel, FinalNotify, ddlAction.SelectedItem.Text)
                            End If
                            'RefreshLists()
    ...
    Private Sub SendMail(sb As StringBuilder, RaisedBy_Email As String, [to] As String, cc As String, bcc As String, Subject As String, SanctionNote As String, CurrentLevel As Int16, MaxLevel As Int16, NotifyAllList As String, Action As String)
        ...
        End Try
    End Sub
    Protected Function GetPage(page_name As String, SanctionNote As String) As String
        ...
        'currentPageUrl = "http://localhost:2987/FusionApps/OPS/Returned_Stock_Selling_Preview.aspx?SanctionID=" & SanctionNote
        ...
        currentPageUrl = "http://misdev/FusionApps/OPS/Returned_Stock_Selling_Preview.aspx?SanctionID=" & SanctionNote
    ...
    Private Sub SendMailPage(RaisedBy_Email As String, [to] As String, cc As String, bcc As String, Subject As String, SanctionNote As String, CurrentLevel As Int16, MaxLevel As Int16, NotifyAllList As String, Action As String)
        Try
            Dim sb As New StringBuilder()
            sb.AppendLine("ReInvoicing Request # " & SanctionNote & "</a> has been Authorised successfully.")
            sb.AppendLine(GetPage("Returned_Stock_Selling_Preview.aspx?SanctionID=" & SanctionNote, SanctionNote))
            Dim from As String
            If CurrentLevel < MaxLevel Then
                from = "noreply@jctltd.com"
            Else
            ...
            If [to].ToLower.ToString() = "rohits@jctltd.com" Then
                from = "approvals@jctltd.com"
            ...
            Dim mail As New MailMessage()
            mail.Subject = Subject '& " To " & SenderEmail & "or " & RaisedBy_Email & "cc " & cc & " all " & NotifyAllList
