    ...
    <div style="margin-top:0px; margin-right : auto; margin-left : auto;">
        ...
        <table style="border: thin none #000000; width:950px; margin-right : auto; margin-left : auto;" 
          ...
          <td colspan="4" style="font-size:small">
                    Authorization Remarks</td>
            </tr>
              <tr>
                <td colspan="4">
                    <asp:GridView ID="GridView3" runat="server" Width="100%" 
                        AutoGenerateColumns="False" BorderColor="Black" BorderStyle="Solid" 
                        BorderWidth="1px" DataSourceID="dsPayTerms0" 
                        EnableModelValidation="True">
                        <Columns>
                            <asp:BoundField DataField="SanctionID" HeaderText="SanctionID" ReadOnly="True" 
                                SortExpression="SanctionID" />
                            <asp:BoundField DataField="AuthorizedOn" HeaderText="AuthorizedOn" 
                                ReadOnly="True" SortExpression="AuthorizedOn" />
                            <asp:BoundField DataField="USERLEVEL" HeaderText="USERLEVEL" ReadOnly="True" 
                      ...
                      <asp:SqlDataSource ID="dsPayTerms0" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:misjctdev %>" 
                        SelectCommand="Jct_Ops_SanctionNote_Authrization_Detail" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                           
                            <asp:QueryStringParameter Name="SanctionNote" QueryStringField="SanctionID" 
                                Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    </td>
