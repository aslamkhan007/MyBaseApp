...
public partial class OPS_Sale_Order_Process_Track : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            lblDateTypeFrom.Text = radDDLPeriodBasis.SelectedItem.Text;
            lblDateTypeTo.Text = radDDLPeriodBasis.SelectedItem.Text;
        }
    }
    ...
    protected void radbtnFetch_Click(object sender, EventArgs e)
    {
        ...
        if (radDDLPeriodBasis.SelectedItem.Text == "Dispatch")
        { 
             sql = "jct_ops_get_sale_order_process_track";
        }
        else if (radDDLPeriodBasis.SelectedItem.Text == "Packing")
        {
            sql = "jct_ops_get_sale_order_packing_track";
        }
    ...
    protected void radDDLPeriodBasis_SelectedIndexChanged(object sender, Telerik.Web.UI.DropDownListEventArgs e)
    {
        if (radDDLPeriodBasis.SelectedItem.Text == "Dispatch")
        {
            lblDateTypeFrom.Text = radDDLPeriodBasis.SelectedItem.Text;
