...
Partial Class OPS_RaiseSanctionNote
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            qry = "Select 0 as [AreaCode],'--Select--' as [AreaName] Union SELECT AreaCode,AreaName FROM Jct_Ops_SanctioNote_Area_Master WHERE STATUS='A' and parentarea=1015 ORDER BY AreaName"
    ...
    Protected Sub imgRemoveItem_Click(sender As Object, e As System.EventArgs) Handles imgRemoveItem.Click
        ...
        CountItems = ChkDynamicListing.Items.Count - 1
        For i = 0 To CountItems
