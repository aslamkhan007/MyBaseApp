...
Partial Class OPS_RaiseSanctionNote
    ...
    'Dim upd As Upload = New Upload


    Protected Sub ddlarea_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlarea.SelectedIndexChanged
        'If (ddlarea.SelectedItem.Text = "GreighTransfer") Then

        '    Response.Redirect("SaleOrderAdjustment.aspx")
        'Else
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            qry = "Select 0 as [AreaCode],'--Select--' as [AreaName] Union SELECT AreaCode,AreaName FROM Jct_Ops_SanctioNote_Area_Master WHERE STATUS='A' and  areacode not in (1018,1019,1020,1021,1015) ORDER BY AreaName"
    ...
    Protected Sub cmdApply_Click(sender As Object, e As System.EventArgs) Handles cmdApply.Click
        ...
        Try
            ...
            qry = " exec Jct_Ops_SanctionNote_Insert_HDR '" & Session("Empcode") & "','" & ddlarea.SelectedItem.Value & "','" & txtSubject.Text & "','" & txtDescription.Text & "','" & Request.ServerVariables("REMOTE_ADDR") & "','" & SanctionID & "','" & ddlplant.SelectedItem.Text & "'"
            ...
            Body1 = Body1 & "<hr>"
            Body2 = "<Br><br> The Sanction Note is genrated by " & GenratedByName & " <Hr>"



            qry = "SELECT a.EmpCode,Empname FROM Jct_Ops_SanctioNote_Area_Emp_Auth_Listing a,jct_empmast_base b WHERE UserLevel=1 and GETDATE() BETWEEN Eff_From AND Eff_To AND STATUS='A' and AreaCode='" & ddlarea.SelectedItem.Value & "' and a.EmpCode=b.empcode "
            cmd = New SqlCommand(qry, obj.Connection)
            dr = cmd.ExecuteReader
            dr.Read()
            If dr.HasRows Then
                Genratedby_Email = Genratedby_Email & "," & dr.Item(0)
            ...
            ''GenrateMail(body, Body1, Body2, Body3, SanctionID, Genratedby_Email, Genratedby_Email, "harshsoni@jctltd.com", "Ashish@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com", "Your SanctionNote No :-" & SanctionID & " has been genrated ")
    ...
    Protected Sub cmdReset_Click(sender As Object, e As System.EventArgs) Handles cmdReset.Click
        ...
        'FlashUpload1.
        If Not Directory.Exists("c:\a") = True Then
