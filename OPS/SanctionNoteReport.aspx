...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                            SelectCommand="Select '' as AreaName,0 as AreaCode Union Select 'JobWork' as AreaName,'1057' as AreaCode Union SELECT AreaName,AreaCode FROM Jct_Ops_SanctioNote_Area_Master WHERE STATUS='A' AND AreaCode NOT IN (1015,1018,1019,1020,1021,1022,1024,1023,1026,1027,1029) ORDER BY AreaName ASC">
                        </asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            ...
            <td class="NormalText">
                        <asp:LinkButton ID="lnkReset0" runat="server" CssClass="buttonPrint" 
                    BorderStyle="None" onclick="lnkReset0_Click"></asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td class="NormalText" style="width: 147px">
            ...
            <td class="NormalText" style="width: 100px">
                <asp:Label ID="Label23" Visible="false" runat="server" Text="Authorized By"></asp:Label>
            </td>
            <td class="NormalText" colspan="2">
                <asp:DropDownList Visible="false" ID="ddlAuthBy" runat="server" CssClass="combobox">
                    <asp:ListItem Selected="True"></asp:ListItem>
        ...
        <tr>
            ...
            <td class="NormalText" style="width: 124px">
                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtRequestBy" runat="server" CssClass="textbox" 
                            AutoPostBack="True" ontextchanged="txtRequestBy_TextChanged"></asp:TextBox>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkSummary" runat="server" CssClass="buttonc" Visible="False"
                            OnClick="lnkSummary_Click">Summary</asp:LinkButton>
                             <asp:LinkButton ID="lnkSanctionSumaary" runat="server" CssClass="buttonc" 
                            onclick="lnkSanctionSumaary_Click"   >Summary</asp:LinkButton>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="pnlMaster" runat="server">
                            <asp:GridView ID="grdMaster" runat="server" EnableModelValidation="True" Width="100%"
                              ...
                              <asp:GridView ID="GridSummary" runat="server" EnableModelValidation="True" Width="100%"
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="lnkSummary" EventName="Click" />
                          <asp:AsyncPostBackTrigger ControlID="lnkSanctionSumaary" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
            ...
            <asp:Panel ID="pnlGrdAuth" runat="server" Visible="false">
                <table style="width: 100%;" class="tableback">
                  ...
                  <table style="width: 100%;" class="tableback">
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="Sanction Note Conversation" Font-Bold="True"
                                Font-Size="10pt"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:GridView ID="GrdConversation" runat="server" Width="100%" EnableModelValidation="True"
                                AutoGenerateColumns="true">
