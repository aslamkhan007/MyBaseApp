...
public partial class OPS_SellingPrice_Vs_DnV : System.Web.UI.Page
{
    ...
    {
        grdDetail.ExportSettings.ExportOnlyData = true;
        grdDetail.ExportSettings.IgnorePaging = true;
        grdDetail.ExportSettings.UseItemStyles = true;
        grdDetail.ExportSettings.OpenInNewWindow = true;
