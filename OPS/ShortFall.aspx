    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <asp:GridView ID="grdDetail" runat="server" AutoGenerateSelectButton="True"
                    ...
                    AllowPaging="True" 
                    PageSize="15" onpageindexchanging="grdDetail_PageIndexChanging">
        ...
        <tr>
            <td class="NormalText" style="width: 140px">
                <asp:Label ID="Label29" runat="server" Text="Damaged Goods Lying At"></asp:Label>
            </td>
            <td class="NormalText" style="width: 170px">
                <asp:DropDownList ID="ddlDamage" runat="server" AutoPostBack="True" 
                    CssClass="combobox">
                    <asp:ListItem Selected="True"></asp:ListItem>
                    <asp:ListItem>Process House</asp:ListItem>
                    <asp:ListItem>Folding</asp:ListItem>
                </asp:DropDownList>


                 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                            ControlToValidate="ddlDamage" ErrorMessage="**" ValidationGroup="A"></asp:RequiredFieldValidator>
