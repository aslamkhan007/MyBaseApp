    ...
    private void SendMailToPlanning(String Body, String OrderNo, String SalesPerson_Email)
    {
        ...
        sql = "SELECT DISTINCT Upper(LOCATION) as Location FROM dbo.jct_ops_planning_order WHERE order_no='" + OrderNo + "' AND status ='A' and location is not null Union SELECT Upper(Plant) as Location FROM production..jct_process_issue_finish_folding WHERE plant is not null and po_number='" + OrderNo + "'";
            ...
            if (Plant == "COTTON")
            {
                ...
                {
                    to = "neeraj@jctltd.com,chandermohan@jctltd.com,santoshkumar@jctltd.com,karanjitsaini@jctltd.com,rashpal@jctltd.com,rahuljindal@jctltd.com,kvsmurty@jctltd.com,vinaypuri@jctltd.com,sukhvendersingh@jctltd.com,bipansharma@jctltd.com,nandksharma@jctltd.com";   //Email Address of Receiver
                }
                else
                {
                    to = "neeraj@jctltd.com,chandermohan@jctltd.com,santoshkumar@jctltd.com,karanjitsaini@jctltd.com,rashpal@jctltd.com,rahuljindal@jctltd.com,kvsmurty@jctltd.com,vinaypuri@jctltd.com,sukhvendersingh@jctltd.com,bipansharma@jctltd.com,nandksharma@jctltd.com," + SalesPerson_Email;   //Email Address of Receiver
                }
                
                bcc = "jatindutta@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com";
                cc = "sobti@jctltd.com,rkkapoor@jctltd.com,sudhirarora@jctltd.com,rajivmehra@jctltd.com,arvindsharma@jctltd.com";
            ...
            else if (Plant == "TAFFETA")
            {
                ...
                to = "trivendermehta@jctltd.com,umeshrana@jctltd.com,nandi@jctltd.com,pillai@jctltd.com,ramanbehal@jctltd.com," + SalesPerson_Email;   //Email Address of Receiver
