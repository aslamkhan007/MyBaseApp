                                                ...
                                                <tr>
                                                    ...
                                                    <td width="150px" style="width: 350px">
                                                        <asp:TextBox ID="txtSearchCustomer" runat="server" AutoPostBack="True" CssClass="textbox"
                                                            Width="200px" 
                                                            ToolTip="Please give Customer Code or Select Customer from the List "></asp:TextBox>
                                                        ...
                                                        &nbsp;<asp:LinkButton ID="CmdSearchCust0" runat="server" 
                                                            CssClass="searchbluesmall" Height="17px"
