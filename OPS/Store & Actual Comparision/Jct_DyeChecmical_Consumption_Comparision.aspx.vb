...
Partial Class OPS_Jct_DyeChecmical_Consumption_Comparision
    ...
    Protected Sub CmdFetch_Click(sender As Object, e As System.EventArgs) Handles CmdFetch.Click
        ...
        If chkIgnoreDate.Checked = True Then
            Qry = "exec Jct_Ops_SubStore_Issue_Vs_Actual '01/01/2001','01/01/2011','" & txtOrderNo.Text & "','Y'," & Optn & " "
        Else
            Qry = "exec Jct_Ops_SubStore_Issue_Vs_Actual '" & txtEffecFrom.Text & "','" & txtEffecTo.Text & "','" & txtOrderNo.Text & "','N'," & Optn & " "
        End If
        Con.Open()
