...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td class="tableheader" colspan="6">
                <asp:Label ID="Label5" runat="server" Text="OPS HelpDesk"
                   ></asp:Label>
            </td>
        </tr>
        <tr>
    ...
    <table width="100%">
        <tr>
            <td >
                <asp:Panel ID="Panel4" runat="server" Visible="False">
                    <table width="100%">
                        <tr>
                            <td colspan="5" class="buttonbackbar" style="text-align: left">
                                <asp:Label ID="Label81" runat="server" Text="Transaction Detail" Width="288px" 
                    Visible="False"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelcells" >
                                <asp:Label ID="Label82" runat="server" Text="TranType" Visible="False"></asp:Label>
                            </td>
                            <td class="textcells">
                                <asp:DropDownList ID="DrpTranType" runat="server" CssClass="combobox" 
                    Width="88px" Visible="False">
                                    <asp:ListItem>Invoice</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td class="labelcells" >
                                <asp:Label ID="Label83" runat="server" Text="TransNo" Visible="False"></asp:Label>
                            </td>
                            <td class="textcells">
                                <asp:TextBox ID="txtTransNo" runat="server" CssClass="textbox" Width="176px" 
                    Visible="False"></asp:TextBox>
                            </td>
                            <td class="labelcells" >
                                <asp:Button ID="cmdFetch" runat="server" CssClass="ButtonBack" 
                    Text="Fetch Detail" BackColor="Black" Visible="False" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
        ...
        <tr>
            <td class="labelcells" >
                <ew:CollapsablePanel ID="PnlGrid" runat="server" CollapseImageUrl="Image/UPARROW.JPG"
                    ...
                    SlideSpeed="50" Width="685px" CssClass="panelcells" Visible="False">
        ...
        <tr>
            ...
            <asp:Label ID="Label4" runat="server" Text="Task Assigned To" Width="202px"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <ew:CollapsablePanel ID="PnlRec" runat="server" CollapseImageUrl="Image/UPARROW.JPG"
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="cmdCC" runat="server" Text="CC" CssClass="ButtonBack" BackColor="Black" />
                            </td>
                            <td colspan="4">
