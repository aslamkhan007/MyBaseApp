            ...
            <td>
                ...
                <asp:GridView ID="grdAuthorisedQuotes" runat="server" 
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton3" runat="server" 
                                    CommandArgument='<%# Eval("Quotation No" ) %>' CommandName="RequestSO" 
                                    ImageUrl="~/Image/Icons/Action/Make_SO_icon_sm.png" 
                                    ToolTip="Request Sale Order for this Quotation" Visible='<%# Eval("ReqSO") %>' 
                                    Width="18px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ShowHeader="False" Visible="False">
                        ...
                        <asp:BoundField DataField="Req_SO" HeaderText="SO_Req" />
                        <asp:BoundField DataField="Customer" HeaderText="Customer" 
                            SortExpression="Customer" >
                        <HeaderStyle Wrap="False" />
                        <ItemStyle Wrap="False" />
