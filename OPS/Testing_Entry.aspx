<%@ Page Title="" Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true"
    CodeFile="Testing_Entry.aspx.vb" Inherits="OPS_Testing_Entry"  MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td rowspan="1" width="60%" valign="top">
                <asp:UpdatePanel ID="UpdatePanel19" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlTestType" runat="server" ValidationGroup="ValidGrpSaveDetail"
                            CssClass="combobox">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>Chemical</asp:ListItem>
                            <asp:ListItem>Physical</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlTestType"
        ...
        <tr>
            ...
            <td width="60%" valign="top">
                <asp:UpdatePanel ID="UpdatePanel22" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlProcess" runat="server" CssClass="combobox" Width="200px"
                            AutoPostBack="True">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
        ...
        <tr>
            <td class="NormalText" valign="top" colspan="4">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel18" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtBatchNo" runat="server" CssClass="textbox" MaxLength="5" Width="50px"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="BatchNo_FilteredTextBoxExtender" runat="server"
                                        Enabled="True" TargetControlID="txtBatchNo" ValidChars="0123456789DUMMYdummy">
                                    </cc1:FilteredTextBoxExtender>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="txtOrderNo" EventName="TextChanged" />
                                    <asp:AsyncPostBackTrigger ControlID="GrdOrderDetails" EventName="SelectedIndexChanged" />
                                    <asp:AsyncPostBackTrigger ControlID="GrdSavedRecords" 
                                        EventName="SelectedIndexChanged" />
                                </Triggers>
                            </asp:UpdatePanel>
             ...
             <%-- <div id="Div2" class="container" style="width: 89%; height: 198px;">--%>
                    <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Panel ID="Pnl" runat="server" Height="200px" ScrollBars="both" Width="95%">
                             <%--   <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>--%>
                                        <asp:GridView ID="GrdOrderDetails" runat="server" AutoGenerateSelectButton="True"
                                            Width="98%">
    ...
    <table style="width: 100%;" class="tableback">
        <tr>
            ...
            <td colspan="1">
                <asp:UpdatePanel ID="UpdatePanel15" runat="server" RenderMode="Inline" 
                    ...
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlLineNo" runat="server" AutoPostBack="True" CssClass="combobox">
                        </asp:DropDownList>
            ...
            <td valign="top">
                <asp:UpdatePanel ID="UpdatePanel16" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="GrdOrderDetails" 
                            EventName="SelectedIndexChanged" />
                        <asp:AsyncPostBackTrigger ControlID="ddlLineNo" 
                            EventName="SelectedIndexChanged" />
                             <asp:AsyncPostBackTrigger ControlID="GrdSavedRecords" 
                            EventName="SelectedIndexChanged" />
                    </Triggers>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTestConductedBy"
                            Display="Dynamic" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="ValidGrpSaveDetail"></asp:RequiredFieldValidator>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td valign="top">
        ...
        <tr>
            <td class="NormalText">
                Any Remark(for this reason)
            </td>
            <td class="NormalText" colspan="2">
                <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSplRemark" runat="server" CssClass="textbox" MaxLength="150"
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="NormalText">
                <asp:Panel ID="Panel2" runat="server" Height="200px" Width="100%" ScrollBars="None">
                    <div id="AdjResultsDiv11" class="container" style="width: 100%; height: 198px;">
                        <asp:UpdatePanel ID="UpdatePanel17" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="GrdSavedRecords" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BatchNo" HeaderText="BatchNo" SortExpression="BatchNo" />
                                         <asp:BoundField DataField="ProdSerialNo" HeaderText="Serial" SortExpression="Serial" />
                                    </Columns>
                                    <HeaderStyle CssClass="GridHeader" />
                                    <RowStyle CssClass="GridItem" />
                                    <SelectedRowStyle CssClass="GridRowGreen" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jctdevConnectionString %>"
                                    SelectCommand="SELECT  OrderNo,LineItem,SortNo,Shade,TestConductedBy,b.empname AS EmpName,convert(varchar(10),TestConductedOn,101) as TestConductedOn ,MetersTested as MtrsTested ,Result ,Reason ,Remarks ,convert(varchar(10),CreatedDate,101) as CreatedDate ,TransID,BatchNo,ProdSerialNo FROM Jct_Ops_QA_Feedback_Entry a,dbo.JCT_EmpMast_Base b WHERE STATUS='A' AND Active='Y' AND a.TestConductedBy=b.empcode order by transID desc"
