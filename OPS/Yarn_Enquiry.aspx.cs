...
public partial class OPS_Yarn_Enquiry : System.Web.UI.Page
{
    ...
    protected void grdDetail_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select distinct vendername from jct_ops_yarn_mat_tb  where requestid=@requestid", con);
    ...
    private void sendmail()
    {
        ...
        sb.Append("<a href='http://testerp/FusionApps/OPS/yarn_approvals.aspx'> Click here  to select the vendors.!! </a><br />");
        ...
        to = ViewState["sendtoEmail"].ToString() + "," + ViewState["RequestByEmail"].ToString() + ",dpbadhwar@jctltd.com";
