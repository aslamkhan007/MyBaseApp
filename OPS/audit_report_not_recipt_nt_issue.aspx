<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="audit_report_not_recipt_nt_issue.aspx.cs" Inherits="OPS_audit_report_po_grpwise_reciept" %><%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table class="mytable">
    <tr>
        <td class="tableheader" colspan="4">
            Stock Not Receipt/Issued</td>
    </tr>
    </table>
   <table class="mytable">
    <tr>
        ...
        <td style="width: 214px">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="txtdatefrm" ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
        ...
        <td class="BoundColumn_long" style="width: 124px">
            Date To</td>
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ControlToValidate="txtdateto" ErrorMessage="*"></asp:RequiredFieldValidator>
