...
public partial class OPS_audit_report_po_grpwise_reciept : System.Web.UI.Page
{
    ...
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        ...
        {
            Panel1.Visible = true;
            SqlCommand cmd = new SqlCommand("jct_inv_neither_receipt_nor_issue",obj.Connection());
            //con.Open();
