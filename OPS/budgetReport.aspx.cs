...
{
    SqlConnection obj = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["misjctgen"].ConnectionString);
    ...
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd =  new SqlCommand("jct_ops_budget_report_new",obj);
        ...
        //if (!string.IsNullOrEmpty(txtIndentorCode.Text))
        //{
        //    cmd.Parameters.Add("@indentor_code", SqlDbType.VarChar, 10).Value = txtIndentorCode.Text.Split('|')[1].ToString().Split('~')[0].ToString();
        //}
