...
public partial class OPS_classimat_test : System.Web.UI.Page
{
   // SqlConnection con = new SqlConnection(@"Data Source=TEST2K;Initial Catalog=Trainee;User ID=trainee ;password=trainee");
    ...
    private void SendMail_classimat()
    {
        ...
        sb.AppendLine("<tr><th> Count td</th> <th>Date</th> <th> Source</th> <th> Length (kms)</th> <th> Weight (kgs)</th>  <th> AllFaultPerKg (A1+A2+A3+A4+ B1+B2+B3+B4+ C1+C2+C3+C4+ D1+D2+D3+D4)</th>  <th>Major objectionable Short Thick   (A4+B4+C3+C4+D3+D4)</th> <th>Objectionable  Short Thick  (A3+B3+C2+D2)</th> <th> LongShotThick (E+F+G)</th> <th> ThinFault (H1)</th> <th>MajorThinFault (H2+I1+I2)</th><th> MachineNo</th> <th>Remarks</th></tr> ");
       ...
       //     {
        ...
        to = "sanjeevkumar@jctltd.com,rameshd@jctltd.com,rd@jctltd.com,kartarsingh@jctltd.com,arwinder@jctltd.com";
        //to = "jatindutta@jctltd.com";
       // string bcc = "shweta@jctltd.com";
        string bcc = "shweta@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com";
