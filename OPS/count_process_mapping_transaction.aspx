    ...
    <table style="width: 111%; height: 342px;">
        ...
        <tr>
            <td style="height: 2px;" colspan="7">
                <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" Height="187px" 
                    Width="728px">
                    <div ID="AdjResultsDiv">
                        <asp:UpdatePanel ID="UpdatePanel25" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="GridView2" runat="server" Font-Bold="False" 
                                    AutoGenerateColumns="True" CssClass="labelcells">
                                    <HeaderStyle CssClass="GridHeader" />
                                </asp:GridView>
                            </ContentTemplate>
                        </asp:UpdatePanel>
