...
Imports System.Math
Partial Class Costing_fibre_type_master
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            sqlpass = "/*select b.action,b.mnuname,b.description,b.parent_menu,b.seq " & _
                ...
                " where a.module ='OPS' and a.uname='" & Session("empcode") & "' and a.mnuname='fibre type master'" & _
                ...
                "and a.mnuname='fibre type master' and a.action<>'Load'" & _
            ...
            '-----Fill GridView1
            sqlpass = "exec jct_costing_fibre_type_master_fetch_all '" & _
                    LTrim(RTrim(Me.ddl_action.Text)) & "','" & _
                    LTrim(RTrim(Me.ddl_main_fibre_code.Text)) & "','" & _
                    Left(LTrim(RTrim(Me.ddl_sub_fibre_code.Text)), 3) & "','" & _
    ...
    Protected Sub ddl_action_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_action.SelectedIndexChanged
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            If Me.lbt_add.Text = "ADD" Then
                ...
                Me.txt_main_fibre_code.Enabled = True
                Me.txt_main_fibre_desc.Enabled = True
                'Me.txt_main_fibre_desc.Text = ""

                Me.ddl_sub_fibre_code.Enabled = True
                Me.txt_sub_fibre_code.Enabled = True
                Me.txt_sub_fibre_desc.Enabled = True
                'Me.txt_sub_fibre_desc.Text = ""

                Me.imb_newcode.Enabled = True

                Me.txt_main_fibre_seqno.Enabled = True
                Me.txt_sub_fibre_seqno.Enabled = True
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "VIEW" Then
            ...
            Me.ddl_main_fibre_code.Enabled = True
            Me.txt_main_fibre_code.Enabled = False
            Me.txt_main_fibre_desc.Enabled = False
            'Me.txt_main_fibre_desc.Text = ""

            Me.ddl_sub_fibre_code.Enabled = True
            Me.txt_sub_fibre_code.Enabled = False
            Me.txt_sub_fibre_desc.Enabled = False
            'Me.txt_sub_fibre_desc.Text = ""

            Me.imb_newcode.Enabled = False

            Me.txt_main_fibre_seqno.Enabled = False
            Me.txt_sub_fibre_seqno.Enabled = False
    ...
    Protected Sub lbt_apply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbt_apply.Click
        ...
        If LTrim(RTrim(Me.txt_main_fibre_desc.Text)) = "" Then
            FMsg.Message = "Pl. enter Main Fibre Desc. "
            FMsg.CssClass = "errormsg"
            FMsg.Display()
            Me.txt_main_fibre_desc.Focus()
            Exit Sub
        End If
        ...
        If LTrim(RTrim(Me.txt_sub_fibre_desc.Text)) = "" Then
            FMsg.Message = "Pl. enter Sub Fibre Desc. "
            FMsg.CssClass = "errormsg"
            FMsg.Display()
            Me.txt_sub_fibre_desc.Focus()
            Exit Sub
        End If

        'If LTrim(RTrim(Me.txt_main_sequence_no.Text)) = "" Then
        '    FMsg.Message = "Pl. enter Main Seq. No. "
        '    FMsg.CssClass = "errormsg"
        '    FMsg.Display()
        '    Me.txt_main_sequence_no.Focus()
        '    Exit Sub
        'End If
        ...
        Else
            FMsg.Message = "Something wromg in Effective From/To Date"
            FMsg.CssClass = "errormsg"
            FMsg.Display()
            Me.txt_efffrom.Focus()
            dr.Close()
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            sqlpass = "select tran_no,isnull(status,'') " & _
                    "from jct_costing_fibre_type_master " & _
                    "where main_fibre_code='" & LTrim(RTrim(Me.ddl_main_fibre_code.Text)) & "' " & _
            ...
            Try
                ...
                If dr.HasRows = True Then
                    ...
                    If greater = "N" Then
                        ...
                        If same = "Y" Then
                            ...
                            Exit Sub
                        Else
                            sqlpass = "update jct_costing_fibre_type_master set eff_to=convert(datetime,'" & efrom & "')-1 " & _
                                    "where main_fibre_code='" & LTrim(RTrim(Me.ddl_main_fibre_code.Text)) & "' " & _
                                    "and sub_fibre_code='" & LTrim(RTrim(Me.ddl_sub_fibre_code.Text)) & "' " & _
                ...
                sqlpass = "exec jct_costing_fibre_type_master_entry '" & _
                            LTrim(RTrim(Me.ddl_action.Text)) & "'," & _
                            sno1 & ",'" & Now() & "','" & _
        ...
        If (UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "CANCEL" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "SHORT CLOSE" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "AUTHORIZE") Then
            ...
            Try
                ...
                sqlpass = "select case isnull(a.status,'') when 'O' then 'OPEN' when 'A' then 'AUTHORIZE' when 'C' then 'CANCEL' when 'S' then 'DELETE' when 'F' then 'FINISH' end " & _
                    "from jct_costing_fibre_type_master a " & _
                ...
                If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Then
                    ...
                    sqlpass = "delete from jct_costing_fibre_type_master " & _
                            "where tran_no='" & LTrim(RTrim(Me.txt_tranno.Text)) & "' " & _
                            "and left(status,1)='O' " & _
                            "and company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "' "
    ...
    Protected Sub txt_main_fibre_code_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_main_fibre_code.TextChanged

        Me.txt_main_fibre_desc.Text = ""

        If LTrim(RTrim(Me.txt_main_fibre_code.Text)) <> "" And UCase(Me.ddl_action.Text) = "ADD" Then

            Dim i As Integer

            Me.txt_main_fibre_code.Text = UCase(Me.txt_main_fibre_code.Text)

            For i = 0 To Me.ddl_main_fibre_code.Items.Count() - 1
                ''GridView1.Rows.Count - 1
                If LTrim(RTrim(Me.txt_main_fibre_code.Text)) = LTrim(RTrim(Me.ddl_main_fibre_code.Items(i).Text)) Then
                    FMsg.Message = "Main Fibre Code already exists "
                    FMsg.CssClass = "errormsg"
                    FMsg.Display()
                    Me.txt_main_fibre_code.Focus()
                    Exit Sub
                End If
            Next

            'Me.ddl_main_fibre_code.Items.Add(LTrim(RTrim(Me.txt_process_location_code.Text)))
            'Me.ddl_main_fibre_code.Text = Me.txt_main_fibre_code.Text

        End If

    End Sub

    Protected Sub txt_sub_fibre_code_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_sub_fibre_code.TextChanged

        Me.txt_sub_fibre_desc.Text = ""

        If LTrim(RTrim(Me.txt_sub_fibre_code.Text)) <> "" And UCase(Me.ddl_action.Text) = "ADD" Then

            Dim i As Integer

            Me.txt_sub_fibre_code.Text = UCase(Me.txt_sub_fibre_code.Text)

            For i = 0 To Me.ddl_sub_fibre_code.Items.Count() - 1
                ''GridView1.Rows.Count - 1
                If LTrim(RTrim(Me.txt_sub_fibre_code.Text)) = LTrim(RTrim(Me.ddl_sub_fibre_code.Items(i).Text)) Then
                    FMsg.Message = "Sub Fibre Code already exists "
                    FMsg.CssClass = "errormsg"
                    FMsg.Display()
                    Me.txt_sub_fibre_code.Focus()
                    Exit Sub
                End If
            Next

            'Me.ddl_sub_fibre_code.Items.Add(LTrim(RTrim(Me.txt_sub_fibre_code.Text)))
            'Me.ddl_sub_fibre_code.Text = Me.txt_sub_fibre_code.Text

        End If

    End Sub

    Protected Sub imb_newcode_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_newcode.Click
        ...
        If LTrim(RTrim(Me.txt_main_fibre_code.Text)) <> "" And UCase(Me.ddl_action.Text) = "ADD" Then
            ...
            Me.ddl_main_fibre_code.Items.Add(LTrim(RTrim(Me.txt_main_fibre_code.Text)))
            Me.ddl_main_fibre_code.Text = Me.txt_main_fibre_code.Text

            Me.txt_main_fibre_code.Text = ""

            Me.txt_main_fibre_desc.Text = Me.txt_main_fibre_desc.Text
            'Me.txt_main_fibre_desc.Text = ""
        ...
        If LTrim(RTrim(Me.txt_sub_fibre_code.Text)) <> "" And UCase(Me.ddl_action.Text) = "ADD" Then
            ...
            Me.txt_sub_fibre_code.Text = ""

            Me.txt_sub_fibre_desc.Text = Me.txt_sub_fibre_desc.Text
            'Me.txt_sub_fibre_desc.Text = ""
    ...
    Protected Sub imb_tran_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_tran_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "VIEW" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "CANCEL" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "SHORT CLOSE" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "AUTHORIZE" Then
            ...
            sqlpass = "select top 1 a.tran_no, a.main_fibre_code," & _
                    "a.main_fibre_desc, a.main_sequence_no, " & _
                    "a.sub_fibre_code, a.sub_fibre_desc, a.sub_sequence_no, " & _
            ...
            If dr.HasRows = True Then
                ...
                Me.ddl_main_fibre_code.Text = dr.Item(1)
                Me.txt_main_fibre_desc.Text = dr.Item(2)
                Me.txt_main_fibre_seqno.Text = dr.Item(3)
                Me.ddl_sub_fibre_code.Text = dr.Item(4)
                Me.txt_sub_fibre_desc.Text = dr.Item(5)
                Me.txt_sub_fibre_seqno.Text = dr.Item(6)
