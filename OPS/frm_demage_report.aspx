<%@ Page Language="VB" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="false" CodeFile="frm_demage_report.aspx.vb" Inherits="frm_demage_report"Title="Untitled Page" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    <table style="width:100%;" >
        ...
        <tr>
            <td class="NormalText" style="width: 104px">
                <asp:Label ID="label14" runat="server" CssClass=" " Text="WareHouse" 
                        ...
                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlwarehouse" runat="server" 
                                    ...
                                    <asp:ListItem>FSY</asp:ListItem>
                                    <asp:ListItem>GWT</asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
            ...
            <td class="NormalText" style="width: 117px" >
                <asp:Label ID="label15" runat="server" CssClass=" " Text="Damage Origin" 
                    style="text-align: left"></asp:Label>
            </td>
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlorigin" runat="server" 
                            CssClass="combobox" Width="80px" Height="18px">
                            <asp:ListItem>All</asp:ListItem>
                            <asp:ListItem>PRP</asp:ListItem>
                            <asp:ListItem>SPG</asp:ListItem>
                            <asp:ListItem>WVG</asp:ListItem>
                            <asp:ListItem>YRN</asp:ListItem>
                        </asp:DropDownList>
                    </ContentTemplate>
