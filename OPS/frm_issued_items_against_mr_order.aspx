...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    ImageUrl="~/Image/loading.gif" Height="12px" Width="102px" />
        ...
        <tr>
            <td style="height: 4px;" colspan="10">
                                ...
                                <EmptyDataTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="confirmed_qty_in_stock_uom" 
                                            DataFormatString="{0:N3}" HeaderText="Issue Qty." 
                                            SortExpression="confirmed_qty_in_stock_uom" />
                                        <asp:BoundField DataField="value" DataFormatString="{0:N2}" HeaderText="Issue Value" 
                                        ...
                                        <asp:BoundField DataField="process_qty" HeaderText="Process Qty." />
