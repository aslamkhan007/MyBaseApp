...
Partial Class OPS_frm_issued_items_against_mr_order
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            sqlpass = "select distinct order_no " & _
                    ...
                    "and len(ltrim(rtrim(isnull(order_no,'')))) = 15 " & _
    ...
    Protected Sub imb_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_fetch.Click
        ...
        sqlpass = "select * from jct_ops_ims_issued_items_against_sales_order " & _
                    "where userid = '" & UCase(LTrim(RTrim(Session("empcode")))) & "' " & _
                    "and company_code = '" & UCase(LTrim(RTrim(Session("companycode")))) & "' " & _
                    "order by order_no, sort_no, issue_date, issue_no, li_no "
