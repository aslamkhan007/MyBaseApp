    ...
    ImageUrl="~/Image/loading.gif" Height="12px" Width="102px" />
        ...
        <tr>
            <td style="height: 4px;" colspan="5">
                <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" Height="200px" 
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="confirmed_qty_in_stock_uom" HeaderText="Qty." 
                                            SortExpression="confirmed_qty_in_stock_uom" DataFormatString="{0:N3}" />
                                        <asp:BoundField DataField="value" HeaderText="Value" 
                                            SortExpression="value" DataFormatString="{0:N2}" />
