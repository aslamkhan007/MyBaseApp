...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <link rel="stylesheet" type="text/css" href="../stylesheets/stylesheet.css" />
    ...
    <table style="width:100%; height: 67px;">
        <tr>
            ...
            <td colspan="2" style="height: 36px">
                            ...
                            <asp:LinkButton ID="lnk_print" runat="server" CssClass="buttonc" 
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" 
                    PostBackUrl="file://test2k/Substore/store.application" Visible="False">Print</asp:LinkButton>
            </td>
            <td colspan="2" style="height: 36px">
                &nbsp;</td>
        </tr>
        ...
        <tr>
            <td style="height: 6px" colspan="5" align="center">
                <asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl="file://test2k/Substore2/store.application">Print</asp:HyperLink>
            </td>
            <td style="height: 6px; width: 168px">
                &nbsp;</td>
        </tr>
    ...
    <table style="width:96%; height: 312px;" class="tableback">
                            ...
                            <asp:TemplateField HeaderText="Reqd.Qty.">
                                <ItemTemplate>
                                    ...
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" 
                                        TargetControlID="txt_move_qty" ValidChars="0123456789.-">
        ...
        <tr>
            <td style="height: 6px" colspan="6" align="left">
                <asp:UpdatePanel ID="UpdatePanel14" runat="server" Visible="true">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnk_next" runat="server" CssClass="buttonc" Visible="False">Next</asp:LinkButton>
                        <asp:LinkButton ID="lnk_previous" runat="server" CssClass="buttonc" 
