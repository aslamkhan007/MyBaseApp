...
Partial Class OPS_frm_items_movement_before_transaction
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'txtPoNo.Attributes.Add("onkeypress", "return clickButton(event,'" + CmdPO.ClientID + "')")
            ...
            ' txt_variant.Attributes.Add("onkeydown", "if(event.which || event.keyCode){if ((event.which == 13) || (event.keyCode == 13)) {document.getElementById('" + lnk_variant_fetch.UniqueID + "').click();return false;}} else {return true}; ")
            '   txt_variant.Attributes.Add("onkeydown", "if(event.which || event.keyCode){if ((event.which == 13) || (event.keyCode == 13)) {document.getElementById('" + lnk_variant_fetch.UniqueID + "').click();return false;}} else {return true}; ")
            ...
            Me.lnk_add_Click(sender, e)  '' set add mode at page loading time
    ...
    Protected Sub lnk_view_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnk_view.Click
        ...
        Me.imb_grupr_no_fetch.Enabled = False
        Me.txt_grupr_no.Enabled = False
        Me.txt_grupr_no.Text = ""

        Me.imb_itemcode_fetch.Enabled = False
        Me.txt_itemcode.Enabled = False
        Me.txt_itemcode.Text = ""

        Me.imb_variant_fetch.Enabled = False
        Me.txt_variant.Enabled = False
        Me.txt_variant.Text = ""

        Me.imb_tranno_fetch.Enabled = True
        Me.txt_entryno.Text = ""
    ...
    Protected Sub lnk_add_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnk_add.Click
        ...
        If lnk_add.Text = "ADD" Then
            ...
            Me.imb_grupr_no_fetch.Enabled = True
            Me.txt_grupr_no.Enabled = True
            Me.txt_grupr_no.Text = ""

            Me.imb_itemcode_fetch.Enabled = True
            Me.txt_itemcode.Enabled = True
            Me.txt_itemcode.Text = ""

            Me.imb_variant_fetch.Enabled = True
            Me.txt_variant.Enabled = True
            Me.txt_variant.Text = ""

            Me.imb_tranno_fetch.Enabled = False
            Me.txt_entryno.Text = ""
    ...
    Protected Sub lnk_apply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnk_apply.Click
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            If Val(CType(GridView1.Rows(i).FindControl("txt_move_qty"), TextBox).Text) > 0 Then
                ...
                If LTrim(RTrim(GridView1.Rows(i).Cells(13).Text)) <> "OPEN" And (Me.ddl_action.Text = "ADD" Or Me.ddl_action.Text = "MODIFY" Or Me.ddl_action.Text = "SHORT CLOSE" Or Me.ddl_action.Text = "AUTHORIZE") Then
                ...
                If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Then
                    ...
                    sqlpass = "select isnull(sum(isnull(moved_qty,0)),0) " & _
                            ...
                            "and entry_no <> " & Val(LTrim(RTrim(GridView1.Rows(i).Cells(1).Text))) & _
                            " and left(ltrim(status),1) not in ('C','S') " & _
                    ...
                    If dr.HasRows = True Then
                        ...
                        'Dim Prev_qty As Double = Val(dr.Item(0))
                        'Dim rcvd_qty As Long = Val(GridView1.Rows(i).Cells(8).Text)
                        'Dim move_qty As Double = Val(CType(GridView1.Rows(i).FindControl("txt_move_qty"), TextBox).Text)

                        If (Val(dr.Item(0)) + Val(CType(GridView1.Rows(i).FindControl("txt_move_qty"), TextBox).Text)) > Val(GridView1.Rows(i).Cells(8).Text) Then
                            FMsg.Message = "Prev. " & dr.Item(0) & " + Current Reqd.Qty. " & CType(GridView1.Rows(i).FindControl("txt_move_qty"), TextBox).Text & "  More than Reqd. Qty. of " & LTrim(RTrim(GridView1.Rows(i).Cells(0).Text)) + " - " + LTrim(RTrim(GridView1.Rows(i).Cells(2).Text))
                            FMsg.CssClass = "errormsg"
                            FMsg.Display()
                            dr.Close()
                            obj.closecn()
                ...
                If wh_type = "0" And LTrim(RTrim(CType(GridView1.Rows(i).FindControl("txt_move_zone"), TextBox).Text)) = "" Then   '' Or LTrim(RTrim(CType(GridView1.Rows(i).FindControl("txt_move_bin"), TextBox).Text = ""))) Then
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            Try
                ...
                sqlpass = "select isnull(max(entry_no),0) + 1 " & _
                        "from jct_ops_items_movement_before_transaction_header " & _
                        "where company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "'"
                ...
                If dr.HasRows = True Then
                    ...
                    sno1 = dr.Item(0)
                Else
                    FMsg.Message = "Error during New Entry No. Creation "
                    FMsg.CssClass = "errormsg"
                    FMsg.Display()
                    dr.Close()
                    obj.closecn()
                ...
                obj.closecn()
                ''''''''''Meaasage'''''''''''''
                FMsg.Message = "Success with Tran. No." + CStr(sno1)
                ...
                sqlpass = "exec jct_ops_gr_upr_fetch_latest '" & LTrim(RTrim(Me.ddl_action.Text)) & "','" & _
                            UCase(LTrim(RTrim(Session("empcode")))) & "','" & _
                            UCase(LTrim(RTrim(Session("companycode")))) & "' "
                ...
                Try
                    ...
                    'Dim move As TextBox = DirectCast(GridView1.Rows(0).FindControl("txt_move_qty"), TextBox)
                    'move.Focus()
                    'End If
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "SHORT CLOSE" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "AUTHORIZE" Then
            ...
            Try
                ...
                sqlpass = "select top 1 isnull(a.status,'') " & _
                    "from jct_ops_items_movement_before_transaction_header a " & _
                    "where a.entry_no='" & UCase(LTrim(RTrim(Me.txt_entryno.Text))) & "' " & _
                ...
                '        "from jct_ops_items_movement_before_transaction_header " & _
                '        "where entry_no='" & LTrim(RTrim(Me.txt_entryno.Text)) & "' " & _
                ...
                '    sqlpass = "delete from jct_ops_items_movement_before_transaction_header " & _
                '            "where entry_no='" & LTrim(RTrim(Me.txt_entryno.Text)) & "' " & _
                '            "and left(ltrim(status),1)='O' " & _
                '            "and company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "' "
    ...
    Protected Sub txt_variant_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_variant.TextChanged
        ...
        If LTrim(RTrim(Me.txt_variant.Text)) <> "" Then
            ...
            Me.imb_variant_fetch_Click(sender, Nothing)
        End If
    ...
    Protected Sub lnk_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnk_print.Click
        ...
        Response.Redirect("rpt_items_movement_before_transaction.aspx")

    End Sub

    'Protected Sub txt_entryno_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_entryno.TextChanged

    '    Me.imb_tranno_fetch_Click(sender, Nothing)

    'End Sub

    Protected Sub imb_tranno_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_tranno_fetch.Click
    ...
    Protected Sub imb_grupr_no_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_grupr_no_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            For i = 0 To GridView1.Rows.Count - 1
                ...
                If UCase(LTrim(RTrim(Me.txt_grupr_no.Text))) = LTrim(RTrim(GridView1.Rows(i).Cells(0).Text)) Then
            ...
            sqlpass = "exec jct_ops_gr_upr_fetch '" & LTrim(RTrim(Me.ddl_action.Text)) & "','" & _
                        UCase(LTrim(RTrim(Me.txt_grupr_no.Text))) & "','" & _
                        UCase(LTrim(RTrim(Session("empcode")))) & "','" & _
                        UCase(LTrim(RTrim(Session("companycode")))) & "' "
    ...
    Protected Sub imb_itemcode_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_itemcode_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            For i = 0 To GridView1.Rows.Count - 1
                ...
                If UCase(LTrim(RTrim(Me.txt_itemcode.Text))) = LTrim(RTrim(GridView1.Rows(i).Cells(3).Text)) Then
    ...
    Protected Sub imb_variant_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_variant_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            For i = 0 To GridView1.Rows.Count - 1
                ...
                If UCase(LTrim(RTrim(Me.txt_itemcode.Text))) = LTrim(RTrim(GridView1.Rows(i).Cells(3).Text)) And UCase(LTrim(RTrim(Me.txt_variant.Text))) = LTrim(RTrim(GridView1.Rows(i).Cells(4).Text)) Then
    ...
    Protected Sub txt_grupr_no_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_grupr_no.TextChanged
