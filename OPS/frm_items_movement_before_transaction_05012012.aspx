...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%; height: 67px;">
        <tr>
            ...
            <td style="height: 36px; width: 127px" colspan="2">
                </td>
        </tr>
        <tr>
            ...
            <td style="width: 168px; height: 20px;" colspan="2">
                <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txt_entryno" runat="server" CssClass="textbox" Width="100px" 
                            AutoPostBack="True"></asp:TextBox>
                        <asp:ImageButton ID="imb_fetch_entryno" runat="server" Height="12px" 
                            ImageUrl="~/Image/Buttons_Tabs/Arrow_Right.png" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txt_itemcode" runat="server" CssClass="textbox" 
                            Width="100px" AutoPostBack="True"></asp:TextBox>
                        <asp:ImageButton ID="imb_fetch2" runat="server" Height="12px" 
                            ImageUrl="~/Image/Buttons_Tabs/Arrow_Right.png" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txt_variant" runat="server" CssClass="textbox" 
                            Width="100px" AutoPostBack="True"></asp:TextBox>
                        <asp:ImageButton ID="imb_fetch3" runat="server" Height="12px" 
                            ImageUrl="~/Image/Buttons_Tabs/Arrow_Right.png" style="width: 15px" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td style="height: 6px; width: 168px" colspan="2">
                &nbsp;</td>
            <td style="height: 6px; width: 168px">
    ...
    <table style="width:100%; height: 67px;" class="tableback">
        <tr>
            <td colspan="4">
