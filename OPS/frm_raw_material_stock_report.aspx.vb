    ...
    Protected Sub imb_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_fetch.Click
        ...
        If Me.chk_agewise.Checked = True Or Me.chk_lotwise.Checked = True Then
            ...
            If Me.chk_agewise.Checked = True And Me.chk_lotwise.Checked <> True Then
                ...
                sqlpass = "select a.wh_no as [WAREHOUSE], a.zone_no as [ZONE NO.], a.stock_no as [ITEM CODE], " & _
                            ...
                            "group by a.wh_no, a.zone_no, a.stock_no, a.variant_no, a.description, a.short_description, a.purchase_uom " & _
                            "order by a.wh_no, a.zone_no, a.stock_no, a.variant_no, a.description, a.short_description, a.purchase_uom "
            End If
            ...
            If Me.chk_agewise.Checked = True And Me.chk_lotwise.Checked = True Then
                ...
                sqlpass = "select a.wh_no as [WAREHOUSE], a.zone_no as [ZONE NO.], a.stock_no as [ITEM CODE], " & _
                            ...
                            "where a.userid ='" & UCase(LTrim(RTrim(Session("empcode")))) & "' " & _
                            "and a.company_code ='" & UCase(LTrim(RTrim(Session("companycode")))) & "' " & _
                            "group by a.wh_no, a.zone_no, a.stock_no, a.variant_no, a.description, a.short_description, a.purchase_uom, a.remarks " & _
                            "order by a.wh_no, a.zone_no, a.stock_no, a.variant_no, a.description, a.short_description, a.purchase_uom, a.remarks "
            End If
        ...
        Else
            ...
            ''----Fill data in GridView1
            sqlpass = "select a.group_no as [GROUPNO],a.wh_no as [WAREHOUSE], a.zone_no as [ZONE NO.], " & _
                     ...
                     "where a.userid ='" & UCase(LTrim(RTrim(Session("empcode")))) & "' " & _
                     "and a.company_code ='" & UCase(LTrim(RTrim(Session("companycode")))) & "' " & _
                     "order by a.group_no, a.wh_no, a.zone_no, a.stock_no, a.variant_no, a.description, a.short_description "
    ...
    Protected Sub imb_excel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_excel.Click
        ...
        If Me.chk_agewise.Checked = True Or Me.chk_lotwise.Checked = True Then
            ...
            If Me.chk_agewise.Checked = True And Me.chk_lotwise.Checked = True Then
                ...
                'GridViewExportUtil.Export("age_wise_current_stock.xls", Me.GridView1)
                Dim filename As String = "age_lot_wise_current_stock.xls"
                GridViewExportUtil.Export(filename, Me.GridView1)
            ...
            If Me.chk_agewise.Checked <> True And Me.chk_lotwise.Checked = True Then
                ...
                'GridViewExportUtil.Export("age_wise_current_stock.xls", Me.GridView1)
                Dim filename As String = "lot_wise_current_stock.xls"
                GridViewExportUtil.Export(filename, Me.GridView1)
