...
Partial Class OPS_frm_raw_material_stock_report
    ...
    Protected Sub imb_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_fetch.Click
        ...
        If Me.chk_agewise.Checked = True Then
            ...
            sqlpass = "select a.wh_no as [WAREHOUSE], a.stock_no as [ITEM CODE], a.variant_no as [VARIANT], a.description as [DESC.], a.short_description as [SHORT DESC.], a.purchase_uom as [UOM], " & _
                        "convert(numeric(12,3),sum(a.qty_old_upto_30_days)) as [0 - 30], " & _
                        "convert(numeric(12,3),sum(a.qty_old_upto_60_days)) as [31 - 60], " & _
                        "convert(numeric(12,3),sum(a.qty_old_upto_90_days)) as [61 - 90], " & _
                        "convert(numeric(12,3),sum(a.qty_old_upto_180_days)) as [91 - 180], " & _
                        "convert(numeric(12,3),sum(a.qty_old_upto_365_days)) as [181 - 365]," & _
                        "convert(numeric(12,3),sum(a.qty_old_above_365_days)) as [>365] " & _
