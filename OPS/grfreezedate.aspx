<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true" CodeFile="grfreezedate.aspx.cs" Inherits="OPS_grfreezedate" %>
            ...
            <tr>
              ...
              <ContentTemplate>
                ...
                <asp:GridView ID="Grdfreezedate" runat="server" Width="100%" 
                      onpageindexchanging="Grdfreezedate_PageIndexChanging">
