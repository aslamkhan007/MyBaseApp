...
public partial class OPS_grfreezedate : System.Web.UI.Page
{
    ...
    protected void lnkbtnFetch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strqry = "jct_gr_freezing_date";
            ...
            cmd.Parameters.Add("@days", SqlDbType.Int).Value = txtDays.Text;
            //cmd.ExecuteNonQuery();                       
    ...
    protected void lnkbtnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string attachment = "attachment; grdetail.xls";
    ...
    protected void Grdfreezedate_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        Grdfreezedate.PageIndex = e.NewPageIndex;
        fillgridview();
