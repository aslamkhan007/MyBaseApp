...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="mytable">
        ...
        <td>
            GrNo</td>
          <td>
              <asp:TextBox ID="txtgrno" runat="server" CssClass="textbox" AutoPostBack="True"></asp:TextBox>
              <cc1:AutoCompleteExtender ID="txtgrno_AutoCompleteExtender" runat="server" 
                  CompletionInterval="100" 
                  CompletionListCssClass="autocomplete_completionListElement" 
                  CompletionSetCount="100" DelimiterCharacters="" Enabled="True" 
                  MinimumPrefixLength="1" ServiceMethod="Get_GrNo" 
                  ServicePath="~/webservice.asmx" TargetControlID="txtgrno">
              </cc1:AutoCompleteExtender>
        </td>
           <td>
               MrNo</td>
           <td>
               ...
               <cc1:AutoCompleteExtender ID="txtmrno_AutoCompleteExtender" runat="server" 
                   DelimiterCharacters="" Enabled="True" ServicePath="~/webservice.asmx" 
                   TargetControlID="txtmrno" CompletionInterval="100" 
                   CompletionListCssClass="autocomplete_completionListElement" 
                   CompletionSetCount="100" MinimumPrefixLength="1" ServiceMethod="Get_mrNo">
               </cc1:AutoCompleteExtender>
        </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="height: 404px">
