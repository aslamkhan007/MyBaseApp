                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Invoice Date">
                                      ...
                                      <asp:TemplateField HeaderText="Order">
                                        <ItemTemplate>
                                            <asp:Label ID="lblOrder" Text='<%# Eval("OrderNo") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="LineNo">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLineNo" Text='<%# Eval("Line_no") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="GrNo">
                                     ...
                                     <%--    <asp:TemplateField HeaderText="GrDate(mm/dd/yyyy)">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGrDate" runat="server" CssClass="text" Width="70px">
                                            </asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="GrDate(mm/dd/yyyy)">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGrDate" runat="server" CssClass="textbox" onkeypress="return OnlyDate()" Columns="5" MaxLength="15"
                                                Width="85" Text='<%# Eval("GrDate") %>'></asp:TextBox>
                                                <cc1:CalendarExtender ID="txtGRDate_CalendarExtender" runat="server" TargetControlID="txtGrDate">
                                            </cc1:CalendarExtender>
