 ...
 <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
      ...
      <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server"  >
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RadAjaxManager1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lblContent" LoadingPanelID="gridLoadingPanel"></telerik:AjaxUpdatedControl>
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td  class="NormalText" style="width: 141px">
                <asp:Label ID="Label18" runat="server" Text="Previous Request ID"></asp:Label>
            </td>
            <td style="margin-left: 80px"  class="NormalText">
                        ...
                        <Columns>
                          <asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Return Qty">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtReturnQty" runat="server"  CssClass="textbox"   
                                        ...
                                        ontextchanged="txtReturnQty_TextChanged" Text='<%# Eval("ReturnQty") %>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Bales">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtbales" runat="server" CssClass="textbox"  Columns="5" 
                                        MaxLength="3" Text='<%# Eval("Bales") %>' ></asp:TextBox>
    ...
    <table style="width: 100%;">
        ...
        <Windows>
            <telerik:RadWindow ID="UserListDialog" runat="server" Title="Material Return Detail" Height="300px"
