...
Partial Class OPS_materialrequest
    ...
    Protected Function ListOfConcernedDepts(ByVal chb As CheckBoxList, sqlcon As SqlConnection, sqltran As SqlTransaction) As String
...
Check:  Next
            ...
            If (flag = 1) Then
                ...
                If (ViewState("RefreshFlag") = 1) Then
                    ...
                    For i As Integer = 0 To GridView2.Rows.Count - 1
                        ...
                        Dim list As String = ListOfElcosures(chbEnclosures, txtEnclosures)
    ...
    Private Sub SendMail()
        ...
        If (Dr.HasRows) Then
            While (Dr.Read())
                ...
                If (Dr(6).ToString = "" Or Dr(6).ToString() = "CEO") Then
                    ViewState("PendingAt") = Dr(6).ToString()
                    sb.AppendLine("<tr> <td> " & Dr(0).ToString & " </td> <td> " & Dr(1).ToString & "  </td>  <td> " & Dr(2).ToString & "</td>  <td>" & Dr(3).ToString & " </td>  <td>" & Dr(4).ToString & " </td> <td> " & Dr(8).ToString() & " </td><td> CEO </td><td>" & Dr("FreightPaidBy").ToString & " </td> </tr> ")
                End If
                Sql = "Select empname from jct_empmast_base where active='Y' and  empcode='" + Dr(6).ToString().Split(",")(0) + "'"
                Dim empname As String = ""
                Dim obj2 As Connection = New Connection
        ...
        sb.AppendLine("<br /><br/>")
        sb.AppendLine("Freight Value: " + txtFreightValue.Text)
        sb.AppendLine("<br /><br />")
        sb.AppendLine("Detailed Description (Entered by Marketing Executive) : " + txtDescription.Text.ToUpper())
        sb.AppendLine("<br /><br />")
        sb.AppendLine("Reason : " + eReasonslist)
        ...
        Try
            ...
            ElseIf (e.CommandName = "Refresh") Then
                ...
                If ViewState("CurrentTable") IsNot Nothing Then
                    ...
                    'cmd.Parameters.Add("@from_date", SqlDbType.VarChar, 20).Value = ""
                    'cmd.Parameters.Add("@to_date", SqlDbType.VarChar, 20).Value = ""
                    'cmd.Parameters.Add("@customer", SqlDbType.VarChar, 20).Value = ""
                    'cmd.Parameters.Add("@sale_person", SqlDbType.VarChar, 20).Value = ""
    ...
    Protected Sub cmdSearch_Click(sender As Object, e As System.EventArgs) Handles cmdSearch.Click
        Qry = "SELECT distinct empcode,empname+'~'+b.DEPTNAME FROM JCT_EmpMast_Base a,DEPTMAST b WHERE empname LIKE '%" & txtEmployee.Text & "%' AND Active='y' AND a.deptcode=b.DEPTCODE ORDER BY empname+'~'+b.DEPTNAME"
