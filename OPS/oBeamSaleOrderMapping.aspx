                        ...
                        <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                            <asp:GridView ID="grdDetail" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Remaining Length">
                                        <ItemTemplate>
                            ...
                            <asp:GridView ID="grdSaleOrder" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Weaving Sort">
                                        <ItemTemplate>
                                            <asp:Label ID="Label25" runat="server" Text='<%# Eval("WeavingSort") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Order Qty">
                                        <ItemTemplate>
                                            <asp:Label ID="Label27" runat="server" Text='<%# Eval("req_qty") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Greigh Required">
                                        <ItemTemplate>
                                            <asp:Label ID="Label29" runat="server" Text='<%# Eval("GreighReq") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
