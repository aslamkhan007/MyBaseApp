...
public partial class OPS_QuotationPlanningReport : System.Web.UI.Page
{
    ...
    protected void radFetch_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@DateFrom", SqlDbType.VarChar, 30).Value = txtDateFrom.Text;
        cmd.Parameters.Add("@DateTo", SqlDbType.VarChar, 30).Value = txtDateTo.Text;
        cmd.Parameters.Add("@QuotationDtFrom", SqlDbType.VarChar, 30).Value = txtQuotDateFrom.Text;
        cmd.Parameters.Add("@QuotationDtTo", SqlDbType.VarChar, 30).Value = txtQuotDateTo.Text;
