...
&nbsp;&nbsp; &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
        ...
        <tr>
            ...
            <td style="height: 12px; width: 380px;">
                ...
                <asp:ImageButton ID="ibtSearchQuotation" runat="server" ImageUrl="~/Image/Icons/Action/Search.png"
                    ToolTip="Search Item Code" Width="24px" CausesValidation="False" />
            </td>
    ...
    Width="66px" AutoPostBack="True"></asp:TextBox>
        ...
        <tr>
            <td class="labelcells" style="width: 150px">
                Item Description</td>
            <td valign="top" style="width: 380px" class="NormalText">
        ...
        <tr>
            ...
            <td style="width: 380px">
                ...
                <asp:SqlDataSource ID="dsFinish" runat="server" 
                    ...
                    SelectCommand="JCT_OPS_Get_Finish_Cost" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlFinish" DefaultValue=" " Name="RecipeCode" 
...
where parent_category = 'printingtype'"></asp:SqlDataSource>
        ...
        <tr>
            ...
            <td style="width: 380px; font-weight: bold;">
                <asp:DropDownList ID="ddlPackMaterial" runat="server" CssClass="combobox" 
                    DataSourceID="dsPackingMaterial" DataTextField="parameter" 
                    DataValueField="parameter_code">
                </asp:DropDownList>
                <asp:SqlDataSource ID="dsPackingMaterial" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="select parameter_code, parameter from jct_ops_multi_master
where parent_category = 'PackingMaterial'
and status = 'A'
order by entrydate
"></asp:SqlDataSource>
            </td>
            <td class="labelcells">
                Packing Style</td>
            <td>
                <asp:DropDownList ID="ddlPackStyle" runat="server" CssClass="combobox" 
                    DataSourceID="dsPackingStyle" DataTextField="parameter" 
                    DataValueField="parameter_code">
                </asp:DropDownList>
                <asp:SqlDataSource ID="dsPackingStyle" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:misjctdev %>" SelectCommand="select parameter_code, parameter from jct_ops_multi_master
where parent_category = 'PackingStyle'
and status = 'A'
order by entrydate
"></asp:SqlDataSource>
            </td>
    ...
    <table class="tableback" style="width: 100%;">
        <tr>
            ...
            <td style="height: 12px; font-weight: bold; font-size: 8pt; text-align: right;">
                &nbsp;</td>
            <td style="height: 12px; font-weight: bold; font-size: 8pt; text-align: right;">
                <asp:LinkButton ID="cmdReqFreshCost" runat="server" CausesValidation="False" 
        ...
        <tr>
            ...
            <td style="height: 12px; font-weight: bold; font-size: 10pt;">
                &nbsp;</td>
            <td style="height: 12px; font-weight: bold; font-size: 8pt;">
                &nbsp;</td>
            <td style="height: 12px; font-weight: bold; font-size: 8pt; text-align: right;">
        ...
        <tr>
            <td colspan="4" style="height: 12px; font-weight: bold; font-size: 10pt;">
                <div>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="grdCosting" runat="server" EnableModelValidation="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="Memo No,Sort,Finishing,Printing" 
                                        DataNavigateUrlFormatString="Quotation_Cost_Memo.aspx?memo_no={0}&amp;sort_no={1}&amp;finish={2}&amp;printing={3}" 
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSpinning" runat="server" CssClass="textbox" Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="labelcells">
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtWeaving" runat="server" CssClass="textbox" Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="labelcells">
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtSizing" runat="server" CssClass="textbox" Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
        <tr>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtShrinkage" runat="server" CssClass="textbox" 
                            Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtValueLoss" runat="server" CssClass="textbox" 
                            Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            ...
            <td class="NormalText" >
                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtPacking" runat="server" CssClass="textbox" Enabled="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td class="labelcells">
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="lblDnVCost" runat="server" ForeColor="#003399"></asp:Label>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="grdCosting" EventName="SelectedIndexChanged" />
                    </Triggers>
    ...
    <table style="width: 100%;" class="tableback">
        <tr>
            ...
            <td class="NormalText">
                <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/LabDipSystem/LabDipRequest.aspx">Create Labdip</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td class="labelcells">
