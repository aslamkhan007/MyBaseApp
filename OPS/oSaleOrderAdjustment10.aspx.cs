...
public partial class OPS_SaleOrderAdjustment10 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            script = "alert(' You can now transfer greigh from a single order to multiple orders..!!  ');";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "Remove")
            {
                ...
                {
                    sql = "Select * from JCT_OPS_PLANNING_SALEORDER_ADJUSTMENT WHERE NEW_SALEORDER=@OrderNo AND NEW_SORT=@SORT AND NEW_QTY =@QTY AND STATUS='P'   ";
    ...
    protected void grd_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        if (txtSubject.Text == "Greigh Transfer" || txtSubject.Text == "Greigh Transfer Taffeta")
        {
            ...
            if (grd.SelectedRow.Cells[10].Text == "")
            {
            ...
            if (grd.SelectedRow.Cells[5].Text != "")
            {
