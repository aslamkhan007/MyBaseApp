...
<script type="text/javascript">
            ...
            <tr>
                ...
                <td class="NormalText" style="width:30px">
                    ...
                    <Columns>
                       <asp:TemplateField>
                                       <ItemTemplate>
                                           <asp:ImageButton ID="ImageButton2" runat="server"  CommandName="OpenPopUp" OnClientClick="ButtonClick()" ImageUrl="~/Image/SplitIcon.png"
                                   ...
                                   <asp:TemplateField HeaderText="Initial Plan Qty.">
                                     ...
                                     <asp:TemplateField HeaderText="Greigh Adj.">
                                       ...
                                       <ItemTemplate>
                                          <asp:Label ID="lblGreyRemaining" runat="server" Text='<%# Eval("Grey_Remaining") %>'></asp:Label>
                                       </ItemTemplate>
                                   </asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="Loom Allot.">
                                    ...
                                    <asp:TemplateField HeaderText="Looms">
                                       <ItemTemplate>
                                          <asp:TextBox ID="txtLoom" runat="server" Columns="3" MaxLength="4"  AutoPostBack="true"
                                               CssClass="textbox" Text='<%# Eval("LoomAllot") %>' > </asp:TextBox>
                                           <asp:Label ID="lblLoomsPerDay" runat="server" Visible="false"
    ...
    <asp:Panel ID="pnlpopup" runat="server" Width="100%" CssClass="panelbg" >
                ...
                Width="100%" 
                    ...
                    <Columns>
                     <asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="Expected Delivery Dt">
                                       <ItemTemplate>
                                           <asp:TextBox ID="lblReqdt1S" runat="server" Columns="12" MaxLength="12" CssClass="textbox" 
                                   ...
                                   <asp:TemplateField HeaderText="Shed">
                                       <ItemTemplate>
                                           <asp:UpdatePanel ID="UpdatePanel9" runat="server" RenderMode="Inline">
                                               ...
                                               <asp:DropDownList ID="ddlShedS" CssClass="combobox" runat="server"   SelectedValue='<%# Eval("Shed") %>'
                                               AutoPostBack="True" >
                                                   <asp:ListItem Value="">Select</asp:ListItem>
                                                   <asp:ListItem Value="RP190">Rapier</asp:ListItem>
                                                   <asp:ListItem Value="AR190">Airjet</asp:ListItem>
