        ...
        try
        {
          ...
          //  ListItem li = new ListItem();
           ...
           // ListItem LineItem = new ListItem();
            ...
            sql = "SELECT distinct a.Plan_Qty,b.attb_discrete  FROM dbo.JCT_OPS_MONTHLY_PLANNING a , miserp.som.dbo.t_order_line_nos_attrb b WHERE a.yearmonth=" + yearMonth() + " and b.attb_code='Shade1' and a.order_no=b.order_no and a.order_srl_no=b.line_no and    a.order_no=@OrderNo AND a.item_no=@ItemNo and a.mode='Freezed' and a.status is null";
            cmd = new SqlCommand(sql, obj.Connection());
            cmd.Parameters.Add("@orderno", SqlDbType.VarChar, 20).Value = txtOrderNo.Text;
