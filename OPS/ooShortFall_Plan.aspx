            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                    ...
                    AutoGenerateColumns="False" EnableModelValidation="True" AllowPaging="True" 
                            ShowFooter="True" onrowcommand="grdShortfall_RowCommand" EmptyDataText="No Shortfall Request Pending.">
                    ...
                    <Columns>
                                      <asp:TemplateField>
                                          <ItemTemplate>
                                              <asp:Image ID="img" runat="server" ImageUrl="~/Image/AvailabilityFalse.png" />
                                          </ItemTemplate>
                                      </asp:TemplateField>
                            ...
                            <tr>
                                ...
                                <td class="NormalText">
                                    <asp:DropDownList ID="ddlShed" runat="server" AutoPostBack="True" 
                                        CssClass="combobox" DataSourceID="SqlDataSource1"  SelectedValue='<%# Eval("Shed") %>'
