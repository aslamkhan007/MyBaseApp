    ...
    protected void SendMailToPlanning(String body, String OrderNo)
    {
        ...
        if (dr.HasRows)
        {
            while (dr.Read())
            {
                ...
                Sm.SendMail("neeraj@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("sobti@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("karanjitsaini@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("rashpal@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("harendra@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("rbaksshi@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("ashish@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("sobti@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("kvsmurty@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("nandksharma@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("rajivmehra@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("sudhirarora@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
                Sm.SendMail("vinaypuri@jctltd.com", "noreply@jctltd.com", "Request for Shortfall - " + OrderNo, body);
