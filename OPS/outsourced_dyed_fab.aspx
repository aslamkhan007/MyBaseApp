...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            <td class="NormalText" style="width: 541px">
                <asp:RadioButtonList ID="rdlst" runat="server" AutoPostBack="True" 
                    ...
                    <asp:ListItem Value="mkt/planing">Request By Mkt/Planning</asp:ListItem>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td class="NormalText" style="width: 205px"  >
                ...
                <asp:LinkButton ID="LinkButton3" runat="server" CssClass="searchbluesmall" 
                    Height="16px" Width="16px" onclick="LinkButton3_Click1">LinkButton</asp:LinkButton>
            </td>
...
"></asp:SqlDataSource>
      ...
      <tr>
            ...
            <td class="NormalText">
                <asp:Label ID="lbfinshprice" runat="server" Text="Finish Sale price"></asp:Label>
            </td>
            <td class="NormalText">
                <asp:TextBox ID="txtfinishsale" runat="server" CssClass="textbox" Width="50px"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="txtfinishsale_FilteredTextBoxExtender" 
                    runat="server" Enabled="True" TargetControlID="txtfinishsale" 
                    ValidChars=".0123456789">
                </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ErrorMessage="*" ControlToValidate="txtfinishsale" 
                    ValidationGroup="mandatory"></asp:RequiredFieldValidator>
            </td>
            <td class="NormalText">
                Costing Memo</td>
            <td class="NormalText">
                <asp:TextBox ID="txtcostmemo" runat="server" CssClass="textbox"></asp:TextBox>
                </td>
        </tr>
        <tr>
            <td class="NormalText">
            ...
            <td class="NormalText">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ControlToValidate="txtDnv" ErrorMessage="*" ValidationGroup="mandatory"></asp:RequiredFieldValidator>
            </td>
            <td class="NormalText">
                Memo Date</td>
            <td class="NormalText">
                <asp:TextBox ID="txtmemodate" runat="server" CssClass="textbox"></asp:TextBox>
                <cc1:CalendarExtender ID="txtmemodate_CalendarExtender" runat="server" 
                    Enabled="True" TargetControlID="txtmemodate">
                </cc1:CalendarExtender>
                </td>
        </tr>
        <tr>
            ...
            <td style="height: 16px">
                &nbsp;</td>
            <td class="NormalText">
                <asp:TextBox ID="txtStdRemarks" runat="server" CssClass="textbox"></asp:TextBox>
            </td>
            <td class="NormalText">
                &nbsp;</td>
            <td class="NormalText">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:RadioButtonList ID="rblType" runat="server" CssClass="combobox" 
                                                    ...
                                                    onselectedindexchanged="rblType_SelectedIndexChanged" Width="247px">
                                                    <asp:ListItem>FABRIC</asp:ListItem>
                                                    <asp:ListItem>YARN</asp:ListItem>
                                                    <asp:ListItem>JOBWORK</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
