...
public partial class OPS_outsourced_fab_specs : System.Web.UI.Page
{
    ...
    protected void lnkapply_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("jct_ops_outsrd_dyed_fab_specs_modified", con.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd.Parameters.Add("@width_inch", SqlDbType.VarChar, 20).Value = txtgreywidth.Text; //Convert.ToDecimal(txtwidth.Text == "" ? 0 : Convert.ToDecimal(txtwidth.Text));//Convert.ToDecimal(txtwidth.Text);
            ...
            //cmd.Parameters.Add("@size_percnt", SqlDbType.VarChar, 5).Value = txtselvage.Text;
            ...
            cmd.Parameters.Add("@selvage", SqlDbType.VarChar, 50).Value = txtselvage.Text;
            cmd.Parameters.Add("@greywidth", SqlDbType.VarChar, 50).Value = txtgreywidth.Text;
            cmd.Parameters.Add("@finishwidth", SqlDbType.VarChar, 50).Value = txtfinishwidth.Text;
    ...
    protected void grdDetail2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        txtgreywidth.Text = grdDetail.SelectedRow.Cells[10].Text.Replace("&nbsp;", ""); ;
        txtwgt.Text = grdDetail.SelectedRow.Cells[15].Text.Replace("&nbsp;", ""); ;
        txtblend.Text = grdDetail.SelectedRow.Cells[11].Text.Replace("&nbsp;", ""); ;
        txtselvage.Text = grdDetail.SelectedRow.Cells[16].Text.Replace("&nbsp;", ""); ;
    ...
    private void sendmail()
    {
       ...
       Dr = cmd.ExecuteReader();
        ...
        sb.Append("<a href='http://testerp/FusionApps/OPS/yarn_enquiry.aspx'> Click here  to enter the vendors againt these specifcation..!! </a><br />");
        ...
        to = ViewState["sendtoEmail"] + "," + ViewState["RequestByEmail"] + ",dpbadhwar@jctltd.com,laxman@jctltd.com,vinaydogra@jctltd.com,rajgopal@jctltd.com,sanjeevj@jctltd.com,skpalta@jctltd.com,somdutt@jctltd.com,skj@jctltd.com";//"Spinning@jctltd.com"
       // to = ViewState["PendingAtEmail"].ToString() + "," + ViewState["RequestByEmail"].ToString() + ", dpbadhwar@jctltd.com,arvindsharma.jctltd.com,skj@jctltd.com ";
      ...
      bcc = "jatindutta@jctltd.com,rbaksshi@jctltd.com,shwetaloria@jctltd.com";
       // bcc = "shwetaloria@jctltd.com,rbaksshi@jctltd.com,ashish@jctltd.com,rajan@jctltd.com";
        subject = "Outsourced Request - " + ViewState["RequestID"];
