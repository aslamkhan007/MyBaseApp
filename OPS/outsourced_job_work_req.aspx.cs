...
public partial class OPS_outsourced_job_work_req : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@style", SqlDbType.VarChar, 20).Value = txtstyle.Text;
    ...
    protected void lnk_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        con.Close();
        string script2 = "alert(' record saved sucesfully.!!!Click Add New to enter another Record for same request!! ');";
        ScriptManager.RegisterStartupScript(this, this.GetType(), "ServerControlScript", script2, true);
