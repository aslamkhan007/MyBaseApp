...
public partial class OPS_outsourced_job_work_vendor_enq : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@entrdby", SqlDbType.VarChar, 20).Value = Session["empcode"];
        ...
        if (!string.IsNullOrEmpty(txtvaliddate.Text))
        {
    ...
    private void sendmail()
    {
        ...
        sb.AppendLine("<tr><th> RequestID  </th> <th>Vendor</th> <th>Rate</th>  <th> Delivery Date </th><th>Job Charges</th></tr> ");
        ...
        sb.AppendLine("</table>");
        sb.AppendLine("<br /><br/>");
        sb.AppendLine("Please Authorize the Request For PO Generation.");
