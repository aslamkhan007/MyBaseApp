...
public partial class OPS_PO_rm_mrkin : System.Web.UI.Page
{
        ...
        if (rdlst.SelectedIndex == 1)
        {
            foreach (GridViewRow rw in grdDetail3.Rows)
            {
                ...
                if (chk1.Checked)
                {
                    ...
                    con.Open();
                    cmd1.Parameters.Add("@requestid", SqlDbType.Int).Value = rw.Cells[5].Text;
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rdlst.SelectedIndex == 0)
        {
            ...
            cmd = new SqlCommand("Exec jct_ops_pending_rate_wardrode", con);
        ...
        //    SqlCommand cmd = new SqlCommand("jct_ops_outsrced_select_for_po ", con);
        //    cmd.CommandType = CommandType.StoredProcedure;
        ...
        //    cmd = new SqlCommand("jct_ops_wardrobe_mkt_approvals ", con);
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    da = new SqlDataAdapter(cmd);
        //    ds = new DataSet();
        //    da.Fill(ds);
