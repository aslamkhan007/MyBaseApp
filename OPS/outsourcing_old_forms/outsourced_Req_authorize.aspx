<%@ Page Title="" Language="C#" MasterPageFile="~/OPS/MasterPage.master" AutoEventWireup="true"
    CodeFile="outsourced_Req_authorize.aspx.cs" Inherits="OPS_outsourced_Req_authorize" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td class="tableheader">
                Authorize Outsourced Fabric/Yarn
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                ...
                <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource2" RepeatDirection="Horizontal"
                    ToolTip="Click any Area to see the detials of it." Width="100%" OnSelectedIndexChanged="DataList1_SelectedIndexChanged"
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <div id="SanctionID-<%# Eval("SanctionID") %>" style="display: none; position: relative;
                                            left: 25px;">
                                            <asp:GridView ID="nestedRemarks" runat="server" Width="100%" AutoGenerateColumns="False">
                                                <SelectedRowStyle CssClass="SelectedRowStyle" />
                                                <HeaderStyle CssClass="GridHeader" />
                                                <RowStyle CssClass="GridItem" />
                                                <AlternatingRowStyle CssClass="GridAI" />
    ...
    <table style="width: 100%;" class="tableback">
        ...
        <tr>
            <td class="labelcells_s">
                <asp:Label ID="lblVendorDetail" runat="server" Text="Vendor Detail" Font-Bold="True"
                    Font-Size="10pt"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GrdVendorDetail" runat="server" Width="100%" EnableModelValidation="True" EmptyDataText="No Vendor List Available"  onrowdatabound="GrdVendorDetail_RowDataBound">
                            <AlternatingRowStyle CssClass="GridAI" />
                            <Columns>
                                <asp:TemplateField HeaderText="Sel" Visible="False">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="ChkSelVendor" runat="server" />
                                    </ItemTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
       <ContentTemplate>
        <table style="width:100%;">
            <tr>
                <td class="NormalText">
                    <asp:LinkButton ID="lnkChangeVendor" runat="server" 
                        onclick="lnkChangeVendor_Click">Change Vendor</asp:LinkButton>
                </td>
                <td class="NormalText">
                    &nbsp;</td>
            </tr>
            <tr>
                <td class="NormalText" colspan="2">
                 <asp:Panel ID="pnlChangeVendor" runat="server" Visible="False">
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 142px">
                                <asp:Label ID="Label17" runat="server" Text="Select to Change Vendor "></asp:Label>
                            </td>
                            <td>
                                &nbsp;<asp:DropDownList ID="ddlvendors" runat="server" CssClass="combobox">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtvendorRemarks" runat="server" Height="50px" 
                                    TextMode="MultiLine" Width="200px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                    ControlToValidate="txtvendorRemarks" Display="Dynamic" 
                                    ErrorMessage="** Field Required" ValidationGroup="V"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                 &nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <cc1:ConfirmButtonExtender ID="btnSave_ConfirmButtonExtender" runat="server" 
                                    ConfirmText="Are you sure you want to change vendor ?" 
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="lnkChangeVendor" EventName="Click" />
                ...
                <asp:Panel ID="pnlReProcessingCost" runat="server" Visible="False">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="NormalText">
                                <asp:TextBox ID="txtReprocessingCost" runat="server" CssClass="textbox" Width="250px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" RenderMode="Inline">
                        <ContentTemplate>
                            <asp:LinkButton ID="CmdAuthorize" runat="server" BorderStyle="None" ValidationGroup="GrpApply"
                                CssClass="buttonc" OnClick="CmdAuthorize_Click">Apply</asp:LinkButton>
