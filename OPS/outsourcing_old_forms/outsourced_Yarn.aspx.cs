...
public partial class OPS_outsourced_Yarn : System.Web.UI.Page
{
    ...
    private void sendmail()
    {
       ...
       // sb.AppendLine("Request is Pending at R&D for approval. <br/><br/>");
        ...
        sb.Append("<a href='http://misdev/FusionApps/OPS/yarnspecs.aspx'> Click here to fill specifications..!! </a><br />");
        ...
        to = ViewState["RequestByEmail"] + ",kartarsingh@jctltd.com,sanjeevj@jctltd.com,arvindsharma@jctltd.com,laxman@jctltd.com";
