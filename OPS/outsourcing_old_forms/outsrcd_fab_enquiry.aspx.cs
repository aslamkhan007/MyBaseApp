...
public partial class OPS_outsrcd_fab_enquiry : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("jct_ops_outsrd_dyed_fab_vendor", con);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        cmd.Parameters.Add("@rate_per_mtr", SqlDbType.Decimal, 2).Value = txtrate.Text;
        ...
        cmd.Parameters.Add("@purchase", SqlDbType.Decimal, 2).Value = txtpurchase.Text == "" ? 0 : Convert.ToDecimal(txtpurchase.Text);
    ...
    //    sb.Append("<a href='http://misdev/FusionApps/OPS/outsrcd_fab_enquiry.aspx'> Click here  to select the vendors.!! </a><br />");
