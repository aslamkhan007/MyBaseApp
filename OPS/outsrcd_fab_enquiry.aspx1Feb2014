    ...
    <table style="width: 100%;" class="tableback">
        ...
        <tr>
            <td class="NormalText">
                Weft Count</td>
            <td class="NormalText">
                <asp:TextBox ID="txtweft" runat="server" CssClass="textbox" MaxLength="8" 
                    Width="50px"></asp:TextBox>
            </td>
            <td class="NormalText">
                Width(OT)/inch</td>
            <td>
                <asp:TextBox ID="txtwidth" runat="server" CssClass="textbox" MaxLength="8" 
                    Width="50px"></asp:TextBox>
            </td>
            <td class="NormalText">
                Weight(gsm)</td>
        ...
        <tr>
            ...
            <td class="NormalText">
                Size (percentage)</td>
            <td>
                <asp:TextBox ID="txtsize" runat="server" CssClass="textbox" Width="50px"></asp:TextBox>
            </td>
            <td class="NormalText">
                Peice Length</td>
            <td>
