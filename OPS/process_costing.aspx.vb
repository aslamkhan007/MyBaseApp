...
Imports System.Math
Partial Class Costing_process_costing
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            sqlpass = "/*select b.action,b.mnuname,b.description,b.parent_menu,b.seq " & _
                ...
                " where a.module ='OPS' and a.uname='" & Session("empcode") & "' and a.mnuname='Process Costing'" & _
                ...
                "and a.mnuname='Process Costing' and a.action<>'Load'" & _
            ...
            ''-----Fill Sale Person Combo Box
            sqlpass = "select upper(ltrim(rtrim(a.group_desc)))+' | '+upper(ltrim(rtrim(a.group_no))) " & _
                    "from miserp.som.dbo.m_cust_group a " & _
                    "where upper(ltrim(rtrim(a.group_type)))='SALESP' " & _
                    "and upper(ltrim(rtrim(a.status)))='O' " & _
                    "and upper(ltrim(rtrim(a.company_no)))='" & UCase(LTrim(RTrim(Session("companycode")))) & "' "
            ...
            If dr.HasRows = True Then
                While dr.Read
                    Me.ddl_saleperson.Items.Add(dr.Item(0))
                End While
                Me.ddl_saleperson.Items.Add("...")
                Me.ddl_saleperson.SelectedIndex = 0
            End If
            dr.Close()
            obj.closecn()
    ...
    Protected Sub imb_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            If LTrim(RTrim(Me.txt_countcode_sortno.Text)) = "" Then
                FMsg.Message = "Pl. enter Count/Sort No. "
                FMsg.CssClass = "errormsg"
                FMsg.Display()
                Me.txt_countcode_sortno.Focus()
                Exit Sub
            End If

            ''-----ReFill GridView1
            sqlpass = "exec jct_costing_process_costing_fetch_upto_spinning '" & _
                        LTrim(RTrim(Me.ddl_action.Text)) & "','" & _
                        LTrim(RTrim(Me.ddl_location.Text)) & "','" & _
                        LTrim(RTrim(Me.txt_countcode_sortno.Text)) & "','" & _
                        Left(LTrim(RTrim(Me.ddl_ratetype.Text)), 1) & "','" & _
                        LTrim(RTrim(Me.txt_partycode.Text)) & "','" & _
                        LTrim(RTrim(Me.txt_partyname.Text)) & "','" & _
                        LTrim(RTrim(Me.ddl_saleperson.Text)) & "','" & _
                        Now().Date & "','','" & _
    ...
    Protected Sub imb_tran_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_tran_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "VIEW" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "CANCEL" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "SHORT CLOSE" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "AUTHORIZE" Then
            ...
            sqlpass = "select distinct case isnull(a.status,'') when 'O' then 'OPEN' " & _
                    "when 'A' then 'AUTHORIZE' when 'C' then 'CANCEL' " & _
                    "when 'S' then 'DELETE' when 'F' then 'FINISH' end, " & _
                    "count_code, case when rate_type = 'B' then 'BOOK' " & _
                    "when rate_type = 'M' then 'MARKET' end, " & _
                    "party_code, party_name, sale_person " & _
                "from jct_costing_process_costing_header a " & _
            ...
            If dr.HasRows = True Then
                ...
                If LTrim(RTrim(dr.Item(0))) = "CANCEL" Or LTrim(RTrim(dr.Item(0))) = "DELETE" Or LTrim(RTrim(dr.Item(0))) = "AUTHORIZE" Then
                    ...
                    Else
                        ...
                        Me.txt_countcode_sortno.Text = dr.Item(1)
                        Me.ddl_ratetype.Text = dr.Item(2)
                        Me.txt_partycode.Text = dr.Item(3)
                        Me.txt_partyname.Text = dr.Item(4)
                        Me.ddl_saleperson.Text = dr.Item(5)
                    End If
                Else
    ...
    Protected Sub imb_excel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_excel.Click
        ...
        Dim filename As String = "cost.xls"
    ...
    Protected Sub ddl_action_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_action.SelectedIndexChanged
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then ''And Me.lbt_add.Text = "ADD" Then
            ...
            If Me.lbt_add.Text = "ADD" Then
                ...
                Me.txt_countcode_sortno.Enabled = True
                Me.ddl_ratetype.Enabled = True
                Me.txt_partycode.Enabled = True
                Me.txt_partyname.Enabled = True
                Me.ddl_saleperson.Enabled = True
                ...
                Me.imb_fetch_partycode.Enabled = True
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Then ''And Me.lbt_modify.Text = "MODIFY" Then
            ...
            If Me.lbt_modify.Text = "MODIFY" Then
                ...
                Me.txt_countcode_sortno.Enabled = False
                Me.ddl_ratetype.Enabled = False
                Me.txt_partycode.Enabled = False
                Me.txt_partyname.Enabled = False
                Me.ddl_saleperson.Enabled = False
                ...
                Me.imb_fetch_partycode.Enabled = False
    ...
    Protected Sub lbt_apply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbt_apply.Click
        ...
        If LTrim(RTrim(Me.txt_countcode_sortno.Text)) = "" Then
            FMsg.Message = "Pl. enter Count Code/Sort No."
            FMsg.CssClass = "errormsg"
            FMsg.Display()
            Me.txt_countcode_sortno.Focus()
            Exit Sub
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            Try
                ...
                sqlpass = "exec jct_costing_process_costing_entry '" & _
                            LTrim(RTrim(Me.ddl_action.Text)) & "'," & _
                            sno1 & ",'" & Now() & "','" & _
                            UCase(LTrim(RTrim(Me.txt_tranno.Text))) & "','" & _
                            UCase(LTrim(RTrim(Me.ddl_location.Text))) & "','" & _
                            UCase(LTrim(RTrim(Me.txt_countcode_sortno.Text))) & "','" & _
                            Left(LTrim(RTrim(Me.ddl_ratetype.Text)), 1) & "','" & _
                            LTrim(RTrim(Me.txt_partycode.Text)) & "','" & _
                            LTrim(RTrim(Me.txt_partyname.Text)) & "','" & _
                            LTrim(RTrim(Me.ddl_saleperson.Text)) & "','" & _
            ...
            Try
                ...
                If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Then
                    ...
                    sqlpass = "select top 1 system_date " & _
                        "from jct_costing_process_costing_header " & _
                        "where location='" & LTrim(RTrim(Me.ddl_location.Text)) & "' " & _
                    ...
                    sqlpass = "delete from jct_costing_process_costing_header " & _
                                "where location='" & LTrim(RTrim(Me.ddl_location.Text)) & "' " & _
                                "and tran_no='" & LTrim(RTrim(Me.txt_tranno.Text)) & "' " & _
                                "and left(status,1)='O' " & _
                                "and company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "' "
        ...
        ''STORE HERE EACH ACTIVITY IN ACTION TABLE
                sqlpass = "insert into jct_costing_action_detail (count_code,tran_no,date,detail,userid,hostname,company_code) " & _
                        "Select '" & LTrim(RTrim(Me.txt_countcode_sortno.Text)) & "','" & sno2 & "',getdate(),'" & _
    ...
    Protected Sub imb_fetch_partycode_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_fetch_partycode.Click

        ''-----Fill Party Name Box
        sqlpass = "select ltrim(rtrim(a.vendor_name))+', '+ltrim(rtrim(a.city)) " & _
                "from miserp.common.dbo.pur_company_vendor_master a " & _
                "where ltrim(rtrim(a.vendor_code)) = '" & Me.txt_partycode.Text & "' " & _
                "and upper(ltrim(rtrim(a.vendor_status)))='A' " & _
                "and upper(ltrim(rtrim(a.company_code)))='" & UCase(LTrim(RTrim(Session("companycode")))) & "' "
        ...
        If dr.HasRows = True Then
            dr.Read()
            Me.txt_partyname.Text = dr.Item(0)
        End If
        dr.Close()
        obj.closecn()
