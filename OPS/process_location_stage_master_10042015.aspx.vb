...
Imports System.Math
Partial Class Costing_process_location_stage_master
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            sqlpass = "/*select b.action,b.mnuname,b.description,b.parent_menu,b.seq " & _
                ...
                " where a.module ='OPS' and a.uname='" & Session("empcode") & "' and a.mnuname='Location & Stage Master'" & _
                ...
                "and a.mnuname='Location & Stage Master' and a.action<>'Load'" & _
            ...
            sqlpass = "select distinct top 1 process_stage_desc, eff_to, seq_no " & _
                    "from jct_costing_process_location_stage_master " & _
            ...
            ''-----Fill GridView1
            sqlpass = "exec jct_costing_process_location_stage_master_fetch_all '" & _
    ...
    Protected Sub ddl_action_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_action.SelectedIndexChanged
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then ''And Me.lbt_add.Text = "ADD" Then
            ...
            If Me.lbt_add.Text = "ADD" Then
                ...
                Me.txt_process_location_code.Enabled = True
                Me.txt_process_location_desc.Enabled = True
                Me.ddl_process_stage_code.Enabled = True
                Me.txt_process_stage_code.Enabled = True
                Me.txt_process_stage_desc.Enabled = True
                Me.txt_seqno.Enabled = True
                Me.imb_newcode.Enabled = True
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Then ''And Me.lbt_modify.Text = "MODIFY" Then
            ...
            If Me.lbt_modify.Text = "MODIFY" Then
                ...
                Me.txt_process_location_code.Enabled = False
                Me.txt_process_location_desc.Enabled = False
                Me.ddl_process_stage_code.Enabled = False
                Me.txt_process_stage_code.Enabled = False
                Me.txt_process_stage_desc.Enabled = False
                Me.txt_seqno.Enabled = True
                Me.imb_newcode.Enabled = False
                Me.txt_efffrom.Enabled = True
                Me.txt_effto.Enabled = True
    ...
    Protected Sub lbt_apply_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbt_apply.Click
        ...
        If LTrim(RTrim(Me.txt_seqno.Text)) = "" Then
            FMsg.Message = "Pl. enter Seq. No. "
            FMsg.CssClass = "errormsg"
            FMsg.Display()
            Me.txt_seqno.Focus()
            Exit Sub
        ...
        Else
            FMsg.Message = "Something wrong in Eff./Exp. Date"
            FMsg.CssClass = "errormsg"
            FMsg.Display()
            Me.txt_efffrom.Focus()
            dr.Close()
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "ADD" Then
            ...
            Try
                ...
                "when 2 then '00' when 3 then '0' when 4 then '' end + ltrim(rtrim(convert(char,isnull(count_value,0)+1))) + ltrim(rtrim(suffix)) " & _
                "from jct_costing_serial_number_master " & _
                "where type_code='PLS' " & _
                ...
                If dr.HasRows = True Then
                    ...
                    If greater = "N" Then
                        ...
                        If same = "Y" Then
                            ...
                            Exit Sub
                        Else
                            sqlpass = "update jct_costing_process_location_stage_master set eff_to=convert(datetime,'" & efrom & "')-1 " & _
                                    "where location='" & LTrim(RTrim(Me.ddl_location.Text)) & "' " & _
                                    "and process_location_code='" & LTrim(RTrim(Me.ddl_process_location_code.Text)) & "' " & _
                                    "and process_stage_code='" & LTrim(RTrim(Me.ddl_process_stage_code.Text)) & "' " & _
                ...
                sqlpass = "exec jct_costing_process_location_stage_master_entry '" & _
                            LTrim(RTrim(Me.ddl_action.Text)) & "'," & _
                            sno1 & ",'" & Now() & "','" & _
                            ...
                            LTrim(RTrim(Me.txt_seqno.Text)) & ",'" & _
                            efrom & "','" & _
                            eto & "','" & _
                            UCase(LTrim(RTrim(Session("empcode")))) & "','" & _
                            UCase(LTrim(RTrim(Session("companycode")))) & "'"
        ...
        If (UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "CANCEL" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "SHORT CLOSE" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "AUTHORIZE") Then
            ...
            Try
                ...
                sqlpass = "select case isnull(a.status,'') when 'O' then 'OPEN' when 'A' then 'AUTHORIZE' when 'C' then 'CANCEL' when 'S' then 'DELETE' when 'F' then 'FINISH' end " & _
                    "from jct_costing_process_location_stage_master a " & _
                    "where location='" & LTrim(RTrim(Me.ddl_location.Text)) & "' " & _
                ...
                If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Then
                    ...
                    sqlpass = "delete from jct_costing_process_location_stage_master " & _
                            "where location='" & LTrim(RTrim(Me.ddl_location.Text)) & "' " & _
                            "and tran_no='" & LTrim(RTrim(Me.txt_tranno.Text)) & "' " & _
                            "and left(status,1)='O' " & _
                            "and company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "' "
                ...
                If Val(Me.txt_seqno.Text) > 0 Then
                    cmd = New SqlCommand(sqlpass, obj.cn)
                    cmd.Transaction = btran
                    cmd.ExecuteNonQuery()
                End If
    ...
    Protected Sub imb_top_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_top.Click
        ...
        If Me.ddl_action.Text <> "ADD" Then
            ...
            sqlpass = "select top 1 a.tran_no, a.location, " & _
                    "a.process_location_code, a.process_location_desc, a.process_stage_code, a.process_stage_desc, " & _
                    "a.seq_no, convert(varchar(11),a.eff_from,101) 'eff_from', " & _
            ...
            If dr.HasRows = True Then
                ...
                Me.ddl_process_location_code.Text = dr.Item(2)
                Me.lbl_process_location_desc.Text = dr.Item(3)
                Me.ddl_process_stage_code.Text = dr.Item(4)
                Me.lbl_process_stage_desc.Text = dr.Item(5)
                Me.txt_seqno.Text = dr.Item(6)
                Me.txt_efffrom.Text = dr.Item(7)
                Me.txt_effto.Text = dr.Item(8)
                Me.lbl_status.Text = dr.Item(9)

                dr.Close()
                obj.closecn()

                ''-----ReFill GridView1
                'sqlpass = "exec jct_costing_process_location_stage_master_fetch '" & _
                '            LTrim(RTrim(Me.ddl_action.Text)) & "','" & _
    ...
    Protected Sub imb_tran_fetch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_tran_fetch.Click
        ...
        If UCase(LTrim(RTrim(Me.ddl_action.Text))) = "MODIFY" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "VIEW" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "CANCEL" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "SHORT CLOSE" Or UCase(LTrim(RTrim(Me.ddl_action.Text))) = "AUTHORIZE" Then
            ...
            If dr.HasRows = True Then
                ...
                ''-----ReFill GridView1
                'sqlpass = "exec jct_costing_process_location_stage_master_fetch '" & LTrim(RTrim(Me.ddl_action.Text)) & "','" & _
                '            LTrim(RTrim(Me.ddl_location.Text)) & "','" & _
                '            LTrim(RTrim(Me.ddl_process_location_code.Text)) & "','" & _
                '            LTrim(RTrim(Me.ddl_process_stage_code.Text)) & "','" & _
                '            LTrim(RTrim(Me.txt_tranno.Text)) & "','" & _
    ...
    Protected Sub txt_process_location_code_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_process_location_code.TextChanged

        If LTrim(RTrim(Me.txt_process_location_code.Text)) <> "" And UCase(Me.ddl_action.Text) = "ADD" Then

            Dim i As Integer

            Me.txt_process_location_code.Text = UCase(Me.txt_process_location_code.Text)

            For i = 0 To Me.ddl_process_location_code.Items.Count() - 1
                ''GridView1.Rows.Count - 1
                If LTrim(RTrim(Me.txt_process_location_code.Text)) = LTrim(RTrim(Me.ddl_process_location_code.Items(i).Text)) Then
                    FMsg.Message = "Process Location Code already exists "
                    FMsg.CssClass = "errormsg"
                    FMsg.Display()
                    Me.txt_process_location_code.Focus()
                    Exit Sub
                End If
            Next

            'Me.ddl_process_location_code.Items.Add(LTrim(RTrim(Me.txt_process_location_code.Text)))
            'Me.ddl_process_location_code.Text = Me.txt_process_location_code.Text

        End If

    End Sub

    Protected Sub txt_process_stage_code_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_process_stage_code.TextChanged

        If LTrim(RTrim(Me.txt_process_stage_code.Text)) <> "" And UCase(Me.ddl_action.Text) = "ADD" Then

            Dim i As Integer

            Me.txt_process_stage_code.Text = UCase(Me.txt_process_stage_code.Text)

            For i = 0 To Me.ddl_process_stage_code.Items.Count() - 1
                ''GridView1.Rows.Count - 1
                If LTrim(RTrim(Me.txt_process_stage_code.Text)) = LTrim(RTrim(Me.ddl_process_stage_code.Items(i).Text)) Then
                    FMsg.Message = "Process Stage Code already exists "
                    FMsg.CssClass = "errormsg"
                    FMsg.Display()
                    Me.txt_process_stage_code.Focus()
                    Exit Sub
                End If
            Next

            'Me.ddl_process_stage_code.Items.Add(LTrim(RTrim(Me.txt_process_stage_code.Text)))
            'Me.ddl_process_stage_code.Text = Me.txt_process_stage_code.Text
    ...
    Protected Sub ddl_process_location_code_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_process_location_code.SelectedIndexChanged
        ...
        ''-----Fill Process Location Code Desc. Text Box
        sqlpass = "select distinct top 1 process_location_desc, eff_to " & _
                "from jct_costing_process_location_stage_master " & _
                "where process_location_code='" & Me.ddl_process_location_code.Text & "' " & _
                "and company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "' " & _
    ...
    Protected Sub ddl_process_stage_code_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_process_stage_code.SelectedIndexChanged
        ...
        ''-----Fill Process Stage Code Desc. Text Box
        sqlpass = "select distinct top 1 process_stage_desc, eff_to, seq_no " & _
                "from jct_costing_process_location_stage_master " & _
                "where process_stage_code='" & Me.ddl_process_stage_code.Text & "' " & _
                "and company_code='" & UCase(LTrim(RTrim(Session("companycode")))) & "' " & _
    ...
    Protected Sub txt_seqno_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_seqno.TextChanged
        ...
        '    Me.txt_process_location_code.Text = ""

        '    Me.lbl_process_location_desc.Text = Me.txt_process_location_desc.Text
        '    Me.txt_process_location_desc.Text = ""
        ...
        '    Me.txt_process_stage_code.Text = ""

        '    Me.lbl_process_stage_desc.Text = Me.txt_process_stage_desc.Text
    ...
    Protected Sub txt_process_stage_desc_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_process_stage_desc.TextChanged

        Me.lbl_process_stage_desc.Text = Me.txt_process_stage_desc.Text

    End Sub

    Protected Sub txt_process_location_desc_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_process_location_desc.TextChanged

        Me.lbl_process_location_desc.Text = Me.txt_process_location_desc.Text

    End Sub

    Protected Sub imb_add_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imb_newcode.Click
