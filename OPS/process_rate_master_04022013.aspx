...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%; height: 291px;">
        ...
        <tr>
            <td style="width: 123px; height: 3px">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label10" runat="server" CssClass="labelcells" Text="Eff. From" 
        ...
        <tr>
            <td style="width: 123px; height: 2px">
            ...
            <td style="height: 2px">
                <asp:Label ID="Label11" runat="server" CssClass="labelcells" Text="Eff. To"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label19" runat="server" CssClass="labelcells" 
                    Text="Recovery UOM" Width="100px"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="height: 13px">
                <asp:Label ID="Label20" runat="server" CssClass="labelcells" 
                    Text="Recovery Method"></asp:Label>
            </td>
            <td style="height: 13px">
