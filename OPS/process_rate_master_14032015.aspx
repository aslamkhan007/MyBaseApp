                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddl_process_location_code" runat="server" 
                            CssClass="combobox" Width="100px" AutoPostBack="True">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddl_process_uom" runat="server" CssClass="combobox" 
                            ...
                            <asp:ListItem>SPINDLES</asp:ListItem>
                            <asp:ListItem>EXSPDYEAR</asp:ListItem>
                            <asp:ListItem>EXSPDSHIFT</asp:ListItem>
                            <asp:ListItem>HANKS</asp:ListItem>
                            <asp:ListItem>EXHNKYEAR</asp:ListItem>
                            <asp:ListItem>EXHNKSHIFT</asp:ListItem>
                        </asp:DropDownList>
