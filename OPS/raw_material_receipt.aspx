...
<%--    <script type="text/javascript">
    ...
    {
        var x = document.GetelementbyId("txt_itemcode");

        $find('AutoCompleteExtender2').set_contextKey(x.value);
    ...
    <table style="width: 100%; height: 335px;">
        ...
        <tr>
            <td style="height: 35px; " colspan="2">
                <asp:Label ID="Label1" runat="server" Text="Raw Material Purchase"></asp:Label>
             </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:ImageButton ID="imb_set_new_payterm" runat="server" Height="16px" 
                            ...
                            <div id="divwidth3" style="display: none;">
                        ...
                        CompletionListItemCssClass="AutoExtenderList" CompletionSetCount="20"
                            MinimumPrefixLength="1" ServiceMethod="GetPaytermcode" 
        ...
        <tr>
            <td style="width: 78px">
                <asp:Label ID="Label39" runat="server" CssClass="labelcells" Text="Other Value" 
                    Width="70px"></asp:Label>
            </td>
            <td style="width: 96px">
                <asp:UpdatePanel ID="UpdatePanel43" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txt_other_value" runat="server" CssClass="textbox" 
                            Width="80px"></asp:TextBox>
                        <cc1:FilteredTextBoxExtender ID="FTBE9" runat="server" 
                            TargetControlID="txt_other_value" ValidChars="0123456789.">
                        </cc1:FilteredTextBoxExtender>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
