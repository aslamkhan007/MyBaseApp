...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%; height: 335px;">
        ...
        <tr>
            ...
            <td style="height: 17px">
                <asp:Label ID="Label29" runat="server" CssClass="labelcells" Text="Supp. Code"></asp:Label>
            </td>
            <td style="height: 17px">
        ...
        <tr>
            <td style="width: 71px; height: 17px;">
                <asp:Label ID="Label13" runat="server" CssClass="labelcells" 
                    Text="Pay Term Code" Width="90px"></asp:Label>
            </td>
            <td style="height: 17px; " colspan="3">
            ...
            <td style="height: 17px">
                <asp:Label ID="Label15" runat="server" CssClass="labelcells" 
                    Text="From (m/d/y)" Width="80px"></asp:Label>
                </td>
            <td style="height: 17px">
            ...
            <td style="height: 17px">
                <asp:Label ID="Label16" runat="server" CssClass="labelcells" 
                    Text="To (m/d/y)" Width="80px"></asp:Label>
            </td>
            <td style="height: 17px">
            ...
            <td style="height: 6px" colspan="5">
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:TextBox ID="txt_item_desc" runat="server" CssClass="textbox" Width="448px"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="width: 96px; height: 3px;">
                 <asp:UpdatePanel ID="UpdatePanel40" runat="server">
                     <ContentTemplate>
                         <asp:DropDownList ID="ddl_uom" runat="server" CssClass="combobox" Width="84px">
            ...
            <td style="height: 3px; width: 55px;">
                <asp:Label ID="Label23" runat="server" CssClass="labelcells" Text="Lead Time" 
        ...
        <tr>
            <td style="width: 71px">
                <asp:Label ID="Label22" runat="server" CssClass="labelcells" Text="Last Landed Rate" 
                    Width="70px"></asp:Label>
            </td>
            <td style="width: 96px">
                <asp:UpdatePanel ID="UpdatePanel27" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txt_last_rate" runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
            ...
            <td colspan="5">
                <asp:UpdatePanel ID="UpdatePanel38" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txt_reason" runat="server" CssClass="textbox" Width="400px"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td>
