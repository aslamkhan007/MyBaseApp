<%@ Page Title="" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false"
    CodeFile="sanctionnote_authrized.aspx.vb" Inherits="OPS_sanctionnote_authrized" %>
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:misjctdev %>"
                    SelectCommand="Jct_Ops_Pending_Authorization_Count_Fetch_manish_For_authrizedonly" SelectCommandType="StoredProcedure">
                    <SelectParameters>
    ...
    <table style="width: 100%;" class="tableback">
        ...
        <tr>
            <td width="200">
                Userlevel</td>
            <td>
                <asp:TextBox ID="txtuserlevel" runat="server" CssClass="textbox"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ControlToValidate="txtuserlevel" ErrorMessage="**Give userlevel" 
                    ValidationGroup="GrpApply"></asp:RequiredFieldValidator>
            </td>
            <td>
                &nbsp;</td>
            ...
            <td class="buttonbackbar" colspan="4">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        ...
                        <asp:LinkButton ID="lnkmailsent" runat="server" CssClass="buttonc">MailSent</asp:LinkButton>
                    </ContentTemplate>
                </asp:UpdatePanel>
        </tr>
        <tr>
