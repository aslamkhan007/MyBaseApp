...
Partial Class OPS_sanctionnote_authrized
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            qry = "Jct_Ops_authrized_request '" & Session("Empcode") & "','" & AreaName & "'"
        ...
        Try
            ...
            Else
                ...
                If e.CommandName = "Select" Then
                    ...
                    If AreaName <> "" And AreaName <> "Greigh Transfer" And AreaName <> "ODS Request" And AreaName <> "Outsourced Yarn" And AreaName <> "Outsourced Fabric" Then
                    ...
                    ElseIf AreaName = "Outsourced Yarn" OrElse AreaName = "Outsourced Fabric" Then
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Try
            ...
            If (GridView1.SelectedRow.Cells(3).Text = "1014") Then
                ...
                qry = "Exec Jct_Ops_authrized_request_Detail '" & Trim(GridView1.SelectedRow.Cells(2).Text) & "','" & Trim(GridView1.SelectedRow.Cells(3).Text) & "'"
    ...
    Protected Sub CmdAuthorize_Click(sender As Object, e As System.EventArgs) Handles CmdAuthorize.Click
        ...
        Try
            ...
            Dim Body As String = ""
            Dim Body3 As String = ""
            Dim AuthorizedBy_name As String
            ...
            Dim sql As String = ("Select Remarks,b.empname AS usercode,c.empname AS empname from JCT_OPS_SanctionNote_AUTHORIZATION_LISTING a JOIN dbo.JCT_EmpMast_Base b ON a.usercode=b.empcode   JOIN  dbo.JCT_EmpMast_Base c ON a.empcode=c.empcode  where  ID = '" + Trim(GridView1.SelectedRow.Cells(2).Text) + "' and userlevel = '" & UserLevel & "'")
            ...
            If dr.HasRows Then
                While dr.Read()
                    AuthorizedBy_name = dr(2).ToString()
                    txtRemarks.Text = dr(0).ToString()
                    RaisedByUserName = dr(1).ToString()
                    ...
                    If .SelectedIndex > -1 Then
                        ...
                        If GridView1.SelectedRow.Cells(1).Text <> "" Or GridView1.Rows.Count >= 1 Then
                            ...
                            If AreaCode <> 9999 Then
                                ...
                                CurrentUserLevel = txtuserlevel.Text

                                'objFun.FetchValue(qry, con, Tran)
                                ...
                                MaxAuthLevel = txtuserlevel.Text      ' objFun.FetchValue(qry, con, Tran)
                        ...
                        Else ' Else part executed for all sanction note other than Exceptions
                            Try
                                ...
                                Next
                                Body3 = "<br/> </a><br /><br /> <p>This mail is a system generated mail and sent to you just for your information.Please do not reply.</p><p>Thanks,<br/>JCT LTD, Phagwara</p>"
                                '   Body3 = "Testing ok"
                                '  CurrentUserLevel = ""
                                ...
                                Else
                                    'SendMail(Body, Body1, Body3, "", SendMailTo, AuthorizedBy, "Ashish@jctltd.com,harendra@jctltd.com,rbaksshi@jctltd.com", "SanctionNote :-" & SanctionNote & "  has been " & ddlAction.SelectedItem.Text & "", SanctionNote, CurrentUserLevel, MaxAuthLevel, FinalNotify, ddlAction.SelectedItem.Text)
                                End If
    ...
    '        bcc = "Ashish@jctltd.com,shwetaloria@jctltd.com"
    '        ' cc = "jatindutta@jctltd.com"
    '        '    subject = "Authorized Shortfall Request - " & Convert.ToString(OrderNo)
    ...
    '        If [to] = "rohits@jctltd.com" Or [to] = "jatindutta@jctltd.com" Then
    ...
    '            from = "approvals@jctltd.com"
    '            cc = NotifyAllList & ",ashish@jctltd.com"
    '            sb.AppendLine("<html>")
    '            sb.AppendLine("<br/><br/>")
    '            sb.AppendLine("Please reply this email with 'YES'  to authorise and  'NO' to cancel and 'REMARKS'.<br/> <br/>")
    ...
    Private Sub SendMail(RaisedBy_Email As String, [to] As String, cc As String, bcc As String, Subject As String, SanctionNote As String, CurrentLevel As Int16, MaxLevel As Int16, NotifyAllList As String, Action As String)
        ...
        Dim Query As String = "SELECT isnull(E_MailID,'') FROM dbo.MISTEL WHERE empcode='" & [to] & "' "
        SenderEmail = [to] 'objFun.FetchValue(query)
        ...
        UserLevel = txtuserlevel.Text
        sql = ("Select Remarks,b.empname AS usercode,c.empname AS empname,a.empcode from JCT_OPS_SanctionNote_AUTHORIZATION_LISTING a JOIN dbo.JCT_EmpMast_Base b ON a.usercode=b.empcode   JOIN  dbo.JCT_EmpMast_Base c ON a.empcode=c.empcode  where  ID = '" + Trim(GridView1.SelectedRow.Cells(2).Text) + "' and userlevel = '" & UserLevel & "'")
        Dim cmd As New SqlCommand(sql, obj.Connection)
        ...
        If dr.HasRows Then
            While dr.Read()
                ...
                txtRemarks.Text = dr(0).ToString()
                RaisedByUserName = dr(1).ToString()
                ViewState("empcode") = dr(3).ToString()
        ...
        sql = "Select e_mailid from mistel where empcode='" & ViewState("empcode") & "'"
        ...
        If (Left(Action, 1) = "A") Then
            ...
            sb.AppendLine("Last Authorized by : " + AuthorizedBy_name + "<br /><br/>")
        ...
        ElseIf (Left(Action, 1) = "C") Then
            ...
            If (Dr.HasRows) Then
                While (Dr.Read())
                    ...
                    ElseIf (Dr(7).ToString() = "C") Then
                        sb.AppendLine("<tr><th> Invoice No</th> <th> Sort</th> <th> Customer</th> <th> Sale Person</th> <th> Invoice Qty</th> <th> Return Qty</th>  <th> Status</th> </tr>")
                        sb.AppendLine("<tr> <td> " & Dr(0).ToString & " </td> <td> " & Dr(1).ToString & "  </td>  <td> " & Dr(2).ToString & "</td>  <td>" & Dr(3).ToString & " </td>  <td>" & Dr(4).ToString & " </td>  <td>" & Dr(5).ToString & "</td>  <td>Cancelled</td> </tr> ")
                    End If
            ...
            bcc = "shwetaloria@jctltd.com,manishk@jctltd.com"
        ...
        mail.Body = body
        [to] = "shwetaloria@jctltd.com,manishk@jctltd.com"
        mail.IsBodyHtml = True
        mail.DeliveryNotificationOptions = DeliveryNotificationOptions.OnFailure
        Dim SmtpMail As New SmtpClient("exchange2k7")
    ...
    Private Sub EMail(ByVal SanctionNote As String)
        ...
        Try
            ...
            sql = "  SELECT USERLEVEL,b.empname AS AuthorisedBy,Remarks,AUTH_DATETIME AS  AuthorisationDate FROM dbo.JCT_OPS_SanctionNote_AUTHORIZATION_LISTING  a INNER JOIN dbo.JCT_EmpMast_Base b ON a.EMPCODE=b.empcode and status is null WHERE ID IN ('" + SanctionNote + "') order by userlevel asc"
            cmd3 = New SqlCommand(sql, obj3.Connection())
            Dr3 = cmd3.ExecuteReader()
            If (Dr3.HasRows) Then
            ...
            sql = "SELECT distinct b.E_MailID FROM dbo.jct_ops_material_request  a INNER JOIN dbo.MISTEL b ON a.userid=b.empcode WHERE RequestID='" + SanctionNote + "' "
            If (objFun.CheckRecordExistInTransaction(sql)) Then
                cc = objFun.FetchValue(sql).ToString()
                ' cc = "manishk@jctltd.com"
            Else
            ...
            ' [to] = "manishK@jctltd.com"

            Dim EmpName As String = String.Empty
            Dim E_MailID As String = String.Empty

            sql = "SELECT b.name,E_MailID FROM dbo.JCT_OPS_SanctionNote_AUTHORIZATION_LISTING a INNER  JOIN dbo.MISTEL b ON a.EMPCODE=b.empcode AND a.ID='" & GridView1.SelectedRow.Cells(2).Text.Trim() & "' AND (a.AUTH_DATETIME IS NOT NULL OR a.CANCEL_DATETIME IS NOT NULL) AND a.USERLEVEL=(SELECT MAX(USERLEVEL) FROM JCT_OPS_SanctionNote_AUTHORIZATION_LISTING WHERE id='" & GridView1.SelectedRow.Cells(2).Text.Trim() & "' AND (AUTH_DATETIME IS NOT NULL OR CANCEL_DATETIME IS NOT NULL))"
            cmd3 = New SqlCommand(sql, obj3.Connection())
            Dr3 = cmd3.ExecuteReader()
            If (Dr3.HasRows) Then
                Dr3.Read()
            ...
            bccA = "shwetaloria@jctltd.com,ashish@jctltd.com,manishk@jctltd.com"
            ...
            If Not String.IsNullOrEmpty(cc) Then
                ...
                If bccA.Contains(",") Then
                    Dim bccs As String() = bccA.Split(","c)
                    For i As Integer = 0 To bccs.Length - 1
                        mail.Bcc.Add(New MailAddress(bccs(i)))
                    Next
                Else
    ...
    Protected Sub lnkmailsent_Click(sender As Object, e As System.EventArgs) Handles lnkmailsent.Click



        ViewState(ID) = GridView1.SelectedRow.Cells(2).Text

        Dim cmd As New SqlCommand("OPS_MR_Email_Resend_log_insert", obj.Connection())
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@SanctionID", SqlDbType.VarChar, 20).Value = ViewState(ID)
        cmd.Parameters.Add("@Resend_by", SqlDbType.VarChar, 20).Value = Session("empcode")
