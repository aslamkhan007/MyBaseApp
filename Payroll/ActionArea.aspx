<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="ActionArea.aspx.cs" Inherits="Payroll_ActionArea" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3" class="buttonbackbar" style="text-align: left">
                <asp:Label ID="Label1" runat="server" Text="Leave Authorization" Width="202px"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <ew:CollapsablePanel ID="PnlExtTasks" CssClass="panelcells" runat="server" Height="320px"
