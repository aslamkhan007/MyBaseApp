<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="CrystalViewHsp.aspx.cs" Inherits="Payroll_CrystalViewHsp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <%--<form id="form2" runat="server">
    ...
    <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
        <Report FileName="Payroll_Salary_Sheet_HSP.rpt">
        </Report>
