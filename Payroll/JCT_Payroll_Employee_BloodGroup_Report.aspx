<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="JCT_Payroll_Employee_BloodGroup_Report.aspx.cs" Inherits="Payroll_JCT_Payroll_Employee_BloodGroup_Report" %>
            ...
            <td class="NormalText">
                 <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox"
                    ...
                    AutoPostBack="True">
                     ...
                     <asp:ListItem Selected="True">BloodGroup</asp:ListItem>
