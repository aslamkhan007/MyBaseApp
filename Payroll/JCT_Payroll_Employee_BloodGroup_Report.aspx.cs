...
public partial class Payroll_JCT_Payroll_Employee_BloodGroup_Report : System.Web.UI.Page
{
    ...
    {
        string sql = "SELECT DISTINCT 'All' as group_name  union SELECT group_name FROM JCT_payroll_blood_master where status='A' order by group_name ";
        ...
        ddl1.Items.Clear();
        ddl1.DataSource = ds;
        ddl1.DataTextField = "group_name";
        ddl1.DataValueField = "group_name";
        ddl1.DataBind();
    }
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "JCT_Payroll_Employee_BloodGroup_Report";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd.Parameters.Add("@BloodGroup", SqlDbType.VarChar, 20).Value = ddl1.SelectedItem.Value;
            cmd.ExecuteNonQuery();
            SqlDataAdapter Da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            Da.Fill(ds);
