...
public partial class Payroll_JCT_Payroll_Employee_DepartmentCount : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "JCT_Payroll_Employee_DepartmentCount_Query";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd.Parameters.Add("@DepartmentCode", SqlDbType.VarChar, 20).Value = ddl2.SelectedItem.Value;
            cmd.ExecuteNonQuery();
            SqlDataAdapter Da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            Da.Fill(ds);
    ...
    {
        SqlCommand sqlCmd = new SqlCommand("Select 'All' as DepartmentCode, 'All' as DepartmentLongDescription union   SELECT Department_code as DepartmentCode,Department_long_Description as DepartmentLongDescription FROM JCT_payroll_department_master WHERE  STATUS='A'  order by DepartmentLongDescription", obj.Connection());
        sqlCmd.CommandType = CommandType.Text;
        SqlDataAdapter da = new SqlDataAdapter(sqlCmd);
        DataSet ds = new DataSet();
        da.Fill(ds);
        ddl2.Items.Clear();
        ddl2.DataSource = ds;
        ddl2.DataTextField = "DepartmentLongDescription";
        ddl2.DataValueField = "DepartmentCode";
        ddl2.DataBind();
