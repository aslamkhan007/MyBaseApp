...
public partial class Payroll_JCT_Payroll_Employee_DesignationCount : System.Web.UI.Page
{
    ...
    public void Designationbind()
    {
        ...
        ddl2.Items.Clear();
        ddl2.DataSource = ds;
        ddl2.DataTextField = "Desg_Long_Description";
        ddl2.DataValueField = "Designation_code";
        ddl2.DataBind();
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "JCT_Payroll_Employee_DesignationCount_Query";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd.Parameters.Add("@DesignationCode", SqlDbType.VarChar, 20).Value = ddl2.SelectedItem.Value;
            cmd.ExecuteNonQuery();
            SqlDataAdapter Da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            Da.Fill(ds);
