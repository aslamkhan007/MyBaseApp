<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="JCT_Payroll_Employee_Detail.aspx.cs" Inherits="Payroll_JCT_Payroll_Employee_Detail" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox"
                    ...
                    <asp:ListItem>GenderCount</asp:ListItem>
                    <asp:ListItem Selected="True">EmployeeDetail</asp:ListItem>
