<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="JCT_Payroll_Employee_GenderCount.aspx.cs" Inherits="Payroll_JCT_Payroll_Employee_GenderCount" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox"
                    ...
                    <asp:ListItem Selected="True">GenderCount</asp:ListItem>
