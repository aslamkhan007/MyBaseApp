<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="JCT_Payroll_Employee_PlantLocationCount.aspx.cs" Inherits="Payroll_JCT_Payroll_Employee_PlantLocationCount" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox"
                    ...
                    <asp:ListItem Selected="True" >PlantLocationCount</asp:ListItem>
                    <asp:ListItem >GenderCount</asp:ListItem>
                    <asp:ListItem>JobTypeCount</asp:ListItem>
                    <asp:ListItem>ReligionCount</asp:ListItem>
