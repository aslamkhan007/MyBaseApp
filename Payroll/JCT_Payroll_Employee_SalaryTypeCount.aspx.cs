...
public partial class Payroll_JCT_Payroll_Employee_SalaryTypeCount : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "JCT_Payroll_Employee_SalaryTypeCount_Query";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd.Parameters.Add("@SalaryType", SqlDbType.VarChar, 15).Value = ddl2.SelectedItem.Value;
            cmd.ExecuteNonQuery();
            SqlDataAdapter Da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            Da.Fill(ds);
