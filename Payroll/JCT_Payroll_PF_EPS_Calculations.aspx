<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="JCT_Payroll_PF_EPS_Calculations.aspx.cs" Inherits="Payroll_JCT_Payroll_PF_EPS_Calculations" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtypes" runat="server" CssClass="combobox" 
                    ...
                    <asp:ListItem Selected="True">PF EPS Calculation</asp:ListItem>
                    <asp:ListItem>PF Transfer</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td class="labelcells">
            </td>
