...
public partial class Payroll_JCT_Payroll_PF_EPS_transfer : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "JCT_Payroll_PFEPS_EmployeePortal";
            ...
            string scripts = "alert('PF Transfer Completed');";
