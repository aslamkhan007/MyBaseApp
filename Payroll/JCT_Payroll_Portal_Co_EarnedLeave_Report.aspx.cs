...
public partial class Payroll_JCT_Payroll_Portal_Co_EarnedLeave_Report : System.Web.UI.Page
{
    ...
    {
        if (ddlReportType.SelectedItem.Text == "Earned")
        {

            try
            {
                string sql = "JCT_Payroll_Portal_Co_EarnedLeave_Report";
                SqlCommand cmd = new SqlCommand(sql, obj.Connection());
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        else if (ddlReportType.SelectedItem.Text == "Laps")
        {
            try
            {
                string sql = "Jct_Payroll_Laps_Co_Detail";
                SqlCommand cmd = new SqlCommand(sql, obj.Connection());
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.Add("@Plant", SqlDbType.VarChar, 10).Value = ddlplant.SelectedItem.Value;
    ...
    {
        Response.Redirect("JCT_Payroll_Portal_Co_EarnedLeave_Report.aspx");
    }    
}