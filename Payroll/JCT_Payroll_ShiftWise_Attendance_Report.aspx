<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="JCT_Payroll_ShiftWise_Attendance_Report.aspx.cs" Inherits="Payroll_JCT_Payroll_ShiftWise_Attendance_Report" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox"
                    ...
                    <asp:ListItem Selected="True">ShiftWise Attendance</asp:ListItem>
