...
public partial class Payroll_JCT_Payroll_Tax_AbsentEarning_Update : System.Web.UI.Page
{
    ...
    protected void lnksave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "JCT_Payroll_Absent_EarningUpdates_Tax";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    {
        Response.Redirect("JCT_Payroll_Tax_AbsentEarning_Update.aspx");
    }
