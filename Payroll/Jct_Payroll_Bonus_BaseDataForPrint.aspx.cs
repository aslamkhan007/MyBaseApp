...
public partial class Payroll_Jct_Payroll_Bonus_BaseDataForPrint : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("Jct_Payroll_Bonus_BaseDataForPrint.aspx");
    }
    ...
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        sql = "Jct_Payroll_Bonus_PaySheet";
        ...
        cmd.Parameters.Add("@user", SqlDbType.VarChar, 50).Value = Session["EmpCode"];
        cmd.ExecuteNonQuery();
