...
public partial class Payroll_Jct_Payroll_Bonus_costcenterwiserreport : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("Jct_Payroll_Bonus_costcenterwiserreport.aspx");
    }
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        if (ddlreporttype.SelectedItem.Value == "Detail")
        {
            string qry = ConfigurationManager.ConnectionStrings["misjctgen"].ToString();
            SqlConnection con = new SqlConnection(qry);
            con.Open();
            sql = "Jct_Payroll_Bonus_CostCenterWise_DetailReport";
        ...
        {   
            ...
            SqlConnection con = new SqlConnection(qry);
            con.Open();
            sql = "Jct_Payroll_Bonus_CostCenterWise_SummaryReport";
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandTimeout = 0;
            cmd.Parameters.Add("@FyPd", SqlDbType.VarChar, 10).Value = txttodates.Text;
