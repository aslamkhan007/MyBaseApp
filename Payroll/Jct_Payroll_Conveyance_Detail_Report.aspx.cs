...
public partial class Payroll_Jct_Payroll_Conveyance_Detail_Report : System.Web.UI.Page
{
    ...
    {
        SqlCommand sqlCmd = new SqlCommand("SELECT 'All' as  Designation_code,'All' as Desg_Long_Description Union SELECT Designation_code,Desg_Long_Description FROM JCT_payroll_designation_master WHERE  STATUS='A' order by Desg_Long_Description", obj.Connection());
    ...
    protected void ddldedtype_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddldedtype.SelectedItem.Value == "Reimbursment")
        {
            Response.Redirect("Jct_Payroll_Conveyance_Detail_Report.aspx");
        }

        if (ddldedtype.SelectedItem.Value == "LeaveEncashment")
        {
            Response.Redirect("Jct_Payroll_LeaveEncashment_Report.aspx");
        }

        if (ddldedtype.SelectedItem.Value == "LTC")
        {
            Response.Redirect("LtaandLtcReport.aspx");
        }

        if (ddldedtype.SelectedItem.Value == "Reimbursment(ii)")
        {
    ...
    public void Componentlist()
    {
        ...
        string sql = "Jct_Payroll_Reimbursement_ParameterList_Dropdown";
    ...
    public void FetchRecord()
    {
        ...
        //SqlPass = "Jct_Payroll_Converyance_Calculation_Report";
        SqlPass = "Jct_Payroll_Reimbursment_Report";        
