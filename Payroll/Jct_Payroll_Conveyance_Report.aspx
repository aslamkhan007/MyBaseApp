<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_Conveyance_Report.aspx.cs" Inherits="Payroll_Jct_Payroll_Conveyance_Report" %>
    ...
    <table class="mytable">
        ...
        <tr>
          ...
          <%--      Pay Status--%>
            ...
            <td class="NormalText">
<%--                <asp:DropDownList ID="ddlpaid" runat="server" AutoPostBack="True" CssClass="combobox"
                    OnSelectedIndexChanged="ddldedtype_SelectedIndexChanged" AppendDataBoundItems="True"
                    DataTextField="Deduction_Short_Description" DataValueField="Deduction_code">
