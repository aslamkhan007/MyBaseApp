...
public partial class Payroll_Jct_Payroll_Conveyance_Report : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("Jct_Payroll_Conveyance_Report.aspx");
    }
    ...
    public void FetchRecord()
    {
        ...
        //SqlPass = "Jct_Payroll_Converyance_Fetch";
        SqlPass = "Jct_Payroll_Converyance_Unpaid_Report";
        ...
        //}
        //Cmd.Parameters.Add("@PaidStatus", SqlDbType.VarChar,10).Value = ddlpaid.SelectedItem.Value;                        
        SqlDataAdapter Da = new SqlDataAdapter(Cmd);
        DataSet ds = new DataSet();
        Da.Fill(ds);
