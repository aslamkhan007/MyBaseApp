<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Jct_Payroll_DepartmentWise_Overtime.aspx.cs" Inherits="Payroll_Jct_Payroll_DepartmentWise_Overtime" %>
       ...
       <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMonth"
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:UpdatePanel ID="Updatedepartment" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddldepartment" runat="server" AutoPostBack="True" CssClass="combobox">
                        </asp:DropDownList>
