<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Jct_Payroll_Hr_SuperannuationReport.aspx.cs" Inherits="Payroll_Jct_Payroll_Hr_SuperannuationReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddlplant" runat="server" CssClass="combobox" OnSelectedIndexChanged="ddlplant_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td class="labelcells">
                Report Type
            ...
            <td class="NormalText">
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="combobox" 
                    ...
                    <asp:ListItem Value="Yes">MEMBER</asp:ListItem>
                    <asp:ListItem Value="No">NONMERMBER</asp:ListItem>
                    <asp:ListItem Value="Mrg">MERGESALARY</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
