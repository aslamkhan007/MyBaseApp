<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_LeaveEncashment_Report.aspx.cs" Inherits="Payroll_Jct_Payroll_LeaveEncashment_Report" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox" OnSelectedIndexChanged="ddldedtype_SelectedIndexChanged"
                    ...
                    <asp:ListItem Selected="True">LeaveEncashment</asp:ListItem>
