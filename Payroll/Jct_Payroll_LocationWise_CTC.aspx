<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_LocationWise_CTC.aspx.cs" Inherits="Payroll_Jct_Payroll_LocationWise_CTC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="mytable">
        ...
        <tr>
            <td class="labelcells">
                <asp:Label ID="lblamount" runat="server">VariablePayAmount</asp:Label>
            </td>
            <td class="NormalText">
               
                <asp:TextBox ID="txtBasic" runat="server" CssClass="textbox" Width="90px" MaxLength="15"></asp:TextBox>
         ...
         <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox" AppendDataBoundItems="True"
                    DataTextField="Deduction_Short_Description" DataValueField="Deduction_code" AutoPostBack="True">
         ...
         <tr>
            ...
            <td class="NormalText" colspan="3">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Width="80px"
