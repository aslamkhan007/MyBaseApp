<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_OvertimeEntry_New.aspx.cs" Inherits="Payroll_Jct_Payroll_OvertimeEntry_New" %>
            ...
            <td class="NormalText">
                      ...
                      <%--  <asp:TextBox ID="TxtOvertimeDate" runat="server" Style="text-transform: capitalize;"
                        ...
                        <cc1:MaskedEditExtender ID="MaskedEditExtender4" runat="server" TargetControlID="TxtOvertimeDate"
                           ...
                           <asp:TextBox ID="TxtOvertimeDate" runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
                <%--       <cc1:CalendarExtender ID="txttodate_CalendarExtender" runat="server" 
                    Enabled="True" TargetControlID="txttodate">
                </cc1:CalendarExtender>--%>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtOvertimeDate"
