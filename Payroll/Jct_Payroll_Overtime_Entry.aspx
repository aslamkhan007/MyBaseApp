<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_Overtime_Entry.aspx.cs" Inherits="Payroll_Jct_Payroll_Overtime_Entry" %>
...
<%--                     <asp:TextBox ID="txttimefrom" runat="server" CssClass="textbox" MaxLength="15" ></asp:TextBox>
               ...
               <ew:TimePicker ID="txttimefrom" runat="server" Enabled="true" Width="63px" Text="..."
            ...
            <td class="textcells">
                   <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                <ew:TimePicker ID="TxtTimeTo" runat="server" Enabled="true" Width="63px" Text="..."
                    MinuteInterval="FifteenMinutes" PopupLocation="Bottom" CssClass="textbox" 
