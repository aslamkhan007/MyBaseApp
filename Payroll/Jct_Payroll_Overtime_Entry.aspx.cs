...
public partial class Payroll_Jct_Payroll_Overtime_Entry : System.Web.UI.Page
{
         ...
         try
          {
           ...
           if (x ==1)
           {
            string sql = "Jct_Payroll_Overtime_Detail_Insert";
    ...
    protected void lnkupdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sql = "Jct_Payroll_Overtime_Detail_Update";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@EmployeeCode", SqlDbType.VarChar, 10).Value = txtEmpCode.Text;
            cmd.Parameters.Add("@OvertimeDate", SqlDbType.DateTime).Value = Convert.ToDateTime(TxtOvertimeDate.Text);
    ...
    protected void lnkdelete_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "Jct_Payroll_Overtime_Detail_Delete";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@EmployeeCode", SqlDbType.VarChar, 10).Value = txtEmpCode.Text;
            cmd.Parameters.Add("@srno", SqlDbType.Int).Value = SrId.Text;
