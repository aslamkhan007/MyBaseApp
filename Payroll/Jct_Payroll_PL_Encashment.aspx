<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Jct_Payroll_PL_Encashment.aspx.cs" Inherits="Payroll_Jct_Payroll_PL_Encashment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:TextBox ID="txtPlBalnace" runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="txtPlBalnace_FilteredTextBoxExtender" runat="server"
                    Enabled="True" TargetControlID="txtPlBalnace" ValidChars=".0123456789">
                </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPlBalnace"
                    ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
                <br />
            </td>
            <td class="labelcells">
                <asp:Label ID="lastencashment" runat="server" Text="Last Encashment"></asp:Label>
            </td>
            <td class="labelcells">
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:TextBox ID="txtencashmentdays" runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="txtencashmentdays_FilteredTextBoxExtender" runat="server"
                    Enabled="True" TargetControlID="txtencashmentdays" ValidChars=".0123456789">
                </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtencashmentdays"
                    ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
            </td>
            <td class="NormalText">
                &nbsp;
        ...
        <tr>
            <td class="buttonbackbar" colspan="4">
                ...
                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="buttonc" CausesValidation="False"
                    OnClick="lnkUpdate_Click1" Visible="False">Update</asp:LinkButton>
            </td>
        </tr>
    </table>
</asp:Content>
