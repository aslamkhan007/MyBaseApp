...
Partial Class Payroll_Jct_Payroll_SalarySlip_View_All
    ...
    Protected Sub textboxclick()
        Dim A, B, c As String
        lblHeader.Text = "Salary Slip - " & DTP2.SelectedItem.Text & "  " & DTP3.SelectedItem.Text & ""
        ''for DTP1 
        ...
        If Session("Companycode") = "JCT00LTD" Then
            ...
            SqlPass = "Jct_Payroll_Salary_Slip_Current"
        ...
        Else
            ...
            cmd = New SqlCommand("Jct_Payroll_Salary_Slip_Current", Obj.Connection())
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add("@Empcode", SqlDbType.VarChar, 10).Value = txtEmployee.Text
            cmd.Parameters.Add("@yearmonth", SqlDbType.VarChar, 10).Value = txttodate.Text
            cmd.Parameters.Add("@EmployeeCode", SqlDbType.VarChar, 10).Value = Session("Empcode")
            ...
            While Dr.Read()
                ...
                If CInt(c) < 200809 Then
                    ...
                    Try
                        ...
                        Me.MobTelCrg.Text = IIf(Dr.Item("TelmobCrg") = 0, "", Dr.Item("TelmobCrg"))
                        Me.GrdnCrg.Text = IIf(Dr.Item("GardeningCrg") = 0, "", Dr.Item("GardeningCrg"))

                        Me.vehloanhsp.Text = IIf(Dr.Item("VehicalLoanHSP") = 0, "", Dr.Item("VehicalLoanHSP"))
                        Me.lblSplalws.Text = IIf(Dr.Item("SpecialAllowance") = 0, "", Dr.Item("SpecialAllowance"))


                        Me.lblhraschools.Text = IIf(Dr.Item("HRASchool") = 0, "", Dr.Item("HRASchool"))
                        Me.lbleduallw.Text = IIf(Dr.Item("EductionalAllowance") = 0, "", Dr.Item("EductionalAllowance"))


                        Me.lblfathername.Text = Dr.Item("fathername")
                        Me.pfnos.Text = Dr.Item("PfNo")
                        Me.fpfnos.Text = Dr.Item("FpfNo")


                        Me.lblCovidloan.Text = IIf(Dr.Item("BankLoanCovid") = 0, "", Dr.Item("BankLoanCovid"))
    ...
    Protected Sub lnkreset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkreset.Click        
        Response.Redirect("Jct_Payroll_SalarySlip_View_All.aspx")
    End Sub
