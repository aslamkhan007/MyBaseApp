<%@ Page Title="" Language="VB" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="false" CodeFile="Jct_Payroll_SalarySlip_View_hsp.aspx.vb" Inherits="Payroll_Jct_Payroll_SalarySlip_View_hsp" %>
                                        ...
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 10px">
                                                    <asp:Label ID="Label24" runat="server" Height="13px" Text="Designation" Width="70px"></asp:Label>
                                                </td>
                                                <td class="labelcells" colspan="3" style="height: 10px;">
                                            ...
                                            <tr>
                                                <td class="labelcells" style="width: 77px; height: 1px">
                                                    <asp:Label ID="Label26" runat="server" Height="13px" Text="A/C No." Width="46px"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 10px;">
                                                    <asp:Label ID="Salary1lbl" runat="server" Height="13px" Text="Salary Loan" Width="88px"></asp:Label>
                                                </td>
                                                ...
                                                <td class="labelcells" style="width: 102px; height: 10px;">
                                                    ...
                                                    <asp:Label ID="lbl213" runat="server" Height="13px" Text="BusGrdCrg" Width="32px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 85px; height: 10px;">
                                                    
                                                    <asp:Label ID="BusGrd" runat="server" Height="13px" Width="65px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 55px; height: 13px;">
                                                    ...
                                                    <asp:Label ID="Label13" runat="server" Height="13px" Text="Adhoc" Width="32px"></asp:Label>
                                                </td>
                                                ...
                                                <td class="labelcells" style="width: 102px; height: 13px;">
                                                    ...
                                                    <asp:Label ID="lbl214" runat="server" Height="13px" Text="ServiceSecurity" Width="88px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 85px; height: 13px;">
                                                    
                                                    <asp:Label ID="ServiceSecurity" runat="server" Height="13px" Width="80px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 70px;">
                                                    ...
                                                    <asp:Label ID="Label101" runat="server" Height="13px" Text="DA/VDA/SPLDA" Width="58px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 51px;">
                                                    
                                                   <asp:Label ID="lblvda101" runat="server" Height="13px" Width="58px"></asp:Label>
                                                </td>
...
<asp:Label ID="Label42" runat="server" Height="13px" Text="P.F.Loan" Width="102px"></asp:Label>  
                                                ...
                                                <td class="labelcells" style="width: 102px;">
                                                    ...
                                                    <asp:Label ID="lbl215" runat="server" Height="13px" Text="Ptg/StgCrg" Width="32px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 85px;">
                                                    
                                                    
                                                        <asp:Label ID="PrintingStationary" runat="server" Height="13px" Width="80px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="labelcells" style="width: 77px; height: 1px;">
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 1px;">
                                                   <asp:Label ID="Label46" runat="server" Height="13px" Text="SocietyLoan" Width="91px"></asp:Label> 
                                                ...
                                                <td class="labelcells" style="width: 102px; height: 1px;">
                                                    ...
                                                    <asp:Label ID="lbl216" runat="server" Height="13px" Text="Tel/MobCrg" Width="88px"></asp:Label>
                                                    
                                                </td>
                                                <td class="labelcells" style="width: 85px; height: 1px;">
                                                    
                                                    <asp:Label ID="TelmobCrg" runat="server" Height="13px" Width="80px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 2px;">
                                                    <asp:Label ID="lbl208" runat="server" Height="13px" Text="Vehicle Loan." Width="105px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 2px; height: 2px;">
                                                    <asp:Label ID="VehicalLoanHSP" runat="server" Height="13px" Text="Label" Width="62px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 102px; height: 2px;">
                                                    
                                                    <asp:Label ID="lbl217" runat="server" Height="13px" Text="SocShr/FundTrf" Width="92px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 85px; height: 2px;">
                                                    
                                                    <asp:Label ID="SocCrg" runat="server" Height="13px" Width="76px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 7px;">
                                                   <asp:Label ID="Lable91" runat="server" Height="13px" Text="Veh.Stand Crg." Width="105px"></asp:Label> 
                                                ...
                                                <td class="labelcells" style="width: 102px; height: 7px;">
                                                    ...
                                                    <asp:Label ID="lbl218" runat="server" Height="13px" Text="MonetoryHelp" Width="91px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 85px; height: 7px;">
                                                    
                                                    <asp:Label ID="MonetaryHelp" runat="server" Height="13px" Width="80px"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
...
<asp:Label ID="lblBusTea" runat="server" Width="47px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 10px;">
                                                <asp:Label ID="Label94" runat="server" Text="Elec/RprCrg" Width="60px"></asp:Label>
     ...
     <asp:Label ID="electric" runat="server" Height="13px" Text="Label" Width="62px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <asp:Label ID="Label34" runat="server" Height="13px" Text="MessMeal/Security" Width="105px"></asp:Label>
     ...
     <asp:Label ID="Messexpense" runat="server" Height="13px" Text="Label" Width="62px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 55px; height: 5px;">
                                                    <asp:Label ID="lbl203" runat="server" Height="13px" Text="ConveyanceAlw" Width="62px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 51px; height: 5px;">
                                                    <asp:Label ID="Conveyancealw" runat="server" Height="13px" Text="Label" Width="62px"></asp:Label>
                                                </td>
                                                ...
                                                <td class="labelcells" style="width: 102px; height: 8px;">
                                                    <asp:Label ID="Label43" runat="server" Height="13px" Text="RD&Lic" Width="88px"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 55px; height: 2px;">
                                                   <asp:Label ID="lbl204" runat="server" Height="13px" Text="TPTADJ" Width="62px"></asp:Label> 
                                                </td>
                                                <td class="labelcells" style="width: 51px; height: 2px;">
                                                    <asp:Label ID="TPTAllowance" runat="server" Height="13px" Width="62px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 108px; height: 2px;">
                                                    <asp:Label ID="Label35" runat="server" Height="13px" Text="ClubMemberCrg." Width="100px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 51px; height: 5px;">
                                                    ...
                                                    <asp:Label ID="TelephoneAllowance" runat="server" Height="13px" Text="Label" Width="62px"></asp:Label>
                    
                                                </td>
                                                <td class="labelcells" style="width: 108px; height: 5px;">
                                                    
                                                    
                                                  <asp:Label ID="lbl211" runat="server" Height="13px" Text="Caffeteria." Width="96px"></asp:Label>  

                                                </td>
                                                <td class="labelcells" style="width: 2px; height: 5px;">
                                                    
                                                     <asp:Label ID="ClubCafeteria" runat="server" Height="13px" Width="80px"></asp:Label>   
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 55px; height: 5px;">
                                                      <asp:Label ID="lbl207" runat="server" Height="13px" Text="EducationAlw" Width="62px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 51px; height: 5px;">
                                                    <asp:Label ID="EductionalAllowance" runat="server" Height="13px" Text="Label" Width="62px"></asp:Label>
                                                </td>
                                                <td class="labelcells" style="width: 108px; height: 5px;">
                                                
                                                    
<asp:Label ID="lbl212" runat="server" Height="13px" Text="WorkerClubCrg" Width="105px"></asp:Label>
                                                    
                                                    
                                                </td>
                                                <td class="labelcells" style="width: 2px; height: 5px;">
                                                    
                                                    <asp:Label ID="WorkerClubDed" runat="server" Height="13px" Width="63px"></asp:Label>
...
<asp:Label ID="lbl221" runat="server" Height="13px" Text="LabourWelfare" Width="74px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 5px;">
                                                    ...
                                                    <asp:Label ID="lbl210" runat="server" Height="13px" Text="Pool/MemberCrg." Width="96px"></asp:Label>
                                             
                                                    </td>
                                                <td class="labelcells" style="width: 2px; height: 5px;">
                                                    <asp:Label ID="SwimCrg" runat="server" Height="13px" Width="80px"></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelcells" style="width: 108px; height: 5px;">
                                                    <asp:Label ID="Label96" runat="server" Height="13px" Text="GroupMedicalIns" Width="96px"></asp:Label>
                                                    </td>
                                                <td class="labelcells" style="width: 2px; height: 5px;">
