...
Partial Class Payroll_Jct_Payroll_SalarySlip_View_hsp
    ...
    Protected Sub txtEmployee_TextChanged(ByVal sender As Object, ByVal e As EventArgs)
        Try
            Dim employeecode As String = txtEmployee.Text.Split("|"c)(1).ToString()
            txtEmployee.Text = employeecode
        Catch exception As Exception
            txtEmployee.Text = ""
            Dim script As String = "alert('Please Select Record From List');"
            ScriptManager.RegisterStartupScript(Me, Me.[GetType](), "ServerControlScript", script, True)
        End Try
    End Sub
    ...
    Protected Sub DTP2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DTP2.SelectedIndexChanged
        ...
        If Session("Companycode") = "JCT00LTD" Then
            ...
            SqlPass = "Jct_Payroll_Salary_Slip_Hsp"
            ...
            cmd.Parameters.Add("@yearmonth", SqlDbType.VarChar, 10).Value = txttodate.Text
        ...
        Else
            ...
            cmd = New SqlCommand("Jct_Payroll_Salary_Slip_Hsp", Obj.Connection())
            cmd.CommandType = CommandType.StoredProcedure
            'cmd.Parameters.Add("@Empcode", SqlDbType.VarChar, 10).Value = Session("EmpCode")
            cmd.Parameters.Add("@Empcode", SqlDbType.VarChar, 10).Value = txtEmployee.Text
            cmd.Parameters.Add("@yearmonth", SqlDbType.VarChar, 10).Value = txttodate.Text
            ...
            While Dr.Read()
                ...
                Else
                    ...
                    Try
                        ...
                        'aslam commented to change field to SAL_ADV only
                        'Me.Salary1.Text = IIf(Val(Dr.Item("SAL_ADV") + Val(Dr.Item("SADV_LOAN"))) = 0, "", Val(Dr.Item("SAL_ADV") + Val(Dr.Item("SADV_LOAN"))))
                        Me.Salary1.Text = IIf(Dr.Item("LoanAgSalHSP") = 0, "", Dr.Item("LoanAgSalHSP"))
                        ...
                        Me.VPF.Text = IIf(Dr.Item("VPF") = 0, "", Dr.Item("VPF"))
                        Me.PFLoan.Text = IIf(Dr.Item("PFLoanHSP") = 0, "", Dr.Item("PFLoanHSP"))
                        Me.lblvda101.Text = IIf(Dr.Item("VDA") = 0, "", Dr.Item("VDA"))
                        'Me.Da.Text = IIf(Dr.Item("DearnessAllowance") = 0, "", Dr.Item("DearnessAllowance"))
                        'Me.SpecialDa.Text = IIf(Dr.Item("SpecialDA") = 0, "", Dr.Item("SpecialDA"))
                        Me.Conveyancealw.Text = IIf(Dr.Item("ConveyanceAllowance") = 0, "", Dr.Item("ConveyanceAllowance"))
                        Me.TelephoneAllowance.Text = IIf(Dr.Item("TelephoneAllowance") = 0, "", Dr.Item("TelephoneAllowance"))
                        Me.EductionalAllowance.Text = IIf(Dr.Item("EductionalAllowance") = 0, "", Dr.Item("EductionalAllowance"))

                        Me.VehicalLoanHSP.Text = IIf(Dr.Item("VehicalLoanHSP") = 0, "", Dr.Item("VehicalLoanHSP"))
                        ...
                        Me.TWCCSOCIETY.Text = IIf(Dr.Item("SocietyLoanHSP") = 0, "", Dr.Item("SocietyLoanHSP"))
                        ...
                        Me.Medicine.Text = IIf(Dr.Item("MedicineCrg") = 0, "", Dr.Item("MedicineCrg"))
                        Me.Clubcrg.Text = IIf(Dr.Item("CLUB") = 0, "", Dr.Item("CLUB"))
                        Me.ClubCafeteria.Text = IIf(Dr.Item("ClubCafeteria") = 0, "", Dr.Item("ClubCafeteria"))
                        Me.WorkerClubDed.Text = IIf(Dr.Item("WorkerClubDed") = 0, "", Dr.Item("WorkerClubDed"))

                        Me.SwimCrg.Text = IIf(Dr.Item("SwimCrg") = 0, "", Dr.Item("SwimCrg"))


                        Me.MedicalInsurance.Text = IIf(Dr.Item("GroupMedicalInsurnance") = 0, "", Dr.Item("GroupMedicalInsurnance"))
                        Me.LabourWelfare.Text = IIf(Dr.Item("LabourWelfareFund") = 0, "", Dr.Item("LabourWelfareFund"))

                        Me.BusGrd.Text = IIf(Dr.Item("BusGrd") = 0, "", Dr.Item("BusGrd"))
                        Me.ServiceSecurity.Text = IIf(Dr.Item("ServiceSecurity") = 0, "", Dr.Item("ServiceSecurity"))
                        Me.TelmobCrg.Text = IIf(Dr.Item("TelmobCrg") = 0, "", Dr.Item("TelmobCrg"))
                        Me.SocCrg.Text = IIf(Dr.Item("SocCrg") = 0, "", Dr.Item("SocCrg"))
                        Me.MonetaryHelp.Text = IIf(Dr.Item("MonetaryHelp") = 0, "", Dr.Item("MonetaryHelp"))

                        Me.TPTAllowance.Text = IIf(Dr.Item("TPTAllowance") = 0, "", Dr.Item("TPTAllowance"))
                        Me.PrintingStationary.Text = IIf(Dr.Item("PrintingStationary") = 0, "", Dr.Item("PrintingStationary"))
    ...
    Public Sub CheckPage()
        ...
        SqlPass = "Jct_Payroll_CheckPlantSalarySlip"
    ...
    Protected Sub lnkreset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkreset.Click
        Response.Redirect("Jct_Payroll_SalarySlip_View_hsp.aspx")
    End Sub
End Class
