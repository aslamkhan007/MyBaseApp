<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Jct_Payroll_Tax_Challan_Report.aspx.cs" Inherits="Payroll_Jct_Payroll_Tax_Challan_Report" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddlReporttypes" runat="server" CssClass="combobox" OnSelectedIndexChanged="ddlReporttypes_SelectedIndexChanged"
                    ...
                    <asp:ListItem Selected="True">ChallanReport</asp:ListItem>
        ...
        <tr>
            ...
            <td class="NormalText">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txttodate"
                    ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
                <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtendeqweqwr1" runat="server"
                    WatermarkCssClass="watermark" WatermarkText="202001" TargetControlID="txttodate">
                </cc1:TextBoxWatermarkExtender>
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtendqweqweer1" runat="server" Enabled="True"
