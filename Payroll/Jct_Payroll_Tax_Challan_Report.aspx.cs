...
public partial class Payroll_Jct_Payroll_Tax_Challan_Report : System.Web.UI.Page
{
    ...
    {
        sql = "Jct_Payroll_Tax_Challan_Report";
        SqlCommand cmd = new SqlCommand(sql, obj.Connection());
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@Plant", SqlDbType.VarChar, 10).Value = ddlplant.SelectedItem.Value;
        cmd.Parameters.Add("@FromYrMonth", SqlDbType.Int).Value = txttodate.Text;
        cmd.Parameters.Add("@ToYrMonth", SqlDbType.Int).Value = txtSerialNo.Text;
