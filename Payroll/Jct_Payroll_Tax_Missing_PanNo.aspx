<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_Tax_Missing_PanNo.aspx.cs" Inherits="Payroll_Jct_Payroll_Tax_Missing_PanNo" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddlReporttypes" runat="server" CssClass="combobox" OnSelectedIndexChanged="ddlReporttypes_SelectedIndexChanged"
                    ...
                    <asp:ListItem Selected="True">MissingPanNumber</asp:ListItem>
