...
public partial class Payroll_Jct_Payroll_Transport_GuestHouse_Report : System.Web.UI.Page
{
    ...
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        try
        {            
            sql = "Jct_Payroll_Transport_GuestHouse_Report";
            ...
            cmd.Parameters.Add("@ReimbursementType", SqlDbType.VarChar, 25).Value = ddlreimbursetype.SelectedItem.Value;
            cmd.Parameters.Add("@ChargableNonChargable", SqlDbType.VarChar, 3).Value = ddlChargableNonChargable.SelectedItem.Value;
            cmd.Parameters.Add("@PendingAuthorise", SqlDbType.VarChar, 1).Value = ddlPendingAuthorise.SelectedItem.Value;
    ...
    {
        Response.Redirect("Jct_Payroll_Transport_GuestHouse_Report.aspx");
    }
