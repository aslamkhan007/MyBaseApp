...
public partial class Payroll_Jct_Payroll_Upload_Reset : System.Web.UI.Page
{
    ...
    protected void lnkfetch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // cmd.Parameters.Add("@ComponentName", SqlDbType.VarChar, 25).Value = ddlReporttype.SelectedItem.Value;
            // cmd.ExecuteNonQuery();
            // string script = "alert('Reseting Successfull');";
