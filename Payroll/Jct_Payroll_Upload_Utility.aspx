<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Jct_Payroll_Upload_Utility.aspx.cs" Inherits="Payroll_Jct_Payroll_Upload_Utility" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                ...
                <asp:DropDownList ID="ddlPaymode" runat="server" CssClass="combobox"
                    ...
                    <asp:ListItem>ElectricityConsumption</asp:ListItem>
                    <asp:ListItem>MessMeal</asp:ListItem>
                    <asp:ListItem>MedicineExp</asp:ListItem>
                    <asp:ListItem>IncrementArrear </asp:ListItem>
                    <asp:ListItem>TaxDeclaration</asp:ListItem>
        ...
        <tr>
            <td class="buttonbackbar" colspan="4">
                ...
                <asp:LinkButton ID="lnkreset0" runat="server" CssClass="buttonc" 
                    ...
                    >Unfreeze</asp:LinkButton>
                <asp:LinkButton ID="lnkresetatt" runat="server" CssClass="buttonc" 
                    CausesValidation="False" onclick="lnkresetatt_Click" 
                    >ResetAttend.</asp:LinkButton>
            </td>
        </tr>
        <tr>
