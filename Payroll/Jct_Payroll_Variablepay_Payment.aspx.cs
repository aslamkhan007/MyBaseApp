...
public partial class Payroll_Jct_Payroll_Variablepay_Payment : System.Web.UI.Page
{
    ...
    public void Save()
    {
        ...
        SqlPass = "Jct_Payroll_VariablePay_Payment_Insert";
        ...
        Cmd.Parameters.Add("@EmployeeType", SqlDbType.VarChar, 10).Value = ddldedtype.SelectedItem.Value;
    ...
    public void BindGrid()
    {
        ...
        string SqlPass = null;
        SqlCommand Cmd = new SqlCommand();
        SqlPass = "Jct_Payroll_VariablePay_Payment_AutoBind";
        Cmd = new SqlCommand(SqlPass, obj.Connection());
        Cmd.CommandType = CommandType.StoredProcedure;        
        Cmd.Parameters.Add("@EmployeeCode", SqlDbType.VarChar, 20).Value = txtEmployee.Text;
    ...
    {
        Response.Redirect("Jct_Payroll_Variablepay_Payment_Report.aspx");
    }
}