<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Jct_Payroll_Workflow_Request_Entry.aspx.cs" Inherits="Payroll_Jct_Payroll_Workflow_Request_Entry" %>
        ...
        <tr>
            <td class="buttonbackbar" colspan="4">
                ...
                <asp:LinkButton ID="lnkFreeze0" runat="server" CssClass="buttonc" ValidationGroup="A"
                    OnClick="lnkFreeze0_Click">Plant Hier.</asp:LinkButton>
                <asp:LinkButton ID="lnkFreeze1" runat="server" CssClass="buttonc" ValidationGroup="A"
                    OnClick="lnkFreeze1_Click">DeActivate</asp:LinkButton>
                <asp:LinkButton ID="lnkFreeze2" runat="server" CssClass="buttonc"
                    OnClick="lnkFreeze2_Click">Report</asp:LinkButton>
                <asp:LinkButton ID="lnkFreeze3" runat="server" CssClass="buttonc"
                    OnClick="lnkFreeze3_Click">PortalRights</asp:LinkButton>
            </td>
        </tr>
        <tr>
