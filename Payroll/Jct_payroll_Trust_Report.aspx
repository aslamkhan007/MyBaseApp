<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Jct_payroll_Trust_Report.aspx.cs" Inherits="Payroll_Jct_payroll_Trust_Report" %>
...
<tr>
            ...
            <td class="NormalText">
                ...
                <asp:ListItem Selected ="True">Refundable Loan</asp:ListItem>
                <asp:ListItem>NonRefundable Loan</asp:ListItem>
                </asp:DropDownList>               
            </td>
            <td class="NormalText">
            </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server" Height="350px" ScrollBars="Both" Width="950px">
                            <asp:GridView ID="grdDetail" runat="server" EmptyDataText="No Record Found " EnableModelValidation="True" Width = "100%"
