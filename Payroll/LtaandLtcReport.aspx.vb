...
Partial Class Payroll_LtaandLtcReport
    ...
    Public Sub BindData()
        ...
        Try
            ...
            SqlPass = "Jct_Payroll_Ltc_Report"
    ...
    Protected Sub ddlReporttype_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlReporttype.SelectedIndexChanged
        If (ddlReporttype.SelectedItem.Value = "Reimbursment") Then

            Response.Redirect("Jct_Payroll_Conveyance_Detail_Report.aspx")
        End If

        If (ddlReporttype.SelectedItem.Value = "LeaveEncashment") Then

            Response.Redirect("Jct_Payroll_LeaveEncashment_Report.aspx")

        End If

        If (ddlReporttype.SelectedItem.Value = "LTC") Then
