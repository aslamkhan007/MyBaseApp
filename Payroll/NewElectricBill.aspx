<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="NewElectricBill.aspx.cs" Inherits="Payroll_NewElectricBill" %>
    ...
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText">
                ...
                <cc1:AutoCompleteExtender ID="txtEmployee_AutoCompleteExtender" runat="server" DelimiterCharacters=""
                    ...
                    ServiceMethod="GetEmployee_sh_Common_Employeecodewise" ServicePath="~/WebService.asmx" MinimumPrefixLength="1">
        ...
        <tr>
            <td class="NormalText">
                Rate</td>
            <td class="NormalText">
                <asp:TextBox ID="txtdedamount0" runat="server" CssClass="textbox" Visible="False"
                    Width="80px"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="txtdedamount0_FilteredTextBoxExtender" runat="server"
                    Enabled="True" TargetControlID="txtdedamount0" ValidChars=".0123456789">
                </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtdedamount0"
                    ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
            </td>
            <td class="NormalText">
                Amount</td>
            <td class="NormalText">
                <asp:TextBox ID="txtdedamount1" runat="server" CssClass="textbox" Visible="False"
                    Width="80px"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="txtdedamount1_FilteredTextBoxExtender" runat="server"
                    Enabled="True" TargetControlID="txtdedamount1" ValidChars=".0123456789">
                </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtdedamount1"
                    ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
