<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Payroll_Arear_Confirm_Entry.aspx.cs" Inherits="Payroll_Payroll_Arear_Confirm_Entry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" AutoPostBack="True" CssClass="combobox"
                    ...
                    <asp:ListItem Selected="True">Confirm</asp:ListItem>
                    <asp:ListItem>Fda</asp:ListItem>
        ...
        <tr>
            ...
            <td class="NormalText">
             <asp:TextBox ID="TextBox3" runat="server" CssClass="textbox" Width="80px" MaxLength="7"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                    Enabled="True" TargetControlID="TextBox3" ValidChars=".0123456789">
                </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="req6" runat="server" ControlToValidate="TextBox3"
                    ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
            </td>
        </tr>
