<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Payroll_Arear_PayDay_Entry.aspx.cs" Inherits="Payroll_Payroll_Arear_PayDay_Entry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="mytable">
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" AutoPostBack="True" CssClass="combobox"
                   ...
                   <asp:ListItem Selected="True">PayDays</asp:ListItem>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:TextBox ID="txtdedamount" runat="server" CssClass="textbox" Width="50px" MaxLength="4"></asp:TextBox>
