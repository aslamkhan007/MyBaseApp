<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="Payroll_Employee_Relocate_Print.aspx.cs" Inherits="Payroll_Payroll_Employee_Relocate_Print" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Payroll_Salary_Employee_Relocate.rpt">
        </Report>
