<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true"
    CodeFile="Payroll_Salary_Sheet_Deparmentwise_Print.aspx.cs" Inherits="Payroll_Payroll_Salary_Sheet_Deparmentwise_Print" %>
    ...
    <table class="mytable">
        <tr>
            <td class="tableheader" colspan="4">
                Salary Sheet (Departmentwise) Report:
            </td>
        </tr>
        <tr>
            <td class="labelcells">
        ...
        <tr>
            ...
            <td class="NormalText">
              ...
              <asp:DropDownList ID="ddlDeparment" runat="server" AutoPostBack="True"                     
