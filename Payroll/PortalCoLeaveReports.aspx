<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/MasterPage.master" AutoEventWireup="true" CodeFile="PortalCoLeaveReports.aspx.cs" Inherits="Payroll_PortalCoLeaveReports" %>
        ...
        <tr>
            ...
            <td class="NormalText">
                <asp:DropDownList ID="ddldedtype" runat="server" CssClass="combobox"
                    ...
                    <asp:ListItem Selected="True" >EarnedLeave</asp:ListItem>                    
                </asp:DropDownList>
            </td>
            <td class="labelcells">
                &nbsp;
