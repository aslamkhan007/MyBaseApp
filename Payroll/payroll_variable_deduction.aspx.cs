...
public partial class PayRoll_payroll_variable_deduction : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("Jct_Payroll_Variable_Components_List", obj.Connection());
    ...
    public void CheckExistingRecords()
    {
        ...
        {
            string employeecode = txtEmployee.Text.Split('|')[1].ToString();
            string sql = "Jct_Payroll_Variable_Deduction_Fetch";
            SqlCommand cmd = new SqlCommand(sql, obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    {
        Response.Redirect("payroll_variable_deduction.aspx");
    }
    protected void lnkUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            string employeecode = txtEmployee.Text.Split('|')[1].ToString();
            SqlCommand cmd = new SqlCommand("jct_payroll_variable_deduction_Update", obj.Connection());
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@deduction_type", SqlDbType.VarChar, 10).Value = ddldedtype.SelectedItem.Value;
            cmd.Parameters.Add("@empcode", SqlDbType.VarChar, 30).Value = employeecode;
            if (txtdedamount.Visible == true)
    ...
    protected void txtdedamount_TextChanged(object sender, EventArgs e)
    {
        lnksave.Focus();
    }
}