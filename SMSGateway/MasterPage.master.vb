...
Partial Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) 'Handles Me.Load
        ...
        If IsPostBack = False Then
            '            obj2.RegAppHit(Session("Companycode"), Session("Empcode"), "SMS Gateway", Request.UserHostAddress)
            Menu1.Items.Clear()
            obj.opencn()
            qry = "select b.description,page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='smsgateway' and uname='" & Session("empcode") & "' union select b.description,page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='smsgateway' and uname='" & Trim(Session("empcode")) & "' order by parent_menu,seq"
    ...
    Private Function GetMenuData() As DataTable
        ...
        Try
            ...
            Dim strSQL As String = "select b.description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname where a.module ='smsgateway' and uname='" & Session("Empcode") & "' union select b.description,page_name=isnull(replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.module = c.module and b.mnuname=c.mnuname  where a.module ='smsgateway' and uname='" & Trim(Session("Empcode")) & "' order by parent_menu,seq" '"select b.description,page_name=isnull(page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..user_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname left outer join jctdev..JCT_Menu_Form_Mapping c on b.mnuname=c.mnuname where a.module ='Costing System' and uname='" & Session("Empcode") & "' union select b.description,page_name=isnull(page_name=replace(replace(replace(isnull(c.page_name,''),'~',''),'/',''),'\',''),''),parent_menu,seq from production..role_module_menus_mapping a inner join production..modules_menu_master b on a.module=b.module and a.mnuname=b.mnuname inner join production..role_user_mapping e on a.role=e.role left outer join jctdev..JCT_Menu_Form_Mapping c on b.mnuname=c.mnuname  where a.module ='Costing System' and uname='" & Trim(Session("Empcode")) & "' order by parent_menu,seq"
