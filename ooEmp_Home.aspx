    ...
    <table style="background-position: center 0px; width: 100%; vertical-align: middle;
        ...
        <tr>
            <td style="vertical-align: top">
                <%-- <div runat="server" id="ParentDiv" style="background-position: center 0px; width: 100%;
        height: 100%; vertical-align: middle; text-align: center; background-image: url('Image/Plain_Footer.png');
        background-repeat: no-repeat; display: block; overflow: scroll;">--%>
                <%--</div>--%>
